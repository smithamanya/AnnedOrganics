...
<!-- Mirrored from www.w3schools.com/xsl/tryxslt.asp?xmlfile=cdcatalog&xsltfile=cdcatalog_apply by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:14 GMT -->
<head>
...
<xsl:template match="artist">
  ...
  <div class="w3-col l12">
	...
	<iframe class="result_output" style="width:100%;height:100%;background-color:#ffffff;border:1px solid rgb(169, 169, 169);" frameborder="0" name="view" src="tryxslt_result0e31.html?xmlfile=cdcatalog&amp;xsltfile=cdcatalog_apply"></iframe>
  </div>    
</div>
</div>
</form>
