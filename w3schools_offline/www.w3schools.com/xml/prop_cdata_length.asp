...
<!-- Mirrored from www.w3schools.com/xml/prop_cdata_length.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:58 GMT -->
<head>
...
<h1>XML DOM cdata <span class="color_h1">length</span> Property</h1>
<hr>
...
into xmlDoc and gets the text node data and length from the first &lt;title&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	...
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; x.data + &quot; 
	- Length: &quot; + x.length; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
<b>Stunning!</b> - Length: 16
</div>
<a target="_blank" href="tryita123.asp?filename=try_dom_cdata_length" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
