...
<!-- Mirrored from www.w3schools.com/xml/met_comment_deletedata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:00 GMT -->
<head>
...
into xmlDoc and deletes some characters from first comment node:</p>
...
<a target="_blank" href="tryit992d.asp?filename=try_dom_comment_deletedata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
