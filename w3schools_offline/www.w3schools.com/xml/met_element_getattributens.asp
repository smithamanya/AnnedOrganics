...
<!-- Mirrored from www.w3schools.com/xml/met_element_getattributens.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:51 GMT -->
<head>
...
into xmlDoc and gets the &quot;lang&quot; attribute value from the first &lt;title&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	"books_ns.xml", true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	var x = xmlDoc.getElementsByTagName("title")[0];<br>&nbsp;&nbsp;&nbsp; var 
	ns = "<a href="../children/index.html">http://www.w3schools.com/children/</a>";<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById("demo").innerHTML =<br>&nbsp;&nbsp;&nbsp; 
	x.getAttributeNS(ns, "lang");<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
en
</div>
<a target="_blank" href="tryit9c59.asp?filename=try_dom_element_getattributens" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
