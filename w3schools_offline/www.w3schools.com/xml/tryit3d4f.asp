...
<!-- Mirrored from www.w3schools.com/xml/tryit.asp?filename=try_dom_change_nodevalue2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:36 GMT -->
<head>
...
function myFunction(xml) {
    ...
    document.getElementById("demo1").innerHTML = txt; 
     for (i = 0; i < x.length; i++) {
         x[i].childNodes[0].nodeValue = "changed";
    }
    txt = ""; 
    for (i = 0; i < x.length; i++) { 
        txt += x[i].childNodes[0].nodeValue + "<br>";
