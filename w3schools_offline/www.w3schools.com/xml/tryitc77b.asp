...
<!-- Mirrored from www.w3schools.com/xml/tryit.asp?filename=try_dom_xmlhttprequest by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:33 GMT -->
<head>
...
function loadXMLDoc() {
  ...
  xhttp.open("GET.html", "xmlhttp_info.txt", true);
  xhttp.send();
}
</script>
