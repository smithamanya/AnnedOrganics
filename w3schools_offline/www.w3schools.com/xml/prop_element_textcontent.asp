...
<!-- Mirrored from www.w3schools.com/xml/prop_element_textcontent.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:50 GMT -->
<head>
...
into xmlDoc and gets text nodes from the first &lt;title&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = 
	xmlDoc.getElementsByTagName(&quot;title&quot;)[0];<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; &quot;Text 
	Nodes: &quot; + x.textContent;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
Text Nodes: Everyday Italian
</div>
<a target="_blank" href="tryita05f.asp?filename=try_dom_textcontent" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> This property does not work in Internet Explorer 9 (it 
returns undefined).</p>
<h2>Syntax</h2>
<p>Return text:</p>
...
<h3>Example 2</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and gets text nodes from the first &lt;book&gt; element, and replaces all nodes with a new text node:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = 
	xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; &quot;Before: &quot; 
	+ x.textContent + &quot;&lt;br&gt;&quot;;<br><br>&nbsp;&nbsp;&nbsp; x.textContent = &quot;hello&quot;;<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML +=<br>&nbsp;&nbsp;&nbsp; &quot;After: &quot; 
	+ x.textContent;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
Before: Everyday Italian Giada De Laurentiis 2005 30.00<br>
After: hello
</div>
<a target="_blank" href="tryita042.asp?filename=try_dom_textcontent2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
