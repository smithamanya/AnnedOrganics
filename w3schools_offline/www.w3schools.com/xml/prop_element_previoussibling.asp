...
<!-- Mirrored from www.w3schools.com/xml/prop_element_previoussibling.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:49 GMT -->
<head>
...
into xmlDoc and gets the previous sibling node from the first &lt;author&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	...
	Check if the previous sibling node is an element node<br>function 
	get_previoussibling(n) {<br>&nbsp;&nbsp;&nbsp; var x = n.previousSibling;<br>&nbsp;&nbsp;&nbsp; 
	while (x.nodeType != 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = 
	x.previousSibling;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return x;<br>}<br><br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	var x = xmlDoc.getElementsByTagName(&quot;author&quot;)[0];<br>&nbsp;&nbsp;&nbsp; var y 
	= get_previoussibling(x);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
	= x.nodeName + &quot; = &quot; + <br>&nbsp;&nbsp;&nbsp; x.childNodes[0].nodeValue +<br>&nbsp;&nbsp;&nbsp; 
	&quot;&lt;br&gt;Previous sibling: &quot; + y.nodeName + &quot; = &quot; + <br>&nbsp;&nbsp;&nbsp; 
	y.childNodes[0].nodeValue;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
author = Giada De Laurentiis<br>
Previous sibling: title = Everyday Italian
</div>
<a target="_blank" href="tryitc905.asp?filename=try_dom_previoussibling" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit7944.asp?filename=try_dom_nextsibling2">nextSibling - Get the next sibling of a node</a></p>
<hr>
