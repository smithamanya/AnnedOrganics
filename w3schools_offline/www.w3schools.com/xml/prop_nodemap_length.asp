...
<!-- Mirrored from www.w3schools.com/xml/prop_nodemap_length.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:43 GMT -->
<head>
...
<hr>
<a href="dom_namednodemap.html"><img class="navup" src="../images/up.gif" alt="NamedNodeMap Object Reference" /> NamedNodeMap Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and gets the number of attributes in the first &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	xmlDoc.getElementsByTagName(&quot;book&quot;);<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; &quot;Number of 
	attributes in the first book element: &quot; +<br>&nbsp;&nbsp;&nbsp; x.item(0).attributes.length;<br>
	}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	Number of attributes in the first book element:
1</div>
<a target="_blank" href="tryit958e.asp?filename=try_dom_nodemap_length" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit1663.asp?filename=try_dom_length">length - Return the number of nodes in a node list</a></p>
<p><a target="_blank" href="tryit9b49.asp?filename=try_dom_length2">length - Loop through the nodes in a node list</a></p>
<hr>
