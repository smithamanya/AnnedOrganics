...
<!-- Mirrored from www.w3schools.com/xml/prop_documenttype_systemid.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:47 GMT -->
<head>
...
<hr>
<a href="dom_documenttype.asp"><img class="navup" src="../images/up.gif" alt="DocumentType Object Reference" /> DocumentType Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="note_external_dtd.xml">note_external_dtd.xml</a>&quot; 
into xmlDoc and displays the system id for the external DTD:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;note_external_dtd.xml&quot;, true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; 
	xmlDoc.doctype.systemId;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
note.dtd
</div>
<a target="_blank" href="tryit2d51.asp?filename=try_dom_systemid" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
