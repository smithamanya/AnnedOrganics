...
<!-- Mirrored from www.w3schools.com/xml/prop_element_tagname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:50 GMT -->
<head>
...
into xmlDoc and gets the tag name from the first &lt;title&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; x.tagName;<br>
	}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
title
</div>
<a target="_blank" href="tryitc081.asp?filename=try_dom_tagname2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
