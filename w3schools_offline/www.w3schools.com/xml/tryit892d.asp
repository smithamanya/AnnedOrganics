...
<!-- Mirrored from www.w3schools.com/xml/tryit.asp?filename=try_dom_removeattribute2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:37 GMT -->
<head>
...
function myFunction(xml) {
    ...
    xLen = x.length;
    txt = "";
    // Display the value of all "category" attributes
    for (i = 0; i < xLen; i++) {
