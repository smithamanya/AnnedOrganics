...
<!-- Mirrored from www.w3schools.com/xml/prop_attr_isid.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:54 GMT -->
<head>
...
into xmlDoc and returns whether the category attribute is an ID 
...
<div class="w3-code notranslate jsHigh">
	...
	&lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += 
	x.item(i).attributes[0].isId + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt;<br>}</div>
<a target="_blank" href="tryit84fc.asp?filename=try_dom_attr_isid" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
