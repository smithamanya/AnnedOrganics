...
<!-- Mirrored from www.w3schools.com/xml/prop_node_baseuri.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:39 GMT -->
<head>
...
into xmlDoc and returns the base URI of the &lt;title&gt; elements:</p>
<div class="w3-code notranslate jsHigh">
	...
	&quot;books_ns.xml&quot;, true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var 
	x, i, xmlDoc, txt;<br>    &nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.getElementsByTagName(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
	x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt +=&nbsp; 
	&quot;Base URI: &quot; + x.item(i).baseURI + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	Base URI: http://192.168.1.19/xml/books_ns.xml<br>Base URI: 
	http://192.168.1.19/xml/books_ns.xml</div>
<a target="_blank" href="tryitdada.asp?filename=try_dom_node_prefix" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
