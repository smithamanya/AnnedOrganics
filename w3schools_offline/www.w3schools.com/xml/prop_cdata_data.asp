...
<!-- Mirrored from www.w3schools.com/xml/prop_cdata_data.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:57 GMT -->
<head>
...
<h1>XML DOM cdata <span class="color_h1">data</span> Property</h1>
<hr>
<a href="dom_cdatasection.html"><img class="navup" src="../images/up.gif" alt="CDATA Object Reference" /> CDATA Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books_cdata.xml">books_cdata.xml</a>&quot; 
into xmlDoc and gets the data from all the &lt;html&gt; 
elements:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, 
	&quot;books_cdata.xml&quot;, true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, 
	xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
	x = xmlDoc.getElementsByTagName(&quot;html&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 
	0; i &lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt 
	+= x[i].childNodes[0].data + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
<b>Stunning!</b><br>
<i>Magic! Six stars!</i><br>
<a href="../xquery">Learn XQuery</a><br>
<a href="../xml">Learn XML</a>
</div>
<a target="_blank" href="tryit2990.asp?filename=try_dom_cdata_data" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/xml/prop_cdata_data.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:58 GMT -->
</html>
