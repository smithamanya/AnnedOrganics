...
<!-- Mirrored from www.w3schools.com/xml/prop_documenttype_name.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:47 GMT -->
<head>
...
into xmlDoc and displays the name of the DTD:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;note_internal_dtd.xml&quot;, true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; 
	xmlDoc.doctype.name;<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
note
</div>
<a target="_blank" href="tryita36e.asp?filename=try_dom_doctype_name" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
