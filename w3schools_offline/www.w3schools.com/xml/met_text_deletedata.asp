...
<!-- Mirrored from www.w3schools.com/xml/met_text_deletedata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:57 GMT -->
<head>
...
<a href="dom_text.html"><img class="navup" src="../images/up.gif" alt="Text Object Reference" /> Text Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and deletes some characters from the text node of the first &lt;title&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0];<br>
	&nbsp;&nbsp;&nbsp;
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; x.nodeValue;<br><br>
	&nbsp;&nbsp;&nbsp;
	x.deleteData(0, 9);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML +=<br>&nbsp;&nbsp;&nbsp; &quot;&lt;br&gt;&quot; 
	+ x.nodeValue;<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
	Everyday Italian<br>Italian</div>
<a target="_blank" href="tryit735b.asp?filename=try_dom_deletedata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
