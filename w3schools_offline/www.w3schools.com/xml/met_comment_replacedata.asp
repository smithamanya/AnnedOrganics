...
<!-- Mirrored from www.w3schools.com/xml/met_comment_replacedata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:00 GMT -->
<head>
...
into xmlDoc and replace &quot;Simple&quot; with &quot;Easy&quot; in the 
comment node of the first &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;books_comment.xml&quot;, true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, txt, xmlDoc;<br>&nbsp;&nbsp;&nbsp;&nbsp;xmlDoc = xml.responseXML;<br>&nbsp;&nbsp; 
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.getElementsByTagName(&quot;book&quot;)[0].childNodes;<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp; // Process only 
	comment nodes<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (x[i].nodeType 
	== 8) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x[i].replaceData(4, 6, &quot;Easy&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += x[i].data + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit1820.asp?filename=try_dom_comment_replacedata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>		
