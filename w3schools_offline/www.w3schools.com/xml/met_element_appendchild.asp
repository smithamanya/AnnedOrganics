...
<!-- Mirrored from www.w3schools.com/xml/met_element_appendchild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:50 GMT -->
<head>
...
<a href="dom_element.html"><img class="navup" src="../images/up.gif" alt="Element Object Reference" /> Element Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and creates a node (&lt;edition&gt;), and appends it after the last 
child of the first &lt;book&gt; node:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var newel = 
	xmlDoc.createElement(&quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp; var x = 
	xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>&nbsp;&nbsp;&nbsp; x.appendChild(newel);<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; 
	x.getElementsByTagName(&quot;edition&quot;)[0].nodeName;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
edition
</div>
<a target="_blank" href="tryitc301.asp?filename=try_dom_createelement2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and appends a new node to all &lt;book&gt; elements:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; 
	var x, y, z, i, newel, newtext, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
	x = xmlDoc.getElementsByTagName(&quot;book&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 0; i 
	&lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; newel = 
	xmlDoc.createElement(&quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newtext = xmlDoc.createTextNode(&quot;first&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newel.appendChild(newtext);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x[i].appendChild(newel);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; // 
	Output all titles and editions<br>&nbsp;&nbsp;&nbsp; y = 
	xmlDoc.getElementsByTagName(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; z = 
	xmlDoc.getElementsByTagName(&quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 0; i 
	&lt; y.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += 
	y[i].childNodes[0].nodeValue + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; - Edition: &quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; z[i].childNodes[0].nodeValue 
	+ &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
...
<a target="_blank" href="tryitcad2.asp?filename=try_dom_createelement" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
