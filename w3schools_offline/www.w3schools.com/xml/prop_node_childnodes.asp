...
<!-- Mirrored from www.w3schools.com/xml/prop_node_childnodes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:40 GMT -->
<head>
...
into xmlDoc and displays the child nodes of the XML document:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var x, i, xmlDoc, 
	txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.childNodes;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; x.length; i++) {
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += &quot;Nodename: &quot; + x[i].nodeName 
	+<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot; (nodetype: &quot; + x[i].nodeType 
...
<p>Output IE9 and earlier:</p>
<div class="w3-code notranslate">
	Nodename: xml (nodetype: 7)<br>Nodename: bookstore (nodetype: 1)</div>
<a target="_blank" href="tryitb613.asp?filename=try_dom_document_childnodes" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit3110.asp?filename=try_dom_nodetype">Display all child 
