...
<!-- Mirrored from www.w3schools.com/xml/met_cdata_substringdata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:59 GMT -->
<head>
...
<a target="_blank" href="tryit0140.asp?filename=try_dom_cdata_substringdata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h2>Syntax</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">CDATANode.substringData(start,length)
</div></div>
