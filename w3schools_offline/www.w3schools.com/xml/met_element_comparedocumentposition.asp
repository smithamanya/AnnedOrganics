...
<!-- Mirrored from www.w3schools.com/xml/met_element_comparedocumentposition.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:50 GMT -->
<head>
...
into xmlDoc and compares the placement of two nodes (the first and 
...
<div class="w3-code notranslate jsHigh">
	...
	xmlDoc.getElementsByTagName('book')[0];<br>&nbsp;&nbsp;&nbsp; var y = 
	xmlDoc.getElementsByTagName('book')[2];<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; 
	x.compareDocumentPosition(y);<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
4
</div>
<a target="_blank" href="tryitbe0d.asp?filename=try_dom_element_comparedocumentposition" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>Most browsers, will treat empty white-spaces or new lines 
as text nodes, IE 9 and earlier will not. So, in the example above, most 
browsers will output 4, while IE 9 and earlier will output 2.</p><p>To read more about the differences between browsers, visit our
