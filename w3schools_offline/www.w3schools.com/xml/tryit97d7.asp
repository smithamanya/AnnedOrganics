...
<!-- Mirrored from www.w3schools.com/xml/tryit.asp?filename=try_dom_xmlhttprequest_responsexml by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:33 GMT -->
<head>
...
function loadXMLDoc() {
  ...
  xmlhttp.open("GET.html", "cd_catalog.xml", true);
  xmlhttp.send();
}
