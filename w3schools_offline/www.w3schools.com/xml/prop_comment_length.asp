...
<!-- Mirrored from www.w3schools.com/xml/prop_comment_length.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:59 GMT -->
<head>
...
<hr>
<a href="dom_comment.html"><img class="navup" src="../images/up.gif" alt="Comment Object Reference" /> Comment Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books_comment.xml">books_comment.xml</a>&quot; 
into xmlDo<a href="dom_loadxmldoc.asp">c</a>, gets the text node data and length from the first &lt;title&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	...
	&quot;books_comment.xml&quot;, true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, 
	xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
	x = xmlDoc.getElementsByTagName(&quot;book&quot;)[0].childNodes;<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp; // Process only 
	comment nodes<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (x[i].nodeType 
	== 8) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += x[i].length + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>
	}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
44
</div>
<a target="_blank" href="tryitd84c.asp?filename=try_dom_comment_length" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/xml/prop_comment_length.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:00 GMT -->
</html>
