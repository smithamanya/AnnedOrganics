...
<!-- Mirrored from www.w3schools.com/xml/prop_attr_nodevalue.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:55 GMT -->
<head>
...
<a href="dom_attribute.html"><img class="navup" src="../images/up.gif" alt="Attr Object Reference" /> Attr Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc, displays the node name, node value, and node type of the 
...
<div class="w3-code notranslate jsHigh">
	...
	txt += x.item(i).attributes[0].nodeName + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; = &quot; +<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.item(i).attributes[0].nodeValue 
	+<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot; (nodetype: &quot; + x.item(i).attributes[0].nodeType 
	+ &quot;)&quot; + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
	category = cooking (nodetype: 2)<br>category = children (nodetype: 2)<br>
	category = web (nodetype: 2)<br>category = web (nodetype: 2)</div>
<a target="_blank" href="tryit97bc.asp?filename=try_dom_attr_nodename" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
