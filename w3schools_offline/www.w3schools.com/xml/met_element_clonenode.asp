...
<!-- Mirrored from www.w3schools.com/xml/met_element_clonenode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:50 GMT -->
<head>
...
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot;, clones the first &lt;book&gt; node and then adds 
...
<div class="w3-code notranslate jsHigh">
	...
	var x, y, cloneNode, i, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
	x = xmlDoc.getElementsByTagName('book')[0];<br>&nbsp;&nbsp;&nbsp; cloneNode 
	= x.cloneNode(true);<br>&nbsp;&nbsp;&nbsp; 
	xmlDoc.documentElement.appendChild(cloneNode);<br><br>&nbsp;&nbsp;&nbsp; // 
	Output all titles<br>&nbsp;&nbsp;&nbsp; y = xmlDoc.getElementsByTagName(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; y.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += y[i].childNodes[0].nodeValue + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit2271.asp?filename=try_dom_clonenode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
