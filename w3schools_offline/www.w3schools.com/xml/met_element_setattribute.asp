...
<!-- Mirrored from www.w3schools.com/xml/met_element_setattribute.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:53 GMT -->
<head>
...
into xmlDoc and adds an &quot;edition&quot; attribute to all &lt;book&gt; 
elements:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
	x = xmlDoc.getElementsByTagName('title');<br>&nbsp;&nbsp;&nbsp; // Add a new 
	attribute to each title element<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
	x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].setAttribute(&quot;edition&quot;, 
	&quot;first&quot;); <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; // Output titles 
	and edition value<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += x[i].childNodes[0].nodeValue + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; - Edition: &quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].getAttribute('edition') 
	+ &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
	Everyday Italian - Edition: first<br>Harry Potter - Edition: first<br>
	XQuery Kick Start - Edition: first<br>Learning XML - Edition: first</div>
<a target="_blank" href="tryitd429.asp?filename=try_dom_setattribute2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryitd29c.asp?filename=try_dom_setattribute">
