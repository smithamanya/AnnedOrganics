...
<!-- Mirrored from www.w3schools.com/xml/prop_element_nodename.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:49 GMT -->
<head>
...
into xmlDoc and gets the tag name from the first &lt;title&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	...
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; x.nodeName;<br>
	}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
title
</div>
<a target="_blank" href="tryit974c.asp?filename=try_dom_nodename2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
