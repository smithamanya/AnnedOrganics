...
<!-- Mirrored from www.w3schools.com/xml/met_element_setattributens.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:53 GMT -->
<head>
...
into xmlDoc and adds an &quot;edition&quot; attribute to the first &lt;book&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;books_ns.xml&quot;, true);<br>xhttp.send();<br><br>
	function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = 
	xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>&nbsp;&nbsp;&nbsp; var ns = 
	&quot;http://www.w3schools.com/edition/&quot;;<br>&nbsp;&nbsp;&nbsp; x.setAttributeNS(ns, 
	&quot;edition&quot;, &quot;first&quot;);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
	=<br>&nbsp;&nbsp;&nbsp; x.getAttributeNS(ns,&quot;edition&quot;);<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
first
</div>
<a target="_blank" href="tryit82b0.asp?filename=try_dom_element_setattributens" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books_ns.xml">books_ns.xml</a>&quot; 
into xmlDoc and changes the &quot;lang&quot; value of the first &lt;title&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;books_ns.xml&quot;, true);<br>xhttp.send();<br><br>
	function myFunction(xml) {<br>    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = 
	xmlDoc.getElementsByTagName(&quot;title&quot;)[0];<br>&nbsp;&nbsp;&nbsp; var ns = 
	&quot;http://www.w3schools.com/edition/&quot;;<br>&nbsp;&nbsp;&nbsp; x.setAttributeNS(ns, 
	&quot;c:lang&quot;, &quot;italian&quot;);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
	=<br>&nbsp;&nbsp;&nbsp; x.getAttributeNS(ns, &quot;lang&quot;);<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
italian
</div>
<a target="_blank" href="tryit21eb.asp?filename=try_dom_element_setattributens2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
