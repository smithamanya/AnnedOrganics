...
<!-- Mirrored from www.w3schools.com/xml/met_cdata_deletedata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:58 GMT -->
<head>
...
into xmlDoc and deletes some characters (the &quot;&lt;b&gt;&quot; tag) from the text node of the 
first &lt;html&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;books_cdata.xml&quot;, true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = xmlDoc.getElementsByTagName(&quot;html&quot;)[0].childNodes[0];<br>
	&nbsp;&nbsp;&nbsp;
	x.deleteData(0, 3);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; x.data;
	<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
Stunning!
</div>
<a target="_blank" href="tryit45d8.asp?filename=try_dom_cdata_deletedata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h2>Syntax</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">CDATANode.deleteData(start,length)
</div></div>
