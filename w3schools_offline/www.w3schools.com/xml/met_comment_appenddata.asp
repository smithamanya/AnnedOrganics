...
<!-- Mirrored from www.w3schools.com/xml/met_comment_appenddata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:00 GMT -->
<head>
...
into xmlDoc and appends text to the first comment element:</p>
...
<a target="_blank" href="tryitf3c7.asp?filename=try_dom_comment_appenddata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
