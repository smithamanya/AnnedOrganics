...
<!-- Mirrored from www.w3schools.com/xml/met_document_createtextnode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:46 GMT -->
<head>
...
into xmlDoc and adds an element node with a containing text node to each &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;books.xml&quot;, 
	true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; 
	var x, y, z, i, xLen, yLen, newEle, newText, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; 
	xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
	x = xmlDoc.getElementsByTagName(&quot;book&quot;);<br>&nbsp;&nbsp;&nbsp; xLen = 
	x.length;<br>&nbsp;&nbsp;&nbsp; // Create element nodes and text nodes<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; xLen; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newEle = xmlDoc.createElement(&quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newText = xmlDoc.createTextNode(&quot;first&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newEle.appendChild(newText);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x[i].appendChild(newEle);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; // 
	Output all titles and editions<br>&nbsp;&nbsp;&nbsp; y = 
	xmlDoc.getElementsByTagName(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; yLen = y.length<br>&nbsp;&nbsp;&nbsp; 
	z = xmlDoc.getElementsByTagName(&quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 
	0; i &lt; yLen; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += 
