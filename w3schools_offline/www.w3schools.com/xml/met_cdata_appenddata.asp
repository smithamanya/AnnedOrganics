...
<!-- Mirrored from www.w3schools.com/xml/met_cdata_appenddata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:58 GMT -->
<head>
...
into xmlDoc and appends text to the first &lt;html&gt; element:</p>
<div class="w3-code notranslate jsHigh">var xhttp = new 
		XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;books_cdata.xml&quot;, true);<br>xhttp.send();<br>
...
<a target="_blank" href="tryit486c.asp?filename=try_dom_cdata_appenddata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
