...
<!-- Mirrored from www.w3schools.com/xml/met_document_getelementsbytagnamens.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:47 GMT -->
<head>
...
<a href="dom_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and adds an element node with a namespace to each &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, y, z, i, newel, 
	newtext, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = 
	xmlDoc.getElementsByTagName(&quot;book&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
	x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; newel = 
	xmlDoc.createElementNS(&quot;p&quot;, &quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newtext = xmlDoc.createTextNode(&quot;First&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	newel.appendChild(newtext);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].appendChild(newel);<br>&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; // Output all titles and editions<br>&nbsp;&nbsp;&nbsp; 
	y = xmlDoc.getElementsByTagName(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; z = 
	xmlDoc.getElementsByTagNameNS(&quot;p&quot;,&quot;edition&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 
	0; i &lt; y.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt 
	+= y[i].childNodes[0].nodeValue + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; - &quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; z[i].childNodes[0].nodeValue 
	+ <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot; edition.&quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; Namespace: &quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; z[i].namespaceURI 
	+ &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	Everyday Italian - First edition. Namespace: p<br>Harry Potter - First 
	edition. Namespace: p<br>XQuery Kick Start - First edition. Namespace: p<br>
	Learning XML - First edition. Namespace: p</div>
<a target="_blank" href="tryit5805.asp?filename=try_dom_createelementns" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
