...
<!-- Mirrored from www.w3schools.com/xml/prop_document_lastchild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:45 GMT -->
<head>
...
into xmlDoc and displays the node name and node type of the 
...
<div class="w3-code notranslate jsHigh">
	...
	&quot;books.xml&quot;, true);<br>xhttp.send();<br><br>// Check if the last node is an 
	element node<br>function get_lastchild(n) {<br>&nbsp;&nbsp;&nbsp; 
	...
	var x = get_lastchild(xmlDoc);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
	=<br>&nbsp;&nbsp;&nbsp; &quot;Nodename: &quot; + x.nodeName + <br>&nbsp;&nbsp;&nbsp; &quot; 
	(nodetype: &quot; + x.nodeType + &quot;)&lt;br&gt;&quot;;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
Nodename: bookstore (nodetype: 1)
</div>
<a target="_blank" href="tryitf500.asp?filename=try_dom_doc_lastchild" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit79ea.asp?filename=try_dom_doc_firstchild">Get the 
