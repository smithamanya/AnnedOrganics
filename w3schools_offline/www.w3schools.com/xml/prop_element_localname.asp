...
<!-- Mirrored from www.w3schools.com/xml/prop_element_localname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:48 GMT -->
<head>
...
into xmlDoc and gets the local name from the first &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	var x = xmlDoc.getElementsByTagName("book")[0];<br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit0f17.asp?filename=try_dom_localname" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h3>Example 2</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and gets the local name from the last child node:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br><br>// 
	Check if the last node is an element node<br>function get_lastchild(n) {<br>&nbsp;&nbsp;&nbsp; 
	var x = n.lastChild;<br>&nbsp;&nbsp;&nbsp; while (x.nodeType != 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x = x.previousSibling;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return 
	x;<br>}<br><br>function myFunction(xml) {<br>    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	var x = xmlDoc.documentElement;<br>&nbsp;&nbsp;&nbsp; var lastNode = 
	get_lastchild(x);<br>&nbsp;&nbsp;&nbsp; document.getElementById("demo").innerHTML 
	= <br>&nbsp;&nbsp;&nbsp; lastNode.localName; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
book
</div>
<a target="_blank" href="tryitbdd4.asp?filename=try_dom_localname2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
