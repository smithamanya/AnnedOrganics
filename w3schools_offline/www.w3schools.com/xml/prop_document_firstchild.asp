...
<!-- Mirrored from www.w3schools.com/xml/prop_document_firstchild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:45 GMT -->
<head>
...
<div class="w3-code notranslate jsHigh">
	...
	// Check if the first node is an element node<br>function get_firstchild(n) 
	{<br>&nbsp;&nbsp;&nbsp; var x = n.firstChild;<br>&nbsp;&nbsp;&nbsp; while (x.nodeType 
	!= 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = x.nextSibling;<br>&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; return x;<br>}<br><br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	var x = get_firstchild(xmlDoc);<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById("demo").innerHTML =<br>&nbsp;&nbsp;&nbsp; "Nodename: 
	" + x.nodeName + <br>&nbsp;&nbsp;&nbsp; " (nodetype: " + x.nodeType + ")&lt;br&gt;";<br>
	}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
Nodename: bookstore (nodetype: 1)
</div>
<a target="_blank" href="tryit79ea.asp?filename=try_dom_doc_firstchild" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryitf500.asp?filename=try_dom_doc_lastchild">Get the 
