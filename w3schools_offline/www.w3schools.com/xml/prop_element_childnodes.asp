...
<!-- Mirrored from www.w3schools.com/xml/prop_element_childnodes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:48 GMT -->
<head>
...
into xmlDoc and gets the text node from the first &lt;title&gt; 
...
<div class="w3-code notranslate jsHigh">
	...
	xmlDoc.getElementsByTagName(&quot;title&quot;)[0];<br>&nbsp;&nbsp;&nbsp; var y = 
	x.childNodes[0];<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
	=<br>&nbsp;&nbsp;&nbsp; y.nodeValue;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
Everyday Italian
</div>
<a target="_blank" href="tryitba33.asp?filename=try_dom_getelementsbytagname" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and gets the number of child nodes from the first &lt;book&gt; element in &quot;books.xml&quot;:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = 
	xmlDoc.getElementsByTagName(&quot;book&quot;)[0].childNodes;<br>&nbsp;&nbsp;&nbsp; 
...
<p>In IE9 and earlier, the output of the code above will be:</p>
<div class="w3-code notranslate">
4
</div>
<a target="_blank" href="tryitf998.asp?filename=try_dom_childnodes_length" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
