...
<!-- Mirrored from www.w3schools.com/xml/prop_node_nodevalue.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:41 GMT -->
<head>
...
into xmlDoc and displays the node name and node value of the 
root node:</p>
<div class="w3-code notranslate jsHigh">
	...
	xmlDoc.nodeName +<br>&nbsp;&nbsp;&nbsp; (&quot; (value: &quot; + xmlDoc.childNodes[0].nodeValue) + 
	&quot;)&quot;;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	Nodename: #document (value: null)</div>
<a target="_blank" href="tryit7711.asp?filename=try_dom_nodevalue" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The nodeValue property sets or returns the value of a node, depending on its type.</p>
<hr>
