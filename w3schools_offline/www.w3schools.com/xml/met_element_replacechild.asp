...
<!-- Mirrored from www.w3schools.com/xml/met_element_replacechild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:53 GMT -->
<head>
...
into xmlDoc and replaces the first &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, y, z, i, newNode, newTitle, newText, 
	xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>
	&nbsp;&nbsp;&nbsp;
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.documentElement;<br><br>&nbsp;&nbsp;&nbsp; // Create a book 
	element, title element and a text node<br>&nbsp;&nbsp;&nbsp; newNode = xmlDoc.createElement(&quot;book&quot;);<br>
	&nbsp;&nbsp;&nbsp;
	newTitle = xmlDoc.createElement(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; newText = xmlDoc.createTextNode(&quot;A 
	...
	<br>&nbsp;&nbsp;&nbsp; // Replace the first book node with the new book node<br>&nbsp;&nbsp;&nbsp; x.replaceChild(newNode, 
	y);<br><br>&nbsp;&nbsp;&nbsp; z = xmlDoc.getElementsByTagName(&quot;title&quot;);<br>&nbsp;&nbsp;&nbsp; // Output all titles
	<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; z.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += z[i].childNodes[0].nodeValue 
	+ &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	A Notebook<br>Harry Potter<br>XQuery Kick Start<br>Learning XML</div>
<a target="_blank" href="tryitb744.asp?filename=try_dom_element_replacechild" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
