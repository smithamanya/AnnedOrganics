...
<!-- Mirrored from www.w3schools.com/xml/met_document_createcdatasection.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:46 GMT -->
<head>
...
into xmlDoc and adds a CDATA section node to the &lt;book&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, newCDATA, 
	newtext, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = 
	xmlDoc.getElementsByTagName(&quot;book&quot;);<br>&nbsp;&nbsp;&nbsp; newtext = 
	&quot;Special Offer &amp; Book Sale&quot;;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; x.length; 
	i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; newCDATA = 
	xmlDoc.createCDATASection(newtext);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x[i].appendChild(newCDATA);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += x[i].getElementsByTagName(&quot;title&quot;)[0].childNodes[0].nodeValue + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; - &quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].lastChild.nodeValue 
	+ &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
	<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	Everyday Italian - Special Offer &amp; Book Sale<br>Harry Potter - Special Offer 
	&amp; Book Sale<br>XQuery Kick Start - Special Offer &amp; Book Sale<br>Learning XML 
	- Special Offer &amp; Book Sale</div>
<a target="_blank" href="tryit9215.asp?filename=try_dom_createcdatasection" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
