...
<!-- Mirrored from www.w3schools.com/xml/met_nodemap_removenameditem.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:44 GMT -->
<head>
...
into xmlDoc, loops through the &lt;book&gt; elements and 
removes the category attributes:</p>
<div class="w3-code notranslate jsHigh">
 function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
 var x = xmlDoc.getElementsByTagName('book');<br>&nbsp;&nbsp;&nbsp; txt += 
 x.item(0).attributes.length + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; x.item(0).attributes.removeNamedItem(&quot;category&quot;);<br>&nbsp;&nbsp;&nbsp; 
 txt += x.item(0).attributes.length;<br>&nbsp;&nbsp;&nbsp; 
 document.getElementById(&quot;demo&quot;).innerHTML = txt;<br>}
</div>
<a target="_blank" href="tryitfe2c.asp?filename=try_dom_removenameditem" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
