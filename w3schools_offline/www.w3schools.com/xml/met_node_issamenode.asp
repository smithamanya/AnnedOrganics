...
<!-- Mirrored from www.w3schools.com/xml/met_node_issamenode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:42 GMT -->
<head>
...
into xmlDoc and tests whether the two nodes are the same node:</p>
<div class="w3-code notranslate jsHigh">
	...
	xmlDoc.getElementsByTagName('book')[1];<br>&nbsp;&nbsp;&nbsp; var y = 
	xmlDoc.getElementsByTagName('book')[1];<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; 
	x.isSameNode(y);<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
	true
</div>
<a target="_blank" href="tryitab49.asp?filename=try_dom_element_issamenode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
