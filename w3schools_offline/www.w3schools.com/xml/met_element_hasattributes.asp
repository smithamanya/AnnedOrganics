...
<!-- Mirrored from www.w3schools.com/xml/met_element_hasattributes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:52 GMT -->
<head>
...
into xmlDoc and checks if the first &lt;book&gt; element has any attributes:</p>
<div class="w3-code notranslate jsHigh">
	...
	x.hasAttributes();<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
true
</div>
<a target="_blank" href="tryitc135.asp?filename=try_dom_element_hasattributes" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
