...
<!-- Mirrored from www.w3schools.com/xml/met_element_removeattributenode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:53 GMT -->
<head>
...
into xmlDoc and removes the &quot;category&quot; attribute nodes from all &lt;book&gt; elements:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, attnode, 
	old_att, xmlDoc, txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = 
	xmlDoc.getElementsByTagName('book');<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
	x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; while (x[i].attributes.length 
	&gt; 0) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	attnode = x[i].attributes[0];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	old_att = x[i].removeAttributeNode(attnode);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += &quot;Removed: &quot; + old_att.nodeName +<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot;: &quot; + old_att.nodeValue + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp; }<br>document.getElementById(&quot;demo&quot;).innerHTML = 
	txt; <br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
	Removed: category: cooking<br>Removed: category: children<br>Removed: 
	category: web<br>Removed: category: web<br>Removed: cover: paperback</div>
<a target="_blank" href="tryitec51.asp?filename=try_dom_removeattributenode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
