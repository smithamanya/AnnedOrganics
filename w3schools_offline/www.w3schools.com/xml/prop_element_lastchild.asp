...
<!-- Mirrored from www.w3schools.com/xml/prop_element_lastchild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:48 GMT -->
<head>
...
into xmlDoc and gets the last child node:</p>
<div class="w3-code notranslate jsHigh">
	...
	element node<br>function get_lastchild(n) {<br>&nbsp;&nbsp;&nbsp; var x = 
	n.lastChild;<br>&nbsp;&nbsp;&nbsp; while (x.nodeType != 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x = x.previousSibling;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return 
	x;<br>}<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, 
	txt, firstNode, xmlDoc;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.documentElement;<br>&nbsp;&nbsp;&nbsp; 
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; firstNode = get_lastchild(x);<br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit25c0.asp?filename=try_dom_lastchild" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
