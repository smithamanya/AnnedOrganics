...
<!-- Mirrored from www.w3schools.com/xml/prop_element_firstchild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:48 GMT -->
<head>
...
into xmlDoc and gets the first child node:</p>
<div class="w3-code notranslate jsHigh">
	...
	Check if the first node is an element node<br>function get_firstchild(n) {<br>&nbsp;&nbsp;&nbsp; 
	var x = n.firstChild;<br>&nbsp;&nbsp;&nbsp; while (x.nodeType != 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x = x.nextSibling;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return x;<br>
	}<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; 
	var x, i, txt, firstNode, xmlDoc;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.documentElement;<br>&nbsp;&nbsp;&nbsp; 
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; firstNode = get_firstchild(x);<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; firstNode.childNodes.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	if (firstNode.childNodes[i].nodeType == 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	//Process only element nodes<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += firstNode.childNodes[i].nodeName + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&quot; = &quot; + <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	firstNode.childNodes[i].childNodes[0].nodeValue + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit4318.asp?filename=try_dom_firstchild" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
