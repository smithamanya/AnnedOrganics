...
<!-- Mirrored from www.w3schools.com/xml/tryit.asp?filename=try_dom_xmlhttprequest_database by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:34 GMT -->
<head>
...
function showCustomer(str) {
  ...
  xmlhttp.open("GET.html", "getcustomer03d2.asp?q="+str, true);
  xmlhttp.send();
}
</script>
