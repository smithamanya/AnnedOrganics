...
<!-- Mirrored from www.w3schools.com/xml/prop_element_namespaceuri.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:48 GMT -->
<head>
...
into xmlDoc and gets namespace URI from the first &lt;title&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	x.namespaceURI;<br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
http://www.w3schools.com/children/
</div>
<a target="_blank" href="tryit2359.asp?filename=try_dom_element_namespaceuri" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
