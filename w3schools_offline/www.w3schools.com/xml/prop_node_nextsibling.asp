...
<!-- Mirrored from www.w3schools.com/xml/prop_node_nextsibling.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:40 GMT -->
<head>
...
into xmlDoc and gets the next sibling node from the first &lt;title&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	...
	Check if the next sibling node is an element node<br>function 
	get_nextsibling(n) {<br>&nbsp;&nbsp;&nbsp; var x = n.nextSibling;<br>&nbsp;&nbsp;&nbsp; 
	while (x.nodeType != 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = 
	x.nextSibling;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return x;<br>}<br><br>function myFunction(xml) {<br>    &nbsp;&nbsp;&nbsp;    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	var x = xmlDoc.getElementsByTagName(&quot;title&quot;)[0];<br>&nbsp;&nbsp;&nbsp; var y 
	= get_nextsibling(x);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
	= x.nodeName + &quot; = &quot; + <br>&nbsp;&nbsp;&nbsp; x.childNodes[0].nodeValue +<br>&nbsp;&nbsp;&nbsp; 
	&quot;&lt;br&gt;Next sibling: &quot; + y.nodeName + &quot; = &quot; + <br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit7944.asp?filename=try_dom_nextsibling2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryitc905.asp?filename=try_dom_previoussibling">previousSibling - Get the previous sibling of a node</a></p>
<hr>
