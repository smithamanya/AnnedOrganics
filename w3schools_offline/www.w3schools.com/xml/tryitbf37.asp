...
<!-- Mirrored from www.w3schools.com/xml/tryit.asp?filename=try_dom_parser_error by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:01 GMT -->
<head>
...
// gptAdSlots[0] = googletag.defineSlot('/16833175/TryitLeaderboard', [728, 90], 'div-gpt-ad-1428407818244-0').
   ...
   googletag.pubads().setTargeting("content","tryxml");
  ...
  <div class="textareacontainer">
    <div class="textarea">
      ...
      <div class="textareawrapper">
        <textarea autocomplete="off" class="code_input" id="textareaCode" wrap="logical" spellcheck="false"><html>
<body>
...
xhttp.open("GET.html", "note_error.xml", true);
xhttp.send();
