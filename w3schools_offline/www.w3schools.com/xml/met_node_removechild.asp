...
<!-- Mirrored from www.w3schools.com/xml/met_node_removechild.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:43 GMT -->
<head>
...
into xmlDoc and removes the first child node in the first &lt;book&gt; node:</p>
<div class="w3-code notranslate jsHigh">
	...
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp;&nbsp;var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var root = 
	xmlDoc.documentElement;<br>&nbsp;&nbsp;&nbsp; var currNode = root.childNodes[1];<br>&nbsp;&nbsp;&nbsp; 
	removedNode = currNode.removeChild(currNode.childNodes[1]);<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; &quot;Removed 
	node: &quot; + removedNode.nodeName;<br>}</div>
<p>Output:</p>
<div class="w3-code notranslate">
	Removed node: title</div>
<a target="_blank" href="tryit6860.asp?filename=try_dom_removechild" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
