...
<!-- Mirrored from www.w3schools.com/xml/met_nodelist_item.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:43 GMT -->
<head>
...
into xmlDoc and loops through all <strong>child element nodes</strong> of the &lt;bookstore&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	...
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.documentElement.childNodes;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
	x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (x.item(i).nodeType 
	== 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit46f6.asp?filename=try_dom_nodelist_item" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
