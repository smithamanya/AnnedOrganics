...
<!-- Mirrored from www.w3schools.com/xml/prop_element_attributes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:47 GMT -->
<head>
...
into xmlDoc and gets the number of attributes in the first &lt;title&gt; element in &quot;books.xml&quot;:</p>
<div class="w3-code notranslate jsHigh">
	...
	xmlDoc.getElementsByTagName(&quot;book&quot;)[0].attributes;<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp;&nbsp;&nbsp; x.length;<br>
	}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
1
</div>
<a target="_blank" href="tryitbc2b.asp?filename=try_dom_attributes_length" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h3>Example 2</h3>
<p>The following code fragment loads &quot;<a target="_blank" href="books.xml">books.xml</a>&quot; 
into xmlDoc and gets the value of the &quot;category&quot; 
attribute in the first &lt;book&gt; element&quot;:</p>
<div class="w3-code notranslate jsHigh">
	var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>    if (xhttp.readyState == 4 && xhttp.status == 200) {<br>        myFunction(xhttp);<br>    }<br>};<br>xhttp.open("GET", "books.xml", true);<br>xhttp.send();<br>
	<br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; var x, i, att, xmlDoc, 
	txt;<br>&nbsp;&nbsp;&nbsp; xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
	txt = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; x = xmlDoc.getElementsByTagName('book');<br>&nbsp;&nbsp;&nbsp; 
	for (i = 0; i &lt; x.length; i++) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	att = x.item(i).attributes.getNamedItem(&quot;category&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	txt += att.value + &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = txt; <br>}</div>
<p>The output of the code above will be:</p>
<div class="w3-code notranslate">
	cooking<br>children<br>web<br>web</div>
<a target="_blank" href="tryit3f39.asp?filename=try_dom_getnameditem" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
