...
<!-- Mirrored from www.w3schools.com/xml/met_cdata_insertdata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:58 GMT -->
<head>
...
into xmlDoc and inserts data into the CDATA node of the first &lt;html&gt; element:</p>
...
<a target="_blank" href="tryitcf6d.asp?filename=try_dom_cdata_insertdata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<h2>Syntax</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">insertData(start,string)
</div></div>
