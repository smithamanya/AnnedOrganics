...
<!-- Mirrored from www.w3schools.com/js/tryit.asp?filename=tryjs_form_name by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:10 GMT -->
<head>
...
<form id="frm1" name="form1" action="http://www.w3schools.com/js/form_action.asp">
