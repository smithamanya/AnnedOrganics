...
<!-- Mirrored from www.w3schools.com/tags/av_event_suspend.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:59 GMT -->
<head>

<title>HTML Audio/Video DOM suspend Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">suspend</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that the loading of media data is prevented from continuing:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onsuspend = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Loading of the media is 
	suspended&quot;);<br>};</div>
<br>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The suspend event occurs when the browser is intentionally not getting media 
data.</p>
<p>This event occurs when the loading of the media is suspended (prevented from 
continuing). This can happen when the download has completed, or because it has 
been paused for some reason.</p>
<p><strong>Tip:</strong> Related events that occurs when there is some kind of 
disturbance to the media loading process, are:</p>
<ul>
	<li><a href="av_event_abort.asp">abort</a></li>
	<li>emptied</li>
...
&lt;<i>element</i> onsuspend=&quot;<i>myScript</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onsuspend=function(){<i>myScript</i>};</div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;suspend&quot;, <em>myScript</em>);</div></div>
