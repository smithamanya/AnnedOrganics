...
<!-- Mirrored from www.w3schools.com/tags/canvas_stroketext.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:10 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryitfcd1.html?filename=tryhtml5_canvas_stroketext" target="_blank">Try it yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas5eba.html?filename=playcanvas_stroketexttext">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasd759.html?filename=playcanvas_stroketextx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas1f09.html?filename=playcanvas_stroketexty">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td><i>maxWidth</i></td>
		<td>Optional. The maximum allowed width of the text, in pixels</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasaab9.html?filename=playcanvas_stroketextmaxwidth">Play it &raquo;</a></td>		
	</tr>
</table>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/canvas_stroketext.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:13 GMT -->
</html>
