...
<!-- Mirrored from www.w3schools.com/tags/av_event_ended.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:23 GMT -->
<head>

<title>HTML Audio/Video DOM ended Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">ended</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that the audio has ended:</p>
<div class="w3-code notranslate jsHigh">
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onended = function() {<br>&nbsp;&nbsp;&nbsp; 
	alert(&quot;The audio has ended&quot;);<br>};</div>
<a target="_blank" href="tryitd118.html?filename=tryhtml5_av_event_ended" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The ended event occurs when the audio/video has reached the end.</p>
<p>This event is useful for messages like &quot;thanks for listening&quot;, 
&quot;thanks for watching&quot;, etc.</p>
<hr>
...
&lt;<em>audio|video</em> onended=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitb47c.html?filename=tryhtml5_av_event_ended_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onended=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitd118.html?filename=tryhtml5_av_event_ended">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;ended&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit797e.html?filename=tryhtml5_av_event_ended_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert that the video has ended:</p>
	<div class="w3-code notranslate jsHigh">
  
    	var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onended = 
		function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The video has ended&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita37d.html?filename=tryhtml5_av_event_ended2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_ended.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:27 GMT -->
</html>
