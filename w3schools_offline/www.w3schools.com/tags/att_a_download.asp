...
<!-- Mirrored from www.w3schools.com/tags/att_a_download.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:53:08 GMT -->
<head>
...
<h3>Example</h3>
<p>Download file when clicking on the link (instead of navigating to the file):</p>
<div class="w3-code notranslate htmlHigh">
    &lt;a href=&quot;/images/myw3schoolsimage.jpg&quot; download&gt;
</div>
<a target="_blank" href="tryit53d7.html?filename=tryhtml5_a_download" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The download attribute specifies that the target will be downloaded when a user clicks on the hyperlink.</p>
<p>This attribute is only used if the href attribute is set.</p>
<p>The value of the attribute will be the name of the downloaded file. There are 
no restrictions on allowed values, and the browser will automatically detect the 
correct file extension and add it to the file (.img, .pdf, .txt, .html, etc.).</p>
<p>If the value is omitted, the original filename is used.</p>
<hr>
...
<table class="browserref notranslate">
  <tr>
    ...
    <th style="width:14%;" class="bsSafari" title="Safari"></th>
...
<table class="w3-table-all notranslate">
	...
	<tr>
		<td><i>filename</i></td>
		<td>Optional. Specifies the new filename for the downloaded file</td>
	</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify a value for the download attribute, which will be the new filename of the 
downloaded file (&quot;w3logo.jpg&quot; instead of &quot;myw3schoolsimage.jpg&quot;):</p>
<div class="w3-code notranslate htmlHigh">
    &lt;a href=&quot;/images/myw3schoolsimage.jpg&quot; download=&quot;w3logo&quot;&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitbd7a.html?filename=tryhtml5_a_download2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/att_a_download.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:53:10 GMT -->
</html>