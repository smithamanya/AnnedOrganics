...
<!-- Mirrored from www.w3schools.com/tags/av_prop_volume.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:11 GMT -->
<head>
...
<div class="w3-code notranslate jsHigh">
    ...
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.volume = 0.2;</div>
<a target="_blank" href="tryit8b14.html?filename=tryhtml5_av_prop_volume" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.volume=<em>number</em></div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
	...
	between 0.0 and 1.0.<br><br>Example 
	values:<ul><li>1.0 is highest volume (100%. This is default)</li>
		<li>0.5 is half volume (50%)</li>
		<li>0.0 is silent (same as mute)</li>
	</ul>
	  </td>
  </tr>
</table>
