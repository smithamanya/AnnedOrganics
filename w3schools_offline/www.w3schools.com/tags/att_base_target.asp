...
<!-- Mirrored from www.w3schools.com/tags/att_base_target.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:59:39 GMT -->
<head>
...
<p><a href="tag_base.html"><img class="navup" src="../images/up.gif" alt="HTML base Tag Reference" /> HTML &lt;base&gt; tag</a></p>
...
<a target="_blank" href="tryite7d4.asp?filename=tryhtml_base_target" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The target attribute specifies the default target for all hyperlinks and forms in the page.</p>
<p>This attribute can be overridden by using the target attribute for each hyperlink/form.</p>
<hr>
...
<p>Frames and framesets are no longer supported in HTML5. Therefore, the _parent, _top and <i>framename</i> values are now mostly used with iframes.</p>
<hr>
...
<hr>
<a href="tag_base.html"><img class="navup" src="../images/up.gif" alt="HTML base Tag Reference" /> HTML &lt;base&gt; tag</a>
</div>
