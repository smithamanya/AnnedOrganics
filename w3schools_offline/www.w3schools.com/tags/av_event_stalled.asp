...
<!-- Mirrored from www.w3schools.com/tags/av_event_stalled.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:59 GMT -->
<head>

<title>HTML Audio/Video DOM stalled Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">stalled</span> Event</h1>
...
<h3>Example</h3>
<p>If the browser is not able to fetch media data, alert that media data is not 
available:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onstalled = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Media data is not available&quot;);<br>
	};</div>
<br>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The stalled event occurs when the browser is trying to get media data, but data 
is not available.</p>
...
&lt;<i>element</i> onstalled=&quot;<i>myScript</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onstalled=function(){<i>myScript</i>};</div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;stalled&quot;, <em>myScript</em>);</div></div>
