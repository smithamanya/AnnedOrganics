...
<!-- Mirrored from www.w3schools.com/tags/att_button_formenctype.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:59:44 GMT -->
<head>
...
<p><a href="tag_button.html"><img class="navup" src="../images/up.gif" alt="HTML button Tag Reference" /> 
HTML &lt;button&gt; tag</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>A form with two submit buttons. The first submit button submits the form data 
with default character encoding, and the second submits the form data without 
...
<a class="w3-btn w3-margin-bottom" href="tryit11bc.html?filename=tryhtml5_button_formenctype" target="_blank">
	Try it yourself »</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The formenctype attribute specifies how form-data should be encoded before sending it to a server. This attribute overrides the form's <a href="att_form_enctype.asp">enctype</a> attribute.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">formenctype</td>
    <td>9.0</td>
    <td>10.0</td>
    <td>4.0</td>
    <td>5.1</td>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>No characters are encoded (use this when you are using forms that have a 
	file upload control)</td>
    </tr>
  <tr>
    <td>text/plain</td>
...
<hr>
<a href="tag_button.html"><img class="navup" src="../images/up.gif" alt="HTML button Tag Reference" /> 
HTML &lt;button&gt; tag</a>
</div>
...
<!-- Mirrored from www.w3schools.com/tags/att_button_formenctype.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:59:45 GMT -->
</html>
