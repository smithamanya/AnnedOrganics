...
<!-- Mirrored from www.w3schools.com/tags/att_select_required.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:03:43 GMT -->
<head>
...
<p><a href="tag_select.html"><img class="navup" src="../images/up.gif" alt="HTML select Tag Reference"> HTML &lt;select&gt; tag</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>An HTML form with a required drop-down list:</p>
<div class="w3-code notranslate htmlHigh">
    &lt;select required&gt;<br>&nbsp; &lt;option value=&quot;&quot;&gt;None&lt;/option&gt;<br>
      &nbsp;
      ...
      &lt;/select&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryitbb11.html?filename=tryhtml5_select_required" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The required attribute is a boolean attribute.</p>
<p>When present, it specifies the user is required to select a value before submitting the form.</p>
<hr>
