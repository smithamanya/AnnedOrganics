...
<!-- Mirrored from www.w3schools.com/tags/av_event_pause.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:36 GMT -->
<head>

<title>HTML Audio/Video DOM pause Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">pause</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that the video has been paused:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onpause = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;The video has been paused&quot;);<br>};</div>
<a target="_blank" href="tryit52b4.html?filename=tryhtml5_av_event_pause" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The pause event occurs when the audio/video is paused either by the user or 
programmatically.</p>
<p><strong>Tip:</strong> The <a href="av_event_play.asp">play</a> event occurs 
when the audio/video has been started or is no longer paused.</p>
<hr>
...
&lt;<em>audio|video</em> onpause=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit3f36.html?filename=tryhtml5_av_event_pause_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onpause=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit52b4.html?filename=tryhtml5_av_event_pause">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;pause&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit831e.html?filename=tryhtml5_av_event_pause_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert that the audio has been paused:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onpause = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;The audio has been paused&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6a4d.html?filename=tryhtml5_av_event_pause2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_pause.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:39 GMT -->
</html>
