...
<!-- Mirrored from www.w3schools.com/tags/av_event_abort.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:11 GMT -->
<head>

<title>HTML Audio/Video DOM abort Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">abort</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that the loading of a video has been aborted:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onabort = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Video load aborted&quot;);<br>};</div>
<br>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The abort event occurs when the loading of an audio/video is aborted.</p>
<p>This event occurs when the media data download has been aborted, and not 
because of an error.</p>
<p><strong>Tip:</strong> Related events that occurs when there is some kind of 
disturbance to the media loading process, are:</p>
<ul>
	<li>emptied</li>
	<li><a href="av_event_error.asp">error</a></li>
	<li><a href="av_event_stalled.asp">stalled</a></li>
	<li><a href="av_event_suspend.asp">suspend</a></li>
</ul>
<hr>
...
<p><strong>Note:</strong> The abort event is not supported in Internet Explorer 11 on Windows 7.</p>
<hr>

<h2>Syntax</h2>
<p>In HTML:</p>
<div class="w3-code w3-border notranslate"><div>
&lt;<i>element</i> onabort=&quot;<i>myScript</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onabort=function(){<i>myScript</i>};</div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;abort&quot;, <em>myScript</em>);</div></div>
