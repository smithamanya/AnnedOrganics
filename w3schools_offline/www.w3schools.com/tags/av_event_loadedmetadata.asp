...
<!-- Mirrored from www.w3schools.com/tags/av_event_loadedmetadata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:30 GMT -->
<head>
...
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onloadedmetadata = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Meta data for video loaded&quot;);<br>
	};</div>
<a target="_blank" href="tryitfa0f.html?filename=tryhtml5_av_event_loadedmetadata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> onloadedmetadata=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit8e8b.html?filename=tryhtml5_av_event_loadedmetadata_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onloadedmetadata=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitfa0f.html?filename=tryhtml5_av_event_loadedmetadata">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;loadedmetadata&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryita287.html?filename=tryhtml5_av_event_loadedmetadata_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert when meta data for the audio is loaded:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onloadedmetadata = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Meta data for audio loaded&quot;);<br>
	};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit000d.html?filename=tryhtml5_av_event_loadedmetadata2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_loadedmetadata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:33 GMT -->
</html>
