...
<!-- Mirrored from www.w3schools.com/tags/av_event_seeked.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:51 GMT -->
<head>

<title>HTML Audio/Video DOM seeked Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">seeked</span> Event</h1>
...
<h3>Example</h3>
<p>When the user is finished moving/skipping to a new position in the video, 
alert some text:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onseeked = function() {<br>&nbsp;&nbsp;&nbsp; 
	alert(&quot;Seek operation completed!&quot;);<br>};</div>
<a target="_blank" href="tryitb08d.html?filename=tryhtml5_av_event_seeked" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The seeked event occurs when the user is finished moving/skipping to a new 
position in the audio/video.</p>
<p><strong>Tip:</strong> The seeked event is the opposite of the 
<a href="av_event_seeking.asp">seeking</a> 
event.</p>
...
&lt;<em>audio|video</em> onseeked=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitc2d0.html?filename=tryhtml5_av_event_seeked_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onseeked=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitb08d.html?filename=tryhtml5_av_event_seeked">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;seeked&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitfce7.html?filename=tryhtml5_av_event_seeked_el">Try it</a> </div></div>
...
<h3>Example</h3>
	...
	playtime position when the user is finished moving/skipping to a new 
	position:</p>
<div class="w3-code notranslate jsHigh">
  
    // Get the &lt;video&gt; element with id=&quot;myVideo&quot;<br>var vid = 
	document.getElementById(&quot;myVideo&quot;);<br><br>// Attach a seeked event to the 
	&lt;video&gt;, and execute a function when a seek operation completes<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit42c6.html?filename=tryhtml5_av_event_seeked_currenttime">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>When the user is finished moving/skipping to a new position in the audio, 
alert some text:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>
	aud.onseeked = function() {<br>&nbsp;&nbsp;&nbsp; 
	alert(&quot;Seek operation completed!&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6649.html?filename=tryhtml5_av_event_seeked2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_seeked.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:55 GMT -->
</html>
