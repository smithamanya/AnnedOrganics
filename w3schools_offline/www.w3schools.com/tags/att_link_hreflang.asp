...
<!-- Mirrored from www.w3schools.com/tags/att_link_hreflang.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:02:49 GMT -->
<head>
...
<a target="_blank" href="tryit16bd.html?filename=tryhtml5_link_hreflang" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> The hreflang attribute does not render as anything special in any of the 
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<a href="ref_language_codes.html">Language code reference</a>.</p>
