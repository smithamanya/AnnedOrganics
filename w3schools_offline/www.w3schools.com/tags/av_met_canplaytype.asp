...
<!-- Mirrored from www.w3schools.com/tags/av_met_canplaytype.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:43 GMT -->
<head>
...
<div class="w3-code notranslate jsHigh">
    ...
    var vid = document.createElement('video');<br>isSupp = vid.canPlayType(vidType+';codecs=&quot;'+codType+'&quot;');  
</div>
<a target="_blank" href="tryite1f4.html?filename=tryhtml5_av_met_canplaytype" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
...
<table class="tecspec">
  <tr>
	...
	<td>A String, representing the level of support. Possible return values:<br>
	<ul>
