...
<!-- Mirrored from www.w3schools.com/tags/av_event_loadeddata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:27 GMT -->
<head>
...
<h3>Example</h3>
<p>Alert that data for the current frame is available (for &lt;video&gt;):</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onloadeddata = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Browser has loaded the current 
	frame&quot;);<br>};</div>
<a target="_blank" href="tryitcf84.html?filename=tryhtml5_av_event_loadeddata" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> onloadeddata=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit35c6.html?filename=tryhtml5_av_event_loadeddata_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onloadeddata=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitcf84.html?filename=tryhtml5_av_event_loadeddata">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;loadeddata&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit7602.html?filename=tryhtml5_av_event_loadeddata_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert that data for the current frame is available (for &lt;audio&gt;):</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onloadeddata = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Browser has loaded the current 
	frame&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitfb73-2.html?filename=tryhtml5_av_event_loadeddata2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_loadeddata.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:30 GMT -->
</html>
