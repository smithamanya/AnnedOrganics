...
<!-- Mirrored from www.w3schools.com/tags/att_input_multiple.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:01:55 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryit4ebe.html?filename=tryhtml5_input_multiple" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> For &lt;input type=&quot;file&quot;&gt;: to select multiple files, hold 
down the CTRL or SHIFT key while selecting.</p>
<p><strong>Tip:</strong> For &lt;input type=&quot;email&quot;&gt;: separate each email with a 
comma, like: mail@example.com, mail2@example.com, mail3@example.com in the email 
field.</p>
<hr>
