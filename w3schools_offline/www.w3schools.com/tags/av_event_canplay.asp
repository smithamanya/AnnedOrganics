...
<!-- Mirrored from www.w3schools.com/tags/av_event_canplay.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:12 GMT -->
<head>
...
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.oncanplay = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;Can start playing video&quot;);<br>};</div>
<a target="_blank" href="tryit8ef5.html?filename=tryhtml5_av_event_canplay" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The canplay event occurs when the browser can start playing the specified 
audio/video (when it has 
buffered enough to begin).</p>
...
&lt;<em>audio|video</em> oncanplay=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitfb60.html?filename=tryhtml5_av_event_canplay_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.oncanplay=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit8ef5.html?filename=tryhtml5_av_event_canplay">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;canplay&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit65a4.html?filename=tryhtml5_av_event_canplay_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert that the audio is ready to start playing:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.oncanplay = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;Can start playing audio&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit0dd4.html?filename=tryhtml5_av_event_canplay2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_canplay.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:16 GMT -->
</html>
