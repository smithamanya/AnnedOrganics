...
<!-- Mirrored from www.w3schools.com/tags/av_event_loadstart.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:33 GMT -->
<head>
...
<p>Alert that the video is starting to load:</p>
	<div class="w3-code notranslate jsHigh">
    	var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onloadstart = 
		function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Starting to load video&quot;);<br>
		};</div>
<a target="_blank" href="tryit0161.html?filename=tryhtml5_av_event_loadstart" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
&lt;<em>audio|video</em> onloadstart=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit7e9e.html?filename=tryhtml5_av_event_loadstart_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onloadstart=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit0161.html?filename=tryhtml5_av_event_loadstart">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;loadstart&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit2d61.html?filename=tryhtml5_av_event_loadstart_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert that the audio is starting to load:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onloadstart = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Starting to load video&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit47fb.html?filename=tryhtml5_av_event_loadstart2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_loadstart.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:36 GMT -->
</html>
