...
<!-- Mirrored from www.w3schools.com/tags/av_event_play.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:39 GMT -->
<head>

<title>HTML Audio/Video DOM play Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">play</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that the video has started to play:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onplay = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;The video has started to play&quot;);<br>};</div>
<a target="_blank" href="tryit080f.html?filename=tryhtml5_av_event_play" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The play event occurs when the audio/video has been started or is no 
longer paused.</p>
<p><strong>Tip:</strong> The <a href="av_event_pause.asp">pause</a> event 
occurs when the audio/video has been paused.</p>
<hr>
...
&lt;<em>audio|video</em> onplay=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit2b08.html?filename=tryhtml5_av_event_play_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onplay=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit080f.html?filename=tryhtml5_av_event_play">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;play&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitd73a.html?filename=tryhtml5_av_event_play_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert that the audio has started to play:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>aud.onplay = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;The audio has started to play&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitdc0b.html?filename=tryhtml5_av_event_play2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_play.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:42 GMT -->
</html>
