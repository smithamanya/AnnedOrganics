...
<!-- Mirrored from www.w3schools.com/tags/av_event_waiting.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:05 GMT -->
<head>

<title>HTML Audio/Video DOM waiting Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">waiting</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that the video needs to buffer the next frame before it can start 
playing:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onwaiting = function() 
	{<br>&nbsp;&nbsp;&nbsp; alert(&quot;Wait! I need to buffer the next frame&quot;);<br>
	};</div>
<a target="_blank" href="tryit0e18.html?filename=tryhtml5_av_event_waiting" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The waiting event occurs when the video stops because it needs to buffer the 
next frame.</p>
<p>This event can also be used on &lt;audio&gt; elements, but it is mostly used for 
videos.</p>
<hr>
...
&lt;<em>audio|video</em> onwaiting=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryite225.html?filename=tryhtml5_av_event_waiting_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onwaiting=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit0e18.html?filename=tryhtml5_av_event_waiting">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;waiting&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitf315.html?filename=tryhtml5_av_event_waiting_el">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_waiting.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:07 GMT -->
</html>
