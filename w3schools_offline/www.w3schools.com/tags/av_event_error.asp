...
<!-- Mirrored from www.w3schools.com/tags/av_event_error.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:27 GMT -->
<head>

<title>HTML Audio/Video DOM error Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">error</span> Event</h1>
...
<h3>Example</h3>
<p>Alert that an error occured while loading the video:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onerror = 
	function() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Error! Something went wrong&quot;);<br>
	};</div>
<br>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The error event occurs when an error occurred during the loading of an 
audio/video.</p>
...
&lt;<i>element</i> onerror=&quot;<i>myScript</i>&quot;&gt;</div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onerror=function(){<i>myScript</i>};</div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;error&quot;, <em>myScript</em>);</div></div>
