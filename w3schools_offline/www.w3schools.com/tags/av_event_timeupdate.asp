...
<!-- Mirrored from www.w3schools.com/tags/av_event_timeupdate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:59 GMT -->
<head>

<title>HTML Audio/Video DOM timeupdate Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">timeupdate</span> Event</h1>
<p><a href="ref_av_dom.html"><img class="navup" src="../images/up.gif" alt="HTML audio Tag Reference" /> HTML Audio/Video DOM Reference</a></p>
<div class="w3-example">

<h3>Example</h3>
<p>When the playing position of a video has changed, display the current 
position of the video in seconds:</p>
<div class="w3-code notranslate jsHigh">
    // Get the &lt;video&gt; element with id="myVideo"<br>var vid = 
	document.getElementById("myVideo");<br><br>// Assign an ontimeupdate event 
	to the &lt;video&gt; element, and execute a function if the current playback 
	position has changed<br>vid.ontimeupdate = function() {myFunction()};<br>
	<br>function myFunction() {<br>// Display the current position of the video 
	in a &lt;p&gt; element with id="demo"<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById("demo").innerHTML = vid.currentTime;<br>}</div>
<a target="_blank" href="tryit51b2.html?filename=tryhtml5_av_event_timeupdate" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The timeupdate event occurs when the playing position of an audio/video has 
changed.</p>
<p>This event is invoked by:</p>
<ul>
	<li>Playing the audio/video</li>
	<li>Moving the playback position (like when the user fast forwards to a 
	different point in the audio/video)</li>
</ul>
<p><strong>Tip:</strong> This timeupdate event is often used together with the 
<a href="av_prop_currenttime.asp">currentTime</a> property of the Audio/Video Object, 
which returns the current 
position of the audio/video playback, in seconds.</p>
<hr>
...
&lt;<em>audio|video</em> ontimeupdate=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitc2d8.html?filename=tryhtml5_av_event_timeupdate_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.ontimeupdate=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit51b2.html?filename=tryhtml5_av_event_timeupdate">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;timeupdate&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit4bd5.html?filename=tryhtml5_av_event_timeupdate_el">Try it</a> </div></div>
<p><strong>Note:</strong> The <a href="../jsref/met_element_addeventlistener.html">addEventListener()</a> method is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>

<h2>Technical Details</h2>
<table class="tecspec">
  <tr>
	<th style="width:32%">Supported HTML tags:</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>When the playing position of an audio has changed, display the current 
position of the audio in seconds:</p>
<div class="w3-code notranslate jsHigh">
  
    // Get the &lt;audio&gt; element with id="myVideo"<br>var aud = 
	document.getElementById("myVideo");<br><br>// Assign an ontimeupdate event 
	to the &lt;audio&gt; element, and execute a function if the current playback 
	position has changed<br>aud.ontimeupdate = function() {myFunction()};<br>
	<br>function myFunction() {<br>// Display the current position of the audio 
	in a &lt;p&gt; element with id="demo"<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById("demo").innerHTML = aud.currentTime;<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit9213.html?filename=tryhtml5_av_event_timeupdate2">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using the currentTime property to set the current playback position to 5 
seconds:</p>
<div class="w3-code notranslate jsHigh">
  
	document.getElementById(&quot;myVideo&quot;).currentTime = 5;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit188b.html?filename=tryhtml5_av_event_timeupdate_currenttime">Try it yourself &raquo;</a>
</div>
<hr>
<a href="ref_av_dom.html"><img class="navup" src="../images/up.gif" alt="HTML audio Tag Reference" /> HTML Audio/Video DOM Reference</a>
</div>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_timeupdate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:02 GMT -->
</html>
