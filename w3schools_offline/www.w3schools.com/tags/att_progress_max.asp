...
<!-- Mirrored from www.w3schools.com/tags/att_progress_max.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:03:31 GMT -->
<head>
...
<p><a href="tag_progress.html"><img class="navup" src="../images/up.gif" alt="HTML progress Tag Reference" /> HTML &lt;progress&gt; tag</a></p>
...
<a class="w3-btn w3-margin-bottom" href="tryit3ecb.asp?filename=tryhtml5_progress" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
	...
	<tr>
		<td><em>number</em></td>
		<td>A floating point number that specifies how much work the task requires in total 
		before it can be considered complete. Default value is 1.0.</td>
	</tr>
</table>
<hr>
<a href="tag_progress.html"><img class="navup" src="../images/up.gif" alt="HTML progress Tag Reference" /> HTML &lt;progress&gt; tag</a>
</div>
