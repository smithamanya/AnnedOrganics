...
<!-- Mirrored from www.w3schools.com/tags/canvas_drawimage.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:14 GMT -->
<head>
...
<p><a href="ref_canvas.html"><img class="navup" src="../images/up.gif" alt="HTML canvas Reference" /> HTML Canvas Reference</a></p>
...
&nbsp;&nbsp;&nbsp;
ctx.drawImage(img,10,10);<br>};</div>
<a class="w3-btn w3-margin-bottom" href="tryitb868.html?filename=tryhtml5_canvas_drawimage" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9, Firefox, Opera, Chrome, and Safari support the drawImage() method.</p>
...
<td><strong>Note:</strong> You cannot call the drawImage() method before the 
image has loaded. To ensure that the image has been loaded, you can call 
drawImage() from window.onload() or from document.getElementById(&quot;<em>imageID</em>&quot;).onload.
</td>
</tr></table>
...
<table class="w3-table-all notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasf26e.html?filename=playcanvas_drawimagedx&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>sy</i></td>
		<td>Optional. The y coordinate where to start clipping</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasbf3b.html?filename=playcanvas_drawimagedy&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>swidth</i></td>
		<td>Optional. The width of the clipped image</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas9556.html?filename=playcanvas_drawimagedwidth&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>sheight</i></td>
		<td>Optional. The height of the clipped image</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas42f8.html?filename=playcanvas_drawimagedheight&amp;preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate where to place the image on the canvas</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvase7d7.html?filename=playcanvas_drawimagex&amp;preval=img,10,10">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate where to place the image on the canvas</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas0510.html?filename=playcanvas_drawimagey&amp;preval=img,10,10">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>width</i></td>
		<td>Optional. The width of the image to use (stretch or reduce the image)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasf9ab.html?filename=playcanvas_drawimagewidth&amp;preval=img,10,10,220,277">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>height</i></td>
		<td>Optional. The height of the image to use (stretch or reduce the image)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasa247.html?filename=playcanvas_drawimageheight&amp;preval=img,10,10,220,277">Play it &raquo;</a></td>		
	</tr>
</table>
<hr>
...
&nbsp;&nbsp;&nbsp; var ctx=c.getContext(&quot;2d&quot;);<br>
&nbsp;&nbsp;&nbsp; var img=document.getElementById(&quot;scream&quot;);<br>
&nbsp;&nbsp;&nbsp; ctx.drawImage(img,10,10,150,180);<br>};</div>
<a class="w3-btn w3-margin-bottom" href="tryitfb53.html?filename=tryhtml5_canvas_drawimage2" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
var c=document.getElementById(&quot;myCanvas&quot;);<br>&nbsp;&nbsp;&nbsp; var 
	...
	&nbsp;&nbsp;&nbsp;
	ctx.drawImage(img,90,130,50,60,10,10,50,60);<br>};</div>
<a class="w3-btn w3-margin-bottom" href="tryite6f7.html?filename=tryhtml5_canvas_drawimage3" target="_blank">Try it yourself &raquo;</a>
</div>
<br>
...
Your browser does not support the HTML5 canvas tag.</canvas>
<p>JavaScript (the code draws the current frame of the video every 20 millisecond):</p>
<div class="w3-code notranslate">
...
<a class="w3-btn w3-margin-bottom" href="tryit339d.html?filename=tryhtml5_canvas_drawimage_video" target="_blank">Try it yourself &raquo;</a>
</div>
<script>
...
<hr>
<a href="ref_canvas.html"><img class="navup" src="../images/up.gif" alt="HTML canvas Reference" /> HTML Canvas Reference</a>
</div>
...
<!-- Mirrored from www.w3schools.com/tags/canvas_drawimage.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:24 GMT -->
</html>
