...
<!-- Mirrored from www.w3schools.com/tags/att_basefont_size.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:59:39 GMT -->
<head>
...
<a target="_blank" href="tryitf949.asp?filename=tryhtml_basefont_size" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><b>Note</b>: The size attribute is only supported in Internet Explorer 9, and earlier versions.</p>
<hr>
...
<p><a target="_blank" href="tryit88dc.asp?filename=tryhtml_basefont_size_css">CSS 
Example: Specify a default font-size for a page</a></p>
<p>In our CSS tutorial you can find more details about the
<a href="../cssref/pr_font_font-size.html">font-size property</a>.</p>
<hr>
