...
<!-- Mirrored from www.w3schools.com/tags/canvas_filltext.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:06 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryitd9ca.html?filename=tryhtml5_canvas_filltext" target="_blank">Try it yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate">
	...
	<tr>
		...
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas58f1.html?filename=playcanvas_filltexttext">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>x</i></td>
		<td>The x coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvas16fd.html?filename=playcanvas_filltextx">Play it &raquo;</a></td>		
	</tr>
	<tr>
		<td><i>y</i></td>
		<td>The y coordinate where to start painting the text (relative to the 
		canvas)</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvasd03a.html?filename=playcanvas_filltexty">Play it &raquo;</a></td>
	</tr>
	<tr>
		<td><i>maxWidth</i></td>
		<td>Optional. The maximum allowed width of the text, in pixels</td>
		<td><a target="_blank" class="w3-btn btnplayit" href="playcanvase9db.html?filename=playcanvas_filltextmaxwidth">Play it &raquo;</a></td>		
	</tr>
</table>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/canvas_filltext.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:40:09 GMT -->
</html>
