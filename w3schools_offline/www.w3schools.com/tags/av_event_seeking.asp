...
<!-- Mirrored from www.w3schools.com/tags/av_event_seeking.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:55 GMT -->
<head>

<title>HTML Audio/Video DOM seeking Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">seeking</span> Event</h1>
...
<h3>Example</h3>
<p>When the user starts moving/skipping to a new position in the video, 
alert some text:</p>
<div class="w3-code notranslate jsHigh">
    var vid = document.getElementById(&quot;myVideo&quot;);<br>vid.onseeking = function() {<br>&nbsp;&nbsp;&nbsp; 
	alert(&quot;Seek operation began!&quot;);<br>};</div>
<a target="_blank" href="tryit6378.html?filename=tryhtml5_av_event_seeking" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>

<hr>
<h2>Definition and Usage</h2>
<p>The seeking event occurs when the user starts moving/skipping to a new 
position in the audio/video.</p>
<p><strong>Tip:</strong> The seeking event is the opposite of the 
<a href="av_event_seeked.asp">seeked</a> 
event.</p>
<p><strong>Tip:</strong> Use the <a href="av_prop_currenttime.asp">currentTime</a> property of the Audio/Video Object to get the current 
playback position.</p>
<hr>
...
&lt;<em>audio|video</em> onseeking=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit46ab.html?filename=tryhtml5_av_event_seeking_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onseeking=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit6378.html?filename=tryhtml5_av_event_seeking">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;seeking&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryite7da.html?filename=tryhtml5_av_event_seeking_el">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates the difference between the seeking event and 
seeked event:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;video onseeking=&quot;myFunction()&quot; onseeked=&quot;mySecondFunction()&quot;&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2236.html?filename=tryhtml5_av_event_seeked_seeking">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
	...
	document.getElementById(&quot;myVideo&quot;);<br><br>// Attach a seeking event to the 
	&lt;video&gt;, and execute a function if a seek operation begins<br>
	vid.addEventListener(&quot;seeking&quot;, myFunction);<br><br>function myFunction() {<br>
	// Display the current position of the &lt;video&gt; in a p element with id=&quot;demo&quot;<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = vid.currentTime;<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitba67.html?filename=tryhtml5_av_event_seeking_currenttime">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>When the user starts moving/skipping to a new position in the audio, 
alert some text:</p>
<div class="w3-code notranslate jsHigh">
  
    var aud = document.getElementById(&quot;myAudio&quot;);<br>
	aud.onseeking = function() {<br>&nbsp;&nbsp;&nbsp; 
	alert(&quot;Seek operation began!&quot;);<br>};<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1f09.html?filename=tryhtml5_av_event_seeking2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_seeking.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:59 GMT -->
</html>
