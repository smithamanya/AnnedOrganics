...
<!-- Mirrored from www.w3schools.com/tags/av_event_ratechange.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:49 GMT -->
<head>

<title>HTML Audio/Video DOM ratechange Event</title>
...
<h1>HTML Audio/Video DOM <span class="color_h1">ratechange</span> Event</h1>
...
<h3>Example</h3>
<p>Change the playing speed of a video and alert that the speed was changed:</p>
<div class="w3-code notranslate jsHigh">
    // Get the &lt;video&gt; element with id=&quot;myVideo&quot;<br>var vid = 
	document.getElementById(&quot;myVideo&quot;);<br><br>// Set the current playback speed 
	of the video to 0.3 (slow motion)<br>function setPlaySpeed() { <br>&nbsp;&nbsp;&nbsp; 
	vid.playbackRate = 0.3;<br>} <br><br>// Assign a ratechange event to the 
	&lt;video&gt; element, and execute a function if the playing speed of the video is 
	changed. The function will alert some text<br>vid.onratechange = function() 
	{myFunction()};<br><br>function 
	myFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;The playing speed of the video 
	was changed&quot;);<br>}</div>
<a target="_blank" href="tryitb0e3.html?filename=tryhtml5_av_event_ratechange" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ratechange event occurs when the playing speed of the audio/video is changed (like when a user switches to a slow motion or fast forward mode).</p>
<p>This event is invoked by the <a href="av_prop_playbackrate.asp">playbackRate</a> property of the Audio/Video Object, which sets or returns the 
...
&lt;<em>audio|video</em> onratechange=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit5a3e.html?filename=tryhtml5_av_event_ratechange_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.onratechange=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitb0e3.html?filename=tryhtml5_av_event_ratechange">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>audio|video</em>.addEventListener(&quot;ratechange&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitc3d5.html?filename=tryhtml5_av_event_ratechange_el">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/tags/av_event_ratechange.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:41:51 GMT -->
</html>
