...
<!-- Mirrored from www.w3schools.com/tags/att_form_accept.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:00:34 GMT -->
<head>
...
<a target="_blank" href="tryit1d99.html?filename=tryhtml_form_accept" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> Look at the <a href="att_input_accept.asp">&lt;input&gt; 
accept attribute</a> instead.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>file_type</i></td>
    <td>One or more file types that can be submitted/uploaded. To specify more 
	than one file type, separate the types with a comma</td>
  </tr>
  </table>
<hr>
