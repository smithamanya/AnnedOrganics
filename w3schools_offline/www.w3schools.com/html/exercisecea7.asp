...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_forms1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:49 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_forms1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make a HTML form, containing an &lt;input&gt; element with type="button", and 
value=&quot;OK&quot;.</p>
<p id="hint">Hint: Make a &lt;form&gt; element, and place the &lt;input type=&quot;button&quot; 
value=&quot;OK&quot;&gt; element inside it.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "input",
            "errname" : "No input element inside the form element",
            "attr" : [{
                "name" : "type",
                "errname" : "type attribute not found",
                "value" : "button",
