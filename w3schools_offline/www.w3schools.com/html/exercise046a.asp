...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_lists6 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:41 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_lists6".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make the list below display horizontally.<p>
<p id="hint">Hint: Add an id attribute to &lt;ul&gt;.</p>
<script>
required = {
    "tags" : [{
        "name" : "ul",
        ...
        "attr" : [{
            "name" : "id",
            "errname" : "No id attribute found",        
            "value" : "menu",
            "errvalue" : "id attribute has wrong value"
        }]
    }]
}
