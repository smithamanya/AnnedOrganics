...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_iframe3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:42 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_iframe3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Remove the border from the iframe.</p>
<p id="hint">Hint: Use the CSS border property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            ...
            "value" : "none",
            "errvalue" : "The top border-style is not none"
        },{
            "style" : "border-right-style",
            "value" : "none",
            "errvalue" : "The right border-style is not none"
        },{
            "style" : "border-bottom-style",
            "value" : "none",
            "errvalue" : "The bottom border-style is not none"
        },{
            "style" : "border-left-style",
            "value" : "none",
            "errvalue" : "The left border-style is not none"
        }]
    }]
}</script>
