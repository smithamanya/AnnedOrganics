...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_scripts1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:48 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_scripts1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Use JavaScript to change the HTML content of the &lt;p&gt; element to "Hello World!".</p>
...
required = {
    "tags" : [{
        ...
        "value" : "Hello World!",
        "errvalue" : "The HTML content of the p element is wrong"
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "innerHTML",
        "errinvalue" : "Error in script, missing innerHTML"
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "Hello World!",
        "errinvalue" : "Error in script, missing Hello World!"
    }]
}
</script>
