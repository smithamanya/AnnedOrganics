...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_scripts2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:48 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_scripts2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Use JavaScript to change the text size of the &lt;p&gt; element to 40 pixels.</p>
<p id="hint"><strong>Hint: 
</strong>Use the document.getElementById() method to find the &lt;p&gt; element.<br>
Then, use the style.fontSize property to change its font size.
</p>
<script>
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "font-size",
            "value" : "40px",
            "errvalue" : "The p element is not 40 px"
        }]
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "40px",
        "errinvalue" : "Error in script, missing 40px"
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "style.fontSize",
        "errinvalue" : "Error in script, missing fontSize"
    }]
}
</script>
