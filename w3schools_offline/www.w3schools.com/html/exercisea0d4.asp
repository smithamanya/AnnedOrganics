...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_attributes4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:29 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_attributes4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the destination of the link below to "www.wwf.org.uk".</p>
<p id="hint">Hint: Change the href attribute.</p>
