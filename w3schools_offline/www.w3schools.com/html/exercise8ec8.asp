...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_attributes1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:28 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_attributes1".replace("exercise_","");
...
<p id="hint">Hint: Use the title attribute.</p>
<script>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            "name" : "title",
            "errname" : "No tooltip found",        
            "value" : "About W3Schools",
            "errvalue" : "Tooltip has wrong value"
        }]
    }]
}
</script>
...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_attributes1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:29 GMT -->
</html>
</textarea>
