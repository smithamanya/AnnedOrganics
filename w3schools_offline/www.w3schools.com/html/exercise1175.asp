...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_tables1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:38 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_tables1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make the table borders collapse into single borders.</p>
<p id="hint">Hint: Add the CSS border-collapse property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            ...
            "value" : "collapse",
            "errvalue" : "The borders do not collapse"
        }]
    }]
}
</script>
