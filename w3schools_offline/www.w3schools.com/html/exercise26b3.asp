...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_quotation_elements4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:34 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_quotation_elements4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>The letters "WHO" in the text below is an abbreviation of "World Health Organization".<br>
Use an HTML element to provide the specified abbreviation of "WHO".</p>
<p id="hint">Hint: Use the &lt;abbr&gt; element, and add the title attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "abbr",
        "errname" : "No abbreviation element found",
        "value" : "WHO",
        "errvalue" : "Wrong word",
        "attr" : [{
            "name" : "title",
            "errname" : "title attribute not found",        
            "value" : "World Health Organization",
            "errvalue" : "Wrong title value"
        }]
    }]
}
</script>
