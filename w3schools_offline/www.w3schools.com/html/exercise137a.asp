...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_paragraphs3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:31 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_paragraphs3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Fix the display of the poem below. Display the poem over 4 lines using &lt;br&gt; 
elements.</p>
<p id="hint">Hint: Use &lt;br&gt; elements to seperate the lines.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "br",
            "count" : 3,
            "errname" : "You should include at least three br elements in the paragraph"
        }]
    }]
}
</script>
