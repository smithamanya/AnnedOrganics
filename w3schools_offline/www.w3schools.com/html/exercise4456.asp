...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_elements3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:50 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_elements3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Set the display text of the &lt;button&gt; to: &quot;Click Me!&quot;.</p>
<p id="hint">Hint: Add the text beween &lt;button&gt; and &lt;/button&gt;. </p>

<script>
required = {
    "tags" : [{
        "name" : "button",
        "errname" : "No button found",
        "invalue" : "Click Me!",
        "errinvalue" : "Button display text should be Click Me!"
    }]
}
</script>
