...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_tables5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:39 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_tables5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Left align the text in the table.</p>
<p id="hint">Hint: Change the CSS text-align property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "text-align",
            "value" : "left",
            "errvalue" : "The text is not left aligned"
        }]
    }]
}
