...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_attributes3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:53 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_attributes3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the size of the input field to display up to 40 characters.</p>
<p id="hint">Hint: Add the size attribute.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            ...
            "attr" : [{
                "name" : "size",
                "errname" : "No size attribute found",        
                "value" : "40",
                "errvalue" : "No input element with size 40 was found"
            }]
        }]
    }]
}
