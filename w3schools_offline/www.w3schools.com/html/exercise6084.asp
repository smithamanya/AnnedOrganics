...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_input_types1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:51 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_input_types1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Create an input field for text.</p>
<p id="hint">Hint: Use input type="text".</p>
<script>
required = {
    "tags" : [{
        "name" : "input",
        "errname" : "No input field found",
        "attr" : [{
            "name" : "type",
            "errname" : "No type attribute found",        
            "value" : "text",
            "errvalue" : "Input field is wrong type"
        }]
    }]
}
</script>
