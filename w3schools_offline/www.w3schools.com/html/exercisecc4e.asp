...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_computercode_elements2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:34 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_computercode_elements2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Define the text inside the &lt;code&gt; element as preformatted text (preserve 
spaces and line breaks):</p>
<p id="hint">Hint: Use the &lt;pre&gt; element.</p>

<script>
required = {
    "tags" : [{
        "name" : "pre",
        "errname" : "No pre element found",
        "tags" : [{
            "name" : "code",
            "errname" : "No code element inside the pre element"
        }]
    }]
}
</script>
