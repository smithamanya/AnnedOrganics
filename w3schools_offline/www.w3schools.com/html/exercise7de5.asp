...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_links2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:36 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_links2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the link below to a local link.</p>
<p id="hint">Hint: Change the href attribute value.</p>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            ...
            "invalue" : "!http://",
            "errinvalue" : "The href has wrong value"
        }]
    }]
}
</script>
