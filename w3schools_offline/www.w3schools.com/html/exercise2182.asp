...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_images2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:37 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_images2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Double the size of the image below.</p>
<p id="hint">Hint: Change the width and height properties.</p> 
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "width",
            "value" : "256px",
            "errvalue" : "The width is not 256px"
        },{
            "style" : "height",
            "value" : "256px",
            "errvalue" : "The height is not 256px"
        }]
    }]
}
</script>
