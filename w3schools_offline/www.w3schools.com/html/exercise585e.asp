...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_images4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:38 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_images4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make the image below float to the left of the paragraph.</p>
<p id="hint">Hint: Add the CSS float property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "float",
            "value" : "left",
            "errvalue" : "The image does not float to the left of the paragraph"
        }]
    }]
}
</script>
