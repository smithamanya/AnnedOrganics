...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_tables3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:39 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_tables3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a caption with the letters "Names" to the table.</p>
<p id="hint">Hint: Use a &lt;caption&gt; element.</p>
<script>
required = {
    "tags" : [{
        "name" : "table",
        ...
        "tags" : [{
            "name" : "caption",
            "errname" : "No caption found for table",
            "value" : "Names",
            "errvalue" : "Wrong caption"
        }]
    }]
}
</script>
