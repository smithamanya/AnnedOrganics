...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_tables6 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:39 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_tables6".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a black background color with white text to all table rows.</p>
<p id="hint">Hint: Add the CSS "background-color" and "color" property for all &lt;tr&gt; elements.</p>
...
required = {
    "tags" : [{
        ...
        "errname" : "No table found",
          "tags" : [{
            "name" : "tr",
            "errname" : "No table row found",
            "css" : [{
                "style" : "background-color",
                "value" : "black",
                "errvalue" : "A tr element without black background is found"
            },{
                "style" : "color",
                "value" : "white",
                "errvalue" : "A tr element without white text is found"
            }]
        }]
    }]
}
