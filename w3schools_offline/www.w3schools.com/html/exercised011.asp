...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_forms3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:49 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_forms3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a submit button to the form, and specify that the form should go to "demo_form_exercise.php".</p>
<p id="hint">Hint: Add an &lt;input&gt; element with type=&quot;submit&quot;. Set the action 
attribute for the &lt;form&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            "name" : "action",
            "errname" : "No action attribute found",        
            "value" : "demo_form_exercise.php",
            "errvalue" : "The form goes to the wrong URL"
        }],
        "tags" : [{
            "name" : "input",
            "errname" : "No submit button found",        
            "attr" : [{
                "name" : "type",
                "errname" : "No type attribute found for submit button",        
                "value" : "submit",
                "errvalue" : "No submit button"
            }]
