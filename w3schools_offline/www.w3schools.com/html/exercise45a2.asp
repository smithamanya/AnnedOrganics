...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_styles1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:31 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_styles1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the text color of the paragraph to "blue".</p>
<p id="hint">Hint: Change the style attribute.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "color",
            "value" : "blue",
            "errvalue" : "The paragraph is not blue"
        }]
    }]
}
</script>
