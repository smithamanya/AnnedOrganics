...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_formatting1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:32 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_formatting1".replace("exercise_","");
...
<p id="hint">Hint: Use the &lt;strong&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "strong",
            "errname" : "No strong element inside the p element",
            "value" : "degradation",
            "errvalue" : "Wrong word"
        }]
    }]
