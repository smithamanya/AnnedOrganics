...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_attributes3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:29 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_attributes3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Transform the text below into a link that goes to "www.w3schools.com".</p>
<p id="hint">Hint: Add an &lt;a&gt; element that has a href attribute.</p>
