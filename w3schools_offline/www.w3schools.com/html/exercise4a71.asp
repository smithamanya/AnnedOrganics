...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_headings3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:30 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_headings3".replace("exercise_","");
...
<p>Start with the most important heading and end with the least important heading.</p>
<p id="hint">Hint: Use &lt;h1&gt;, &lt;h2&gt;, &lt;h3&gt;, etc.</p>
...
required = {
    ...
    {
        "name" : "h3",
        "errname" : "No h3 element is found"
    },
    {
        "name" : "h4",
        "errname" : "No h4 element is found"
    },
    {
        "name" : "h5",
        "errname" : "No h5 element is found"
    },
    {
        "name" : "h6",
        "errname" : "No h6 element is found"
    }],
    alsorequired : {
        "tags" : [{
            "order" : "h1,h2,h3,h4,h5,h6",
            "errorder" : "The elments are not in correct order"
        }]
    }
}
