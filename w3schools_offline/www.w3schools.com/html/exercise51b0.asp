...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_formatting4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:33 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_formatting4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Apply subscript formatting to the number "2" in the text below.</p>
<p id="hint">Hint: Use the &lt;sub&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "sub",
            "errname" : "No sub element inside the p element",
            "value" : "2",
            "errvalue" : "Wrong word"
        }]
    }]
