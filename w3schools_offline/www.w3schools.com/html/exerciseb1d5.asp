...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_quotation_elements3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:33 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_quotation_elements3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make the text below go right-to-left.</p>
<p id="hint">Hint: Use the &lt;bdo&gt; element and add the dir attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "bdo",
        "errname" : "No bdo element found",
        "invalue" : "What a beautiful day!",
        "errinvalue" : "Wrong text",
        "attr" : [{
            "name" : "dir",
            "errname" : "dir attribute not found",        
            "value" : "rtl",
            "errvalue" : "Text does not go right-to-left"
        }]
    }]
}
</script>
...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_quotation_elements3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:34 GMT -->
</html>
</textarea>
