...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_formatting2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:32 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_formatting2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Emphasize the word "metropolitan" in the text below.</p>
<p id="hint">Hint: Use the &lt;em&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "em",
            "errname" : "No em element inside the p element",
            "value" : "metropolitan",
            "errvalue" : "Wrong word"
        }]
    }]
...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_formatting2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:33 GMT -->
</html>
</textarea>
