...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_input_types5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:51 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_input_types5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>1. Create an input field that should only contain a numeric value, and place it inside the &lt;form&gt; element.</p>
<p>2. Add the name attribute with a value of "quantity" to the input element.</p>
<p>3. Set restrictions on the input field to only accept numbers between 1 and 5.</p>
<p id="hint">Hint: 1. Use input type="number". 2. Add the name attribute. 3. Add the min and max attributes.</p>
    ...
    "tags" : [{
        ...
        "tags" : [{
            ...
            "attr" : [{
                ...
                "value" : "number",
                "errvalue" : "No number field was found"
            },{
                "name" : "min",
                "errname" : "No min attribute found",        
                "value" : "1",
                "errvalue" : "The min attribute has wrong value"
            },{
                "name" : "max",
                "errname" : "No max attribute found",        
                "value" : "5",
                "errvalue" : "The max attribute has wrong value"
            }]
        }]
    }]
}
