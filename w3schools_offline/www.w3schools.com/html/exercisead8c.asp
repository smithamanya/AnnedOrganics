...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_links3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:36 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_links3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the link below to open in a new window.</p>
<p id="hint">Hint: Add a target attribute.</p>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            "name" : "target",
            "errname" : "target attribute not found",        
            "value" : "_blank",
            "errvalue" : "target attribute has wrong value"
        }]
    }]
}
</script>
