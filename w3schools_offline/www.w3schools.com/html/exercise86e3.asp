...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_styles4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:32 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_styles4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the text size of the paragraph to 50px.</p>
<p id="hint">Hint: Add the style attribute and use the font-size property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "font-size",
            "value" : "50px",
            "errvalue" : "The paragraph is not 50px"
        }]
    }]
}
</script>
