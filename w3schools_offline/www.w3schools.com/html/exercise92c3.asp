...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_paragraphs1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a paragraph to this document with the text "Hello World!".</p>
<p id="hint">Hint: Add a &lt;p&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "value" : "Hello World!",
        "errvalue" : "Paragraph has wrong value"
    }]
}
