<script>var exnames = [], excounts = [], exheadings = [];exnames[0] = 'attributes';excounts[0] = '5';exheadings[0] = 'Attributes';exnames[1] = 'headings';excounts[1] = '4';exheadings[1] = 'Headings';exnames[2] = 'paragraphs';excounts[2] = '4';exheadings[2] = 'Paragraphs';exnames[3] = 'styles';excounts[3] = '6';exheadings[3] = 'Styles';exnames[4] = 'formatting';excounts[4] = '5';exheadings[4] = 'Formatting';exnames[5] = 'quotation_elements';excounts[5] = '4';exheadings[5] = 'Quotations';exnames[6] = 'computercode_elements';excounts[6] = '3';exheadings[6] = 'Computercode';exnames[7] = 'comments';excounts[7] = '2';exheadings[7] = 'Comments';exnames[8] = 'css';excounts[8] = '6';exheadings[8] = 'CSS';exnames[9] = 'links';excounts[9] = '5';exheadings[9] = 'Links';exnames[10] = 'images';excounts[10] = '6';exheadings[10] = 'Images';exnames[11] = 'tables';excounts[11] = '6';exheadings[11] = 'Tables';exnames[12] = 'lists';excounts[12] = '6';exheadings[12] = 'Lists';exnames[13] = 'classes';excounts[13] = '3';exheadings[13] = 'Classes';exActiveNo = 13;exnames[14] = 'iframe';excounts[14] = '4';exheadings[14] = 'Iframes';exnames[15] = 'scripts';excounts[15] = '4';exheadings[15] = 'Scripts';exnames[16] = 'forms';excounts[16] = '4';exheadings[16] = 'Forms';exnames[17] = 'form_elements';excounts[17] = '3';exheadings[17] = 'Form Elements';exnames[18] = 'form_input_types';excounts[18] = '5';exheadings[18] = 'Input Types';exnames[19] = 'form_attributes';excounts[19] = '4';exheadings[19] = 'Form Attributes';</script>
<!DOCTYPE html>
<html lang="en-US">

<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_classes3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:41 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_classes3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Create a class selector named "cities". Add the following styles:</p>
<ul>
  <li>black background color</li>
  <li>white text color</li>
  <li>20 pixels padding and margin</li>
</ul>
<p>Add the class "cities" to the &lt;div&gt; element.</p>

<p id="hint">Hint: Add the class name inside the &lt;style&gt; element.</p>
...
required = {
    "tags" : [{
        "name" : "style",
        "errname" : "No style element found",        
        "invalue" : ".cities",                
        "errinvalue" : "No class selector named 'cities' found in the style section"
    },{
    	"name" : "div",
    	"errname" : "No div element found",
    	"attr" : [{
            "name" : "class",
            "errname" : "A div element with no class attribute found",        
            "value" : "cities",
            "errvalue" : "A div element with the wrong class value found"
        }],
        "css" : [{
	        "style" : "background-color",
	        "value" : "black",                
	        "errvalue" : "The div is not black"
	    },{
	        "style" : "color",
	        "value" : "white",                
	        "errvalue" : "The text is not white"
	    },{
	        "style" : "padding-top",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px padding-top"
	    },{
	        "style" : "padding-right",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px padding-right"
	    },{
	        "style" : "padding-bottom",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px padding-bottom"
	    },{
	        "style" : "padding-left",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px padding-left"
	    },{
	        "style" : "margin-top",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px margin-top"
	    },{
	        "style" : "margin-right",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px margin-right"
	    },{
	        "style" : "margin-bottom",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px margin-bottom"
	    },{
	        "style" : "margin-left",
	        "value" : "20px",                
	        "errvalue" : "The div does not have a 20px margin-left"
	    }]
    }],
}
