...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_formatting5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a line through (strikeout) the letters "blue" in the text below.</p>
<p id="hint">Hint: Use the &lt;del&gt; element.</p>

<script>
required = {
    "tags" : [{
        "name" : "p",
        "errname" : "No paragrahp found",        
        "tags" : [{
            "name" : "del",
            "errname" : "No del element inside the p element",
            "value" : "blue",
            "errvalue" : "Wrong word"
        }]
    }]
