...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_links1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:36 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_links1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make the link below go to www.w3schools.com.</p>
<p id="hint">Hint: Add an href attribute.</p>
