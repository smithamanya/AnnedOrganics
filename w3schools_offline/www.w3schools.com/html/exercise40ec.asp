<script>var exnames = [], excounts = [], exheadings = [];exnames[0] = 'attributes';excounts[0] = '5';exheadings[0] = 'Attributes';exnames[1] = 'headings';excounts[1] = '4';exheadings[1] = 'Headings';exnames[2] = 'paragraphs';excounts[2] = '4';exheadings[2] = 'Paragraphs';exnames[3] = 'styles';excounts[3] = '6';exheadings[3] = 'Styles';exnames[4] = 'formatting';excounts[4] = '5';exheadings[4] = 'Formatting';exnames[5] = 'quotation_elements';excounts[5] = '4';exheadings[5] = 'Quotations';exnames[6] = 'computercode_elements';excounts[6] = '3';exheadings[6] = 'Computercode';exnames[7] = 'comments';excounts[7] = '2';exheadings[7] = 'Comments';exnames[8] = 'css';excounts[8] = '6';exheadings[8] = 'CSS';exnames[9] = 'links';excounts[9] = '5';exheadings[9] = 'Links';exnames[10] = 'images';excounts[10] = '6';exheadings[10] = 'Images';exnames[11] = 'tables';excounts[11] = '6';exheadings[11] = 'Tables';exnames[12] = 'lists';excounts[12] = '6';exheadings[12] = 'Lists';exnames[13] = 'classes';excounts[13] = '3';exheadings[13] = 'Classes';exnames[14] = 'iframe';excounts[14] = '4';exheadings[14] = 'Iframes';exnames[15] = 'scripts';excounts[15] = '4';exheadings[15] = 'Scripts';exnames[16] = 'forms';excounts[16] = '4';exheadings[16] = 'Forms';exActiveNo = 16;exnames[17] = 'form_elements';excounts[17] = '3';exheadings[17] = 'Form Elements';exnames[18] = 'form_input_types';excounts[18] = '5';exheadings[18] = 'Input Types';exnames[19] = 'form_attributes';excounts[19] = '4';exheadings[19] = 'Form Attributes';</script>
<!DOCTYPE html>
<html lang="en-US">

<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_forms4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:50 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_forms4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Specify that the form is submitted using the "post" method.</p>
<p id="hint">Hint: Use the method attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "form",
        "errname" : "No form element found",        
        "attr" : [{
            "name" : "method",
            "errname" : "No method attribute found",        
            "value" : "post",
            "errvalue" : "The method of the form is not 'post'"
        }]
    }]
}
</script>
...
<form action="http://www.w3schools.com/html/demo_form_exercise.php" method="post">
Name: <input type="text" name="name">
<input type="submit">
</form>
