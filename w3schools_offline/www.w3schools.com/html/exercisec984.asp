...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_lists4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:40 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_lists4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the list below to display letters instead of numbers.</p>
<p id="hint">Hint: Add a type attribute.</p>
<script>
required = {
    "tags" : [{
        "name" : "ol",
        ...
        "attr" : [{
            ...
            "value" : "a",
            "errvalue" : "type attribute has wrong value"
        }]
    }]
}
</script>
