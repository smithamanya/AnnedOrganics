...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_styles6 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:32 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_styles6".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Center align all content on the page.</p>
<p id="hint">Hint: Add the style attribute to &lt;body&gt; and use the text-align property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "text-align",
            "value" : "center",
            "errvalue" : "The content is not center aligned"
        }]
    }]
}
</script>
