...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_quotation_elements1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:33 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_quotation_elements1".replace("exercise_","");
...
<p id="hint">Hint: Use the &lt;q&gt; element.</p>

<script>
required = {
    "tags" : [{
        "name" : "q",
        "errname" : "No q element inside the p element",        
        "value" : "cool",
        "errvalue" : "Wrong word"
    }]
}
