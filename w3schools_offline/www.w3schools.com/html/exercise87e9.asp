...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_tables2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:39 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_tables2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Make the table 300 pixels wide.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "width",
            "value" : "300px",
            "errvalue" : "The table is not 300 pixels wide"
        }]
    }]
}
</script>
