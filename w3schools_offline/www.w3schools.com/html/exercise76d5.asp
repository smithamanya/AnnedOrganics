...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_paragraphs2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:31 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_paragraphs2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Clean up this document with proper end tags.</p>
<p id="hint">Hint: Add the end tag to each &lt;p&gt; element.</p>
