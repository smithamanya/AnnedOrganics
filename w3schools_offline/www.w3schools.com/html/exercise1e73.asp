...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_images5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:38 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_images5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the image address to "pic_mountain.jpg"</p>
<p id="hint">Hint: Change the src attribute.</p>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            "name" : "src",
            "errname" : "src attribute not found",        
