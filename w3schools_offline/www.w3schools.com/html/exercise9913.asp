...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_computercode_elements3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:34 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_computercode_elements3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Define the character "x" in the equation as a variable:</p>
<p id="hint">Hint: Use the &lt;var&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "var",
            "errname" : "No var element inside the p element",
            "value" : "x",
            "errvalue" : "Wrong text inside the var element"
        }]
    }]
}
</script>
