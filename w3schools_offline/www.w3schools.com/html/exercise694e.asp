...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_elements2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:50 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_elements2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a text area with name="note" to the form.</p>
<p id="hint">Hint: Add a &lt;texarea&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "textarea",
            "errname" : "No text area found",
            "attr" : [{
                "name" : "name",
                "errname" : "name attribute not found",
                "value" : "note",
                "errvalue" : "name attribute should be note"
            }]
        }]
    }]
}
