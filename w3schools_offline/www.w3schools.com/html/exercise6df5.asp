...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_forms2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:49 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_forms2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add 2 radio buttons to the form. One for &quot;male&quot;, and one for &quot;female&quot;, both 
with name=&quot;gender&quot;.</p>
<p id="hint">Hint: Add 2 &lt;input&gt; elements. Set type, name, and value attributes. </p>

<script>
required = {
    "tags" : [{
        "name" : "form",
        "errname" : "No form found",        
        "tags" : [{
            "name" : "input",
            "errname" : "No input element for male radio button",
            "attr" : [{
                "name" : "type",
                "errname" : "no type attribute",
                "value" : "radio",
                "errvalue" : "wrong input type"
            },{
                "name" : "name",
                "errname" : "name attribute not found",
                "value" : "gender",
                "errvalue" : "wrong input name"
            },{
                "name" : "value",
                "errname" : "name attribute not found",
                "value" : "male",
                "errvalue" : "wrong input value for male radio button"
            }]   
        },{
            "name" : "input",
            "errname" : "No input element for female radio button",
            "attr" : [{
                "name" : "type",
                "errname" : "no type attribute",
                "value" : "radio",
                ...
                "errname" : "name attribute not found",
                "value" : "female",
                "errvalue" : "wrong input value for female radio button"
            }]   
        }]
    }]
}
