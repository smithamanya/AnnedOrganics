...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_css6 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:36 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_css6".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add the "intro" class to all &lt;p&gt; elements.</p>
<p id="hint">Hint: Use the class attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "*p",
        "errname" : "No paragraphs found",
        "attr" : [{
            "name" : "class",
            "errname" : "A paragraph with no class attribute found",        
            "value" : "intro",
            "errvalue" : "A paragraph with the wrong class value found"
        }]
    }]
}
</script>
