...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_paragraphs4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:31 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_paragraphs4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Fix the display of this poem. Display the poem as suggested in the code below 
using &lt;pre&gt;.</p>
<p id="hint">Hint: Use a &lt;pre&gt; element instead of &lt;p&gt;.</p>

<script>
required = {
    "tags" : [{
        "name" : "pre",
        "errname" : "No pre element is found",
        "invalue" : "Bonnie",
        "errinvalue" : "The poem has wrong value"
    }]
}
</script>
