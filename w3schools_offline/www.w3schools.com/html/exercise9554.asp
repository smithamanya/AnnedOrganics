...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_css2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:35 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_css2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the font of both the h1 and the p element to "courier".</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "font-family",
            "value" : "Courier",
            "errvalue" : "The h1 element does not have the correct font"
        }]
    },{
        "name" : "p",
        ...
        "css" : [{
            "style" : "font-family",
            "value" : "Courier",
            "errvalue" : "The p element does not have the correct font"
        }]
    }]
}
</script>
