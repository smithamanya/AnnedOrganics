...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_iframe1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:42 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_iframe1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Create an iframe with a URL address that goes to http://www.w3schools.com.</p>
<p id="hint">Hint: Create an &lt;iframe&gt; element and add the src attribute.</p>
<script>
required = {
    "tags" : [{
        "name" : "iframe",
        "errname" : "No iframe found",
        "attr" : [{
            "name" : "src",
            "errname" : "No src attribute found",        
            "value" : "http://www.w3schools.com",
            "errvalue" : "src attribute has wrong value"
        }]
    }]
}
</script>
