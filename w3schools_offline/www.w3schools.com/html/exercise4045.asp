...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_comments1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:34 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_comments1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Remove the comment tags around the &lt;p&gt; element:</p>
<p id="hint">Hint: Remove &lt;!-- and --&gt;.</p>

<script>
required = {
    "tags" : [{
        "name" : "p",
        "errname" : "No p element displayed in browser"
    }]
}
</script>
