...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_lists5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:40 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_lists5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Complete the description list below.</p>
<p id="hint">Hint: Add &lt;dd&gt; elements.</p>
...
required = {
    "tags" : [{
        "name" : "dl",
        "errname" : "No dl element found",
        "tags" : [{
            "name" : "dd",
            "errname" : "There should be two dd elements inside the dl element",
            "count" : 2
        }]
    }]
}
