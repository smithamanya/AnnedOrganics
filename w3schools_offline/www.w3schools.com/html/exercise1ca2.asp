...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_attributes2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:29 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_attributes2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the size of the image to 250 pixels wide and 400 pixels tall.</p>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            "name" : "width",
            "errname" : "Width not found",        
            "value" : "250",
            "errvalue" : "Width has wrong value"
        },
        {
            "name" : "height",
            "errname" : "Height not found",
            "value" : "400",
            "errvalue" : "Height has wrong value"
        }]
    }]
}
</script>
