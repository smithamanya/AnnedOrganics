...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_quotation_elements2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>The text below should be a quoted section.<br>
Add the proper HTML element to it, and specify that it is quoted from the following URL:<br>
http://www.worldwildlife.org/who/index.html</p>
<p id="hint">Hint: Use the &lt;blockquote&gt; element, and add the cite attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "blockquote",
        "errname" : "No blockquote found",
        "invalue" : "WWF has been protecting the future of nature",
        "errinvalue" : "Quoted wrong text",
        "attr" : [{
            "name" : "cite",
            "errname" : "cite attribute not found",        
            "value" : "http://www.worldwildlife.org/who/index.html",
            "errvalue" : "cite attribute has wrong value"
        }]
    }]
}
</script>
