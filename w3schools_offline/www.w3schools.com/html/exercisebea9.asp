...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_headings1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:30 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_headings1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a heading to the paragraph with the text "London".</p>
<p id="hint">Hint: Add a &lt;h1&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "errname" : "No header found",
        "value" : "London",
        "errvalue" : "Heading has wrong value"
    }]
}
