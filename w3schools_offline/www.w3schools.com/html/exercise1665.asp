...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_input_types4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:51 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_input_types4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Create a button (using input types) that says "Click Me", which alerts "Hello World" when you click on it.</p>
<p id="hint">Hint: Use input type="button" and add the HTML onclick attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "input",
        "errname" : "No input element found",
        "attr" : [{
            "name" : "type",
            "errname" : "No type attribute",
            "value" : "button",
            "errvalue" : "The type attribute is not button"
        },{
            "name" : "value",
            "errname" : "No value attribute",
            "value" : "Click Me",
            "errvalue" : "Wrong text for button"
        },{
            "name" : "onclick",
            "errname" : "Missing onclick attribute",
            "invalue" : "alert",
            "errinvalue" : "No alert in onclick"
        }]
    }]
}
</script>
