...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_headings2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:30 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_headings2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add a horizontal rule between the heading and the paragraph.</p>
<p id="hint">Hint: Add a &lt;hr&gt; element.</p>
...
required = {
    "tags" : [{
        "name" : "hr",
        "errname" : "No horizontal rule found"
    }],
    alsorequired : {
        "tags" : [{
            "order" : "h1,hr,p",
