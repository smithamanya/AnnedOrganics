...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_classes1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:41 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_classes1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add the "cities" class to the &lt;div&gt; element.</p>
<script>
required = {
    "tags" : [{
        "name" : "div",
        ...
        "attr" : [{
            "name" : "class",
            "errname" : "No class attribute found",
            "value" : "cities",
            "errvalue" : "class attribute has wrong value"
        }]
    }]
}
</script>
