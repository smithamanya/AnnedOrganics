...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_images1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:37 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_images1".replace("exercise_","");
...
<p id="hint">Hint: Change the width and height attributes.</p> 
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "width",
            "value" : "96px",
            "errvalue" : "The width is not 96px"
        },{
            "style" : "height",
            "value" : "96px",
            "errvalue" : "The height is not 96px"
        }]
    }]
}
</script>
