...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_css3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:35 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_css3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the color of all paragraphs in the page below.</p>
<p id="hint">Hint: Inside the &lt;style&gt; element, add the color property for all &lt;p&gt; elements.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            "style" : "color",
            "value" : "!black",
            "errvalue" : "A p element has not changed it's color"
        }]
    }]
}
</script>
