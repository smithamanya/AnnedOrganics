...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_css1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:35 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_css1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Change the background color of the page below to yellow.</p>
<p id="hint">Hint: Change the value of the background-color property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            ...
            "value" : "yellow",
            "errvalue" : "The body element does not have a yellow background"
        }]
    }]
}
</script>
