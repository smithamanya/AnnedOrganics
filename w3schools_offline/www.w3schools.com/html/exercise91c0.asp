...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_css5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:35 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_css5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Add an id with the value "special" to the last paragraph.</p>
<p id="hint">Hint: Use the id attribute.</p>

<script>
required = {
    "tags" : [{
        "name" : "p",
        "errname" : "No p element",        
        "attr" : [{
            "name" : "id",
            "errname" : "No p element found with an id attribute",
            "value" : "special",
            "errvalue" : "id has wrong value"
        }]
    }]
}
</script>
...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_css5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:36 GMT -->
</html>
</textarea>
