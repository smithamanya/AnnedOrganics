...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_headings4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Mark up the following text with appropriate tags:
<br>"Universal Studios Presents" is the most important content.
<br>"Jurassic Park" is the next most important content.
<br>"About" is of lesser importance than Jurassic Park.
<br>The last sentence is just a paragraph.</p>
<p id="hint">Hint: Use &lt;h1&gt;, &lt;h2&gt;, &lt;h3&gt; and &lt;p&gt;.</p>
...
required = {
    "tags" : [{
        "name" : "h1",
        "errname" : "No h1 element is found",
        "value" : "Universal Studios Presents",
        "errvalue" : "Header 1 has wrong value"
    },
    {
        "name" : "h2",
        "errname" : "No h2 element is found",
        "value" : "Jurassic Park",
        "errvalue" : "Header 2 has wrong value"
    },
    {
        "name" : "h3|h4|h5|h6",
        "errname" : "No header element of less importance than a h2 is found",
        "value" : "About",
        "errvalue" : "A header with less importance has wrong value"
    },
    {
        "name" : "p",
        "errname" : "No paragraph is found",
        "value" : "On the Island of Isla Nublar, a new park has been built: Jurassic Park is a theme park of cloned dinosaurs!!",
        "errvalue" : "The paragraph has wrong value"
    }]
}
