...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_styles5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:32 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_styles5".replace("exercise_","");
...
<p id="hint">Hint: Add the style attribute to &lt;body&gt; and use the background-color property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            ...
            "value" : "yellow",
            "errvalue" : "The background is not yellow"
        }]
    }]
}
</script>
