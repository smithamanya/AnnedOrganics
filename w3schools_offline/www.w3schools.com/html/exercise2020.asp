...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_styles3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:32 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_styles3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Center align the paragraph.</p>
<p id="hint">Hint: Add the style attribute and use the text-align property.</p>
<script>
required = {
    "tags" : [{
        "name" : "p",
        ...
        "css" : [{
            "style" : "text-align",
            "value" : "center",
            "errvalue" : "The paragraph is not center aligned"
        }]
    }]
}
</script>
