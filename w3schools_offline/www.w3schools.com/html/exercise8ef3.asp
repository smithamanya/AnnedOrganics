...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_formatting3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:33 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_formatting3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Highlight the word "FUN" in the text below.</p>
<p id="hint">Hint: Use the &lt;mark&gt; element.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            "name" : "mark",
            "errname" : "No mark element inside the p element",
            "value" : "FUN",
            "errvalue" : "Wrong word"
        }]
    }]
