...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_classes2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:41 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_classes2".replace("exercise_","");
...
<p>Add the color property with the value "red" inside "special".</p>
<p>At last, add the "special" class to &lt;span&gt; and &lt;p&gt;.</p>
...
required = {
    "tags" : [{
        ...
        "invalue" : ".special",                
        "errinvalue" : "No class selector named 'special' found in the style section"
    },{
        "name" : "span",
        "errname" : "No span element found",
        "attr" : [{
            "name" : "class",
            "errname" : "A span element with no class attribute found",        
            "value" : "special",
            "errvalue" : "A span element with the wrong class value found"
        }],
        "css" : [{
            "style" : "color",
            "value" : "red",
            "errvalue" : "No red span elements found"
        }]        
    },{
        "name" : "p",
        ...
        "attr" : [{
            "name" : "class",
            "errname" : "A p element with no class attribute found",        
            "value" : "special",
            "errvalue" : "A p element with the wrong class value found"
        }],
        "css" : [{
            "style" : "color",
            "value" : "red",
            "errvalue" : "No red paragraphs found"
        }]        
    }]
}
