...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_scripts3 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:49 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_scripts3".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Use JavaScript to add a red background color to the &lt;p&gt; element.</p>
<p id="hint"><strong>Hint: 
</strong>Use the document.getElementById() method to find the &lt;p&gt; element.<br>
Then, use the style.backgroundColor property to add a background color.
</p>
<script>
required = {
    "tags" : [{
        ...
        "css" : [{
            ...
            "value" : "red",
            "errvalue" : "The background color of the p element is not red"
        }]
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "red",
        "errinvalue" : "Error in script, missing red"
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "style",
        "errinvalue" : "Error in script, missing style"
    },{
        "name" : "script",
        "errname" : "No script element found",
        "invalue" : "background",
        "errinvalue" : "Error in script, missing any background properties"
    }]
}
</script>
