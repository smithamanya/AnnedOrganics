...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_links4 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:37 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_links4".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Remove the underline from the link below.</p>
<p id="hint">Hint: Use the CSS text-decoration property.</p>
...
required = {
    "tags" : [{
        ...
        "css" : [{
            ...
            "value" : "none",
            "errvalue" : "The link is still underlined"
        }]
    }]
}
</script>
...
<a href="html_images.html" target="_blank" style="text-decoration:none">HTML Images</a>
