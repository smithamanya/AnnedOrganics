...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_attributes5".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>The image below does not exist. Specify the alternate text "w3schools.com" for the image.</p>
...
required = {
    "tags" : [{
        ...
        "attr" : [{
            "name" : "alt",
            "errname" : "alt attribute not found",        
            "value" : "w3schools.com",
...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_attributes5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:30 GMT -->
</html>
</textarea>
