...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_attributes1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:53 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_attributes1".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Specify an initial value of "John" for the input field.</p>
<p id="hint">Hint: Add the value attribute.</p>
    ...
    "tags" : [{
        ...
        "tags" : [{
            ...
            "attr" : [{
                ...
                "value" : "John",
                "errvalue" : "Not a correct initial value"
            }]
        }]
    }]
}
