...
<!-- Mirrored from www.w3schools.com/html/exercise.asp?filename=exercise_form_attributes2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:53 GMT -->
<head>
...
window.onload = function() {
    ...
    for (i = 0; i < exnames.length; i++) {
        ...
        if (i == exActiveNo) {
            exNo = "exercise_form_attributes2".replace("exercise_","");
...
<td id="topTD">
  ...
  <div>
    ...
    <h1>Exercise:</h1>
    <p>Disable the input field.</p>
<p id="hint">Hint: Add the disabled attribute.</p>
...
required = {
    "tags" : [{
        ...
        "tags" : [{
            ...
            "attr" : [{
                "name" : "disabled",
                "errname" : "No form element was disabled"
            }]
        }]
    }]
}
