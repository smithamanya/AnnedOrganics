...
<!-- Mirrored from www.w3schools.com/php/func_error_set_error_handler.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:34 GMT -->
<head>
...
<h3>Example</h3>
<p>Set a user-defined error handler function with the set_error_handler() 
function, and trigger an error (with trigger_error()):</p>
<div class="w3-code notranslate">
&lt;?php<br>
// A user-defined error handler function<br>
...
<br>
// Set user-defined error handler function<br>
...
Error on line 14 in C:\webfolder\test.php</div>
<br>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The set_error_handler() function sets a user-defined error handler function.</p>
<p><b>Note:</b> The standard PHP error handler is completely bypassed if this function is used,
and the user-defined error handler must terminate the script, die(), if necessary.</p>
<p><b>Note:</b>
...
<div class="w3-code w3-border notranslate"><div>
	set_error_handler(<em>errorhandler</em>,E_ALL|E_STRICT);</div>
</div>
<br>
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the name of the function to be run at errors</td>
  </tr>
  <tr>
    <td>E_ALL|E_STRICT</td>
    <td>Optional. Specifies on which error report level the user-defined error 
	will be shown. Default is &quot;E_ALL&quot;</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">A string that contains the previously defined error 
	handler</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.5: The parameter <em>errorhandler</em> now accepts NULL<br>PHP 
	5.2: The error handler must return FALSE to populate $php_errormsg</td>
</tr>
</table>
<hr>
