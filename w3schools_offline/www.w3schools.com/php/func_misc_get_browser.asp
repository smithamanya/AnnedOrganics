...
<!-- Mirrored from www.w3schools.com/php/func_misc_get_browser.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:01 GMT -->
<head>
...
&lt;?php<br>echo $_SERVER['HTTP_USER_AGENT'];<br>$browser = get_browser();<br>
	print_r($browser);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp4b53.asp?filename=demo_func_misc_get_browser">Run example &raquo;</a>
</div>
<hr>
