...
<!-- Mirrored from www.w3schools.com/php/func_mysqli_multi_query.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:08 GMT -->
<head>
...
&nbsp;&nbsp;}<br><br>$sql = &quot;SELECT Lastname FROM Persons ORDER BY LastName;&quot;;<br>
	...
	($result=mysqli_store_result($con)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
	Fetch one and one row<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	while ($row=mysqli_fetch_row($result))<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; printf(&quot;%s\n&quot;,$row[0]);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Free result set<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; mysqli_free_result($result);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
