...
<!-- Mirrored from www.w3schools.com/php/func_mysqli_real_escape_string.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:10 GMT -->
<head>
...
<p><a href="php_ref_mysqli.html"><img class="navup" src="../images/up.gif" alt="PHP MySQLi Reference" /> PHP MySQLi Reference</a></p>
...
&nbsp; echo &quot;Failed to connect to MySQL: &quot; . mysqli_connect_error();<br>
	...
	// escape variables for security<br>$firstname = mysqli_real_escape_string($con, $_POST['firstname']);<br>
	$lastname = mysqli_real_escape_string($con, $_POST['lastname']);<br>$age = 
	mysqli_real_escape_string($con, $_POST['age']);<br><br>$sql=&quot;INSERT INTO Persons (FirstName, 
	LastName, Age)<br>VALUES ('$firstname', '$lastname', '$age')&quot;;<br><br>if (!mysqli_query($con,$sql))
	{<br>&nbsp; die('Error: ' . mysqli_error($con));<br>}<br>echo &quot;1 record 
	added&quot;;<br><br>mysqli_close($con);<br>
?&gt;
</div>
</div>
<hr>
...
<a href="php_ref_mysqli.html"><img class="navup" src="../images/up.gif" alt="PHP MySQLi Reference" /> PHP MySQLi Reference</a>
</div>
