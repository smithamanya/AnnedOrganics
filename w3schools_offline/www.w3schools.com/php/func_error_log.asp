...
<!-- Mirrored from www.w3schools.com/php/func_error_log.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:33 GMT -->
<head>
...
<p><a href="php_ref_error.html"><img class="navup" src="../images/up.gif" alt="PHP Error"> PHP Error Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Send error messages to the web server's error log and to a mail account:</p>
<div class="w3-code notranslate">
&lt;?php<br>
	// Send error message to the server log if error connecting to the 
	database<br>if (!mysqli_connect(&quot;localhost&quot;,&quot;bad_user&quot;,&quot;bad_password&quot;,&quot;my_db&quot;)) {<br>&nbsp;&nbsp;&nbsp; 
	error_log(&quot;Failed to connect to database!&quot;, 0);<br>}<br><br>// Send email to administrator if 
	we run out of FOO<br>if (!($foo = allocate_new_foo())) {<br>&nbsp;&nbsp;&nbsp; 
	error_log(&quot;Oh no! We are out of FOOs!&quot;, 1, &quot;admin@example.com&quot;);<br>}<br>?&gt;
</div>
<br>
</div>
<hr>
...
<p>The error_log() function sends an error message to a log, 
to a file, or to a mail account.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	error_log(<em>message,type,destination,headers</em>);</div>
</div>
<br>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>message</em></td>
    <td>Required. Specifies the error message to log</td>
  </tr>
  <tr>
    <td><em>type</em></td>
    <td>Optional. Specifies where the error message should go.
	Possible values:<ul>
		<li>0 - Default. Message is sent to PHP's system logger, 
		using the OS' system logging mechanism or a file, depending on what the error_log configuration is set 
		to in php.ini</li>
		<li>1 - Message is sent by email to the address in the <em>destination</em> 
		parameter </li>
		<li>2 - No longer in use (only available in PHP 3)</li>
		<li>3 - Message is appended to the file specified in <em>destination</em></li>
		<li>4 - Message is sent directly to the SAPI logging handler</li>
	</ul>
		</td>
  </tr>
  <tr>
    <td><em>destination</em></td>
    <td>Optional. Specifies the destination of the error message. This value depends on the value of the 
	<em>type</em> parameter</td>
  </tr>
  <tr>
    <td><em>headers</em></td>
    <td>Optional. Only used if the <em>type</em> parameter is set to 1. 
...
<tr>
	...
	<td style="width:80%">TRUE on success, or FALSE on failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.2.7: The value of 4 was added to the <em>type</em> parameter</td>
</tr>
</table>
<hr>

<a href="php_ref_error.html"><img class="navup" src="../images/up.gif" alt="PHP Error"> PHP Error Reference</a>
</div>
