...
<!-- Mirrored from www.w3schools.com/php/func_date_create_from_format.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:25 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpd01e.asp?filename=demo_func_date_create_from_format">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<ul>
		...
		<li>g - 12 hour format without leading zeros</li>
		<li>G - 24 hour format without leading zeros</li>
		<li>h - 12 hour format with leading zeros</li>
		<li>H - 24 hour format with leading zeros</li>
