...
<!-- Mirrored from www.w3schools.com/php/func_error_debug_print_backtrace.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:33 GMT -->
<head>
...
#0 c(Cleveland) called at [C:\webfolder\test.php:6]<br>
#1 b(Glenn) called at [C:\webfolder\test.php:3]<br>
#2 a(Peter) called at [C:\webfolder\test.php:11]</div>
<br>
</div>
<hr>
...
<p>The debug_print_backtrace() function prints a PHP backtrace.</p>
...
<div class="w3-code w3-border notranslate"><div>
	debug_print_backtrace(<em>options</em>,<em>limit</em>);</div>
</div>
<br>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>options</em></td>
    <td>Optional. Specifies a bitmask for the following option: 
	DEBUG_BACKTRACE_IGNORE_ARGS (Whether or not to omit the &quot;args&quot; index, and 
	all the function/method arguments, to save memory)</td>
  </tr>
  <tr>
    <td><em>limit</em></td>
...
<tr>
	...
	optional parameter <em>options</em> was added<br></td>
</tr>
</table>
<hr>
