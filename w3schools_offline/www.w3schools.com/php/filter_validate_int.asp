...
<!-- Mirrored from www.w3schools.com/php/filter_validate_int.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:44 GMT -->
<head>
...
<h3>Example</h3>
<p>Check if the variable $int is an integer:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$int = 100;<br><br>if (!filter_var($int, FILTER_VALIDATE_INT) === 
	false) {<br>&nbsp;&nbsp;&nbsp; echo("Variable is an integer");<br>} else {<br>&nbsp;&nbsp;&nbsp; echo("Variable 
	is not an integer");<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpf8cf.asp?filename=demo_func_validate_int">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The FILTER_VALIDATE_INT filter is used to validate value as integer.</p>
<p>FILTER_VALIDATE_INT also allows us to specify a range for the integer 
variable.</p>
...
associative multidimensional array with the name &quot;options&quot;.</p>
<hr>

<h2>More Examples</h2>
<p><strong>FILTER_VALIDATE_INT and Problem With 0</strong> - In the example above, if $int was set to 0, the function above will return 
"Variable is not an integer". To solve this problem, use the code below:</p>

<div class="w3-example">
<h3>Example 1</h3>
<p>Fix code to validate 0 as integer:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$int = 0;<br><br>if (filter_var($int, FILTER_VALIDATE_INT) === 0 || 
	!filter_var($int, FILTER_VALIDATE_INT) === false) {<br>&nbsp;&nbsp;&nbsp; 
	echo(&quot;Variable is an integer&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable 
	is not an integer&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp66a8.asp?filename=demo_func_validate_int2">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 2</h3>
<p>Check if a variable is both of type INT, and between 1 and 200:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$int = 122;<br>$min = 1;<br>$max = 200;<br><br>if (filter_var($int, 
	FILTER_VALIDATE_INT, array(&quot;options&quot; =&gt; array(&quot;min_range&quot;=&gt;$min, &quot;max_range&quot;=&gt;$max))) 
	=== false) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable value is not within the 
	legal range&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable value is 
	within the legal range&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpfdb6.asp?filename=demo_func_validate_int3">Run example &raquo;</a>
</div>
