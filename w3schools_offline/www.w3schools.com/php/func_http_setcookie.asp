...
<!-- Mirrored from www.w3schools.com/php/func_http_setcookie.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:51 GMT -->
<head>
...
<p><a href="php_ref_http.html"><img class="navup" src="../images/up.gif" alt="PHP HTTP Reference" /> PHP HTTP Reference</a></p>
...
The &quot;/&quot; means that the cookie is available in entire website (otherwise, select the directory you prefer).</p>
	<p>We then retrieve the value of the cookie "user" (using the global variable 
$_COOKIE). We also use the isset() function to find out if the cookie is set:</p>
<div class="w3-code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;?php<br>$cookie_name = &quot;user&quot;;<br>$cookie_value = &quot;John 
	Doe&quot;;<br>setcookie($cookie_name, $cookie_value, time() + (86400 * 30), &quot;/&quot;); 
	// 86400 = 1 day<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>if(!isset($_COOKIE[$cookie_name])) 
	{<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie named '&quot; . $cookie_name . &quot;' is not 
	set!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie '&quot; . $cookie_name 
	. &quot;' is set!&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; echo &quot;Value is: &quot; . $_COOKIE[$cookie_name];<br>}<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp7b24.asp?filename=demo_func_http_setcookie">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The setcookie() function defines a cookie to be sent along with the rest of 
the HTTP headers.</p>
...
<p><strong><b>Note:</b></strong> The setcookie() function must appear BEFORE the &lt;html&gt; tag.</p>
...
URLencoding, use <a href="func_http_setrawcookie.asp">setrawcookie()</a> instead).</p>
<h2>Syntax</h2>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>value</em></td>
    <td>Optional. Specifies the value of the cookie</td>
  </tr>
  <tr>
    <td><em>expire</em></td>
    <td>Optional. Specifies when the cookie expires. The value: time()+86400*30, will set the cookie to expire in 30 days. If this parameter 
	is omitted or set to 0, the cookie will expire at the end of the session (when the browser closes). 
	Default is 0</td>
  </tr>
  <tr>
    <td><em>path</em></td>
    <td>Optional. Specifies the server path of the cookie.
	...
	cookie is being set in</td>
  </tr>
  <tr>
    <td><em>domain</em></td>
    <td>Optional. Specifies the domain name of the cookie. To make the cookie available on all subdomains of example.com, 
	set domain to &quot;example.com&quot;. Setting it to www.example.com will make the cookie only available in the www subdomain</td>
  </tr>
  <tr>
    <td><em>secure</em></td>
    <td>Optional. Specifies whether or not the cookie should only be transmitted 
	over a secure HTTPS connection. TRUE indicates that the cookie will only be 
	set if a secure connection exists. Default is FALSE</td>
  </tr>
  <tr>
    <td><em>httponly</em></td>
    <td>Optional. If set to TRUE the cookie will be accessible only through the 
...
<tr>
	<th>PHP Changelog:</th>
	<td>PHP 5.5 - A Max-Age attribute was included in the Set-Cookie header sent 
	to the client<br>PHP 5.2 - The httponly parameter was added</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Several expire dates for cookies:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$value = &quot;Hello world!&quot;;<br><br>// cookie will expire when the 
	browser close<br>setcookie(&quot;myCookie&quot;, $value);<br><br>// cookie will expire 
	in 1 hour<br>setcookie(&quot;myCookie&quot;, $value, time() + 3600);<br><br>// cookie 
	will expire in 1 hour, and will only be available<br>// within the php 
	directory + all sub-directories of php<br>setcookie(&quot;myCookie&quot;, $value, 
	time() + 3600, &quot;/php/&quot;);<br>?&gt; <br>&lt;html&gt;<br>&lt;body&gt;<br><br>...some code...<br>
	<br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp109a.asp?filename=demo_func_http_setcookie2">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
	&lt;?php<br>$cookie_name = &quot;user&quot;;<br>$cookie_value = &quot;Alex 
	Porter&quot;;<br>
	setcookie($cookie_name, $cookie_value, time() + (86400 * 30), &quot;/&quot;);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>if(!isset($_COOKIE[$cookie_name])) 
	{<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie named '&quot; . $cookie_name . &quot;' is not 
	set!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie '&quot; . $cookie_name 
	. &quot;' is set!&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; echo &quot;Value is: &quot; . $_COOKIE[$cookie_name];<br>}<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp7d5b.asp?filename=demo_func_http_setcookie3">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
	&lt;?php<br>// set the expiration date to one hour ago<br>setcookie(&quot;user&quot;, 
	&quot;&quot;, time() - 3600);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie 'user' 
	is deleted.&quot;;<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp1a01.asp?filename=demo_func_http_setcookie4">Run example &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Create a small script that checks whether cookies are enabled. First, try to create a test cookie with the setcookie() function, then count the $_COOKIE array variable:</p>
<div class="w3-code notranslate">
	&lt;?php<br>setcookie(&quot;test_cookie&quot;, &quot;test&quot;, time() + 3600, '/');<br>?&gt;<br>
	&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>if(count($_COOKIE) &gt; 0) {<br>&nbsp;&nbsp;&nbsp; 
	echo &quot;Cookies are enabled.&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookies 
	are disabled.&quot;;<br>}<br>?&gt;<br><br>
	&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpe5d7.asp?filename=demo_func_http_setcookie5">Run example &raquo;</a>
</div>
<hr>
<a href="php_ref_http.html"><img class="navup" src="../images/up.gif" alt="PHP HTTP Reference" /> PHP HTTP Reference</a>
</div>
