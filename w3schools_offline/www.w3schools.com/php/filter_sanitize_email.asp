...
<!-- Mirrored from www.w3schools.com/php/filter_sanitize_email.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:45 GMT -->
<head>
...
<div class="w3-code notranslate">
	&lt;?php<br>$email = &quot;john(.doe)@exa//mple.com&quot;;<br><br>$email = 
	filter_var($email, FILTER_SANITIZE_EMAIL);<br>echo $email;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpaec1.asp?filename=demo_func_sanitize_email">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The FILTER_SANITIZE_EMAIL filter removes all illegal characters from an email 
address.</p>
<hr>
