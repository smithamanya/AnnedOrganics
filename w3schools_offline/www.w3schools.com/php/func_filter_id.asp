...
<!-- Mirrored from www.w3schools.com/php/func_filter_id.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:43 GMT -->
<head>
...
<h3>Example</h3>
<p>Return the filter ID of the VALIDATE_EMAIL filter:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$echo(filter_id(&quot;validate_email&quot;));<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpc057.asp?filename=demo_func_filter_id">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The filter_id() function returns filter ID of a specified filter name.</p>

<hr>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	filter_id(<em>filter_name</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>filter_name</em></td>
    <td>Required. The filter name to get the id from. <strong>Tip:</strong> Use the <a href="func_filter_list.asp">
		filter_list()</a> function to list the names of all available filters</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the filter ID on success, or FALSE if the 
	filter does not exist</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.2.0+</td>
...
<div class="w3-example">
<h3>Example 1</h3>
<p>The filter_list() function can be used to list the name and ID of all 
available filters:</p>
<div class="w3-code notranslate">
	&lt;table&gt;<br>&nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;td&gt;Filter Name&lt;/td&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;td&gt;Filter ID&lt;/td&gt;<br>&nbsp; &lt;/tr&gt;<br>&nbsp; &lt;?php<br>&nbsp; foreach (filter_list() 
	as $id =&gt;$filter) {<br>&nbsp;&nbsp;&nbsp; echo '&lt;tr&gt;&lt;td&gt;' . $filter . 
	'&lt;/td&gt;&lt;td&gt;' . filter_id($filter) . '&lt;/td&gt;&lt;/tr&gt;';<br>&nbsp; }<br>?&gt;<br>
	&lt;/table&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpecf1.asp?filename=demo_func_filter_id2">Run example &raquo;</a>
</div>
