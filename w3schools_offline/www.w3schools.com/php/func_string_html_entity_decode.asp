...
<!-- Mirrored from www.w3schools.com/php/func_string_html_entity_decode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:18 GMT -->
<head>
...
<div class="w3-code notranslate">
	&lt;?php<br>$str = "&amp;lt;&amp;copy; W3S&amp;ccedil;h&amp;deg;&amp;deg;&amp;brvbar;&amp;sect;&amp;gt;";<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>flags</em></td>
    <td>Optional. Specifies how to handle quotes and which document type to use.<p>
	The available quote styles are:</p>
	<ul>
...
<tr>
	...
	to UTF-8 in PHP 5<br><br>The additional flags for specifying the used 
	doctype; ENT_HTML401, ENT_HTML5, ENT_XML1 and ENT_XHTML were added in PHP 
	5.4<br><br>Support for multi-byte encodings was added in PHP 5.0<br></td>
</tr>
</table>
<hr>
<h2>More Examples</h2>
...
<div class="w3-code notranslate">
	...
	quotes<br>
	echo "&lt;br&gt;";<br>
	echo html_entity_decode($str, ENT_NOQUOTES); // Does not convert any quotes<br>
	?&gt;</div>
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
...
<div class="w3-example">
<h3>Example 2</h3>
<p>Convert some HTML entities to characters, using the Western European 
character-set:</p>
<div class="w3-code notranslate">
	&lt;?php<br>
