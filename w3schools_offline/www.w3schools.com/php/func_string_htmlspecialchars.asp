...
<!-- Mirrored from www.w3schools.com/php/func_string_htmlspecialchars.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:19 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp211c.asp?filename=demo_func_string_htmlspecialchars">Run example &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all"> 
  ...
  <tr>
	...
	<ul>
		...
		<li>ENT_DISALLOWED - Replaces code points that are 
		invalid in the specified doctype with a Unicode Replacement Character 
		U+FFFD (UTF-8) or &amp;#FFFD;</li>
	</ul>
...
<tr>
	...
	<td style="width:80%">Returns the converted string<br><br>If 
	the <em>string</em> contains invalid encoding, it will return an empty 
	string, unless either the ENT_IGNORE or ENT_SUBSTITUTE flags are set</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp5c55.asp?filename=demo_func_string_htmlspecialchars2">Run example &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
	...
	I love &quot;PHP&quot;.</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpe006.asp?filename=demo_func_string_htmlspecialchars3">Run example &raquo;</a>
</div>
<hr>
