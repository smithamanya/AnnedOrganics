...
<!-- Mirrored from www.w3schools.com/php/func_string_trim.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:35 GMT -->
<head>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp7ad1-2.asp?filename=demo_func_string_trim">Run example &raquo;</a>
</div>
<hr>
...
<ul>
	...
	<li><a href="func_string_rtrim.asp">rtrim()</a> - Removes whitespace or other predefined characters from the right side of a 
	string</li>
</ul>
<hr>
<h2>Syntax</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp2dbd.asp?filename=demo_func_string_trim2">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpe068.asp?filename=demo_func_string_trim3">Run example &raquo;</a>
</div>
<hr>
