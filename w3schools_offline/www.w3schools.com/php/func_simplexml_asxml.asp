...
<!-- Mirrored from www.w3schools.com/php/func_simplexml_asxml.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:12 GMT -->
<head>
...
<h3>Example</h3>
<p>Return a well-formed XML string (XML version 1.0) from a SimpleXML object:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp1824.asp?filename=demo_func_simplexml_asxml">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The asXML() function returns a well-formed XML string (XML version 1.0) from 
a SimpleXML object.</p>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Optional. If specified, the function writes the data to the file, 
	instead of returning the string</td>
  </tr>
  </table>
