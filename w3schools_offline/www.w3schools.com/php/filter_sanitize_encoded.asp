...
<!-- Mirrored from www.w3schools.com/php/filter_sanitize_encoded.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:45 GMT -->
<head>
...
<h3>Example</h3>
<p>Encode special characters in the $url variable:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$url="http://www.w3schoolsÅÅ.com";<br><br>$url = filter_var($url, 
	FILTER_SANITIZE_ENCODED);<br>echo $url;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpebef.asp?filename=demo_func_sanitize_encoded">
	Run example »</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The FILTER_SANITIZE_ENCODED filter removes or encodes special characters.</p>
<p>This filter works a lot like the urlencode() function.</p>
...
<div class="w3-example">
<h3>Example 1</h3>
<p>Encode special characters, and remove all characters with ASCII value &gt; 127:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$url="http://www.w3schoolsÅÅ.com";<br><br>$url = filter_var($url, 
	FILTER_SANITIZE_ENCODED, FILTER_FLAG_STRIP_HIGH);<br>echo $url;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpc672.asp?filename=demo_func_sanitize_encoded2">
	Run example »</a>
</div>
