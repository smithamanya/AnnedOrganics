...
<!-- Mirrored from www.w3schools.com/php/func_filter_var.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:43 GMT -->
<head>
...
<p><a href="php_ref_filter.html"><img class="navup" src="../images/up.gif" alt="PHP Filter Reference" /> PHP Filter Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Check if the variable $email is a valid email address:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$email = &quot;john.doe@example.com&quot;;<br><br>if (!filter_var($email, 
	FILTER_VALIDATE_EMAIL) === false) {<br>&nbsp; echo(&quot;$email is a valid email 
	address&quot;);<br>} else {<br>&nbsp; echo(&quot;$email is not a valid email 
	address&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp3e43.asp?filename=demo_func_filter_var">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The filter_var() function filters a variable with the specified filter.</p>

<hr>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	filter_var(<em>var, filtername, options</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>var</em></td>
    <td>Required. The variable to filter</td>
  </tr>
  <tr>
    <td><em>filtername</em></td>
    <td>Optional. Specifies the ID or name of the filter to use. Default is 
	FILTER_DEFAULT, which results in no filtering </td>
  </tr>
  <tr>
    <td><em>options</em></td>
    <td>Optional. Specifies one or more flags/options to use. Check each filter for possible options and flags</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">Returns the filtered data on success, or FALSE on 
	failure</td>
</tr>
<tr>
	<th>PHP Version:</th>
...
<h2>More Examples</h2>
<p>The example below both sanitizes and validates an email address:</p>

<div class="w3-example">
<h3>Example 1</h3>
<p>First remove all illegal characters from the $email variable, then check if it is a valid email address:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$email = &quot;john.doe@example.com&quot;;<br><br>// Remove all illegal 
	characters from email<br>$email = filter_var($email, FILTER_SANITIZE_EMAIL);<br>
	<br>// Validate e-mail<br>if (!filter_var($email, FILTER_VALIDATE_EMAIL) === 
	false) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$email is a valid email address&quot;);<br>} 
	else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$email is not a valid email address&quot;);<br>
	}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp5496.asp?filename=demo_func_filter_var2">Run example &raquo;</a>
</div>

<hr>
<a href="php_ref_filter.html"><img class="navup" src="../images/up.gif" alt="PHP Filter Reference" /> PHP Filter Reference</a>
</div>
...
<!-- Mirrored from www.w3schools.com/php/func_filter_var.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:44 GMT -->
</html>
