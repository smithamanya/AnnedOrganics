...
<!-- Mirrored from www.w3schools.com/php/func_filter_input.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:43 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp9eb1.asp?filename=demo_func_filter_input">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The filter_input() function gets an external variable (e.g. from form input) and optionally filters it.</p>
<p>This function is used to validate variables from insecure sources, such as user input.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	filter_input(<em>type, variable, filter, options</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>Required. The variable name to check</td>
  </tr>
  <tr>
    <td><em>filter</em></td>
...
<tr>
	...
	<td style="width:80%">
<p>Returns the value of the variable on success, FALSE on failure, or NULL if the 
