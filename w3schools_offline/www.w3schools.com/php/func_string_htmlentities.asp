...
<!-- Mirrored from www.w3schools.com/php/func_string_htmlentities.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:18 GMT -->
<head>
...
<p><a href="php_ref_string.html"><img class="navup" src="../images/up.gif" alt="PHP String Reference" /> 
...
<div class="w3-code notranslate">
	...
	&lt;© W3Sçh°°¦§&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp534b.asp?filename=demo_func_string_htmlentities">
	Run example »</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<tr>
    <td><em>flags</em></td>
    <td>Optional. Specifies how to handle quotes, invalid encoding and the used 
	document type.<p>The available quote styles are:</p>
	<ul>
	...
	<ul>
		...
		<li>ENT_DISALLOWED - Replaces code points that are invalid in the 
		specified doctype with a Unicode Replacement Character U+FFFD (UTF-8) or 
		&amp;#FFFD;</li>
	</ul>
  ...
  <tr>
    ...
    <td>Optional. A string that specifies which character-set to use.<p>Allowed 
	values are:</p>
	<ul>
	    <li>UTF-8 - Default. ASCII compatible multi-byte 8-bit Unicode</li>
		<li>ISO-8859-1 - Western European</li>
		<li>ISO-8859-15 - Western European (adds the Euro sign + French and 
		Finnish letters missing in ISO-8859-1)</li>
...
<tr>
	...
	<td style="width:80%">Returns the converted string<br><br>If the <em>string</em> 
	contains invalid encoding, it will return an empty string, unless either the 
	ENT_IGNORE or ENT_SUBSTITUTE flags are set</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4+</td>
...
<tr>
	...
	to UTF-8 in PHP 5<br><br>ENT_SUBSTITUTE, ENT_DISALLOWED, ENT_HTML401, 
	ENT_HTML5, ENT_XML1 and ENT_XHTML were added in PHP 5.4<br><br>ENT_IGNORE 
	was added in PHP 5.3<br><br>The <em>double_encode</em> parameter was added 
	in PHP 5.2.3<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp5792.asp?filename=demo_func_string_htmlentities2">
	Run example »</a>
</div>
<br>
...
<p>The HTML output of the code above will be (View Source):</p>
<div class="w3-code notranslate">
	&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br>My name is &amp;Oslash;yvind &amp;Aring;sane. 
	I&amp;#039;m Norwegian.<br>&lt;/body&gt;<br>&lt;/html&gt;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpe2b5.asp?filename=demo_func_string_htmlentities3">
	Run example »</a>
</div>
<hr>
<a href="php_ref_string.html"><img class="navup" src="../images/up.gif" alt="PHP String Reference" /> 
PHP String Reference</a>
</div>
