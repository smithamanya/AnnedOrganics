...
<!-- Mirrored from www.w3schools.com/php/func_http_setrawcookie.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:51 GMT -->
<head>
...
<h3>Example</h3>
<p>The following example creates a cookie with PHP. The cookie is named &quot;user&quot; 
and the value will be &quot;John Doe&quot;. The cookie value will not be URL 
encoded. The cookie will expire after 30 days (86400 * 30). 
Using &quot;/&quot;, means that the cookie is available in entire website (otherwise, select the directory you prefer):</p>
<div class="w3-code notranslate">
&lt;?php<br>
	$cookie_name = &quot;user&quot;;<br>$cookie_value = &quot;John&quot;;<br>
	setrawcookie($cookie_name, $cookie_value, time() + (86400 * 30), &quot;/&quot;);<br>// 
	86400 = 1 day<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie is set.&quot;;<br>
	?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp526e.asp?filename=demo_func_http_setrawcookie">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The setrawcookie() function defines a cookie (without URL encoding) to be sent along with the rest of 
the HTTP headers.</p>
...
<p><strong><b>Note:</b></strong> The setrawcookie() function must appear BEFORE the &lt;html&gt; tag.</p>

<p><b>Note: </b>To automatically URL-encode the cookie value when sending, and automatically decode when receiving, use 
the <a href="func_http_setcookie.asp">setcookie()</a> function instead.</p>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
setrawcookie(<em>name,value,expire,path,domain,secure</em>);</div></div>
<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	is not set, the cookie will expire at the end of the session (when the browser closes)</td>
  </tr>
  <tr>
    <td><em>path</em></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Retrieve the value of the cookie named "user" (using the global variable 
$_COOKIE). Also use the isset() function to find out if the cookie exists:</p>
<div class="w3-code notranslate">
	&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>$cookie_name = &quot;user&quot;;<br>if(!isset($_COOKIE[$cookie_name])) 
	{<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie named '&quot; . $cookie_name . &quot;' does not 
	exist!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie is named: &quot; . $cookie_name 
	. &quot;&lt;br&gt;Value is: &quot; . $_COOKIE[$cookie_name];<br>}<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp8b15.asp?filename=demo_func_http_setrawcookie2">Run example &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>To modify a cookie, just set (again) the cookie using the setrawcookie() function:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$cookie_name = &quot;user&quot;;<br>$cookie_value = &quot;Alex&quot;;<br>
	setrawcookie($cookie_name, $cookie_value, time() + (86400 * 30), &quot;/&quot;);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>$cookie_name = &quot;user&quot;;<br>if(!isset($_COOKIE[$cookie_name])) 
	{<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie named '&quot; . $cookie_name . &quot;' does not 
	exist!&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookie is named: &quot; . $cookie_name 
	. &quot;&lt;br&gt;Value is: &quot; . $_COOKIE[$cookie_name];<br>}<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpe711.asp?filename=demo_func_http_setrawcookie3">Run example &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>To delete a cookie, use the setrawcookie() function with an expiration date in the past:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$cookie_name = &quot;user&quot;;<br>
	unset($_COOKIE[$cookie_name]);<br>// empty value and expiration one hour 
	before<br>$res = setrawcookie($cookie_name, '', time() - 3600);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie 'user' 
	is deleted.&quot;;<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp7d54.asp?filename=demo_func_http_setrawcookie4">Run example &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Create a small script that checks whether cookies are enabled. First, try to create a test cookie with the setrawcookie() function, then count the $_COOKIE array variable:</p>
<div class="w3-code notranslate">
	&lt;?php<br>setrawcookie(&quot;test_cookie&quot;, &quot;test&quot;, time() + 3600, '/');<br>?&gt;<br>
	&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>if(count($_COOKIE) &gt; 0) {<br>&nbsp;&nbsp;&nbsp; 
	echo &quot;Cookies are enabled&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookies 
	are disabled&quot;;<br>}<br>?&gt;<br><br>
	&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp2856.asp?filename=demo_func_http_setrawcookie5">Run example &raquo;</a>
</div>
<hr>
