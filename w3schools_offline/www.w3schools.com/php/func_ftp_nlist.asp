...
<!-- Mirrored from www.w3schools.com/php/func_ftp_nlist.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:49 GMT -->
<head>
...
&lt;?php<br>// connect and login to FTP server<br>
	...
	of current directory<br>$file_list = ftp_nlist($ftp_conn, &quot;.&quot;);<br>var_dump($file_list);<br><br>// close connection<br>ftp_close($ftp_conn);<br>?&gt;
</div>
</div>
<hr>
