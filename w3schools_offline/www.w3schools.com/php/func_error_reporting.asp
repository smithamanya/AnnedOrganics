...
<!-- Mirrored from www.w3schools.com/php/func_error_reporting.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:33 GMT -->
<head>
...
<h3>Example</h3>
<p>Specify different error level reporting:</p>
...
error_reporting(E_ALL);<br><br>// Same as error_reporting(E_ALL);<br>ini_set(&quot;error_reporting&quot;, 
	E_ALL);<br><br>// Report all errors except E_NOTICE<br>
...
<p>PHP has many levels of errors, and using this function sets that level for the 
current script.</p>
...
<div class="w3-code w3-border notranslate"><div>
	error_reporting(<em>level</em>);</div>
</div>
<br>
<table class="w3-table-all notranslate">
  ...
  <tr>
	...
	script. <a href="php_ref_error.html">Error numbers and named constants</a> are accepted.
	<strong>Note:</strong> 
	Named constants 
	are recommended to ensure compatibility for future PHP versions</td>
  </tr>
</table>
...
<tr>
	...
	<td style="width:80%">Returns the old error reporting level or the current 
	error reporting level if no <em>level</em> parameter is given</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>4.0+</td>
