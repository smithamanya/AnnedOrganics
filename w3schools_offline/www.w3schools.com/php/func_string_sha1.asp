...
<!-- Mirrored from www.w3schools.com/php/func_string_sha1.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:24 GMT -->
<head>
...
echo sha1($str);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpf7fe.asp?filename=demo_func_string_sha1">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp9feb.asp?filename=demo_func_string_sha12">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp410f.asp?filename=demo_func_string_sha13">Run example &raquo;</a>
</div>
<hr>
