...
<!-- Mirrored from www.w3schools.com/php/func_error_trigger_error.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:34 GMT -->
<head>
...
<h3>Example</h3>
<p>If $usernum &gt; 10, trigger an error:</p>
<div class="w3-code notranslate">
&lt;?php<br>
if ($usernum&gt;10) {<br>
&nbsp;&nbsp;&nbsp; trigger_error(&quot;Number cannot be larger than 10&quot;);<br>
	}<br>
	?&gt;
</div>
...
<b>Notice</b>: Number cannot be larger than 10<br>
...
<p>The trigger_error() function creates a user-level error message.</p>
<p>The trigger_error() function can be used with 
the built-in error handler, or with a user-defined function set by the
<a href="func_error_set_error_handler.asp">set_error_handler()</a> 
function.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	trigger_error(<em>errormsg,errortype</em>);</div>
</div>
<br>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>errormsg</em></td>
    <td>Required. Specifies the error message for this error. Max 1024 
	bytes in length</td>
  </tr>
  <tr>
    <td><em>errortype</em></td>
    <td>Optional. Specifies the error type for this error. Possible values:
	<ul>
		<li>E_USER_ERROR</li>
...
<tr>
	...
	<td style="width:80%">FALSE if wrong error type is specified, TRUE 
	otherwise</td>
</tr>
<tr>
	<th>PHP Version:</th>
