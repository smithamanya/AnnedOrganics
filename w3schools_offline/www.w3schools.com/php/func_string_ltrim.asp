...
<!-- Mirrored from www.w3schools.com/php/func_string_ltrim.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:20 GMT -->
<head>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp59a0.asp?filename=demo_func_string_ltrim">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpcd0d.asp?filename=demo_func_string_ltrim2">Run example &raquo;</a>
</div>
<br>
...
Without ltrim: Hello World!<br>
With ltrim: Hello World! </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp9147.asp?filename=demo_func_string_ltrim3">Run example &raquo;</a>
</div>
<hr>
