...
<!-- Mirrored from www.w3schools.com/php/func_misc_sleep.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:02 GMT -->
<head>
...
echo date('h:i:s');<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp49f1.asp?filename=demo_func_misc_sleep">Run example &raquo;</a>
</div>
<hr>
