...
<!-- Mirrored from www.w3schools.com/php/func_filter_list.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:43 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpee69-2.asp?filename=demo_func_filter_list">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The filter_list() function returns a list of all supported filters.</p>
<hr>
...
<tr>
	...
	<td style="width:80%">Returns an array of all supported filter names, or an 
	empty array if there are no such filters</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.2.0+</td>
