...
<!-- Mirrored from www.w3schools.com/php/func_string_crypt.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:16 GMT -->
<head>
...
<p>The crypt() function returns a hashed string using DES, Blowfish, 
or MD5 algorithms.</p>
<p>This function behaves different on different operating systems. PHP checks what algorithms 
are available and what algorithms to use when it is installed.</p>
<p>The salt parameter is optional. However, crypt() creates a weak password 
without the salt. Make sure to specify a strong enough salt for better security.</p>
...
<p>Constants:</p>
<ul>
	<li>[CRYPT_STD_DES] - Standard DES-based hash with two character salt 
	from the alphabet &quot;./0-9A-Za-z&quot;. Using invalid characters in the salt will 
	cause this function to fail.</li>
	<li>[CRYPT_EXT_DES] - Extended DES-based hash with a nine character salt 
	...
	function to fail.</li>
	<li>[CRYPT_MD5] - MD5 
	hashing with a 12 character salt starting with $1$</li>
	<li>[CRYPT_BLOWFISH] - Blowfish hashing with a salt starting with 
	...
	<li>[CRYPT_SHA_256] - SHA-256 hash with a 16 character salt starting with&nbsp; 
	...
	nearest limit.</li>
	<li>[CRYPT_SHA_512] - SHA-512 hash with a 16 character salt starting with $6$.
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>str</em></td>
    <td>Required. Specifies the string to be hashed</td>
  </tr>
  <tr>
    <td><em>salt</em></td>
    <td>Optional. A salt string to base the hashing on 
	</td>
  </tr>
  </table>
