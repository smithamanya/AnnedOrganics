...
<!-- Mirrored from www.w3schools.com/php/func_string_soundex.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:25 GMT -->
<head>
...
echo soundex($str);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp8d1f.asp?filename=demo_func_string_soundex">Run example &raquo;</a>
</div>
<hr>
...
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp0b35.asp?filename=demo_func_string_soundex2">Run example &raquo;</a>
</div>
<hr>
