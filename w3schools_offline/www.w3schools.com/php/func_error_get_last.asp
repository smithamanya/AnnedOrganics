...
<!-- Mirrored from www.w3schools.com/php/func_error_get_last.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:33 GMT -->
<head>
...
<h3>Example</h3>
<p>Return the last error that occurred:</p>
...
<p>The error_get_last() function returns the last error that occurred (as an 
associative array).</p>
<p>The associative array contains four keys:</p>
<ul>
	<li>[type] - Describes the error type</li>
	<li>[message] - Describes the error message</li>
	<li>[file] - Describes the file where the error occurred</li>
	<li>[line] - Describes the line where the error occurred</li>
</ul>
...
<tr>
	...
	<td style="width:80%">Returns an associative array describing the last error 
	with keys: type, message, file, and line. Returns NULL if no error has 
	occurred yet</td>
</tr>
<tr>
	<th>PHP Version:</th>
