...
<!-- Mirrored from www.w3schools.com/php/func_error_restore_exception_handler.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:34 GMT -->
<head>
...
<h3>Example</h3>
<p>Restore exception handler example:</p>
<div class="w3-code notranslate">
&lt;?php<br>// Two user-defined exception handler functions<br>
function myException1($exception)
{<br>
&nbsp;&nbsp;&nbsp;
echo &quot;[&quot; . __FUNCTION__ . &quot;]&quot; . $exception-&gt;getMessage();<br>
}<br>
...
<br>
set_exception_handler(&quot;myException1&quot;);<br>set_exception_handler(&quot;myException2&quot;);<br>
	<br>restore_exception_handler();<br>
	<br>// Throw exception<br>throw new Exception(&quot;This triggers the first 
...
<div class="w3-code notranslate">
	...
	[myException1] This triggers the first exception handler...</div>
<br>
</div>
<hr>
...
it with the <a href="func_error_set_exception_handler.asp">set_exception_handler()</a> function. </p>
<p><b>Tip:</b> The previous exception handler could be the built-in exception handler or 
a user-defined exception handler function.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
restore_exception_handler();</div>
</div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td style="width:80%">Always TRUE</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.0+</td>
