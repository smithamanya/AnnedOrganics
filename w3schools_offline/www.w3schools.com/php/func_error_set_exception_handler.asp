...
<!-- Mirrored from www.w3schools.com/php/func_error_set_exception_handler.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:34 GMT -->
<head>
...
<h3>Example</h3>
<p>Set a user-defined exception handler function:</p>
<div class="w3-code notranslate">
&lt;?php<br>// A user-defined exception handler function<br>
...
<br>
// Set user-defined exception handler function<br>
set_exception_handler(&quot;myException&quot;);<br>
	<br>// Throw exception<br>throw new Exception(&quot;Uncaught exception occurred!&quot;);<br>
	?&gt;
</div>
<p>The above code will output something like this:</p>
<div class="w3-code notranslate">

<b>Exception:</b> Uncaught exception occurred!</div>
<br>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The set_exception_handler() function sets a user-defined exception handler function.</p>

<p>The script will stop executing after the exception handler is 
called.&nbsp;</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	set_exception_handler(<em>exceptionhandler</em>);</div>
</div>
<br>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>exceptionhandler</em></td>
    <td>Required. Specifies the name of the function to be run when an uncaught 
	exception occurs. NULL can be passed instead, to reset this handler to its 
	default state</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">A string that contains the previously defined exception 
	handler, or NULL on error or if no previous handler was defined</td>
</tr>
<tr>
	<th>PHP Version:</th>
	<td>5.0+</td>
...
<tr>
	<th>PHP Changelog:</th>
	<td>Previously, if NULL was passed then this function returned TRUE. It 
	returns the previous handler since PHP 5.5</td>
</tr>
</table>
<hr>
