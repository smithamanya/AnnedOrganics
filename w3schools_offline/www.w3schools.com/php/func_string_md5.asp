...
<!-- Mirrored from www.w3schools.com/php/func_string_md5.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:20 GMT -->
<head>
...
echo md5($str);<br>
?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp8a47.asp?filename=demo_func_string_md5">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpd760.asp?filename=demo_func_string_md52">Run example &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpfc8b.asp?filename=demo_func_string_md53">Run example &raquo;</a>
</div>
<hr>
