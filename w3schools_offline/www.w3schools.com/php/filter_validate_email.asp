...
<!-- Mirrored from www.w3schools.com/php/filter_validate_email.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:44 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpef49.asp?filename=demo_func_validate_email">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The FILTER_VALIDATE_EMAIL filter validates an e-mail address.</p>
<hr>
...
<div class="w3-example">
<h3>Example 1</h3>
<p>First remove all illegal characters from the $email variable, then check if 
it is a valid email address:</p>
<div class="w3-code notranslate">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp54e8.asp?filename=demo_func_validate_email2">Run example &raquo;</a>
</div>
