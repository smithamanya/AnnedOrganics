...
<!-- Mirrored from www.w3schools.com/php/func_filter_input_array.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:43 GMT -->
<head>
...
<h3>Example</h3>
<p>Check if the external variable &quot;email&quot; is sent to the PHP page, 
through the 
&quot;get&quot; method, and also check if it is a valid email address:</p>
<div class="w3-code notranslate">
	&lt;?php<br>if (!filter_input(INPUT_GET, &quot;email&quot;, 
	FILTER_VALIDATE_EMAIL)) {<br>&nbsp;&nbsp;&nbsp; 
	echo(&quot;Email is not valid&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Email 
	is valid&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpe32e.asp?filename=demo_func_filter_input_array">Run example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The filter_input_array() function gets external variables (e.g. from form input) and optionally filters them.</p>
<p>This function is useful for retrieving/filtering many values instead of 
calling filter_input() many times.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	filter_input_array(<em>type, definition, add_empty</em>)</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><em>type</em></td>
    <td>Required. The input type to check for. Can be one of the following:
		<ul>
			<li>INPUT_GET</li>
			<li>INPUT_POST</li>
			<li>INPUT_COOKIE</li>
  ...
  <tr>
    ...
    <td>Optional. Specifies an array of filter arguments. A valid array key is a 
	variable name, and a valid value is a filter name or ID, or an array 
	specifying the filter, flags and options. This parameter can also be a 
	single filter name/ID; then all values in the input array are filtered by 
	the specified filter</td>
  </tr>
  <tr>
    <td><em>add_empty</em></td>
    <td>Optional. A Boolean value. When set to TRUE it add missing keys as NULL 
	to the return value. Default value is TRUE</td>
  </tr>
  </table>
...
<tr>
	...
	<td style="width:80%">
<p>Returns an array containing the values of the variables on success, or FALSE 
on failure</p>
	</td>
</tr>
<tr>
...
<hr>
<a href="php_ref_filter.html"><img class="navup" src="../images/up.gif" alt="PHP Filter Reference" /> Complete PHP Filter Reference</a>
</div>
