...
<!-- Mirrored from www.w3schools.com/php/filter_sanitize_string.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:46 GMT -->
<head>
...
<p><a href="php_ref_filter.html"><img class="navup" src="../images/up.gif" alt="PHP Filter Reference" /> 
PHP Filter Reference</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Remove all HTML tags from a string:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$str = "&lt;h1&gt;Hello World!&lt;/h1&gt;";<br><br>$newstr = filter_var($str, 
	FILTER_SANITIZE_STRING);<br>echo $newstr;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp03a3.asp?filename=demo_func_sanitize_string">
	Run example »</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The FILTER_SANITIZE_STRING filter removes tags and remove or encode special 
characters from a string.</p>

<p>Possible options and flags:</p>
<ul>
	<li>FILTER_FLAG_NO_ENCODE_QUOTES - Do not encode quotes</li>
	<li>FILTER_FLAG_STRIP_LOW - Remove characters with ASCII value &lt; 32</li>
	<li>FILTER_FLAG_STRIP_HIGH - Remove characters with ASCII value &gt; 127</li>
	<li>FILTER_FLAG_ENCODE_LOW - Encode characters with ASCII value &lt; 32</li>
	<li>FILTER_FLAG_ENCODE_HIGH - Encode characters with ASCII value &gt; 127</li>
...
<div class="w3-example">
<h3>Example 1</h3>
<p>Remove all HTML tags and all characters with ASCII value &gt; 127, from a 
string:</p>
<div class="w3-code notranslate">
	&lt;?php<br>$str = "&lt;h1&gt;Hello WorldÆØÅ!&lt;/h1&gt;";<br>
	<br>$newstr = filter_var($str, FILTER_SANITIZE_STRING, 
	FILTER_FLAG_STRIP_HIGH);<br>echo $newstr;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpdc5a.asp?filename=demo_func_sanitize_string2">
	Run example »</a>
</div>

<hr>
<a href="php_ref_filter.html"><img class="navup" src="../images/up.gif" alt="PHP Filter Reference" /> 
PHP Filter Reference</a>
</div>
