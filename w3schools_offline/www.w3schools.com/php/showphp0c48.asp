...
<!-- Mirrored from www.w3schools.com/php/showphp.asp?filename=demo_simplexml_read_string_error by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:20 GMT -->
<head>
...
<div class="container">
  <div class="textareacontainer">
    <div class="textarea">
      ...
      <div class="iframewrapper">
        <iframe id="iframeSource" frameborder="0" src="showphpcode6d8d.asp?source=demo_simplexml_read_string_error"></iframe>
      </div>
    </div>
  </div>
  <div class="iframecontainer">
    <div class="iframe">
      ...
      <div class="iframewrapper">
        <iframe id="iframeResult" frameborder="0" src="demo_simplexml_read_string_error.php"></iframe>
      </div>
    </div> 
  </div>
