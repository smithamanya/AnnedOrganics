...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-vertical_align_center by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:01 GMT -->
<head>
...
<h1>vertical_align_center</h1>

<i class="material-icons">vertical_align_center</i>
<i class="material-icons" style="font-size:36px">vertical_align_center</i>
<i class="material-icons" style="font-size:48px;color:red">vertical_align_center</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">vertical_align_center</i></button>
