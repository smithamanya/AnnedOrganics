...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-phone_forwarded by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:20 GMT -->
<head>
...
<h1>phone_forwarded</h1>

<i class="material-icons">phone_forwarded</i>
<i class="material-icons" style="font-size:36px">phone_forwarded</i>
<i class="material-icons" style="font-size:48px;color:red">phone_forwarded</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">phone_forwarded</i></button>
