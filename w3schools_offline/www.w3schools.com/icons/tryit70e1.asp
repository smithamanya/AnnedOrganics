...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-photo_album by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:12 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">photo_album</i>
<i class="material-icons" style="font-size:48px;color:red">photo_album</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">photo_album</i></button>
