...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-puzzle-piece by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:27 GMT -->
<head>
...
<h1>fa fa-puzzle-piece</h1>

<i class="fa fa-puzzle-piece"></i>
<i class="fa fa-puzzle-piece" style="font-size:24px"></i>
<i class="fa fa-puzzle-piece" style="font-size:36px"></i>
<i class="fa fa-puzzle-piece" style="font-size:48px;color:red"></i>
<br>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="fa fa-puzzle-piece"></i></button>
