...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-arrow_drop_down by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:17 GMT -->
<head>
...
<h1>arrow_drop_down</h1>

<i class="material-icons">arrow_drop_down</i>
<i class="material-icons" style="font-size:36px">arrow_drop_down</i>
<i class="material-icons" style="font-size:48px;color:red">arrow_drop_down</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">arrow_drop_down</i></button>
