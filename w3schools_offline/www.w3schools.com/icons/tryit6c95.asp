...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-monochrome_photos by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:11 GMT -->
<head>
...
<h1>monochrome_photos</h1>

<i class="material-icons">monochrome_photos</i>
<i class="material-icons" style="font-size:36px">monochrome_photos</i>
<i class="material-icons" style="font-size:48px;color:red">monochrome_photos</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">monochrome_photos</i></button>
