...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-bluetooth_searching by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:56 GMT -->
<head>
...
<h1>bluetooth_searching</h1>

<i class="material-icons">bluetooth_searching</i>
<i class="material-icons" style="font-size:36px">bluetooth_searching</i>
<i class="material-icons" style="font-size:48px;color:red">bluetooth_searching</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">bluetooth_searching</i></button>
