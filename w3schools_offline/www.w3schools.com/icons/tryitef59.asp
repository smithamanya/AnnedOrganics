...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-control_point_duplicate by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:06 GMT -->
<head>
...
<h1>control_point_duplicate</h1>

<i class="material-icons">control_point_duplicate</i>
<i class="material-icons" style="font-size:36px">control_point_duplicate</i>
<i class="material-icons" style="font-size:48px;color:red">control_point_duplicate</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">control_point_duplicate</i></button>
