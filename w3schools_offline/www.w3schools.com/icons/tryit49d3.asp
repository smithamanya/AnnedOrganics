...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-report_problem by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:41 GMT -->
<head>
...
<h1>report_problem</h1>

<i class="material-icons">report_problem</i>
<i class="material-icons" style="font-size:36px">report_problem</i>
<i class="material-icons" style="font-size:48px;color:red">report_problem</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">report_problem</i></button>
