...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-center_focus_strong by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:06 GMT -->
<head>
...
<h1>center_focus_strong</h1>

<i class="material-icons">center_focus_strong</i>
<i class="material-icons" style="font-size:36px">center_focus_strong</i>
<i class="material-icons" style="font-size:48px;color:red">center_focus_strong</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">center_focus_strong</i></button>
