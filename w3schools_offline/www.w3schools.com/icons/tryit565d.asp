...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-swap_horiz by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:43 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">swap_horiz</i>
<i class="material-icons" style="font-size:48px;color:red">swap_horiz</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">swap_horiz</i></button>
