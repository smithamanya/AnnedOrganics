...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-present_to_all by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:52 GMT -->
<head>
...
<h1>present_to_all</h1>

<i class="material-icons">present_to_all</i>
<i class="material-icons" style="font-size:36px">present_to_all</i>
<i class="material-icons" style="font-size:48px;color:red">present_to_all</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">present_to_all</i></button>
