...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-power_input by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:03 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">power_input</i>
<i class="material-icons" style="font-size:48px;color:red">power_input</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">power_input</i></button>

</body>

<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-power_input by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:04 GMT -->
</html>
</textarea>
