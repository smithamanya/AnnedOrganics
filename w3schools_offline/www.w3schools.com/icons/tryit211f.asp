...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-ondemand_video by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:19 GMT -->
<head>
...
<h1>ondemand_video</h1>

<i class="material-icons">ondemand_video</i>
<i class="material-icons" style="font-size:36px">ondemand_video</i>
<i class="material-icons" style="font-size:48px;color:red">ondemand_video</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">ondemand_video</i></button>
