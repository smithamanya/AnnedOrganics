...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-developer_mode by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:56 GMT -->
<head>
...
<h1>developer_mode</h1>

<i class="material-icons">developer_mode</i>
<i class="material-icons" style="font-size:36px">developer_mode</i>
<i class="material-icons" style="font-size:48px;color:red">developer_mode</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">developer_mode</i></button>
