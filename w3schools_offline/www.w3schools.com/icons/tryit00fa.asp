...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-indeterminate_check_box by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:23 GMT -->
<head>
...
<h1>indeterminate_check_box</h1>

<i class="material-icons">indeterminate_check_box</i>
<i class="material-icons" style="font-size:36px">indeterminate_check_box</i>
<i class="material-icons" style="font-size:48px;color:red">indeterminate_check_box</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">indeterminate_check_box</i></button>
