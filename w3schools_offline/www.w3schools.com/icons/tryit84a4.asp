...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-surround_sound by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:49 GMT -->
<head>
...
<h1>surround_sound</h1>

<i class="material-icons">surround_sound</i>
<i class="material-icons" style="font-size:36px">surround_sound</i>
<i class="material-icons" style="font-size:48px;color:red">surround_sound</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">surround_sound</i></button>
