...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-chrome_reader_mode by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:36 GMT -->
<head>
...
<h1>chrome_reader_mode</h1>

<i class="material-icons">chrome_reader_mode</i>
<i class="material-icons" style="font-size:36px">chrome_reader_mode</i>
<i class="material-icons" style="font-size:48px;color:red">chrome_reader_mode</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">chrome_reader_mode</i></button>
