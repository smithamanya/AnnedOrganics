...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-hourglass_empty by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:38 GMT -->
<head>
...
<h1>hourglass_empty</h1>

<i class="material-icons">hourglass_empty</i>
<i class="material-icons" style="font-size:36px">hourglass_empty</i>
<i class="material-icons" style="font-size:48px;color:red">hourglass_empty</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">hourglass_empty</i></button>
