...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-swap_vertical_circle by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:43 GMT -->
<head>
...
<h1>swap_vertical_circle</h1>

<i class="material-icons">swap_vertical_circle</i>
<i class="material-icons" style="font-size:36px">swap_vertical_circle</i>
<i class="material-icons" style="font-size:48px;color:red">swap_vertical_circle</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">swap_vertical_circle</i></button>
