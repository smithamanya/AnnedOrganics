...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-settings_system_daydream by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:56 GMT -->
<head>
...
<h1>settings_system_daydream</h1>

<i class="material-icons">settings_system_daydream</i>
<i class="material-icons" style="font-size:36px">settings_system_daydream</i>
<i class="material-icons" style="font-size:48px;color:red">settings_system_daydream</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">settings_system_daydream</i></button>
