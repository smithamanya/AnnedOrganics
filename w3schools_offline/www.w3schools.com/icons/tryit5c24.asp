...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-insert_drive_file by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:00 GMT -->
<head>
...
<h1>insert_drive_file</h1>

<i class="material-icons">insert_drive_file</i>
<i class="material-icons" style="font-size:36px">insert_drive_file</i>
<i class="material-icons" style="font-size:48px;color:red">insert_drive_file</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">insert_drive_file</i></button>
