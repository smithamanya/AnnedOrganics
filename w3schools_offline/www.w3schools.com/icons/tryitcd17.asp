...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-system_update_alt by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:43 GMT -->
<head>
...
<h1>system_update_alt</h1>

<i class="material-icons">system_update_alt</i>
<i class="material-icons" style="font-size:36px">system_update_alt</i>
<i class="material-icons" style="font-size:48px;color:red">system_update_alt</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">system_update_alt</i></button>
