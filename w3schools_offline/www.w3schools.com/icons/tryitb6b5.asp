...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:18 GMT -->
<head>
...
<h1>fa fa-dashboard</h1>

<i class="fa fa-dashboard"></i>
<i class="fa fa-dashboard" style="font-size:24px"></i>
<i class="fa fa-dashboard" style="font-size:36px"></i>
<i class="fa fa-dashboard" style="font-size:48px;color:red"></i>
<br>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="fa fa-dashboard"></i></button>
