...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-local_convenience_store by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:15 GMT -->
<head>
...
<h1>local_convenience_store</h1>

<i class="material-icons">local_convenience_store</i>
<i class="material-icons" style="font-size:36px">local_convenience_store</i>
<i class="material-icons" style="font-size:48px;color:red">local_convenience_store</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">local_convenience_store</i></button>
