...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-people_outline by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:22 GMT -->
<head>
...
<h1>people_outline</h1>

<i class="material-icons">people_outline</i>
<i class="material-icons" style="font-size:36px">people_outline</i>
<i class="material-icons" style="font-size:48px;color:red">people_outline</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">people_outline</i></button>
