...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-flash_off by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:09 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">flash_off</i>
<i class="material-icons" style="font-size:48px;color:red">flash_off</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">flash_off</i></button>
