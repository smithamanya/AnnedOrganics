...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-stay_current_portrait by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:52 GMT -->
<head>
...
<h1>stay_current_portrait</h1>

<i class="material-icons">stay_current_portrait</i>
<i class="material-icons" style="font-size:36px">stay_current_portrait</i>
<i class="material-icons" style="font-size:48px;color:red">stay_current_portrait</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">stay_current_portrait</i></button>
