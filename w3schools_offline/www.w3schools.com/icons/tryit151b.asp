...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-perm_data_setting by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:40 GMT -->
<head>
...
<h1>perm_data_setting</h1>

<i class="material-icons">perm_data_setting</i>
<i class="material-icons" style="font-size:36px">perm_data_setting</i>
<i class="material-icons" style="font-size:48px;color:red">perm_data_setting</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">perm_data_setting</i></button>
