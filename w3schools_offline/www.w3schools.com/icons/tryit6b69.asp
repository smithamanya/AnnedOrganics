...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-border_outer by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:58 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">border_outer</i>
<i class="material-icons" style="font-size:48px;color:red">border_outer</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">border_outer</i></button>
