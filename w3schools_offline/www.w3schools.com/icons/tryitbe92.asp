...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-desktop_windows by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:02 GMT -->
<head>
...
<h1>desktop_windows</h1>

<i class="material-icons">desktop_windows</i>
<i class="material-icons" style="font-size:36px">desktop_windows</i>
<i class="material-icons" style="font-size:48px;color:red">desktop_windows</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">desktop_windows</i></button>
