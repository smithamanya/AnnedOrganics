...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-file-photo-o by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:02 GMT -->
<head>
...
<h1>fa fa-file-photo-o</h1>

<i class="fa fa-file-photo-o"></i>
<i class="fa fa-file-photo-o" style="font-size:24px"></i>
<i class="fa fa-file-photo-o" style="font-size:36px"></i>
<i class="fa fa-file-photo-o" style="font-size:48px;color:red"></i>
<br>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="fa fa-file-photo-o"></i></button>
