...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-sim_card_alert by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:20 GMT -->
<head>
...
<h1>sim_card_alert</h1>

<i class="material-icons">sim_card_alert</i>
<i class="material-icons" style="font-size:36px">sim_card_alert</i>
<i class="material-icons" style="font-size:48px;color:red">sim_card_alert</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">sim_card_alert</i></button>
