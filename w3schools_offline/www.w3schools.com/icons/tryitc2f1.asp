...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-folder_special by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:19 GMT -->
<head>
...
<h1>folder_special</h1>

<i class="material-icons">folder_special</i>
<i class="material-icons" style="font-size:36px">folder_special</i>
<i class="material-icons" style="font-size:48px;color:red">folder_special</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">folder_special</i></button>
