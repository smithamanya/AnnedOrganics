...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-keyboard_capslock by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:02 GMT -->
<head>
...
// gptAdSlots[0] = googletag.defineSlot('/16833175/TryitLeaderboard', [728, 90], 'div-gpt-ad-1428407818244-0').
   ...
   googletag.pubads().setTargeting("content","tryicons");
...
<h1>keyboard_capslock</h1>

<i class="material-icons">keyboard_capslock</i>
<i class="material-icons" style="font-size:36px">keyboard_capslock</i>
<i class="material-icons" style="font-size:48px;color:red">keyboard_capslock</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">keyboard_capslock</i></button>

</body>

<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-keyboard_capslock by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:03 GMT -->
</html>
</textarea>
