...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-panorama_fish_eye by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:12 GMT -->
<head>
...
<h1>panorama_fish_eye</h1>

<i class="material-icons">panorama_fish_eye</i>
<i class="material-icons" style="font-size:36px">panorama_fish_eye</i>
<i class="material-icons" style="font-size:48px;color:red">panorama_fish_eye</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">panorama_fish_eye</i></button>
