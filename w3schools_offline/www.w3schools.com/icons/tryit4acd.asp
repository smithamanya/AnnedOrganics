...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-settings_applications by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:41 GMT -->
<head>
...
<h1>settings_applications</h1>

<i class="material-icons">settings_applications</i>
<i class="material-icons" style="font-size:36px">settings_applications</i>
<i class="material-icons" style="font-size:48px;color:red">settings_applications</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">settings_applications</i></button>
