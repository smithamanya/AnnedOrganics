...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-developer_board by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:02 GMT -->
<head>
...
<h1>developer_board</h1>

<i class="material-icons">developer_board</i>
<i class="material-icons" style="font-size:36px">developer_board</i>
<i class="material-icons" style="font-size:48px;color:red">developer_board</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">developer_board</i></button>
