...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-perm_identity by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:40 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">perm_identity</i>
<i class="material-icons" style="font-size:48px;color:red">perm_identity</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">perm_identity</i></button>
