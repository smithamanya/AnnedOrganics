...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-location_disabled by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:56 GMT -->
<head>
...
<h1>location_disabled</h1>

<i class="material-icons">location_disabled</i>
<i class="material-icons" style="font-size:36px">location_disabled</i>
<i class="material-icons" style="font-size:48px;color:red">location_disabled</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">location_disabled</i></button>
