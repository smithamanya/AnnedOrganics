...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-looks_one by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:11 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">looks_one</i>
<i class="material-icons" style="font-size:48px;color:red">looks_one</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">looks_one</i></button>
