...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-movie_creation by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:11 GMT -->
<head>
...
<h1>movie_creation</h1>

<i class="material-icons">movie_creation</i>
<i class="material-icons" style="font-size:36px">movie_creation</i>
<i class="material-icons" style="font-size:48px;color:red">movie_creation</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">movie_creation</i></button>
