...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-format_indent_decrease by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:59 GMT -->
<head>
...
<h1>format_indent_decrease</h1>

<i class="material-icons">format_indent_decrease</i>
<i class="material-icons" style="font-size:36px">format_indent_decrease</i>
<i class="material-icons" style="font-size:48px;color:red">format_indent_decrease</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">format_indent_decrease</i></button>
