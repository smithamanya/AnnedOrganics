...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-shopping_basket by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:42 GMT -->
<head>
...
<h1>shopping_basket</h1>

<i class="material-icons">shopping_basket</i>
<i class="material-icons" style="font-size:36px">shopping_basket</i>
<i class="material-icons" style="font-size:48px;color:red">shopping_basket</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">shopping_basket</i></button>
