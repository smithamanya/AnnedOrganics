...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-personal_video by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:19 GMT -->
<head>
...
<h1>personal_video</h1>

<i class="material-icons">personal_video</i>
<i class="material-icons" style="font-size:36px">personal_video</i>
<i class="material-icons" style="font-size:48px;color:red">personal_video</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">personal_video</i></button>
