...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-thumbs_up_down by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:44 GMT -->
<head>
...
<h1>thumbs_up_down</h1>

<i class="material-icons">thumbs_up_down</i>
<i class="material-icons" style="font-size:36px">thumbs_up_down</i>
<i class="material-icons" style="font-size:48px;color:red">thumbs_up_down</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">thumbs_up_down</i></button>
