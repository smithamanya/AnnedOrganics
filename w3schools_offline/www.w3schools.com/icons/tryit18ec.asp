...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-color_lens by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:06 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">color_lens</i>
<i class="material-icons" style="font-size:48px;color:red">color_lens</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">color_lens</i></button>
