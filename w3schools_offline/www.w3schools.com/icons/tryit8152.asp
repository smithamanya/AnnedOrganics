...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-question_answer by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:41 GMT -->
<head>
...
<h1>question_answer</h1>

<i class="material-icons">question_answer</i>
<i class="material-icons" style="font-size:36px">question_answer</i>
<i class="material-icons" style="font-size:48px;color:red">question_answer</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">question_answer</i></button>
