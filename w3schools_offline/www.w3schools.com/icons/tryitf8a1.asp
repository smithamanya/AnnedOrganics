...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-strikethrough_s by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:01 GMT -->
<head>
...
<h1>strikethrough_s</h1>

<i class="material-icons">strikethrough_s</i>
<i class="material-icons" style="font-size:36px">strikethrough_s</i>
<i class="material-icons" style="font-size:48px;color:red">strikethrough_s</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">strikethrough_s</i></button>
