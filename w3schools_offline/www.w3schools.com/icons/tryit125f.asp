...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-radio_button_checked by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:23 GMT -->
<head>
...
<h1>radio_button_checked</h1>

<i class="material-icons">radio_button_checked</i>
<i class="material-icons" style="font-size:36px">radio_button_checked</i>
<i class="material-icons" style="font-size:48px;color:red">radio_button_checked</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">radio_button_checked</i></button>
