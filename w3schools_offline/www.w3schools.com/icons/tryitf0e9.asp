...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-keyboard_voice by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:03 GMT -->
<head>
...
<h1>keyboard_voice</h1>

<i class="material-icons">keyboard_voice</i>
<i class="material-icons" style="font-size:36px">keyboard_voice</i>
<i class="material-icons" style="font-size:48px;color:red">keyboard_voice</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">keyboard_voice</i></button>
