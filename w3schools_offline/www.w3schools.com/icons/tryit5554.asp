...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-youtube by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:55 GMT -->
<head>
...
<button style="font-size:24px">Button <i class="fa fa-youtube"></i></button>
