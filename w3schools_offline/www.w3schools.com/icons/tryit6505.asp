...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-closed_caption by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:46 GMT -->
<head>
...
<h1>closed_caption</h1>

<i class="material-icons">closed_caption</i>
<i class="material-icons" style="font-size:36px">closed_caption</i>
<i class="material-icons" style="font-size:48px;color:red">closed_caption</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">closed_caption</i></button>
