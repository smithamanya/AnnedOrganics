...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-exposure_plus_1 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:08 GMT -->
<head>
...
<h1>exposure_plus_1</h1>

<i class="material-icons">exposure_plus_1</i>
<i class="material-icons" style="font-size:36px">exposure_plus_1</i>
<i class="material-icons" style="font-size:48px;color:red">exposure_plus_1</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">exposure_plus_1</i></button>
