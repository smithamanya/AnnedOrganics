...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-airline_seat_legroom_normal by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:18 GMT -->
<head>
...
<h1>airline_seat_legroom_normal</h1>

<i class="material-icons">airline_seat_legroom_normal</i>
<i class="material-icons" style="font-size:36px">airline_seat_legroom_normal</i>
<i class="material-icons" style="font-size:48px;color:red">airline_seat_legroom_normal</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">airline_seat_legroom_normal</i></button>
