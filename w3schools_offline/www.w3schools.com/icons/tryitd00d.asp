...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-photo_size_select_small by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:12 GMT -->
<head>
...
<h1>photo_size_select_small</h1>

<i class="material-icons">photo_size_select_small</i>
<i class="material-icons" style="font-size:36px">photo_size_select_small</i>
<i class="material-icons" style="font-size:48px;color:red">photo_size_select_small</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">photo_size_select_small</i></button>
