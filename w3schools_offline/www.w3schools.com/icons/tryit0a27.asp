...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-screen_lock_rotation by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:56 GMT -->
<head>
...
<h1>screen_lock_rotation</h1>

<i class="material-icons">screen_lock_rotation</i>
<i class="material-icons" style="font-size:36px">screen_lock_rotation</i>
<i class="material-icons" style="font-size:48px;color:red">screen_lock_rotation</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">screen_lock_rotation</i></button>
