...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-event_available by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:19 GMT -->
<head>
...
<h1>event_available</h1>

<i class="material-icons">event_available</i>
<i class="material-icons" style="font-size:36px">event_available</i>
<i class="material-icons" style="font-size:48px;color:red">event_available</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">event_available</i></button>
