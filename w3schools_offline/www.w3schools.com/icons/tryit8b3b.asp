...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-restaurant_menu by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:17 GMT -->
<head>
...
<h1>restaurant_menu</h1>

<i class="material-icons">restaurant_menu</i>
<i class="material-icons" style="font-size:36px">restaurant_menu</i>
<i class="material-icons" style="font-size:48px;color:red">restaurant_menu</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">restaurant_menu</i></button>
