...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-directions_run by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:15 GMT -->
<head>
...
<h1>directions_run</h1>

<i class="material-icons">directions_run</i>
<i class="material-icons" style="font-size:36px">directions_run</i>
<i class="material-icons" style="font-size:48px;color:red">directions_run</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">directions_run</i></button>
