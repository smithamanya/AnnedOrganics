...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-grid_on by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:10 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">grid_on</i>
<i class="material-icons" style="font-size:48px;color:red">grid_on</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">grid_on</i></button>
