...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-speaker_phone by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:52 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">speaker_phone</i>
<i class="material-icons" style="font-size:48px;color:red">speaker_phone</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">speaker_phone</i></button>
