...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-directions_subway by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:15 GMT -->
<head>
...
<h1>directions_subway</h1>

<i class="material-icons">directions_subway</i>
<i class="material-icons" style="font-size:36px">directions_subway</i>
<i class="material-icons" style="font-size:48px;color:red">directions_subway</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">directions_subway</i></button>
