...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-plus_one by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:22 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">plus_one</i>
<i class="material-icons" style="font-size:48px;color:red">plus_one</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">plus_one</i></button>
