...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-pinterest-p by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:51 GMT -->
<head>
...
<h1>fa fa-pinterest-p</h1>

<i class="fa fa-pinterest-p"></i>
<i class="fa fa-pinterest-p" style="font-size:24px"></i>
<i class="fa fa-pinterest-p" style="font-size:36px"></i>
<i class="fa fa-pinterest-p" style="font-size:48px;color:red"></i>
<br>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="fa fa-pinterest-p"></i></button>
