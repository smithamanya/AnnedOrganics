...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-pages by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:22 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">pages</i>
<i class="material-icons" style="font-size:48px;color:red">pages</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">pages</i></button>
