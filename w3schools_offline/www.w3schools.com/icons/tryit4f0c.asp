...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-visibility_off by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:45 GMT -->
<head>
...
<h1>visibility_off</h1>

<i class="material-icons">visibility_off</i>
<i class="material-icons" style="font-size:36px">visibility_off</i>
<i class="material-icons" style="font-size:48px;color:red">visibility_off</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">visibility_off</i></button>
