...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-do_not_disturb by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:19 GMT -->
<head>
...
<h1>do_not_disturb</h1>

<i class="material-icons">do_not_disturb</i>
<i class="material-icons" style="font-size:36px">do_not_disturb</i>
<i class="material-icons" style="font-size:48px;color:red">do_not_disturb</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">do_not_disturb</i></button>
