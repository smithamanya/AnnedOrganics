...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-games by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:46 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">games</i>
<i class="material-icons" style="font-size:48px;color:red">games</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">games</i></button>
