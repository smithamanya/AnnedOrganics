...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-wifi_tethering by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:57 GMT -->
<head>
...
<h1>wifi_tethering</h1>

<i class="material-icons">wifi_tethering</i>
<i class="material-icons" style="font-size:36px">wifi_tethering</i>
<i class="material-icons" style="font-size:48px;color:red">wifi_tethering</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">wifi_tethering</i></button>
