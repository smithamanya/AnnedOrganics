...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-video_library by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:49 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">video_library</i>
<i class="material-icons" style="font-size:48px;color:red">video_library</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">video_library</i></button>
