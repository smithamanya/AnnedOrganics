...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-exit_to_app by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:37 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">exit_to_app</i>
<i class="material-icons" style="font-size:48px;color:red">exit_to_app</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">exit_to_app</i></button>
