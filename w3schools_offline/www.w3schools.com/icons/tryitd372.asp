...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-assignment_returned by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:35 GMT -->
<head>
...
<h1>assignment_returned</h1>

<i class="material-icons">assignment_returned</i>
<i class="material-icons" style="font-size:36px">assignment_returned</i>
<i class="material-icons" style="font-size:48px;color:red">assignment_returned</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">assignment_returned</i></button>
