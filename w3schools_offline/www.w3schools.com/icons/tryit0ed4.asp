...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-airplanemode_active by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:55 GMT -->
<head>
...
<h1>airplanemode_active</h1>

<i class="material-icons">airplanemode_active</i>
<i class="material-icons" style="font-size:36px">airplanemode_active</i>
<i class="material-icons" style="font-size:48px;color:red">airplanemode_active</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">airplanemode_active</i></button>
