...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-invert_colors by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:39 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">invert_colors</i>
<i class="material-icons" style="font-size:48px;color:red">invert_colors</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">invert_colors</i></button>
