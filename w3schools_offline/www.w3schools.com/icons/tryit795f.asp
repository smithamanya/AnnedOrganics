...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-select_all by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:55 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">select_all</i>
<i class="material-icons" style="font-size:48px;color:red">select_all</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">select_all</i></button>
