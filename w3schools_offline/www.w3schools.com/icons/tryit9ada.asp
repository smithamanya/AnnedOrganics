...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-picture_as_pdf by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:12 GMT -->
<head>
...
<h1>picture_as_pdf</h1>

<i class="material-icons">picture_as_pdf</i>
<i class="material-icons" style="font-size:36px">picture_as_pdf</i>
<i class="material-icons" style="font-size:48px;color:red">picture_as_pdf</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">picture_as_pdf</i></button>
