...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-contact_phone by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:50 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">contact_phone</i>
<i class="material-icons" style="font-size:48px;color:red">contact_phone</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">contact_phone</i></button>
