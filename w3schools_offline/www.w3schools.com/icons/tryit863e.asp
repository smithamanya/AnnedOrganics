...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-image_aspect_ratio by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:10 GMT -->
<head>
...
<h1>image_aspect_ratio</h1>

<i class="material-icons">image_aspect_ratio</i>
<i class="material-icons" style="font-size:36px">image_aspect_ratio</i>
<i class="material-icons" style="font-size:48px;color:red">image_aspect_ratio</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">image_aspect_ratio</i></button>
