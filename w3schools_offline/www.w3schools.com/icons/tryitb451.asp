...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-skip_next by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:49 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">skip_next</i>
<i class="material-icons" style="font-size:48px;color:red">skip_next</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">skip_next</i></button>
