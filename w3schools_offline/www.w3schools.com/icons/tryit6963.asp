...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-camera_enhance by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:36 GMT -->
<head>
...
<h1>camera_enhance</h1>

<i class="material-icons">camera_enhance</i>
<i class="material-icons" style="font-size:36px">camera_enhance</i>
<i class="material-icons" style="font-size:48px;color:red">camera_enhance</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">camera_enhance</i></button>
