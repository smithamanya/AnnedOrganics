...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-bluetooth_audio by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:19 GMT -->
<head>
...
<h1>bluetooth_audio</h1>

<i class="material-icons">bluetooth_audio</i>
<i class="material-icons" style="font-size:36px">bluetooth_audio</i>
<i class="material-icons" style="font-size:48px;color:red">bluetooth_audio</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">bluetooth_audio</i></button>
