...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-youtube_searched_for by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:45 GMT -->
<head>
...
<h1>youtube_searched_for</h1>

<i class="material-icons">youtube_searched_for</i>
<i class="material-icons" style="font-size:36px">youtube_searched_for</i>
<i class="material-icons" style="font-size:48px;color:red">youtube_searched_for</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">youtube_searched_for</i></button>
