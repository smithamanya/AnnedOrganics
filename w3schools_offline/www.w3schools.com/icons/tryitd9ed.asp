...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-tag_faces by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:13 GMT -->
<head>
...
<i class="material-icons" style="font-size:48px;color:red">tag_faces</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">tag_faces</i></button>
