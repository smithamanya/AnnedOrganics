...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-wb_sunny by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:14 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">wb_sunny</i>
<i class="material-icons" style="font-size:48px;color:red">wb_sunny</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">wb_sunny</i></button>
