...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-markunread_mailbox by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:39 GMT -->
<head>
...
<h1>markunread_mailbox</h1>

<i class="material-icons">markunread_mailbox</i>
<i class="material-icons" style="font-size:36px">markunread_mailbox</i>
<i class="material-icons" style="font-size:48px;color:red">markunread_mailbox</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">markunread_mailbox</i></button>
