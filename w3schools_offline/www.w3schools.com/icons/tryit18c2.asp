...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-filter_vintage by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:09 GMT -->
<head>
...
<h1>filter_vintage</h1>

<i class="material-icons">filter_vintage</i>
<i class="material-icons" style="font-size:36px">filter_vintage</i>
<i class="material-icons" style="font-size:48px;color:red">filter_vintage</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">filter_vintage</i></button>
