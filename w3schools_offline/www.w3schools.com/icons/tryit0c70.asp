...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-navigate_before by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:12 GMT -->
<head>
...
<h1>navigate_before</h1>

<i class="material-icons">navigate_before</i>
<i class="material-icons" style="font-size:36px">navigate_before</i>
<i class="material-icons" style="font-size:48px;color:red">navigate_before</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">navigate_before</i></button>
