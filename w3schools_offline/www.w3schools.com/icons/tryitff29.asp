...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-format_strikethrough by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:00 GMT -->
<head>
...
<h1>format_strikethrough</h1>

<i class="material-icons">format_strikethrough</i>
<i class="material-icons" style="font-size:36px">format_strikethrough</i>
<i class="material-icons" style="font-size:48px;color:red">format_strikethrough</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">format_strikethrough</i></button>
