...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-view_array by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:44 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">view_array</i>
<i class="material-icons" style="font-size:48px;color:red">view_array</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">view_array</i></button>
