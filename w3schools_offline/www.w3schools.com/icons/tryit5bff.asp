...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-portable_wifi_off by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:52 GMT -->
<head>
...
<h1>portable_wifi_off</h1>

<i class="material-icons">portable_wifi_off</i>
<i class="material-icons" style="font-size:36px">portable_wifi_off</i>
<i class="material-icons" style="font-size:48px;color:red">portable_wifi_off</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">portable_wifi_off</i></button>
