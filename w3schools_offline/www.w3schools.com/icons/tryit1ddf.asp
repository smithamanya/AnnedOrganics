...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-local_car_wash by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:15 GMT -->
<head>
...
<h1>local_car_wash</h1>

<i class="material-icons">local_car_wash</i>
<i class="material-icons" style="font-size:36px">local_car_wash</i>
<i class="material-icons" style="font-size:48px;color:red">local_car_wash</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">local_car_wash</i></button>
