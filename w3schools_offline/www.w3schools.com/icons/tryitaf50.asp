...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-remove_red_eye by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:13 GMT -->
<head>
...
<h1>remove_red_eye</h1>

<i class="material-icons">remove_red_eye</i>
<i class="material-icons" style="font-size:36px">remove_red_eye</i>
<i class="material-icons" style="font-size:48px;color:red">remove_red_eye</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">remove_red_eye</i></button>
