...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-hourglass_full by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:38 GMT -->
<head>
...
<h1>hourglass_full</h1>

<i class="material-icons">hourglass_full</i>
<i class="material-icons" style="font-size:36px">hourglass_full</i>
<i class="material-icons" style="font-size:48px;color:red">hourglass_full</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">hourglass_full</i></button>
