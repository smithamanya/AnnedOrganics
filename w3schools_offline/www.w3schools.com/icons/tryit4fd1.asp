...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-exposure_zero by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:08 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">exposure_zero</i>
<i class="material-icons" style="font-size:48px;color:red">exposure_zero</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">exposure_zero</i></button>
