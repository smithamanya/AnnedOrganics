...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-assistant_photo by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:05 GMT -->
<head>
...
<h1>assistant_photo</h1>

<i class="material-icons">assistant_photo</i>
<i class="material-icons" style="font-size:36px">assistant_photo</i>
<i class="material-icons" style="font-size:48px;color:red">assistant_photo</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">assistant_photo</i></button>
