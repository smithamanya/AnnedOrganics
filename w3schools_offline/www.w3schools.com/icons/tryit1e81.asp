...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-local_laundry_service by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:16 GMT -->
<head>
...
<h1>local_laundry_service</h1>

<i class="material-icons">local_laundry_service</i>
<i class="material-icons" style="font-size:36px">local_laundry_service</i>
<i class="material-icons" style="font-size:48px;color:red">local_laundry_service</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">local_laundry_service</i></button>
