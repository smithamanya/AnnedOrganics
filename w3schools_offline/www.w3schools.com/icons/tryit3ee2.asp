...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-caret-square-o-right by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:59 GMT -->
<head>
...
<h1>fa fa-caret-square-o-right</h1>
...
<button style="font-size:24px">Button <i class="fa fa-caret-square-o-right"></i></button>
