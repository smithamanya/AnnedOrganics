...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-change_history by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:36 GMT -->
<head>
...
<h1>change_history</h1>

<i class="material-icons">change_history</i>
<i class="material-icons" style="font-size:36px">change_history</i>
<i class="material-icons" style="font-size:48px;color:red">change_history</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">change_history</i></button>
