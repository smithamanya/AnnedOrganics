...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-supervisor_account by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:43 GMT -->
<head>
...
<h1>supervisor_account</h1>

<i class="material-icons">supervisor_account</i>
<i class="material-icons" style="font-size:36px">supervisor_account</i>
<i class="material-icons" style="font-size:48px;color:red">supervisor_account</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">supervisor_account</i></button>
