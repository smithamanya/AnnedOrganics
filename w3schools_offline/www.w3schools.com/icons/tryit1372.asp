...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-laptop_windows by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:03 GMT -->
<head>
...
<h1>laptop_windows</h1>

<i class="material-icons">laptop_windows</i>
<i class="material-icons" style="font-size:36px">laptop_windows</i>
<i class="material-icons" style="font-size:48px;color:red">laptop_windows</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">laptop_windows</i></button>
