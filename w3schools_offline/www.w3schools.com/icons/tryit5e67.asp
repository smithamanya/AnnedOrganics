...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-collections_bookmark by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:06 GMT -->
<head>
...
<h1>collections_bookmark</h1>

<i class="material-icons">collections_bookmark</i>
<i class="material-icons" style="font-size:36px">collections_bookmark</i>
<i class="material-icons" style="font-size:48px;color:red">collections_bookmark</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">collections_bookmark</i></button>
