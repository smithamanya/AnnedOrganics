...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-signal_wifi_4_bar by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:57 GMT -->
<head>
...
<h1>signal_wifi_4_bar</h1>

<i class="material-icons">signal_wifi_4_bar</i>
<i class="material-icons" style="font-size:36px">signal_wifi_4_bar</i>
<i class="material-icons" style="font-size:48px;color:red">signal_wifi_4_bar</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">signal_wifi_4_bar</i></button>
