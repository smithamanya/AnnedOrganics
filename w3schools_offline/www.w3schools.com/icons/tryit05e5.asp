...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-phonelink_ring by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:52 GMT -->
<head>
...
<h1>phonelink_ring</h1>

<i class="material-icons">phonelink_ring</i>
<i class="material-icons" style="font-size:36px">phonelink_ring</i>
<i class="material-icons" style="font-size:48px;color:red">phonelink_ring</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">phonelink_ring</i></button>
