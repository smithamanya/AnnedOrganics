...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-email by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:51 GMT -->
<head>
...
<i class="material-icons" style="font-size:48px;color:red">email</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">email</i></button>
