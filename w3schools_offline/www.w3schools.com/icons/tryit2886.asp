...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-border_vertical by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:58 GMT -->
<head>
...
<h1>border_vertical</h1>

<i class="material-icons">border_vertical</i>
<i class="material-icons" style="font-size:36px">border_vertical</i>
<i class="material-icons" style="font-size:48px;color:red">border_vertical</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">border_vertical</i></button>
