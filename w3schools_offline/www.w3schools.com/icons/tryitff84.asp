...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-local_hospital by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:16 GMT -->
<head>
...
<h1>local_hospital</h1>

<i class="material-icons">local_hospital</i>
<i class="material-icons" style="font-size:36px">local_hospital</i>
<i class="material-icons" style="font-size:48px;color:red">local_hospital</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">local_hospital</i></button>
