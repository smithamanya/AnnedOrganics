...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-tap_and_play by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:21 GMT -->
<head>
...
<i class="material-icons" style="font-size:36px">tap_and_play</i>
<i class="material-icons" style="font-size:48px;color:red">tap_and_play</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">tap_and_play</i></button>
