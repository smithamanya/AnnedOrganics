...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-brightness_auto by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:56 GMT -->
<head>
...
<h1>brightness_auto</h1>

<i class="material-icons">brightness_auto</i>
<i class="material-icons" style="font-size:36px">brightness_auto</i>
<i class="material-icons" style="font-size:48px;color:red">brightness_auto</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">brightness_auto</i></button>
