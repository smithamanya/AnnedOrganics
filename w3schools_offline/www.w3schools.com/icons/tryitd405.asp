...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_fa-area-chart by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:56 GMT -->
<head>
...
<h1>fa fa-area-chart</h1>

<i class="fa fa-area-chart"></i>
<i class="fa fa-area-chart" style="font-size:24px"></i>
<i class="fa fa-area-chart" style="font-size:36px"></i>
<i class="fa fa-area-chart" style="font-size:48px;color:red"></i>
<br>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="fa fa-area-chart"></i></button>
