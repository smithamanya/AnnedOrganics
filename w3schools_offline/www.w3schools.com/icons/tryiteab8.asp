...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-remove_circle_outline by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:54 GMT -->
<head>
...
<h1>remove_circle_outline</h1>

<i class="material-icons">remove_circle_outline</i>
<i class="material-icons" style="font-size:36px">remove_circle_outline</i>
<i class="material-icons" style="font-size:48px;color:red">remove_circle_outline</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">remove_circle_outline</i></button>
