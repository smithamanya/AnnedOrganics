...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-open_in_browser by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:39 GMT -->
<head>
...
<h1>open_in_browser</h1>

<i class="material-icons">open_in_browser</i>
<i class="material-icons" style="font-size:36px">open_in_browser</i>
<i class="material-icons" style="font-size:48px;color:red">open_in_browser</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">open_in_browser</i></button>
