...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-favorite_border by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:55:37 GMT -->
<head>
...
<h1>favorite_border</h1>

<i class="material-icons">favorite_border</i>
<i class="material-icons" style="font-size:36px">favorite_border</i>
<i class="material-icons" style="font-size:48px;color:red">favorite_border</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">favorite_border</i></button>
