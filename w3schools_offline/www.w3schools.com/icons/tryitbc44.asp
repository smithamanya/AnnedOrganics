...
<!-- Mirrored from www.w3schools.com/icons/tryit.asp?filename=tryicons_google-local_pharmacy by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:16 GMT -->
<head>
...
<h1>local_pharmacy</h1>

<i class="material-icons">local_pharmacy</i>
<i class="material-icons" style="font-size:36px">local_pharmacy</i>
<i class="material-icons" style="font-size:48px;color:red">local_pharmacy</i>

<p>Used on a button:</p>
<button style="font-size:24px">Button <i class="material-icons">local_pharmacy</i></button>
