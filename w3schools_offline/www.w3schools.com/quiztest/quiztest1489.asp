...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=HTML by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:38:00 GMT -->
<head>
...
googletag.pubads().setTargeting("content","quiz");
...
<a target="_top" href="quiztest103d.html?Qtest=HTML">Quiz HTML</a>
<a target="_top" href="quiztest4d63.asp?qtest=HTML5">Quiz HTML5</a>
<a target="_top" href="quiztest64e6.asp?qtest=CSS">Quiz CSS</a>
<a target="_top" href="quiztestf2dd.asp?qtest=JavaScript">Quiz JavaScript</a>
<a target="_top" href="quizteste4be.asp?qtest=Bootstrap">Quiz Bootstrap</a>
<a target="_top" href="quiztest8471.asp?qtest=jQuery">Quiz jQuery</a>
<a target="_top" href="quiztest01bc.asp?qtest=PHP">Quiz PHP</a>
<a target="_top" href="quiztest4569.asp?qtest=SQL">Quiz SQL</a>
<a target="_top" href="quiztestd80e.asp?qtest=XML">Quiz XML</a>
<a target="_top" href="quizteste967.asp?qtest=ASP">Quiz ASP</a><br><br></div></div>&nbsp;</div>
<div class='w3-rest'>
...
<h1>W3Schools <span class="color_h1">HTML</span> Quiz</h1>

<div class="w3-container">
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. What does HTML stand for?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=HTML' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:19:50 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> Hyperlinks and Text Markup Language</label></div><div class='radio'><label><input type='radio' name='quiz' id='3' value='3' /> Hyper Text Markup Language</label></div><div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> Home Tool Markup Language</label></div>
	<br>
...
<div class="w3-container w3-padding-16">
	<div class="w3-row">
		...
		<div class="w3-col s6" style="text-align:right;">Time spent 0:00</div>
	</div>
</div>
...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=HTML by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:38:01 GMT -->
</html>
