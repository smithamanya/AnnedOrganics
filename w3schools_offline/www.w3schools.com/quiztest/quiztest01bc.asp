...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=PHP by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:21 GMT -->
<head>
...
<h1>W3Schools <span class="color_h1">PHP</span> Quiz</h1>

<div class="w3-container">
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. What does PHP stand for?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=PHP' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:49:28 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> PHP: Hypertext Preprocessor</label></div><div class='radio'><label><input type='radio' name='quiz' id='3' value='3' /> Personal Hypertext Processor</label></div><div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> Private Home Page</label></div>
	<br>
