...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=JavaScript by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:18 GMT -->
<head>
...
<h1>W3Schools <span class="color_h1">JavaScript</span> Quiz</h1>

<div class="w3-container">
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. Inside which HTML element do we put the JavaScript?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=JavaScript' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:43:51 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> &lt;scripting&gt;</label></div><div class='radio'><label><input type='radio' name='quiz' id='4' value='4' /> &lt;js&gt;</label></div><div class='radio'><label><input type='radio' name='quiz' id='3' value='3' /> &lt;javascript&gt;</label></div><div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> &lt;script&gt;</label></div>
	<br>
