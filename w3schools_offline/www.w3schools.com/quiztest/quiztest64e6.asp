...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=CSS by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:53:00 GMT -->
<head>
...
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. What does CSS stand for?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=CSS' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:55:36 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='3' value='3' /> Cascading Style Sheets</label></div><div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> Creative Style Sheets</label></div><div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> Colorful Style Sheets</label></div><div class='radio'><label><input type='radio' name='quiz' id='4' value='4' /> Computer Style Sheets</label></div>
	<br>
