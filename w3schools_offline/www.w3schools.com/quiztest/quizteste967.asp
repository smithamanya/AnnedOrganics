...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=ASP by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:52:03 GMT -->
<head>
...
<h1>W3Schools <span class="color_h1">ASP</span> Quiz</h1>

<div class="w3-container">
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. What does ASP stand for?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=ASP' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:54:40 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='4' value='4' /> Active Standard Pages</label></div><div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> Active Server Pages</label></div><div class='radio'><label><input type='radio' name='quiz' id='3' value='3' /> A Server Page</label></div><div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> All Standard Pages</label></div>
	<br>
