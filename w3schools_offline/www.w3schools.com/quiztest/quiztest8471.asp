...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=jQuery by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:31 GMT -->
<head>
...
<h1>W3Schools <span class="color_h1">jQuery</span> Quiz</h1>

<div class="w3-container">
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. Which of the following is correct?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=jQuery' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:44:25 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> jQuery is a JavaScript Library</label></div><div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> jQuery is a JSON Library</label></div>
	<br>
