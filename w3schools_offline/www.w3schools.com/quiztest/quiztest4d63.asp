...
<!-- Mirrored from www.w3schools.com/quiztest/quiztest.asp?qtest=HTML5 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:38:01 GMT -->
<head>
...
<h1>W3Schools <span class="color_h1">HTML5</span> Quiz</h1>

<div class="w3-container">
<div class="w3-padding-jumbo w3-light-grey">
	<p class="w3-large" style="margin-bottom:30px;">1. What is the previous version of HTML, prior to HTML5?</p>
	<form role="form" name="quizform" action='http://www.w3schools.com/quiztest/quiztest.asp?qtest=HTML5' method='post'>
	<input type="hidden" name="starttime" value="1/19/2016 4:19:51 AM">
	<input type="hidden" name="answers" value="0000000000000000000000000" size="25">
	<input type="hidden" name="qnumber" value="1" size="25">
	<div class='radio'><label><input type='radio' name='quiz' id='1' value='1' /> HTML 4.1</label></div><div class='radio'><label><input type='radio' name='quiz' id='4' value='4' /> HTML 4.01</label></div><div class='radio'><label><input type='radio' name='quiz' id='2' value='2' /> HTML 4</label></div><div class='radio'><label><input type='radio' name='quiz' id='3' value='3' /> HTML 4.9</label></div>
	<br>
