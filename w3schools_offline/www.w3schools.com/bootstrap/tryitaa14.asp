...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_bishop&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Bishop Glyph</h2>
      <p>Bishop icon: <span class="glyphicon glyphicon-bishop"></span></p>    
      <p>Bishop icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-bishop"></span>
        </a>
      </p>
      <p>Bishop icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-bishop"></span> Bishop 
        </button>
      </p>
      <p>Bishop icon on a styled link button:
