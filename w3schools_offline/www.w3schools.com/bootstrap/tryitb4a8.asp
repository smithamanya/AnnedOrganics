...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_check&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:09 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Check Glyph</h2>
      <p>Check icon: <span class="glyphicon glyphicon-check"></span></p>    
      <p>Check icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-check"></span>
        </a>
      </p>
      <p>Check icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-check"></span> Check
        </button>
      </p>
      <p>Check icon on a styled link button:
