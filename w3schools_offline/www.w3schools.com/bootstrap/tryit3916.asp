...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_magnet&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Magnet Glyph</h2>
      <p>Magnet icon: <span class="glyphicon glyphicon-magnet"></span></p>    
      <p>Magnet icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-magnet"></span>
        </a>
      </p>
      <p>Magnet icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-magnet"></span> Magnet
        </button>
      </p>
      <p>Magnet icon on a styled link button:
