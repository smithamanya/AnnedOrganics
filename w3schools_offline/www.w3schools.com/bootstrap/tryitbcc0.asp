...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_resize-vertical&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Resize-vertical Glyph</h2>
      <p>Resize-vertical icon: <span class="glyphicon glyphicon-resize-vertical"></span></p>    
      <p>Resize-vertical icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-resize-vertical"></span>
        </a>
      </p>
      <p>Resize-vertical icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-resize-vertical"></span> Resize
        </button>
      </p>
      <p>Resize-vertical icon on a styled link button:
