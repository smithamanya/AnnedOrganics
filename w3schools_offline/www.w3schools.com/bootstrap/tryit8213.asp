...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_eject&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:10 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Eject Glyph</h2>
      <p>Eject icon: <span class="glyphicon glyphicon-eject"></span></p>    
      <p>Eject icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-eject"></span>
        </a>
      </p>
      <p>Eject icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-eject"></span> Eject 
        </button>
      </p>
      <p>Eject icon on a styled link button:
