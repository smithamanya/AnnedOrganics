...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_bitcoin&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Bitcoin Glyph</h2>
      <p>Bitcoin icon: <span class="glyphicon glyphicon-bitcoin"></span></p>    
      <p>Bitcoin icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-bitcoin"></span>
        </a>
      </p>
      <p>Bitcoin icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-bitcoin"></span> Bitcoin 
        </button>
      </p>
      <p>Bitcoin icon on a styled link button:
