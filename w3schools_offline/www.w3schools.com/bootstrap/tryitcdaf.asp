...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_carousel_number&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:25 GMT -->
<head>
...
<div class="container">
  ...
  <p>The <strong>number</strong> method goes to a specified item in the carousel (zero-based: first item is 0, second item is 1, etc..).</p>
  <button type="button" id="myBtn" class="btn btn-success btn-lg" id="myBtn">Go to second item (1)</button>
  <button type="button" id="myBtn2" class="btn btn-danger btn-lg" id="myBtn">Go to third item (2)</button><br><br>
