...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_option-horizontal&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Option-horizontal Glyph</h2>
      <p>Option-horizontal icon: <span class="glyphicon glyphicon-option-horizontal"></span></p>    
      <p>Option-horizontal icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-option-horizontal"></span>
        </a>
      </p>
      <p>Option-horizontal icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-option-horizontal"></span> Option-horizontal
        </button>
      </p>
      <p>Option-horizontal icon on a styled link button:
