...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_circle-arrow-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Circle-arrow-up Glyph</h2>
      <p>Circle-arrow-up icon: <span class="glyphicon glyphicon-circle-arrow-up"></span></p>    
      <p>Circle-arrow-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-circle-arrow-up"></span>
        </a>
      </p>
      <p>Circle-arrow-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-circle-arrow-up"></span> Up
        </button>
      </p>
      <p>Circle-arrow-up icon on a styled link button:
