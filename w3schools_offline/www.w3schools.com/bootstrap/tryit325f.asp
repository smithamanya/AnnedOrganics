...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_tooltip_selector&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:31 GMT -->
<head>
...
<div class="container">
  ...
  <p>The <strong>selector</strong> option adds a tooltip to a specified selector.</p>
  <button class="btn btn-success btn-md">Hover over me</button>
</div>

<script>
$(document).ready(function(){
    $('body').tooltip({title: "Hooray!", selector: ".btn"}); 
});
</script>
