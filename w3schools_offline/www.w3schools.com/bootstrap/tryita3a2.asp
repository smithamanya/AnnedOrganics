...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_eye-close&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Eye-close Glyph</h2>
      <p>Eye-close icon: <span class="glyphicon glyphicon-eye-close"></span></p>    
      <p>Eye-close icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-eye-close"></span>
        </a>
      </p>
      <p>Eye-close icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-eye-close"></span> Eye-close
        </button>
      </p>
      <p>Eye-close icon on a styled link button:
