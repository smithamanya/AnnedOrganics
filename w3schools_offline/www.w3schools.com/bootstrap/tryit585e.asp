...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_remove-circle&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Remove-circle Glyph</h2>
      <p>Remove-circle icon: <span class="glyphicon glyphicon-remove-circle"></span></p>    
      <p>Remove-circle icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-remove-circle"></span>
        </a>
      </p>
      <p>Remove-circle icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-remove-circle"></span> Remove
        </button>
      </p>
      <p>Remove-circle icon on a styled link button:
