...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_duplicate&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Duplicate Glyph</h2>
      <p>Duplicate icon: <span class="glyphicon glyphicon-duplicate"></span></p>    
      <p>Duplicate icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-duplicate"></span>
        </a>
      </p>
      <p>Duplicate icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-duplicate"></span> Duplicate 
        </button>
      </p>
      <p>Duplicate icon on a styled link button:
