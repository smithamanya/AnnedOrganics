...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_list&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:08 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>List icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-list"></span>
        </a>
      </p>
      <p>List icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-list"></span> List
        </button>
      </p>
      <p>List icon on a styled link button:
