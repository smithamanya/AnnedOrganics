...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_alert&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Alert Glyph</h2>
      <p>Alert icon: <span class="glyphicon glyphicon-alert"></span></p>    
      <p>Alert icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-alert"></span>
        </a>
      </p>
      <p>Alert icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-alert"></span> Alert 
        </button>
      </p>
      <p>Alert icon on a styled link button:
