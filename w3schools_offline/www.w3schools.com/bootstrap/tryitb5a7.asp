...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_modal-window&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Modal-window Glyph</h2>
      <p>Modal-window icon: <span class="glyphicon glyphicon-modal-window"></span></p>    
      <p>Modal-window icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-modal-window"></span>
        </a>
      </p>
      <p>Modal-window icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-modal-window"></span> Modal-window
        </button>
      </p>
      <p>Modal-window icon on a styled link button:
