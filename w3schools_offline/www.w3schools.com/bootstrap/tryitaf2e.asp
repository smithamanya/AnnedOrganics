...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_save-file&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Save File Glyph</h2>
      <p>Save File icon: <span class="glyphicon glyphicon-save-file"></span></p>    
      <p>Save File icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-save-file"></span>
        </a>
      </p>
      <p>Save File icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-save-file"></span> Save File 
        </button>
      </p>
      <p>Save File icon on a styled link button:
