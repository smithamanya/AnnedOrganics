...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_italic&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:08 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Italic Glyph</h2>
      <p>Italic icon: <span class="glyphicon glyphicon-italic"></span></p>    
      <p>Italic icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-italic"></span>
        </a>
      </p>
      <p>Italic icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-italic"></span> Italic
        </button>
      </p>
      <p>Italic icon on a styled link button:
