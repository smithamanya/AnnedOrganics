...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hand-right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hand-right Glyph</h2>
      <p>Hand-right icon: <span class="glyphicon glyphicon-hand-right"></span></p>    
      <p>Hand-right icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hand-right"></span>
        </a>
      </p>
      <p>Hand-right icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hand-right"></span> Right
        </button>
      </p>
      <p>Hand-right icon on a styled link button:
