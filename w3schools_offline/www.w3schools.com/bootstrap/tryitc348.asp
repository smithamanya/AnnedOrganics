...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_open&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Open Glyph</h2>
      <p>Open icon: <span class="glyphicon glyphicon-open"></span></p>    
      <p>Open icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-open"></span>
        </a>
      </p>
      <p>Open icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-open"></span> Open
        </button>
      </p>
      <p>Open icon on a styled link button:
