...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_eye-open&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Eye-open Glyph</h2>
      <p>Eye-open icon: <span class="glyphicon glyphicon-eye-open"></span></p>    
      <p>Eye-open icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-eye-open"></span>
        </a>
      </p>
      <p>Eye-open icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-eye-open"></span> Eye-open
        </button>
      </p>
      <p>Eye-open icon on a styled link button:
