...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_grain&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Grain Glyph</h2>
      <p>Grain icon: <span class="glyphicon glyphicon-grain"></span></p>    
      <p>Grain icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-grain"></span>
        </a>
      </p>
      <p>Grain icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-grain"></span> Grain
        </button>
      </p>
      <p>Grain icon on a styled link button:
