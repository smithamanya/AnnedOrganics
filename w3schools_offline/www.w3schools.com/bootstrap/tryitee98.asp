...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_time&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:06 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>Time icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-time"></span>
        </a>
      </p>
      <p>Time icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-time"></span> Time
        </button>
      </p>
      <p>Time icon on a styled link button:
