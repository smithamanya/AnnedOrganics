...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_plus-sign&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:10 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>Plus-sign icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-plus-sign"></span>
        </a>
      </p>
      <p>Plus-sign icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-plus-sign"></span> Plus
        </button>
      </p>
      <p>Plus-sign icon on a styled link button:
