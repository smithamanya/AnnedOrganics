...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sound-stereo&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sound-stereo Glyph</h2>
      <p>Sound-stereo icon: <span class="glyphicon glyphicon-sound-stereo"></span></p>    
      <p>Sound-stereo icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sound-stereo"></span>
        </a>
      </p>
      <p>Sound-stereo icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sound-stereo"></span> Sound Stereo
        </button>
      </p>
      <p>Sound-stereo icon on a styled link button:
