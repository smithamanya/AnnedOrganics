...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_ok&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:05 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>Ok icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-ok"></span> Ok 
        </button>
      </p>
      <p>Ok icon on a styled link button:
