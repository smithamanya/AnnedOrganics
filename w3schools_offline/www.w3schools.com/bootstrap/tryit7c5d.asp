...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_bed&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Bed Glyph</h2>
      <p>Bed icon: <span class="glyphicon glyphicon-bed"></span></p>    
      <p>Bed icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-bed"></span>
        </a>
      </p>
      <p>Bed icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-bed"></span> Bed 
        </button>
      </p>
      <p>Bed icon on a styled link button:
