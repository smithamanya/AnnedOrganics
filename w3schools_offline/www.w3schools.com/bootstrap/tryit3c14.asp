...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sound-7-1&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sound-7-1 Glyph</h2>
      <p>Sound-7-1 icon: <span class="glyphicon glyphicon-sound-7-1"></span></p>    
      <p>Sound-7-1 icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sound-7-1"></span>
        </a>
      </p>
      <p>Sound-7-1 icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sound-7-1"></span> Sound 7-1
        </button>
      </p>
      <p>Sound-7-1 icon on a styled link button:
