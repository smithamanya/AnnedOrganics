...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_expand&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Expand Glyph</h2>
      <p>Expand icon: <span class="glyphicon glyphicon-expand"></span></p>    
      <p>Expand icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-expand"></span>
        </a>
      </p>
      <p>Expand icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-expand"></span> Expand 
        </button>
      </p>
      <p>Expand icon on a styled link button:
