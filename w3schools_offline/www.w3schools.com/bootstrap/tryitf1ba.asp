...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_thumbs-down&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Thumbs-down Glyph</h2>
      <p>Thumbs-down icon: <span class="glyphicon glyphicon-thumbs-down"></span></p>    
      <p>Thumbs-down icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-thumbs-down"></span>
        </a>
      </p>
      <p>Thumbs-down icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-thumbs-down"></span> Unlike
        </button>
      </p>
      <p>Thumbs-down icon on a styled link button:
