...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_blackboard&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Blackboard Glyph</h2>
      <p>Blackboard icon: <span class="glyphicon glyphicon-blackboard"></span></p>    
      <p>Blackboard icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-blackboard"></span>
        </a>
      </p>
      <p>Blackboard icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-blackboard"></span> Blackboard
        </button>
      </p>
      <p>Blackboard icon on a styled link button:
