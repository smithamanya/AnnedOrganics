...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sound-dolby&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sound-dolby Glyph</h2>
      <p>Sound-dolby icon: <span class="glyphicon glyphicon-sound-dolby"></span></p>    
      <p>Sound-dolby icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sound-dolby"></span>
        </a>
      </p>
      <p>Sound-dolby icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sound-dolby"></span> Sound Dolby
        </button>
      </p>
      <p>Sound-dolby icon on a styled link button:
