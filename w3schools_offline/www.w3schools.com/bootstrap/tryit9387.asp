...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_triangle-right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Triangle-right Glyph</h2>
      <p>Triangle-right icon: <span class="glyphicon glyphicon-triangle-right"></span></p>    
      <p>Triangle-right icon as a link:
        <a href="#">
      ...
      <p>Triangle-right icon on a styled link button:
