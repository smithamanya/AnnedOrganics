...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_warning-sign&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Warning-sign Glyph</h2>
      <p>Warning-sign icon: <span class="glyphicon glyphicon-warning-sign"></span></p>    
      <p>Warning-sign icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-warning-sign"></span>
        </a>
      </p>
      <p>Warning-sign icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-warning-sign"></span> Warning
        </button>
      </p>
      <p>Warning-sign icon on a styled link button:
