...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tag&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tag Glyph</h2>
      <p>Tag icon: <span class="glyphicon glyphicon-tag"></span></p>    
      <p>Tag icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tag"></span>
        </a>
      </p>
      <p>Tag icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tag"></span> Tag
        </button>
      </p>
      <p>Tag icon on a styled link button:
