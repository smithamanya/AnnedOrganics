...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_baby-formula&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Baby-formula Glyph</h2>
      <p>Baby-formula icon: <span class="glyphicon glyphicon-baby-formula"></span></p>    
      <p>Baby-formula icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-baby-formula"></span>
        </a>
      </p>
      <p>Baby-formula icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-baby-formula"></span> Baby-formula
        </button>
      </p>
      <p>Baby-formula icon on a styled link button:
