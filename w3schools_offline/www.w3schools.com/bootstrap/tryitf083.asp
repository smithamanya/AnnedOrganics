...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_cloud-upload&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Cloud-upload Glyph</h2>
      <p>Cloud-upload icon: <span class="glyphicon glyphicon-cloud-upload"></span></p>    
      <p>Cloud-upload icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-cloud-upload"></span>
        </a>
      </p>
      <p>Cloud-upload icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-cloud-upload"></span> Upload in Cloud 
        </button>
      </p>
      <p>Cloud-upload icon on a styled link button:
