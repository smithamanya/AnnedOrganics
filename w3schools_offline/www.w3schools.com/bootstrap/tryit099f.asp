...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_calendar&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Calendar Glyph</h2>
      <p>Calendar icon: <span class="glyphicon glyphicon-calendar"></span></p>    
      <p>Calendar icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-calendar"></span>
        </a>
      </p>
      <p>Calendar icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-calendar"></span> Calendar
        </button>
      </p>
      <p>Calendar icon on a styled link button:
