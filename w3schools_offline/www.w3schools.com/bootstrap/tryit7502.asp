...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_headphones&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Headphones Glyph</h2>
      <p>Headphones icon: <span class="glyphicon glyphicon-headphones"></span></p>    
      <p>Headphones icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-headphones"></span>
        </a>
      </p>
      <p>Headphones icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-headphones"></span> Headphones
        </button>
      </p>
      <p>Headphones icon on a styled link button:
