...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sort&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sort Glyph</h2>
      <p>Sort icon: <span class="glyphicon glyphicon-sort"></span></p>    
      <p>Sort icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sort"></span>
        </a>
      </p>
      <p>Sort icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sort"></span> Sort
        </button>
      </p>
      <p>Sort icon on a styled link button:
