...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_globe&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Globe Glyph</h2>
      <p>Globe icon: <span class="glyphicon glyphicon-globe"></span></p>    
      <p>Globe icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-globe"></span>
        </a>
      </p>
      <p>Globe icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-globe"></span> Globe 
        </button>
      </p>
      <p>Globe icon on a styled link button:
