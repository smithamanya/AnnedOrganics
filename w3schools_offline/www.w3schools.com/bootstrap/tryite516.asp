...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sort-by-alphabet&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sort-by-alphabet Glyph</h2>
      <p>Sort-by-alphabet icon: <span class="glyphicon glyphicon-sort-by-alphabet"></span></p>    
      <p>Sort-by-alphabet icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sort-by-alphabet"></span>
        </a>
      </p>
      <p>Sort-by-alphabet icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sort-by-alphabet"></span> Sort by Alphabet
        </button>
      </p>
      <p>Sort-by-alphabet icon on a styled link button:
