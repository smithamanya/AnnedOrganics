...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_hlp_text-danger&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:59 GMT -->
<head>
...
<div class="container">
  <h2>Text</h2>
  <p class="text-danger">This paragraph is styled with class "text-danger".</p>            
  <a class="text-danger" href="default.html">This link is styled with class "text-danger".</a>           
</div>
