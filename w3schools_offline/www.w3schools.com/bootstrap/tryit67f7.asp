...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_knight&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Knight Glyph</h2>
      <p>Knight icon: <span class="glyphicon glyphicon-knight"></span></p>    
      <p>Knight icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-knight"></span>
        </a>
      </p>
      <p>Knight icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-knight"></span> Knight
        </button>
      </p>
      <p>Knight icon on a styled link button:
