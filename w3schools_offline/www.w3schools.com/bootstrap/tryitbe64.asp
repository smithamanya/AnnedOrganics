...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_floppy-saved&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:17 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Floppy-saved Glyph</h2>
      <p>Floppy-saved icon: <span class="glyphicon glyphicon-floppy-saved"></span></p>    
      <p>Floppy-saved icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-floppy-saved"></span>
        </a>
      </p>
      <p>Floppy-saved icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-floppy-saved"></span> Disk Saved
        </button>
      </p>
      <p>Floppy-saved icon on a styled link button:
