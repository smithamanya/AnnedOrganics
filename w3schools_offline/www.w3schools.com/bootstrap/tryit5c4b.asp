...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_chevron-right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:10 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>Chevron-right icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-chevron-right"></span> Right
        </button>
      </p>
      <p>Chevron-right icon on a styled link button:
