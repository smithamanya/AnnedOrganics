...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_chevron-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Chevron-up Glyph</h2>
      <p>Chevron-up icon: <span class="glyphicon glyphicon-chevron-up"></span></p>    
      <p>Chevron-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-chevron-up"></span>
        </a>
      </p>
      <p>Chevron-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-chevron-up"></span> Up
        </button>
      </p>
      <p>Chevron-up icon on a styled link button:
