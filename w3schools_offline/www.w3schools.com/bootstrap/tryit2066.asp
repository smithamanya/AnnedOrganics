...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_film&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:05 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Film Glyph</h2>
      <p>Film icon: <span class="glyphicon glyphicon-film"></span></p>    
      <p>Film icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-film"></span>
        </a>
      </p>
      <p>Film icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-film"></span> Film 
        </button>
      </p>
      <p>Film icon on a styled link button:
