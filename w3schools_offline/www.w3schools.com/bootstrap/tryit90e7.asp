...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_triangle-top&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Triangle-top Glyph</h2>
      <p>Triangle-top icon: <span class="glyphicon glyphicon-triangle-top"></span></p>    
      <p>Triangle-top icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-triangle-top"></span>
        </a>
      </p>
      <p>Triangle-top icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-triangle-top"></span> Triangle-top
        </button>
      </p>
      <p>Triangle-top icon on a styled link button:
