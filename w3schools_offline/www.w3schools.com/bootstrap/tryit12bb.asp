...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_saved&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Saved Glyph</h2>
      <p>Saved icon: <span class="glyphicon glyphicon-saved"></span></p>    
      <p>Saved icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-saved"></span>
        </a>
      </p>
      <p>Saved icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-saved"></span> Saved
        </button>
      </p>
      <p>Saved icon on a styled link button:
