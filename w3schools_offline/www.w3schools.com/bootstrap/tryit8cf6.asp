...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_popover_selector&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:29 GMT -->
<head>
...
<div class="container">
  ...
  <p>The <strong>selector</strong> option adds a popover to a specified selector.</p>
  <button class="btn btn-success btn-md">Click me</button>
</div>

<script>
$(document).ready(function(){
    $('body').popover({title: "Header", content: "Blabla", selector: ".btn"}); 
});
</script>
