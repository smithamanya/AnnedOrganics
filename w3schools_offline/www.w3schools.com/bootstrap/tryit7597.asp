...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_btn_noborder&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:24 GMT -->
<head>
...
<div class="container">
  ...
  <p>Button without rounded corners:</p>
  <button type="button" class="btn btn-success">Rounded corners</button>
  <button type="button" class="btn btn-default">No rounded corners</button>
</div>
