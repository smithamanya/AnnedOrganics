...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_hlp_bg-info&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:00 GMT -->
<head>
...
<div class="container">
  <h2>Background</h2>
  <p class="bg-info">This paragraph is styled with class "bg-info".</p>
  <a class="bg-info" href="default.html">This link is styled with class "bg-info".</a>
</div>
