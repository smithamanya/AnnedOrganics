...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_subscript&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Subscript Glyph</h2>
      <p>Subscript icon: <span class="glyphicon glyphicon-subscript"></span></p>    
      <p>Subscript icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-subscript"></span>
        </a>
      </p>
      <p>Subscript icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-subscript"></span> Subscript
        </button>
      </p>
      <p>Subscript icon on a styled link button:
