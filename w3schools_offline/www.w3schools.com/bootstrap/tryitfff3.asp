...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_ok-sign&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Ok-sign Glyph</h2>
      <p>Ok-sign icon: <span class="glyphicon glyphicon-ok-sign"></span></p>    
      <p>Ok-sign icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-ok-sign"></span>
        </a>
      </p>
      <p>Ok-sign icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-ok-sign"></span> OK
        </button>
      </p>
      <p>Ok-sign icon on a styled link button:
