...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_align-justify&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:08 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Align-justify Glyph</h2>
      <p>Align-justify icon: <span class="glyphicon glyphicon-align-justify"></span></p>    
      <p>Align-justify icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-align-justify"></span>
        </a>
      </p>
      <p>Align-justify icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-align-justify"></span> Align Justify
        </button>
      </p>
      <p>Align-justify icon on a styled link button:
