...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_oil&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Oil Glyph</h2>
      <p>Oil icon: <span class="glyphicon glyphicon-oil"></span></p>    
      <p>Oil icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-oil"></span>
        </a>
      </p>
      <p>Oil icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-oil"></span> Oil
        </button>
      </p>
      <p>Oil icon on a styled link button:
