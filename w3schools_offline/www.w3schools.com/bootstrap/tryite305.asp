...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_save&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Save Glyph</h2>
      <p>Save icon: <span class="glyphicon glyphicon-save"></span></p>    
      <p>Save icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-save"></span>
        </a>
      </p>
      <p>Save icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-save"></span> Save
        </button>
      </p>
      <p>Save icon on a styled link button:
