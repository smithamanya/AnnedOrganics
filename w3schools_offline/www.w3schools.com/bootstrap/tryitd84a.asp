...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_cutlery&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:17 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Cutlery Glyph</h2>
      <p>Cutlery icon: <span class="glyphicon glyphicon-cutlery"></span></p>    
      <p>Cutlery icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-cutlery"></span>
        </a>
      </p>
      <p>Cutlery icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-cutlery"></span> Cutlery 
        </button>
      </p>
      <p>Cutlery icon on a styled link button:
