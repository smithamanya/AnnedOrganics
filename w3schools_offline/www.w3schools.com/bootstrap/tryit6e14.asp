...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_record&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Record Glyph</h2>
      <p>Record icon: <span class="glyphicon glyphicon-record"></span></p>    
      <p>Record icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-record"></span>
        </a>
      </p>
      <p>Record icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-record"></span> Record
        </button>
      </p>
      <p>Record icon on a styled link button:
