...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_step-backward&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:10 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Step-backward Glyph</h2>
      <p>Step-backward icon: <span class="glyphicon glyphicon-step-backward"></span></p>    
      <p>Step-backward icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-step-backward"></span>
        </a>
      </p>
      <p>Step-backward icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-step-backward"></span> Step Backward
        </button>
      </p>
      <p>Step-backward icon on a styled link button:
