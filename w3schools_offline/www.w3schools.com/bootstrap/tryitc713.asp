...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_file&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:06 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>File Glyph</h2>
      <p>File icon: <span class="glyphicon glyphicon-file"></span></p>    
      <p>File icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-file"></span>
        </a>
      </p>
      <p>File icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-file"></span> File 
        </button>
      </p>
      <p>File icon on a styled link button:
