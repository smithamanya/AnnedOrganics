...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_zoom-out&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:05 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Zoom-out Glyph</h2>
      <p>Zoom-out icon: <span class="glyphicon glyphicon-zoom-out"></span></p>    
      <p>Zoom-out icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-zoom-out"></span>
        </a>
      </p>
      <p>Zoom-out icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-zoom-out"></span> Zoom-out
        </button>
      </p>
      <p>Zoom-out icon on a styled link button:
