...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_floppy-save&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:17 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Floppy-save Glyph</h2>
      <p>Floppy-save icon: <span class="glyphicon glyphicon-floppy-save"></span></p>    
      <p>Floppy-save icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-floppy-save"></span>
        </a>
      </p>
      <p>Floppy-save icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-floppy-save"></span> Save Disk
        </button>
      </p>
      <p>Floppy-save icon on a styled link button:
