...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_text-width&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:08 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Text-width Glyph</h2>
      <p>Text-width icon: <span class="glyphicon glyphicon-text-width"></span></p>    
      <p>Text-width icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-text-width"></span>
        </a>
      </p>
      <p>Text-width icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-text-width"></span> Text Width
        </button>
      </p>
      <p>Text-width icon on a styled link button:
