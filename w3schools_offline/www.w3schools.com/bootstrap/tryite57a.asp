...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_inbox&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:06 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Inbox Glyph</h2>
      <p>Inbox icon: <span class="glyphicon glyphicon-inbox"></span></p>    
      <p>Inbox icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-inbox"></span>
        </a>
      </p>
      <p>Inbox icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-inbox"></span> Inbox
        </button>
      </p>
      <p>Inbox icon on a styled link button:
