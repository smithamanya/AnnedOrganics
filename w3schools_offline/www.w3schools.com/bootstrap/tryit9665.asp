...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_unchecked&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Unchecked Glyph</h2>
      <p>Unchecked icon: <span class="glyphicon glyphicon-unchecked"></span></p>    
      <p>Unchecked icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-unchecked"></span>
        </a>
      </p>
      <p>Unchecked icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-unchecked"></span> Unchecked 
        </button>
      </p>
      <p>Unchecked icon on a styled link button:
