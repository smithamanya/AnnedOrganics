...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_filter&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Filter Glyph</h2>
      <p>Filter icon: <span class="glyphicon glyphicon-filter"></span></p>    
      <p>Filter icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-filter"></span>
        </a>
      </p>
      <p>Filter icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-filter"></span> Filter 
        </button>
      </p>
      <p>Filter icon on a styled link button:
