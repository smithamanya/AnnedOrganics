...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_comment&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>Comment icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-comment"></span>
        </a>
      </p>
      <p>Comment icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-comment"></span> Comment
        </button>
      </p>
      <p>Comment icon on a styled link button:
