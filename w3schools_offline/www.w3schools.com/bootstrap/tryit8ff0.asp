...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_chevron-down&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Chevron-down Glyph</h2>
      <p>Chevron-down icon: <span class="glyphicon glyphicon-chevron-down"></span></p>    
      <p>Chevron-down icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-chevron-down"></span>
        </a>
      </p>
      <p>Chevron-down icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-chevron-down"></span> Chevron down
        </button>
      </p>
      <p>Chevron-down icon on a styled link button:
