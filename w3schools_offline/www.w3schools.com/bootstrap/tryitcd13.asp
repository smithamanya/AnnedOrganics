...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_th-large&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:05 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Th-large Glyph</h2>
      <p>Th-large icon: <span class="glyphicon glyphicon-th-large"></span></p>    
      <p>Th-large icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-th-large"></span>
        </a>
      </p>
      <p>Th-large icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-th-large"></span> Th Large
        </button>
      </p>
      <p>Th-large icon on a styled link button:
