...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_facetime-video&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:09 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Facetime-video Glyph</h2>
      <p>Facetime-video icon: <span class="glyphicon glyphicon-facetime-video"></span></p>    
      <p>Facetime-video icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-facetime-video"></span>
        </a>
      </p>
      <p>Facetime-video icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-facetime-video"></span> Facetime
        </button>
      </p>
      <p>Facetime-video icon on a styled link button:
