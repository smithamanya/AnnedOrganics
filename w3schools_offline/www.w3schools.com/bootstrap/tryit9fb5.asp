...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_new-window&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>New-window Glyph</h2>
      <p>New-window icon: <span class="glyphicon glyphicon-new-window"></span></p>    
      <p>New-window icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-new-window"></span>
        </a>
      </p>
      <p>New-window icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-new-window"></span> New Window
        </button>
      </p>
      <p>New-window icon on a styled link button:
