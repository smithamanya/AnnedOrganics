...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sort-by-order&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sort-by-order Glyph</h2>
      <p>Sort-by-order icon: <span class="glyphicon glyphicon-sort-by-order"></span></p>    
      <p>Sort-by-order icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sort-by-order"></span>
        </a>
      </p>
      <p>Sort-by-order icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sort-by-order"></span> Sort by Order
        </button>
      </p>
      <p>Sort-by-order icon on a styled link button:
