...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_queen&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Queen Glyph</h2>
      <p>Queen icon: <span class="glyphicon glyphicon-queen"></span></p>    
      <p>Queen icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-queen"></span>
        </a>
      </p>
      <p>Queen icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-queen"></span> Queen 
        </button>
      </p>
      <p>Queen icon on a styled link button:
