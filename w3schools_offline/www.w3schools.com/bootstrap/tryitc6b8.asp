...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_text-height&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:08 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Text-height Glyph</h2>
      <p>Text-height icon: <span class="glyphicon glyphicon-text-height"></span></p>    
      <p>Text-height icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-text-height"></span>
        </a>
      </p>
      <p>Text-height icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-text-height"></span> Text Height
        </button>
      </p>
      <p>Text-height icon on a styled link button:
