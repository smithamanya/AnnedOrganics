...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sunglasses&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sunglasses Glyph</h2>
      <p>Sunglasses icon: <span class="glyphicon glyphicon-sunglasses"></span></p>    
      <p>Sunglasses icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sunglasses"></span>
        </a>
      </p>
      <p>Sunglasses icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sunglasses"></span> Sunglasses
        </button>
      </p>
      <p>Sunglasses icon on a styled link button:
