...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_subtitles&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Subtitles Glyph</h2>
      <p>Subtitles icon: <span class="glyphicon glyphicon-subtitles"></span></p>    
      <p>Subtitles icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-subtitles"></span>
        </a>
      </p>
      <p>Subtitles icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-subtitles"></span> Subtitles 
        </button>
      </p>
      <p>Subtitles icon on a styled link button:
