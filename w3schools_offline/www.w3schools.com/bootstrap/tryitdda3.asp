...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_phone&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Phone Glyph</h2>
      <p>Phone icon: <span class="glyphicon glyphicon-phone"></span></p>    
      <p>Phone icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-phone"></span>
        </a>
      </p>
      <p>Phone icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-phone"></span> Phone 
        </button>
      </p>
      <p>Phone icon on a styled link button:
