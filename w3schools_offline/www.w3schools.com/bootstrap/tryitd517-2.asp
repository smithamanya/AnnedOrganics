...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_arrow-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Arrow-up Glyph</h2>
      <p>Arrow-up icon: <span class="glyphicon glyphicon-arrow-up"></span></p>    
      <p>Arrow-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-arrow-up"></span>
        </a>
      </p>
      <p>Arrow-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-arrow-up"></span> Up
        </button>
      </p>
      <p>Arrow-up icon on a styled link button:
