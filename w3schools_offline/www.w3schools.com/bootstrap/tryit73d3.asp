...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_level-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Level-up Glyph</h2>
      <p>Level-up icon: <span class="glyphicon glyphicon-level-up"></span></p>    
      <p>Level-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-level-up"></span>
        </a>
      </p>
      <p>Level-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-level-up"></span> Level-up
        </button>
      </p>
      <p>Level-up icon on a styled link button:
