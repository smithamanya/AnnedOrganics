...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_text-background&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Text-background Glyph</h2>
      <p>Text-background icon: <span class="glyphicon glyphicon-text-background"></span></p>    
      <p>Text-background icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-text-background"></span>
        </a>
      </p>
      <p>Text-background icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-text-background"></span> Text-background
        </button>
      </p>
      <p>Text-background icon on a styled link button:
