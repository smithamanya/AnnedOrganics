...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_triangle-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Triangle-left Glyph</h2>
      <p>Triangle-left icon: <span class="glyphicon glyphicon-triangle-left"></span></p>    
      <p>Triangle-left icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-triangle-left"></span>
        </a>
      </p>
      <p>Triangle-left icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-triangle-left"></span> Triangle-left
        </button>
      </p>
      <p>Triangle-left icon on a styled link button:
