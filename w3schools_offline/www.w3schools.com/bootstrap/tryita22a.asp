...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_paste&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Paste Glyph</h2>
      <p>Paste icon: <span class="glyphicon glyphicon-paste"></span></p>    
      <p>Paste icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-paste"></span>
        </a>
      </p>
      <p>Paste icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-paste"></span> Bell
        </button>
      </p>
      <p>Paste icon on a styled link button:
