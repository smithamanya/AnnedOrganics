...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_certificate&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Certificate Glyph</h2>
      <p>Certificate icon: <span class="glyphicon glyphicon-certificate"></span></p>    
      <p>Certificate icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-certificate"></span>
        </a>
      </p>
      <p>Certificate icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-certificate"></span> Certificate
        </button>
      </p>
      <p>Certificate icon on a styled link button:
