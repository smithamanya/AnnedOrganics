...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hourglass&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hourglass Glyph</h2>
      <p>Hourglass icon: <span class="glyphicon glyphicon-hourglass"></span></p>    
      <p>Hourglass icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hourglass"></span>
        </a>
      </p>
      <p>Hourglass icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hourglass"></span> Hourglass 
        </button>
      </p>
      <p>Hourglass icon on a styled link button:
