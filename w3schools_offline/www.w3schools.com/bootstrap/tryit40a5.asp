...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_lamp&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Lamp Glyph</h2>
      <p>Lamp icon: <span class="glyphicon glyphicon-lamp"></span></p>    
      <p>Lamp icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-lamp"></span>
        </a>
      </p>
      <p>Lamp icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-lamp"></span> Lamp 
        </button>
      </p>
      <p>Lamp icon on a styled link button:
