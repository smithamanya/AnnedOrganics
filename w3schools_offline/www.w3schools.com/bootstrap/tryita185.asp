...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tree-deciduous&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tree-deciduous Glyph</h2>
      <p>Tree-deciduous icon: <span class="glyphicon glyphicon-tree-deciduous"></span></p>    
      <p>Tree-deciduous icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tree-deciduous"></span>
        </a>
      </p>
      <p>Tree-deciduous icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tree-deciduous"></span> Tree 
        </button>
      </p>
      <p>Tree-deciduous icon on a styled link button:
