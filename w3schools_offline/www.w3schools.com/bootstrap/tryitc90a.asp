...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_circle-arrow-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Circle-arrow-left Glyph</h2>
      <p>Circle-arrow-left icon: <span class="glyphicon glyphicon-circle-arrow-left"></span></p>    
      <p>Circle-arrow-left icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-circle-arrow-left"></span>
        </a>
      </p>
      <p>Circle-arrow-left icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-circle-arrow-left"></span> Left
        </button>
      </p>
      <p>Circle-arrow-left icon on a styled link button:
