...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hand-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hand-left Glyph</h2>
      <p>Hand-left icon: <span class="glyphicon glyphicon-hand-left"></span></p>    
      <p>Hand-left icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hand-left"></span>
        </a>
      </p>
      <p>Hand-left icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hand-left"></span> Left
        </button>
      </p>
      <p>Hand-left icon on a styled link button:
...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hand-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
</html>
</textarea>
