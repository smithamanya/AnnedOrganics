...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_equalizer&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Equalizer Glyph</h2>
      <p>Equalizer icon: <span class="glyphicon glyphicon-equalizer"></span></p>    
      <p>Equalizer icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-equalizer"></span>
        </a>
      </p>
      <p>Equalizer icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-equalizer"></span> Equalizer
        </button>
      </p>
      <p>Equalizer icon on a styled link button:
