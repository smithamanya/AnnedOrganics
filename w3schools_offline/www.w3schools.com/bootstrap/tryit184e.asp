...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_menu-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Menu-up Glyph</h2>
      <p>Menu-up icon: <span class="glyphicon glyphicon-menu-up"></span></p>    
      <p>Menu-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-menu-up"></span>
        </a>
      </p>
      <p>Menu-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-menu-up"></span> Menu-up
        </button>
      </p>
      <p>Menu-up icon on a styled link button:
