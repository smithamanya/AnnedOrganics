...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_screenshot&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Screenshot Glyph</h2>
      <p>Screenshot icon: <span class="glyphicon glyphicon-screenshot"></span></p>    
      <p>Screenshot icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-screenshot"></span>
        </a>
      </p>
      <p>Screenshot icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-screenshot"></span> Screenshot 
        </button>
      </p>
      <p>Screenshot icon on a styled link button:
