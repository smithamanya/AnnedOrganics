...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_ruble&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Ruble Glyph</h2>
      <p>Ruble icon: <span class="glyphicon glyphicon-ruble"></span></p>    
      <p>Ruble icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-ruble"></span>
        </a>
      </p>
      <p>Ruble icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-ruble"></span> Ruble 
        </button>
      </p>
      <p>Ruble icon on a styled link button:
