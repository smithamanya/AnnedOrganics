...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_wrench&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Wrench Glyph</h2>
      <p>Wrench icon: <span class="glyphicon glyphicon-wrench"></span></p>    
      <p>Wrench icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-wrench"></span>
        </a>
      </p>
      <p>Wrench icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-wrench"></span> Wrench
        </button>
      </p>
      <p>Wrench icon on a styled link button:
