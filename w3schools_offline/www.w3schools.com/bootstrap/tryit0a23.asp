...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sort-by-attributes&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sort-by-attributes Glyph</h2>
      <p>Sort-by-attributes icon: <span class="glyphicon glyphicon-sort-by-attributes"></span></p>    
      <p>Sort-by-attributes icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sort-by-attributes"></span>
        </a>
      </p>
      <p>Sort-by-attributes icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sort-by-attributes"></span> Sort by Attributes
        </button>
      </p>
      <p>Sort-by-attributes icon on a styled link button:
