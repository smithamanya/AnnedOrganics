...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_align-right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:08 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Align-right Glyph</h2>
      <p>Align-right icon: <span class="glyphicon glyphicon-align-right"></span></p>    
      <p>Align-right icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-align-right"></span>
        </a>
      </p>
      <p>Align-right icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-align-right"></span> Align Right
        </button>
      </p>
      <p>Align-right icon on a styled link button:
