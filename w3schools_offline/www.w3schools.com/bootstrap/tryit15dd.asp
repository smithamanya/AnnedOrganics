...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_resize-horizontal&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Resize-horizontal Glyph</h2>
      <p>Resize-horizontal icon: <span class="glyphicon glyphicon-resize-horizontal"></span></p>    
      <p>Resize-horizontal icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-resize-horizontal"></span>
        </a>
      </p>
      <p>Resize-horizontal icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-resize-horizontal"></span> Resize
        </button>
      </p>
      <p>Resize-horizontal icon on a styled link button:
