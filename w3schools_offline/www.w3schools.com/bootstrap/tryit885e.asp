...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_heart-empty&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Heart-empty Glyph</h2>
      <p>Heart-empty icon: <span class="glyphicon glyphicon-heart-empty"></span></p>    
      <p>Heart-empty icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-heart-empty"></span>
        </a>
      </p>
      <p>Heart-empty icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-heart-empty"></span> Heart
        </button>
      </p>
      <p>Heart-empty icon on a styled link button:
