...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_apple&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Apple Glyph</h2>
      <p>Apple icon: <span class="glyphicon glyphicon-apple"></span></p>    
      <p>Apple icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-apple"></span>
        </a>
      </p>
      <p>Apple icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-apple"></span> Apple 
        </button>
      </p>
      <p>Apple icon on a styled link button:
