...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_scale&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Scale Glyph</h2>
      <p>Scale icon: <span class="glyphicon glyphicon-scale"></span></p>    
      <p>Scale icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-scale"></span>
        </a>
      </p>
      <p>Scale icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-scale"></span> Scale 
        </button>
      </p>
      <p>Scale icon on a styled link button:
