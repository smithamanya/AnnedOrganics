...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hd-video&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hd-video Glyph</h2>
      <p>Hd-video icon: <span class="glyphicon glyphicon-hd-video"></span></p>    
      <p>Hd-video icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hd-video"></span>
        </a>
      </p>
      <p>Hd-video icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hd-video"></span> Video
        </button>
      </p>
      <p>Hd-video icon on a styled link button:
