...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_volume-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Volume-up Glyph</h2>
      <p>Volume-up icon: <span class="glyphicon glyphicon-volume-up"></span></p>    
      <p>Volume-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-volume-up"></span>
        </a>
      </p>
      <p>Volume-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-volume-up"></span> Volume Up
        </button>
      </p>
      <p>Volume-up icon on a styled link button:
