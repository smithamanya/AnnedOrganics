...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_fullscreen&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Fullscreen Glyph</h2>
      <p>Fullscreen icon: <span class="glyphicon glyphicon-fullscreen"></span></p>    
      <p>Fullscreen icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-fullscreen"></span>
        </a>
      </p>
      <p>Fullscreen icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-fullscreen"></span> Fullscreen 
        </button>
      </p>
      <p>Fullscreen icon on a styled link button:
