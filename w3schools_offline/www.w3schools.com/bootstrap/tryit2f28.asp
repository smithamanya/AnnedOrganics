...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_gbp&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>GBP icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-gbp"></span>
        </a>
      </p>
      <p>GBP icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-gbp"></span> GBP 
        </button>
      </p>
      <p>GBP icon on a styled link button:
