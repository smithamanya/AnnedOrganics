...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_flash&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Flash Glyph</h2>
      <p>Flash icon: <span class="glyphicon glyphicon-flash"></span></p>    
      <p>Flash icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-flash"></span>
        </a>
      </p>
      <p>Flash icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-flash"></span> Flash
        </button>
      </p>
      <p>Flash icon on a styled link button:
