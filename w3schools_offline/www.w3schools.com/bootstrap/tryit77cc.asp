...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_open-file&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Open File Glyph</h2>
      <p>Open File icon: <span class="glyphicon glyphicon-open-file"></span></p>    
      <p>Open File icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-open-file"></span>
        </a>
      </p>
      <p>Open File icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-open-file"></span> Open File 
        </button>
      </p>
      <p>Open File icon on a styled link button:
