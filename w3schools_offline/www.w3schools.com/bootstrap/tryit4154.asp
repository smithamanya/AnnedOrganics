...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_education&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Education Glyph</h2>
      <p>Education icon: <span class="glyphicon glyphicon-education"></span></p>    
      <p>Education icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-education"></span>
        </a>
      </p>
      <p>Education icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-education"></span> Education 
        </button>
      </p>
      <p>Education icon on a styled link button:
