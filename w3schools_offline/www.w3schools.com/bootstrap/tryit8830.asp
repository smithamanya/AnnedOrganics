...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_carousel_event_slide&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:25 GMT -->
<head>
...
<div class="container">
  <h2>Carousel Events - slide.bs.carousel</h2>
  <p>The <strong>slide.bs.modal</strong> event occurs when the carousel is about to slide from one item to another.</p>
