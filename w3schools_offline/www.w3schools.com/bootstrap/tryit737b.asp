...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tower&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tower Glyph</h2>
      <p>Tower icon: <span class="glyphicon glyphicon-tower"></span></p>    
      <p>Tower icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tower"></span>
        </a>
      </p>
      <p>Tower icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tower"></span> Tower 
        </button>
      </p>
      <p>Tower icon on a styled link button:
