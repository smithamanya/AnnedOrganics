...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_ice-lolly-tasted&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Ice-lolly-tasted Glyph</h2>
      <p>Ice-lolly-tasted icon: <span class="glyphicon glyphicon-ice-lolly-tasted"></span></p>    
      <p>Ice-lolly-tasted icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-ice-lolly-tasted"></span>
        </a>
      </p>
      <p>Ice-lolly-tasted icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-ice-lolly-tasted"></span> Ice-lolly-tasted
        </button>
      </p>
      <p>Ice-lolly-tasted icon on a styled link button:
