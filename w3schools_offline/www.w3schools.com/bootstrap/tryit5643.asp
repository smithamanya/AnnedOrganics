...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_popover_title_content&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:28 GMT -->
<head>
...
<div class="container">
  ...
  <p>The <strong>title</strong> option specifies the header text of the popover.</p>
  <p>The <strong>content</strong> option specifies the text that should be displayed inside the popover's body.</p>
  <button class="btn btn-success btn-md">Click me</button>
</div>

<script>
$(document).ready(function(){
    $('.btn').popover({title: "Header", content: "Text in popover body",}); 
});
</script>
