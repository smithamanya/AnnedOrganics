...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_floppy-remove&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:17 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Floppy-remove Glyph</h2>
      <p>Floppy-remove icon: <span class="glyphicon glyphicon-floppy-remove"></span></p>    
      <p>Floppy-remove icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-floppy-remove"></span>
        </a>
      </p>
      <p>Floppy-remove icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-floppy-remove"></span> Remove Disk
        </button>
      </p>
      <p>Floppy-remove icon on a styled link button:
