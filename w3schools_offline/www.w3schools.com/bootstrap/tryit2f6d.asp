...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_triangle-bottom&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Triangle-bottom Glyph</h2>
      <p>Triangle-bottom icon: <span class="glyphicon glyphicon-triangle-bottom"></span></p>    
      <p>Triangle-bottom icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-triangle-bottom"></span>
        </a>
      </p>
      <p>Triangle-bottom icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-triangle-bottom"></span> Triangle-bottom
        </button>
      </p>
      <p>Triangle-bottom icon on a styled link button:
