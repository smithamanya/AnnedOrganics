...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tasks&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tasks Glyph</h2>
      <p>Tasks icon: <span class="glyphicon glyphicon-tasks"></span></p>    
      <p>Tasks icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tasks"></span>
        </a>
      </p>
      <p>Tasks icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tasks"></span> Tasks 
        </button>
      </p>
      <p>Tasks icon on a styled link button:
