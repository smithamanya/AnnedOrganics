...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_piggy-bank&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Piggy-bank Glyph</h2>
      <p>Piggy-bank icon: <span class="glyphicon glyphicon-piggy-bank"></span></p>    
      <p>Piggy-bank icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-piggy-bank"></span>
        </a>
      </p>
      <p>Piggy-bank icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-piggy-bank"></span> Piggy-bank 
        </button>
      </p>
      <p>Piggy-bank icon on a styled link button:
