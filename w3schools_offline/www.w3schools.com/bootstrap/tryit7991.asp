...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_pushpin&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Pushpin Glyph</h2>
      <p>Pushpin icon: <span class="glyphicon glyphicon-pushpin"></span></p>    
      <p>Pushpin icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-pushpin"></span>
        </a>
      </p>
      <p>Pushpin icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-pushpin"></span> Pushpin
        </button>
      </p>
      <p>Pushpin icon on a styled link button:
