...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_random&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Random Glyph</h2>
      <p>Random icon: <span class="glyphicon glyphicon-random"></span></p>    
      <p>Random icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-random"></span>
        </a>
      </p>
      <p>Random icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-random"></span> Random 
        </button>
      </p>
      <p>Random icon on a styled link button:
