...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_play&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:10 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Play Glyph</h2>
      <p>Play icon: <span class="glyphicon glyphicon-play"></span></p>    
      <p>Play icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-play"></span>
        </a>
      </p>
      <p>Play icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-play"></span> Play
        </button>
      </p>
      <p>Play icon on a styled link button:
