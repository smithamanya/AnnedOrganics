...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_bell&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Bell Glyph</h2>
      <p>Bell icon: <span class="glyphicon glyphicon-bell"></span></p>    
      <p>Bell icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-bell"></span>
        </a>
      </p>
      <p>Bell icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-bell"></span> Bell
        </button>
      </p>
      <p>Bell icon on a styled link button:
