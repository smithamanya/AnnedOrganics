...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tags&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tags Glyph</h2>
      <p>Tags icon: <span class="glyphicon glyphicon-tags"></span></p>    
      <p>Tags icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tags"></span>
        </a>
      </p>
      <p>Tags icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tags"></span> Tags
        </button>
      </p>
      <p>Tags icon on a styled link button:
