...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_yen&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Yen Glyph</h2>
      <p>Yen icon: <span class="glyphicon glyphicon-yen"></span></p>    
      <p>Yen icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-yen"></span>
        </a>
      </p>
      <p>Yen icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-yen"></span> Yen 
        </button>
      </p>
      <p>Yen icon on a styled link button:
