...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_registration-mark&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Registration-mark Glyph</h2>
      <p>Registration-mark icon: <span class="glyphicon glyphicon-registration-mark"></span></p>    
      <p>Registration-mark icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-registration-mark"></span>
        </a>
      </p>
      <p>Registration-mark icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-registration-mark"></span> Registration Mark
        </button>
      </p>
      <p>Registration-mark icon on a styled link button:
