...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_ice-lolly&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Ice-lolly Glyph</h2>
      <p>Ice-lolly icon: <span class="glyphicon glyphicon-ice-lolly"></span></p>    
      <p>Ice-lolly icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-ice-lolly"></span>
        </a>
      </p>
      <p>Ice-lolly icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-ice-lolly"></span> Ice-lolly
        </button>
      </p>
      <p>Ice-lolly icon on a styled link button:
