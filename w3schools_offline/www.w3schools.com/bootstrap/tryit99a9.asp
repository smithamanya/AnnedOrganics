...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_log-in&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Log-in Glyph</h2>
      <p>Log-in icon: <span class="glyphicon glyphicon-log-in"></span></p>    
      <p>Log-in icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-log-in"></span>
        </a>
      </p>
      <p>Log-in icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-log-in"></span> Log in
        </button>
      </p>
      <p>Log-in icon on a styled link button:
