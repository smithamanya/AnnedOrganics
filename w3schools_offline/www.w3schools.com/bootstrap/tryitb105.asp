...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_folder-close&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Folder-close Glyph</h2>
      <p>Folder-close icon: <span class="glyphicon glyphicon-folder-close"></span></p>    
      <p>Folder-close icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-folder-close"></span>
        </a>
      </p>
      <p>Folder-close icon on a button:
