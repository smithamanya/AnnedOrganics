...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_dashboard&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Dashboard Glyph</h2>
      <p>Dashboard icon: <span class="glyphicon glyphicon-dashboard"></span></p>    
      <p>Dashboard icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-dashboard"></span>
        </a>
      </p>
      <p>Dashboard icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-dashboard"></span> Dashboard
        </button>
      </p>
      <p>Dashboard icon on a styled link button:
