...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_export&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:16 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Export Glyph</h2>
      <p>Export icon: <span class="glyphicon glyphicon-export"></span></p>    
      <p>Export icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-export"></span>
        </a>
      </p>
      <p>Export icon on a button:
