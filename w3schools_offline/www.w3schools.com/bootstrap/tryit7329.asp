...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_ban-circle&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Ban-circle Glyph</h2>
      <p>Ban-circle icon: <span class="glyphicon glyphicon-ban-circle"></span></p>    
      <p>Ban-circle icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-ban-circle"></span>
        </a>
      </p>
      <p>Ban-circle icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-ban-circle"></span> Ban
        </button>
      </p>
      <p>Ban-circle icon on a styled link button:
