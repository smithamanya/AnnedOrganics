...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_circle-arrow-right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Circle-arrow-right Glyph</h2>
      <p>Circle-arrow-right icon: <span class="glyphicon glyphicon-circle-arrow-right"></span></p>    
      <p>Circle-arrow-right icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-circle-arrow-right"></span>
        </a>
      </p>
      <p>Circle-arrow-right icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-circle-arrow-right"></span> Right
        </button>
      </p>
      <p>Circle-arrow-right icon on a styled link button:
