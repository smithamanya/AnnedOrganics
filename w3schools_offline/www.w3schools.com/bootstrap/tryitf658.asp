...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tint&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:09 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tint Glyph</h2>
      <p>Tint icon: <span class="glyphicon glyphicon-tint"></span></p>    
      <p>Tint icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tint"></span>
        </a>
      </p>
      <p>Tint icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tint"></span> Tint
        </button>
      </p>
      <p>Tint icon on a styled link button:
