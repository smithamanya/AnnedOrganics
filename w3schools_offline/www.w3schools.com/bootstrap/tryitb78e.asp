...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_th&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:05 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Th Glyph</h2>
      <p>Th icon: <span class="glyphicon glyphicon-th"></span></p>    
      <p>Th icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-th"></span>
        </a>
      </p>
      <p>Th icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-th"></span> Th 
        </button>
      </p>
      <p>Th icon on a styled link button:
