...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_text-color&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Text-color Glyph</h2>
      <p>Text-color icon: <span class="glyphicon glyphicon-text-color"></span></p>    
      <p>Text-color icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-text-color"></span>
        </a>
      </p>
      <p>Text-color icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-text-color"></span> Text-color
        </button>
      </p>
      <p>Text-color icon on a styled link button:
