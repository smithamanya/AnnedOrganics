...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_cd&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>CD Glyph</h2>
      <p>CD icon: <span class="glyphicon glyphicon-cd"></span></p>    
      <p>CD icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-cd"></span>
        </a>
      </p>
      <p>CD icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-cd"></span> CD
        </button>
      </p>
      <p>CD icon on a styled link button:
