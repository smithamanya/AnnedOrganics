...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_copy&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Copy Glyph</h2>
      <p>Copy icon: <span class="glyphicon glyphicon-copy"></span></p>    
      <p>Copy icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-copy"></span>
        </a>
      </p>
      <p>Copy icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-copy"></span> Copy 
        </button>
      </p>
      <p>Copy icon on a styled link button:
