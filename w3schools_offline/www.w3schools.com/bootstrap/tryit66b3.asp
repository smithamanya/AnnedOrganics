...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_book&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Book Glyph</h2>
      <p>Book icon: <span class="glyphicon glyphicon-book"></span></p>    
      <p>Book icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-book"></span>
        </a>
      </p>
      <p>Book icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-book"></span> Book
        </button>
      </p>
      <p>Book icon on a styled link button:
