...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_transfer&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:17 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Transfer Glyph</h2>
      <p>Transfer icon: <span class="glyphicon glyphicon-transfer"></span></p>    
      <p>Transfer icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-transfer"></span>
        </a>
      </p>
      <p>Transfer icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-transfer"></span> Transfer 
        </button>
      </p>
      <p>Transfer icon on a styled link button:
