...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hand-down&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hand-down Glyph</h2>
      <p>Hand-down icon: <span class="glyphicon glyphicon-hand-down"></span></p>    
      <p>Hand-down icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hand-down"></span>
        </a>
      </p>
      <p>Hand-down icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hand-down"></span> Down
        </button>
      </p>
      <p>Hand-down icon on a styled link button:
