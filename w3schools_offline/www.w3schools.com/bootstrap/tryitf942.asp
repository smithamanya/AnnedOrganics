...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_tent&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Tent Glyph</h2>
      <p>Tent icon: <span class="glyphicon glyphicon-tent"></span></p>    
      <p>Tent icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-tent"></span>
        </a>
      </p>
      <p>Tent icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-tent"></span> Tent 
        </button>
      </p>
      <p>Tent icon on a styled link button:
