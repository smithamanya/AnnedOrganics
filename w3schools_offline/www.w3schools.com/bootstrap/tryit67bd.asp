...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_tooltip_delay&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:31 GMT -->
<head>
...
<div class="container">
  ...
  <p>The <strong>delay</strong> option specifies the number of milliseconds it will take to show and hide the popover.</p>
  <p>This tooltip will take 1000 milliseconds to show when you hover over it, and 1000 milliseconds to hide on mouse leave.</p>
  <button class="btn btn-success btn-md">Hover over me (1000ms)</button><br><br>
  <p>This tooltip will take 500 milliseconds to show when you hover over it, and 100 ms to hide on mouse leave.</p>
  <button class="btn btn-danger btn-md">Hover over me (500ms)</button>
</div>
