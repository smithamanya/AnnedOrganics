...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_fire&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Fire Glyph</h2>
      <p>Fire icon: <span class="glyphicon glyphicon-fire"></span></p>    
      <p>Fire icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-fire"></span>
        </a>
      </p>
      <p>Fire icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-fire"></span> Fire
        </button>
      </p>
      <p>Fire icon on a styled link button:
