...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_bookmark&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Bookmark Glyph</h2>
      <p>Bookmark icon: <span class="glyphicon glyphicon-bookmark"></span></p>    
      <p>Bookmark icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-bookmark"></span>
        </a>
      </p>
      <p>Bookmark icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-bookmark"></span> Bookmark
        </button>
      </p>
      <p>Bookmark icon on a styled link button:
