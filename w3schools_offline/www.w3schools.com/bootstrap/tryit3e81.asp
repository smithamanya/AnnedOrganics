...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_share-alt&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Share-alt Glyph</h2>
      <p>Share-alt icon: <span class="glyphicon glyphicon-share-alt"></span></p>    
      <p>Share-alt icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-share-alt"></span>
        </a>
      </p>
      <p>Share-alt icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-share-alt"></span> Share
        </button>
      </p>
      <p>Share-alt icon on a styled link button:
...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_share-alt&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
</html>
</textarea>
