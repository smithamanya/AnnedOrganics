...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_volume-down&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Volume-down Glyph</h2>
      <p>Volume-down icon: <span class="glyphicon glyphicon-volume-down"></span></p>    
      <p>Volume-down icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-volume-down"></span>
        </a>
      </p>
      <p>Volume-down icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-volume-down"></span> Volume Down
        </button>
      </p>
      <p>Volume-down icon on a styled link button:
