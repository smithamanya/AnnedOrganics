...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_minus-sign&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:11 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Minus-sign Glyph</h2>
      <p>Minus-sign icon: <span class="glyphicon glyphicon-minus-sign"></span></p>    
      <p>Minus-sign icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-minus-sign"></span>
        </a>
      </p>
      <p>Minus-sign icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-minus-sign"></span> Minus
        </button>
      </p>
      <p>Minus-sign icon on a styled link button:
