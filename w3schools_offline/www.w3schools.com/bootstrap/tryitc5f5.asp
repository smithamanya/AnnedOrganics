...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_send&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:17 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Send Glyph</h2>
      <p>Send icon: <span class="glyphicon glyphicon-send"></span></p>    
      <p>Send icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-send"></span>
        </a>
      </p>
      <p>Send icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-send"></span> Send 
        </button>
      </p>
      <p>Send icon on a styled link button:
