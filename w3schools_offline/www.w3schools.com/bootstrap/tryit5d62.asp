...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hand-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hand-up Glyph</h2>
      <p>Hand-up icon: <span class="glyphicon glyphicon-hand-up"></span></p>    
      <p>Hand-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hand-up"></span>
        </a>
      </p>
      <p>Hand-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hand-up"></span> Up
        </button>
      </p>
      <p>Hand-up icon on a styled link button:
