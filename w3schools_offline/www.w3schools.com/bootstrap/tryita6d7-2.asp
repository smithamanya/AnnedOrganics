...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_modal_keyboard_data&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:27 GMT -->
<head>
...
<div class="container">
  <h2>Modal Options</h2>
  <p>The data-keyboard attribute specifies whether the modal can be closed with the escape key.</p>
  <p><strong>Note:</strong> Press the Tab key on your keyboard to enter the modal window and then press the Esc key.</p>
  <!-- Trigger the modal with a button -->
  <button type="button" class="btn btn-success btn-md" id="myBtn" data-toggle="modal" data-target="#myModal" data-keyboard="true">Modal (data-keyboard="true")</button>
  <button type="button" class="btn btn-danger btn-md" id="myBtn2" data-toggle="modal" data-target="#myModal2" data-keyboard="false">Modal (data-keyboard="false")</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>This modal can be closed with the escape key on your keyboard.</p>
          <p><strong>Note:</strong> You need to press the tab key on the keyboard to first enter the modal window, and then press the Esc key.</p>
        </div>
  ...
  <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>This modal cannot be closed with the escape key on your keyboard.</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
