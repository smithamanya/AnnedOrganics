...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_affix_event_affixedtop&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:23 GMT -->
<head>
...
<div class="container-fluid" style="background-color:#2196F3;color:#fff;height:200px;">
  <h1>Bootstrap affixed-top.bs.affix</h1>
  <p>Scroll this page downwards and then scroll to the top.</p>
  <p><strong>The affixed-top.bs.affix event occurs when the .affix class has been replaced with the .affix-top class.</strong></p>
</div>
<br>
