...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_volume-off&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Volume-off Glyph</h2>
      <p>Volume-off icon: <span class="glyphicon glyphicon-volume-off"></span></p>    
      <p>Volume-off icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-volume-off"></span>
        </a>
      </p>
      <p>Volume-off icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-volume-off"></span> Volume Off
        </button>
      </p>
      <p>Volume-off icon on a styled link button:
