...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_pawn&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:19 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Pawn Glyph</h2>
      <p>Pawn icon: <span class="glyphicon glyphicon-pawn"></span></p>    
      <p>Pawn icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-pawn"></span>
        </a>
      </p>
      <p>Pawn icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-pawn"></span> Pawn 
        </button>
      </p>
      <p>Pawn icon on a styled link button:
