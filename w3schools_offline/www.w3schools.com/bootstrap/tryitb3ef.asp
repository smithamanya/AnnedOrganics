...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_hlp_text-muted&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:59 GMT -->
<head>
...
<div class="container">
  <h2>Text</h2>
  <p class="text-muted">This paragraph is styled with class "text-muted".</p>            
  <a class="text-muted" href="default.html">This link is styled with class "text-muted".</a>           
</div>
