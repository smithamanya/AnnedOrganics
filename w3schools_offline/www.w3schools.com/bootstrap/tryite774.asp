...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_link&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:14 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Link Glyph</h2>
      <p>Link icon: <span class="glyphicon glyphicon-link"></span></p>    
      <p>Link icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-link"></span>
        </a>
      </p>
      <p>Link icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-link"></span> Link 
        </button>
      </p>
      <p>Link icon on a styled link button:
