...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_hlp_bg-warning&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:00 GMT -->
<head>
...
<div class="container">
  <h2>Background</h2>
  <p class="bg-warning">This paragraph is styled with class "bg-warning".</p>
  <a class="bg-warning" href="default.html">This link is styled with class "bg-warning".</a>
</div>
