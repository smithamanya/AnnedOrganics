...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_thumbs-up&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Thumbs-up Glyph</h2>
      <p>Thumbs-up icon: <span class="glyphicon glyphicon-thumbs-up"></span></p>    
      <p>Thumbs-up icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-thumbs-up"></span>
        </a>
      </p>
      <p>Thumbs-up icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-thumbs-up"></span> Like
        </button>
      </p>
      <p>Thumbs-up icon on a styled link button:
