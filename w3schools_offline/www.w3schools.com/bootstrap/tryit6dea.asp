...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_adjust&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:09 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Adjust Glyph</h2>
      <p>Adjust icon: <span class="glyphicon glyphicon-adjust"></span></p>    
      <p>Adjust icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-adjust"></span>
        </a>
      </p>
      <p>Adjust icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-adjust"></span> Adjust
        </button>
      </p>
      <p>Adjust icon on a styled link button:
