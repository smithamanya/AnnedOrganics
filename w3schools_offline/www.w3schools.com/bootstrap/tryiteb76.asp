...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_camera&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Camera Glyph</h2>
      <p>Camera icon: <span class="glyphicon glyphicon-camera"></span></p>    
      <p>Camera icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-camera"></span>
        </a>
      </p>
      <p>Camera icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-camera"></span> Camera
        </button>
      </p>
      <p>Camera icon on a styled link button:
