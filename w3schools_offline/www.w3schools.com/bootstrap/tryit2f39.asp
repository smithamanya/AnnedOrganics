...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_scissors&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Scissors Glyph</h2>
      <p>Scissors icon: <span class="glyphicon glyphicon-scissors"></span></p>    
      <p>Scissors icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-scissors"></span>
        </a>
      </p>
      <p>Scissors icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-scissors"></span> Scissors 
        </button>
      </p>
      <p>Scissors icon on a styled link button:
