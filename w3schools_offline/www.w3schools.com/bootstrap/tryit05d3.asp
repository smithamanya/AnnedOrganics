...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_leaf&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Leaf Glyph</h2>
      <p>Leaf icon: <span class="glyphicon glyphicon-leaf"></span></p>    
      <p>Leaf icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-leaf"></span>
        </a>
      </p>
      <p>Leaf icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-leaf"></span> Leaf
        </button>
      </p>
      <p>Leaf icon on a styled link button:
