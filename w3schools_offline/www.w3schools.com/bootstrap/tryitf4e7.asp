...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_comp_jumbotron2&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:04 GMT -->
<head>
...
<div class="jumbotron">
  <div class="container">
    <h1>Hello World!</h1>
    <p>Look over here!</p>
    <p>To let the .jumbotron box span the full width, and without rounded corners, place it outside the .container class:</p>                  
  </div>
</div>
