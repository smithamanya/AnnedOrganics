...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_js_popover_trigger&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:29 GMT -->
<head>
...
<div class="container">
  ...
  <p>The trigger option specifies how the popover is triggered.</p>
  <div>
...
$(document).ready(function(){
    ...
    $('.btn-warning').popover({title: "Header", content: "Blabla", trigger: "hover"}); 
    $('.btn-danger').popover({title: "Header", content: "Blabla", trigger: "focus"}); 
});
</script>
