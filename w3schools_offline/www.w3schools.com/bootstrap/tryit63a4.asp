...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_menu-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Menu-left Glyph</h2>
      <p>Menu-left icon: <span class="glyphicon glyphicon-menu-left"></span></p>    
      <p>Menu-left icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-menu-left"></span>
        </a>
      </p>
      <p>Menu-left icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-menu-left"></span> Menu-left
        </button>
      </p>
      <p>Menu-left icon on a styled link button:
