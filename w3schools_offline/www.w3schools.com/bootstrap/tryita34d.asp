...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_bullhorn&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Bullhorn Glyph</h2>
      <p>Bullhorn icon: <span class="glyphicon glyphicon-bullhorn"></span></p>    
      <p>Bullhorn icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-bullhorn"></span>
        </a>
      </p>
      <p>Bullhorn icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-bullhorn"></span> Bullhorn
        </button>
      </p>
      <p>Bullhorn icon on a styled link button:
