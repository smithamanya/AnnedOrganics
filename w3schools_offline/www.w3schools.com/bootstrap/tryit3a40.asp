...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_flag&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Flag Glyph</h2>
      <p>Flag icon: <span class="glyphicon glyphicon-flag"></span></p>    
      <p>Flag icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-flag"></span>
        </a>
      </p>
      <p>Flag icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-flag"></span> Flag
        </button>
      </p>
      <p>Flag icon on a styled link button:
