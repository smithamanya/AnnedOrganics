...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_signal&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:05 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Signal Glyph</h2>
      <p>Signal icon: <span class="glyphicon glyphicon-signal"></span></p>    
      <p>Signal icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-signal"></span>
        </a>
      </p>
      <p>Signal icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-signal"></span> Signal 
        </button>
      </p>
      <p>Signal icon on a styled link button:
