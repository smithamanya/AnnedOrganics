...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_superscript&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:22 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Superscript Glyph</h2>
      <p>Superscript icon: <span class="glyphicon glyphicon-superscript"></span></p>    
      <p>Superscript icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-superscript"></span>
        </a>
      </p>
      <p>Superscript icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-superscript"></span> Superscript 
        </button>
      </p>
      <p>Superscript icon on a styled link button:
