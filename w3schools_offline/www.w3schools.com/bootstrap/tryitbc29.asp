...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_download-alt&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:06 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Download-alt Glyph</h2>
      <p>Download-alt icon: <span class="glyphicon glyphicon-download-alt"></span></p>    
      <p>Download-alt icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-download-alt"></span>
        </a>
      </p>
      <p>Download-alt icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-download-alt"></span> Download
        </button>
      </p>
      <p>Download-alt icon on a styled link button:
