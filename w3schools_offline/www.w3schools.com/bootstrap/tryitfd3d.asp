...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_sort-by-order-alt&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:15 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Sort-by-order-alt Glyph</h2>
      <p>Sort-by-order-alt icon: <span class="glyphicon glyphicon-sort-by-order-alt"></span></p>    
      <p>Sort-by-order-alt icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-sort-by-order-alt"></span>
        </a>
      </p>
      <p>Sort-by-order-alt icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-sort-by-order-alt"></span> Sort by Order
        </button>
      </p>
      <p>Sort-by-order-alt icon on a styled link button:
