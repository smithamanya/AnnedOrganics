...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_hlp_text-info&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:59 GMT -->
<head>
...
<div class="container">
  <h2>Text</h2>
  <p class="text-info">This paragraph is styled with class "text-info".</p>            
  <a class="text-info" href="default.html">This link is styled with class "text-info".</a>           
</div>
