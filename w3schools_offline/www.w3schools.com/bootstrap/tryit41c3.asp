...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_repeat&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:07 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Repeat Glyph</h2>
      <p>Repeat icon: <span class="glyphicon glyphicon-repeat"></span></p>    
      <p>Repeat icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-repeat"></span>
        </a>
      </p>
      <p>Repeat icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-repeat"></span> Repeat
        </button>
      </p>
      <p>Repeat icon on a styled link button:
