...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_text-size&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Text-size Glyph</h2>
      <p>Text-size icon: <span class="glyphicon glyphicon-text-size"></span></p>    
      <p>Text-size icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-text-size"></span>
        </a>
      </p>
      <p>Text-size icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-text-size"></span> Text-size
        </button>
      </p>
      <p>Text-size icon on a styled link button:
