...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_phone-alt&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:18 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Phone-alt Glyph</h2>
      <p>Phone-alt icon: <span class="glyphicon glyphicon-phone-alt"></span></p>    
      <p>Phone-alt icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-phone-alt"></span>
        </a>
      </p>
      <p>Phone-alt icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-phone-alt"></span> Phone
        </button>
      </p>
      <p>Phone-alt icon on a styled link button:
