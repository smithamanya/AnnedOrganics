...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_option-vertical&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:21 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Option-vertical Glyph</h2>
      <p>Option-vertical icon: <span class="glyphicon glyphicon-option-vertical"></span></p>    
      <p>Option-vertical icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-option-vertical"></span>
        </a>
      </p>
      <p>Option-vertical icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-option-vertical"></span> Option-vertical
        </button>
      </p>
      <p>Option-vertical icon on a styled link button:
