...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_erase&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:20 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Erase Glyph</h2>
      <p>Erase icon: <span class="glyphicon glyphicon-erase"></span></p>    
      <p>Erase icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-erase"></span>
        </a>
      </p>
      <p>Erase icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-erase"></span> Erase 
        </button>
      </p>
      <p>Erase icon on a styled link button:
