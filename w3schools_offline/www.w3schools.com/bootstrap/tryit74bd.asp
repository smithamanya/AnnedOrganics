...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_hdd&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:13 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Hdd Glyph</h2>
      <p>Hdd icon: <span class="glyphicon glyphicon-hdd"></span></p>    
      <p>Hdd icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-hdd"></span>
        </a>
      </p>
      <p>Hdd icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-hdd"></span> HDD
        </button>
      </p>
      <p>Hdd icon on a styled link button:
