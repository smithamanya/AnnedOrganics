...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_resize-full&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Resize-full Glyph</h2>
      <p>Resize-full icon: <span class="glyphicon glyphicon-resize-full"></span></p>    
      <p>Resize-full icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-resize-full"></span>
        </a>
      </p>
      <p>Resize-full icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-resize-full"></span> Resize
        </button>
      </p>
      <p>Resize-full icon on a styled link button:
