...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_fast-backward&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:10 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Fast-backward Glyph</h2>
      <p>Fast-backward icon: <span class="glyphicon glyphicon-fast-backward"></span></p>    
      <p>Fast-backward icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-fast-backward"></span>
        </a>
      </p>
      <p>Fast-backward icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-fast-backward"></span> Fast Backward
        </button>
      </p>
      <p>Fast-backward icon on a styled link button:
