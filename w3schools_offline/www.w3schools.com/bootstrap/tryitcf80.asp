...
<!-- Mirrored from www.w3schools.com/bootstrap/tryit.asp?filename=trybs_ref_glyph_resize-small&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:12 GMT -->
<head>
...
<html>
  ...
  <body>
    <div class="container">
      <h2>Resize-small Glyph</h2>
      <p>Resize-small icon: <span class="glyphicon glyphicon-resize-small"></span></p>    
      <p>Resize-small icon as a link:
        <a href="#">
          <span class="glyphicon glyphicon-resize-small"></span>
        </a>
      </p>
      <p>Resize-small icon on a button:
        <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-resize-small"></span> Resize
        </button>
      </p>
      <p>Resize-small icon on a styled link button:
