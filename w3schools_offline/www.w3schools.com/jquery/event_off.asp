...
<!-- Mirrored from www.w3schools.com/jquery/event_off.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:39 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryita6a9.asp?filename=tryjquery_event_off" target="_blank">Try it yourself &raquo;</a>
</div>
...
<p>
<a href="tryit83cf.asp?filename=tryjquery_event_off_unbind" target="_blank">
Changing from unbind() to off()</a><br>
How to use off() to achieve the same effect as unbind().</p>

<p>
<a href="tryit3472.asp?filename=tryjquery_event_off_undelegate" target="_blank">
Changing from undelegate() to off()</a><br>
How to use off() to achieve the same effect as undelegate().</p>

<p>
<a href="tryit2496.asp?filename=tryjquery_event_off_die" target="_blank">
Changing from die() to off()</a><br>
How to use off() to achieve the same effect as die().</p>

<p><a href="tryitc208.asp?filename=tryjquery_event_off_event" target="_blank">
...
<p><a href="tryit5a0b.asp?filename=tryjquery_event_off_func" target="_blank">Remove 
one specific event 
function added with on()</a><br>
How to remove a specific function added with the on() method. </p>

<p><a href="tryita6d9.asp?filename=tryjquery_event_off_object" target="_blank">Remove 
