...
<!-- Mirrored from www.w3schools.com/jquery/html_addclass.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:48 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitb87f.asp?filename=tryjquery_html_addclass">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit7622.asp?filename=tryjquery_html_addclass_two">Add two classes to an element</a><br>
How to add two class names to a specified element.</p>

<p><a target="_blank" href="tryitf7e8.asp?filename=tryjquery_html_addclass_func">Add classes using a function</a><br>
