...
<!-- Mirrored from www.w3schools.com/jquery/event_unbind.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:42 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryite8c7.asp?filename=tryjquery_event_unbind">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a href="tryit5eff.asp?filename=tryjquery_event_unbind_func" target="_blank">Unbind a specific function</a><br>
How to use the unbind() method to unbind a specific function from a specified event for an element.</p>
<p><a href="tryit1ed3.asp?filename=tryjquery_event_unbind_eventobj" target="_blank">Unbind an event handler using an event object</a><br>
