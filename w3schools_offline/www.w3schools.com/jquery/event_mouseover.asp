...
<!-- Mirrored from www.w3schools.com/jquery/event_mouseover.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:39 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryitd913.asp?filename=tryjquery_event_mouseover_mouseout" target="_blank">Try it yourself &raquo;</a>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit5672.asp?filename=tryjquery_event_mover_mout_trigger">Try it</a>  
</div>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryitd913.asp?filename=tryjquery_event_mouseover_mouseout">Try it</a>  
</div>
</div>
<br>
...
The difference between mouseover(), mouseenter() and mousemove()</a><br>
Demonstrates the difference between mouseover(), mouseenter() and mousemove().</p>
<hr>
