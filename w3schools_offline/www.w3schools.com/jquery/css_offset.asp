...
<!-- Mirrored from www.w3schools.com/jquery/css_offset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:52 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit695f.asp?filename=tryjquery_css_offset">Try it yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<br>Possible values:<ul>
		...
		<li>An object with top and left properties (<a target="_blank" href="tryit9a4d.asp?filename=tryjquery_css_offset_object">example</a>)</li>
	</ul>
	</td>
  </tr>
  <tr>
...
<p><a href="tryite778.asp?filename=tryjquery_css_offset_set" target="_blank">Set the offset coordinates</a><br>
How to set the offset coordinates of an element.</p>

<p><a href="tryit4cbd.asp?filename=tryjquery_css_offset_func" target="_blank">Set offset coordinates using a function</a><br>
Using a function to set the offset coordinates of an element.</p>

<p><a target="_blank" href="tryit9a4d.asp?filename=tryjquery_css_offset_object">Set the offset coordinates for an element using an object</a><br>
How to set the offset coordinates for an element using a new object.</p>

<p><a target="_blank" href="tryit759c.asp?filename=tryjquery_css_offset_object2">Set the offset coordinates for an element using the offset coordinates of another element</a><br>
