...
<!-- Mirrored from www.w3schools.com/jquery/css_scrolltop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:55 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" target="_blank" href="tryit2c57.asp?filename=tryjquery_css_scrolltop_get">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a href="tryita6ba.asp?filename=tryjquery_css_scrolltop_set" target="_blank">Set the vertical scrollbar position</a><br>
How to set the vertical scrollbar position for an element.</p>
<p><a href="tryit07fa.asp?filename=tryjquery_css_scrolltop_class" target="_blank">Toggle between classes on different scroll positions</a><br>
How to toggle between classes on different scroll positions.</p>
...
Using animate() together with scrollTop() to add smooth scrolling to links.</p>
<hr>
