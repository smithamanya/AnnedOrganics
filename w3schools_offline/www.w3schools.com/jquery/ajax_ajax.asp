...
<!-- Mirrored from www.w3schools.com/jquery/ajax_ajax.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:04 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryit3e3d.asp?filename=tryjquery_ajax_ajax" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>
<a href="tryit0d85.asp?filename=tryjquery_ajax_ajax_async" target="_blank">Make an synchronous AJAX request</a><br>
How to use the async setting to specify a synchronous request</p>
<p>
<a href="tryit9893.asp?filename=tryjquery_ajax_ajax_datatype" target="_blank">Make an AJAX request with a specified data type</a><br>
How to use the dataType setting to specify the data type for the request.</p>
<p>
<a href="tryit28dd.asp?filename=tryjquery_ajax_ajax_error" target="_blank">Make an AJAX request with an error</a><br>
