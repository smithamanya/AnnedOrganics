...
<!-- Mirrored from www.w3schools.com/jquery/ajax_load.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:06 GMT -->
<head>
...
<p><a href="jquery_ref_ajax.html"><img class="navup" src="../images/up.gif" alt="jQuery AJAX Methods" /> jQuery AJAX Methods</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd6c8.asp?filename=tryjquery_ajax_load">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The load() method loads data from a server and puts the returned data into the selected element.</p>
<p><strong>Note:</strong> There is also a jQuery <a href="jquery_ref_events.html">Event</a> method called load. Which one is called, depends on the parameters.</p>
<hr>
...
<p>
<a href="tryitb824.asp?filename=tryjquery_ajax_load_data" target="_blank">Make an AJAX request, and send data with the request</a><br>
...
<p>
<a href="tryit3c2d.asp?filename=tryjquery_ajax_load_func" target="_blank">Make an AJAX request and use a callback function</a><br>
How to use the function parameter to work with the data result from the AJAX request.</p>
<p>
<a href="tryit91f6.asp?filename=tryjquery_ajax_load_err" target="_blank">Make an AJAX request with an error</a><br>
...
<!-- Mirrored from www.w3schools.com/jquery/ajax_load.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:07 GMT -->
</html>
