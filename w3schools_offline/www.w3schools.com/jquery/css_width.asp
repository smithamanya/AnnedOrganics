...
<!-- Mirrored from www.w3schools.com/jquery/css_width.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:56 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitdcc4.asp?filename=tryjquery_css_width_ref">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><img border="0" alt="jQuery Dimensions" src="img_width.gif"></p>
<hr>
...
<p><a target="_blank" href="tryit6ea4.asp?filename=tryjquery_css_width_set_values">Set the width of an element</a><br>
How to set the width of an element using different units.</p>

<p><a target="_blank" href="tryit2ff9.asp?filename=tryjquery_css_width_set_func">Decrease the width using a function</a><br>
How to use a function to decrease the width of an element.</p>

<p><a target="_blank" href="tryit517a.asp?filename=tryjquery_css_width_doc_win">Return the width of the document and window elements</a><br>
...
<p><a target="_blank" href="tryitde66.asp?filename=tryjquery_css_width_responsive">Responsive Design with width()</a><br>
How to change the background color of the page on smaller screens.</p>
