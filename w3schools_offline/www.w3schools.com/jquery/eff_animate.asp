...
<!-- Mirrored from www.w3schools.com/jquery/eff_animate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:43 GMT -->
<head>
...
<a href='../html/default.html' class='w3-hide-small' title='HTML Tutorial'>HTML</a><a href='../css/default.html' class='w3-hide-small' title='CSS Tutorial'>CSS</a><a href='../js/default.html' class='w3-hide-small' title='JavaScript Tutorial'>JAVASCRIPT</a><a href='../sql/default.html' class='w3-hide-small' title='SQL Tutorial'>SQL</a><a href='../php/default.html' class='w3-hide-small' title='PHP Tutorial'>PHP</a><a href='../bootstrap/default.html' class='w3-hide-small' title='Bootstrap Tutorial'>BOOTSTRAP</a><a href='default.html' class='w3-hide-small' title='jQuery Tutorial'>JQUERY</a><a href='../angular/default.html' class='w3-hide-small' title='Angular Tutorial'>ANGULAR</a><a href='../xml/default.html' class='w3-hide-small' title='XML Tutorial'>XML</a></div>
...
<a target="_top" href="default.html">jQuery HOME</a>
<a target="_top" href="jquery_intro.html">jQuery Intro</a>
<a target="_top" href="jquery_get_started.html">jQuery Get Started</a>
<a target="_top" href="jquery_syntax.html">jQuery Syntax</a>
<a target="_top" href="jquery_selectors.html">jQuery Selectors</a>
<a target="_top" href="jquery_events.html">jQuery Events</a>
<br>
<h2 class="left"><span class="left_h2">jQuery Effects</span></h2>
<a target="_top" href="jquery_hide_show.html">jQuery Hide/Show</a>
<a target="_top" href="jquery_fade.html">jQuery Fade</a>
<a target="_top" href="jquery_slide.html">jQuery Slide</a>
<a target="_top" href="jquery_animate.html">jQuery Animate</a>
<a target="_top" href="jquery_stop.html">jQuery stop()</a>
<a target="_top" href="jquery_callback.html">jQuery Callback</a>
<a target="_top" href="jquery_chaining.html">jQuery Chaining</a>
<br>
...
<a target="_top" href="jquery_dom_add.html">jQuery Add</a>
<a target="_top" href="jquery_dom_remove.html">jQuery Remove</a>
<a target="_top" href="jquery_css_classes.html">jQuery CSS Classes</a>
...
<a target="_top" href="jquery_traversing.html">jQuery Traversing</a>
<a target="_top" href="jquery_traversing_ancestors.html">jQuery Ancestors</a>
<a target="_top" href="jquery_traversing_descendants.html">jQuery Descendants</a>
<a target="_top" href="jquery_traversing_siblings.html">jQuery Siblings</a>
<a target="_top" href="jquery_traversing_filtering.html">jQuery Filtering</a>
<br>
<h2 class="left"><span class="left_h2">jQuery AJAX</span></h2>
<a target="_top" href="jquery_ajax_intro.html">jQuery AJAX Intro</a>
...
<a target="_top" href="jquery_examples.html">jQuery Examples</a>
...
<a target="_top" href="jquery_ref_selectors.html">jQuery Selectors</a>
<a target="_top" href="jquery_ref_events.html">jQuery Events</a>
<a target="_top" href="jquery_ref_effects.html">jQuery Effects</a>
<a target="_top" href="jquery_ref_html.html">jQuery HTML/CSS</a>
<a target="_top" href="jquery_ref_traversing.html">jQuery Traversing</a>
<a target="_top" href="jquery_ref_ajax.html">jQuery AJAX</a>
<a target="_top" href="jquery_ref_misc.html">jQuery Misc</a>
<a target="_top" href="jquery_ref_prop.html">jQuery Properties</a><br><br></div></div>&nbsp;</div>
<div class='w3-rest'>
...
<p><a href="jquery_ref_effects.html"><img class="navup" src="../images/up.gif" alt="jQuery Effect Methods" /> jQuery Effect Methods</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1a0a.asp?filename=tryjquery_eff_animate">Try it yourself &raquo;</a>
</div>
<hr>
...
String values cannot be animated (like &quot;background-color:red&quot;), except for 
the strings &quot;show&quot;, &quot;hide&quot; and &quot;toggle&quot;. These values allow hiding and showing 
the animated element.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<ul>
		<li><a target="_blank" href="tryitaf43.asp?filename=tryjquery_eff_ani_backgroundpositionxy">backgroundPositionX</a></li>
		<li><a target="_blank" href="tryitaf43.asp?filename=tryjquery_eff_ani_backgroundpositionxy">backgroundPositionY</a></li>
		<li><a target="_blank" href="tryit1223.asp?filename=tryjquery_eff_ani_borderwidth">borderWidth</a></li>
		<li><a target="_blank" href="tryitcfbe.asp?filename=tryjquery_eff_ani_borderbottomwidth">borderBottomWidth</a></li>
		<li><a target="_blank" href="tryit6b21.asp?filename=tryjquery_eff_ani_borderleftwidth">borderLeftWidth</a></li>
		<li><a target="_blank" href="tryit7b40.asp?filename=tryjquery_eff_ani_borderrightwidth">borderRightWidth</a></li>
		<li><a target="_blank" href="tryitc742.asp?filename=tryjquery_eff_ani_bordertopwidth">borderTopWidth</a></li>
		<li><a target="_blank" href="tryitb74b.asp?filename=tryjquery_eff_ani_borderspacing">borderSpacing</a></li>
		<li><a target="_blank" href="tryit7cd5.asp?filename=tryjquery_eff_ani_margin">margin</a></li>
		<li><a target="_blank" href="tryitee8d.asp?filename=tryjquery_eff_ani_marginbottom">marginBottom</a></li>
		<li><a target="_blank" href="tryitfd4c.asp?filename=tryjquery_eff_ani_marginleft">marginLeft</a></li>
		<li><a target="_blank" href="tryit056e.asp?filename=tryjquery_eff_ani_marginright">marginRight</a></li>
		<li><a target="_blank" href="tryit5954.asp?filename=tryjquery_eff_ani_margintop">marginTop</a></li>
		<li><a target="_blank" href="tryitf2a1.asp?filename=tryjquery_eff_ani_outlinewidth">outlineWidth</a></li>
		<li><a target="_blank" href="tryitbb85.asp?filename=tryjquery_eff_ani_padding">padding</a></li>
		<li><a target="_blank" href="tryita5c4.asp?filename=tryjquery_eff_ani_paddingbottom">paddingBottom</a></li>
		<li><a target="_blank" href="tryit467a.asp?filename=tryjquery_eff_ani_paddingleft">paddingLeft</a></li>
		<li><a target="_blank" href="tryitd97a.asp?filename=tryjquery_eff_ani_paddingright">paddingRight</a></li>
		<li><a target="_blank" href="tryite16f.asp?filename=tryjquery_eff_ani_paddingtop">paddingTop</a></li>
		<li><a target="_blank" href="tryit3a6e.asp?filename=tryjquery_eff_ani_height">height</a></li>
		<li><a target="_blank" href="tryit555c.asp?filename=tryjquery_eff_ani_width">width</a></li>				
		<li><a target="_blank" href="tryit7bb9.asp?filename=tryjquery_eff_ani_maxheight">maxHeight</a></li>
		<li><a target="_blank" href="tryit426b.asp?filename=tryjquery_eff_ani_maxwidth">maxWidth</a></li>				
		<li><a target="_blank" href="tryitc4a8.asp?filename=tryjquery_eff_ani_minheight">minHeight</a></li>
		<li><a target="_blank" href="tryitd535.asp?filename=tryjquery_eff_ani_minwidth">minWidth</a></li>				
    	<li><a target="_blank" href="tryit756f.asp?filename=tryjquery_eff_ani_fontsize">fontSize</a></li>				
    	<li><a target="_blank" href="tryit2783.asp?filename=tryjquery_eff_ani_bottom">bottom</a></li>				
    	<li><a target="_blank" href="tryitc0ee.asp?filename=tryjquery_eff_ani_left">left</a></li>				
    	<li><a target="_blank" href="tryitf07e.asp?filename=tryjquery_eff_ani_right">right</a></li>				
    	<li><a target="_blank" href="tryiteac9.asp?filename=tryjquery_eff_ani_top">top</a></li>				
    	<li><a target="_blank" href="tryitba6d.asp?filename=tryjquery_eff_ani_letterspacing">letterSpacing</a></li>
    	<li><a target="_blank" href="tryit1fb6.asp?filename=tryjquery_eff_ani_wordspacing">wordSpacing</a></li>
    	<li><a target="_blank" href="tryit023f.asp?filename=tryjquery_eff_ani_lineheight">lineHeight</a></li>    	
    	<li><a target="_blank" href="tryit9feb.asp?filename=tryjquery_eff_ani_textindent">textIndent</a></li>
    </ul>
	<br>
	Only numeric values can be animated (like "margin:30px"). String values cannot be animated (like "background-color:red"), except for the strings "show", "hide" and "toggle". These values allow hiding and showing the animated element.<br>
	<br><b>Tip:</b> Color animations are not included in the core jQuery library. If 
  ...
  <tr>
    ...
    <td>Optional. A function to be executed after the animation completes. To learn more about callback, please read our <a href="jquery_callback.html">jQuery Callback</a>	chapter</td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
	...
	<ul>
		<li>duration - sets the speed of the animation</li>
		<li>easing - specifies the easing function to use</li>
		<li>complete - specifies a function to be executed after the animation completes</li>
		<li>step - specifies a function to be executed for each step in the animation</li>
		<li>progress - specifies a function to be executed after each step in the animation</li>
		<li>queue - a Boolean value specifying whether or not to place the animation in the effects queue</li>
		<li>specialEasing - a map of one or more CSS properties from the <i>styles</i> parameter, and their corresponding easing functions</li>
		<li>start - specifies a function to be executed when the animation 
		begins</li>
		<li>done - specifies a function to be executed when the animation ends</li>
		<li>fail - specifies a function to be executed if the animation fails to 
		complete</li>
		<li>always - specifies a function to be executed if the animation stops 
...
<p><a target="_blank" href="tryitf222.asp?filename=tryjquery_eff_animate2">Using animate() with a callback function</a><br>
How to use animate() with a callback function that repeats the animation.</p>

<p><a target="_blank" href="tryit9d8a.asp?filename=tryjquery_eff_animate_alt">Alternate Syntax Example</a><br>
Using the alternate syntax to specify multiple animation styles and options.</p>

<p><a target="_blank" href="tryit8fb2.asp?filename=tryjquery_eff_animate_progressbar">Using animate() to create a progress bar</a><br>
How to use the animate() method to create a progress bar.</p>

<p><a target="_blank" href="tryit5cd0.asp?filename=tryjquery_eff_animate_smoothscroll">Add smooth scrolling to page anchors</a><br>
How to use animate() to add smooth scrolling to links.</p>
<hr>
...
<a href="default.html">jQuery Tutorial</a><br>
...
<a href="jquery_ref_selectors.html">jQuery Reference</a><br>
...
<a href="jquery_examples.html">jQuery Examples</a><br>
...
<a href='default.html'>Learn jQuery</a>
...
<a href='jquery_ref_selectors.html'>jQuery Reference</a>
...
<a href='jquery_examples.html' target='_top'>jQuery Examples</a>
...
<!-- Mirrored from www.w3schools.com/jquery/eff_animate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:44 GMT -->
</html>
