...
<!-- Mirrored from www.w3schools.com/jquery/traversing_children.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:58 GMT -->
<head>
...
$(document).ready(function(){
  $("ul.red").children().css({"color":"red","border":"2px solid red"});
});
</script>
<style>
.descendants *
...
<div class="w3-code notranslate">
	...
	solid red&quot;});<br>});<br></div>
<p>Result:</p>
<div class="w3-code notranslate descendants">body (great-grandparent)
  <div>div (grandparent)
    <ul class="red">ul (parent)  
      <li>li (child)
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit70c3.asp?filename=tryjquery_traversing_children">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>
<a target="_blank" href="tryit6bc9.asp?filename=tryjquery_traversing_children2">
Return all direct children of &lt;ul&gt;</a><br>
How to return all direct children of an &lt;ul&gt; element.</p>

<p>
<a href="tryitda90.asp?filename=tryjquery_traversing_children3" target="_blank">
Narrow down the search</a><br>
How to use the filter parameter to 
return all &lt;li&gt; elements with the class name &quot;first&quot;, that are direct children of &lt;ul&gt;.</p>

<p>
<a href="tryit17f1.asp?filename=tryjquery_traversing_children4" target="_blank">Return all &lt;p&gt; elements that are direct children of 
&lt;div&gt;</a><br>
How to select all &lt;p&gt; elements that are direct children of their parent &lt;div&gt; 
element.</p>

<p>
<a target="_blank" href="tryit5cec.asp?filename=tryjquery_traversing_children5">Show 
