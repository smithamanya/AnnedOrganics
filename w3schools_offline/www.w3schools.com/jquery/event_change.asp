...
<!-- Mirrored from www.w3schools.com/jquery/event_change.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:32 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit7834.asp?filename=tryjquery_event_change_ref">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The change event occurs when the value of an element has been changed (only works 
on &lt;input&gt;, &lt;textarea&gt; and &lt;select&gt; elements).</p>
<p>The change() method triggers the change event, or attaches a function to run when 
a change event occurs.</p>
<p><b>Note:</b> For select menus, the change event occurs when an option is 
selected. For text fields or text areas, the change event occurs when the field 
loses focus, after the content has been changed.</p>
...
$(<i>selector</i>).change() <a target="_blank" class="w3-btn btnsmall" href="tryit1f3a.asp?filename=tryjquery_event_change_trigger">Try it</a></div>
</div>
<p>Attach a function to the change event:</p>
<div class="w3-code w3-border notranslate"><div>
  
    $(<i>selector</i>).change(<i>function</i>) <a target="_blank" class="w3-btn btnsmall" href="tryit51d7.asp?filename=tryjquery_event_change">Try it</a></div>
</div>
<br>
