...
<!-- Mirrored from www.w3schools.com/jquery/css_height.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:51 GMT -->
<head>
...
<p><a href="jquery_ref_html.html"><img class="navup" src="../images/up.gif" alt="jQuery HTML/CSS Methods" /> jQuery HTML/CSS Methods</a></p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit03f1.asp?filename=tryjquery_css_height_ref">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><img border="0" alt="jQuery Dimensions" src="img_height.gif"></p>
<hr>
...
<ul>
	...
	<li><a href="html_outerwidth.asp">outerWidth()</a> - Returns the width of an 
	element (includes padding and border)</li>
	<li><a href="html_outerheight.asp">outerHeight()</a> - Returns the height of 
	an element (includes padding and border)</li>	
</ul>
<hr>
...
<p><a target="_blank" href="tryitc719.asp?filename=tryjquery_css_height_set_unit">Set the height of an element</a><br>
How to set the height of an element using different units.</p>

<p><a target="_blank" href="tryit5905.asp?filename=tryjquery_css_height_func">Increase the height using a function</a><br>
How to use a function to increase the height of an element.</p>

<p><a target="_blank" href="tryit3c77.asp?filename=tryjquery_css_height_doc_win">Return the height of the document and window elements</a><br>
How to return the current height of the document and window elements.</p>

<p><a target="_blank" href="tryite416.asp?filename=tryjquery_html_all_dimensions_ref">Display dimensions with related methods</a><br>
