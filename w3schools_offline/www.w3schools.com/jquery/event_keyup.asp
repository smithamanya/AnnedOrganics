...
<!-- Mirrored from www.w3schools.com/jquery/event_keyup.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:37 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitae3d.asp?filename=tryjquery_event_keydown_keyup">Try it yourself &raquo;</a>
...
<p>The keyup() method triggers the keyup event, or attaches a function to run when a keyup event occurs.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryitaf1b.asp?filename=tryjquery_event_keydown_keyup_trigger">Try it</a>  
</div>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryitae3d.asp?filename=tryjquery_event_keydown_keyup">Try it</a>  
</div>
</div>
<br>
...
<p><a href="tryit9a95.asp?filename=tryjquery_event_keyup_which" target="_blank">Determine which key was pressed</a><br>
