...
<!-- Mirrored from www.w3schools.com/jquery/html_removeclass.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:54 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit7c0c.asp?filename=tryjquery_html_removeclass">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit02f7.asp?filename=tryjquery_html_addremoveclass">Change the class name of an element</a><br>
How to use addClass() and removeClass() to remove one class name, and add a new class name.</p>

<p><a target="_blank" href="tryit3261.asp?filename=tryjquery_html_removeclass_func">Remove class using a function</a><br>
Using a function to remove a class from the selected elements.</p>

<p><a target="_blank" href="tryitec90.asp?filename=tryjquery_html_removeclass_several">Remove several class names</a><br>
