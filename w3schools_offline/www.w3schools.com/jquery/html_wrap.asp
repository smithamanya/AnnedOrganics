...
<!-- Mirrored from www.w3schools.com/jquery/html_wrap.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:57 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita93d.asp?filename=tryjquery_html_wrap">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit4b35.asp?filename=tryjquery_html_wrap_element">Create a new element with the DOM</a><br>
How to use document.createElement() to create an element, and wrap it around each selected element.</p>

<p><a target="_blank" href="tryit21ed.asp?filename=tryjquery_html_wrap_func">Wrap elements using a function</a><br>
Using a function to specify what to wrap around each selected element.</p>

<p><a target="_blank" href="tryitd185.asp?filename=tryjquery_html_wrap_unwrap">Wrap and unwrap an element</a><br>
