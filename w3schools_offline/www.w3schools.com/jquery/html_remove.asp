...
<!-- Mirrored from www.w3schools.com/jquery/html_remove.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:54 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryited70.asp?filename=tryjquery_html_remove">Try it yourself &raquo;</a>
...
$(<em>selector</em>).remove(<em>selector</em>)</div></div>
<br>
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>selector</i></td>
    <td>Optional. Specifies one or more elements to be removed.
    <br>To remove multiple elements, separate them with a comma (,)</td>
  </tr>
</table>
<hr>
...
<p><a target="_blank" href="tryit61b3.asp?filename=tryjquery_html_detach_remove">
Difference between detach() and remove()</a><br>
Show the difference between the detach() and remove() methods.</p>
<p><a target="_blank" href="tryitc914.asp?filename=tryjquery_html_remove2">
Remove all &lt;p&gt; elements with class="test"</a><br>
Using the optional parameter to filter the elements to be removed.</p>
<p><a target="_blank" href="tryit222a.asp?filename=tryjquery_html_remove3">
Remove all &lt;p&gt; elements with class="test" and "demo"</a><br>
Using the optional parameter to filter multiple elements to be removed.</p>
