...
<!-- Mirrored from www.w3schools.com/jquery/event_mouseenter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:38 GMT -->
<head>
...
<a class="w3-btn w3-margin-bottom" href="tryit87ac.asp?filename=tryjquery_event_mouseenter_mouseleave" target="_blank">Try it yourself &raquo;</a>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit6735.asp?filename=tryjquery_event_menter_mleave_trigger">Try it</a>  
</div>
</div>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit87ac.asp?filename=tryjquery_event_mouseenter_mouseleave">Try it</a>  
</div>
</div>
<br>
...
<p><a target="_blank" href="tryite507.asp?filename=tryjquery_event_mouseenter_mouseover">
The difference between mouseenter(), mouseover() and mousemove()</a><br>
Demonstrates the difference between mouseenter(), mouseover() and mousemove().</p>
