...
<!-- Mirrored from www.w3schools.com/jquery/event_on.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:39 GMT -->
<head>
...
<p><a href="jquery_ref_events.html"><img class="navup" src="../images/up.gif" alt="jQuery Event Methods" /> jQuery Event Methods</a></p>
...
<div class="w3-code notranslate">
	...
	paragraph was 
	clicked.&quot;);<br>});</div>
<a class="w3-btn w3-margin-bottom" href="tryitd609.asp?filename=tryjquery_event_on" target="_blank">Try it yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> Event handlers attached using the on() method will work 
for both current and FUTURE elements (like a new element created by a script).</p>
<p>
...
<p>
<a href="tryit8082.asp?filename=tryjquery_event_on_bind" target="_blank">
Changing from bind() to on()</a><br>
How to use on() to achieve the same effect as bind().</p>

<p>
<a href="tryit309c.asp?filename=tryjquery_event_on_delegate" target="_blank">
Changing from delegate() to on()</a><br>
How to use on() to achieve the same effect as delegate().</p>

<p>
<a href="tryitaba6.asp?filename=tryjquery_event_on_live" target="_blank">
Changing from live() to on()</a><br>
How to use on() to achieve the same effect as live().</p>

<p>
<a href="tryited19.asp?filename=tryjquery_event_on_multiple" target="_blank">
Attach multiple events</a><br>
How to attach multiple events to an element.</p>

<p><a href="tryit2e8a.asp?filename=tryjquery_event_on_map" target="_blank">Attach multiple event handlers using 
the map parameter</a><br>
How to attach multiple event handlers to the selected elements using the map 
parameter.</p>

<p><a href="tryit3284.asp?filename=tryjquery_event_on_namespace" target="_blank">
Attach a custom event on an element</a><br>
How to attach a customized namespace event on an element.</p>

<p><a href="tryitefe5.asp?filename=tryjquery_event_on_data" target="_blank">Pass along data to the function</a><br>
How to pass along data to the function.</p>

<p><a href="tryit1827.asp?filename=tryjquery_event_on_newel" target="_blank">Add event 
handlers for future elements </a><br>
Show that the on() method also works for elements not yet created.</p>

<p><a href="tryita6a9.asp?filename=tryjquery_event_off" target="_blank">Remove an event handler</a><br>
...
<!-- Mirrored from www.w3schools.com/jquery/event_on.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:57:40 GMT -->
</html>