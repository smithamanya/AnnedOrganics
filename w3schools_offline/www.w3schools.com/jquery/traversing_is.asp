...
<!-- Mirrored from www.w3schools.com/jquery/traversing_is.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:00 GMT -->
<head>
...
<h1>jQuery <span class="color_h1">is()</span> Method</h1>
<p><a href="jquery_ref_traversing.html"><img class="navup" src="../images/up.gif" alt="jQuery HTML Methods" /> jQuery 
Traversing Methods</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>If the parent of &lt;p&gt; is a &lt;div&gt; element, alert some text:</p>
<div class="w3-code notranslate">
  
    if ($(&quot;p&quot;).parent().is(&quot;div&quot;)) {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Parent of p is 
	div&quot;); <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitf2f8.asp?filename=tryjquery_traversing_is">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The is() method checks if one of the selected elements matches the <em>
selectorElement</em>.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
$(<i>selector</i>).is(<em>selectorElement,</em>function<em>(index</em>,<em>element)</em>)</div></div>
<br>
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i>selectorElement</i></td>
    <td>Required. Specifies a selector expression, element or a jQuery object to 
	match the current set of elements against. Returns true if there 
	is at least one match from the given argument, and false if not.<br></td>
  </tr>
  <tr>
    <td>function(<em>index</em>,<em>element</em>)</td>
    <td>
	<p>Optional. Specifies a function to run for the group of selected elements.</p>
	<ul>
		<li>index - the index position of the element</li>
		<li>element - the current element (the &quot;this&quot; selector can also be 
		used)</li>
	</ul>
	</td>
  </tr>
