...
<!-- Mirrored from www.w3schools.com/asp/showasp.asp?filename=demo_vb_mid by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:47 GMT -->
<head>
...
<div class="container">
	<div class="textareacontainer">
		<div class="textarea">
			...
			<div class="iframewrapper">
				<iframe id="iframeSource" frameborder="0" src="showaspcode9c66.asp?source=demo_vb_mid"></iframe>
			</div>
		</div>
	</div>
	<div class="iframecontainer">
		<div class="iframe">
			...
			<div class="iframewrapper">
				<iframe id="iframeResult" frameborder="0" src="demo_vb_mid.asp"></iframe>
			</div>
		</div> 
	</div>
