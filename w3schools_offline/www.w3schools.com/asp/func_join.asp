...
<!-- Mirrored from www.w3schools.com/asp/func_join.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:57 GMT -->
<head>
...
<h3>Example</h3><p>Separating items in an array, with and without using the delimeter parameter:</p>
...
<a target="_blank" href="showaspc4fc.asp?filename=demo_vb_join_func" class="w3-btn w3-margin-bottom">Show Example &raquo;</a>
</div>
