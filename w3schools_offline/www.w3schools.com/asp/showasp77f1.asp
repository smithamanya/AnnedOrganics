...
<!-- Mirrored from www.w3schools.com/asp/showasp.asp?filename=demo_vb_text by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:44 GMT -->
<head>
...
<div class="container">
	<div class="textareacontainer">
		<div class="textarea">
			...
			<div class="iframewrapper">
				<iframe id="iframeSource" frameborder="0" src="showaspcodee36a.asp?source=demo_vb_text"></iframe>
			</div>
		</div>
	</div>
	<div class="iframecontainer">
		<div class="iframe">
			...
			<div class="iframewrapper">
				<iframe id="iframeResult" frameborder="0" src="demo_vb_text.asp"></iframe>
			</div>
		</div> 
	</div>
