...
<!-- Mirrored from www.w3schools.com/asp/showasp.asp?filename=demo_lcid by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:01:04 GMT -->
<head>
...
<div class="container">
	<div class="textareacontainer">
		<div class="textarea">
			...
			<div class="iframewrapper">
				<iframe id="iframeSource" frameborder="0" src="showaspcode4ce1.asp?source=demo_lcid"></iframe>
			</div>
		</div>
	</div>
	<div class="iframecontainer">
		<div class="iframe">
			...
			<div class="iframewrapper">
				<iframe id="iframeResult" frameborder="0" src="demo_lcid.asp"></iframe>
			</div>
		</div> 
	</div>
