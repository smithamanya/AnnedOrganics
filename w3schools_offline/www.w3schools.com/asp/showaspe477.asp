...
<!-- Mirrored from www.w3schools.com/asp/showasp.asp?filename=demo_text_sh by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:41 GMT -->
<head>
...
<div class="container">
	<div class="textareacontainer">
		<div class="textarea">
			...
			<div class="iframewrapper">
				<iframe id="iframeSource" frameborder="0" src="showaspcode7776.asp?source=demo_text_sh"></iframe>
			</div>
		</div>
	</div>
	<div class="iframecontainer">
		<div class="iframe">
			...
			<div class="iframewrapper">
				<iframe id="iframeResult" frameborder="0" src="demo_text_sh.asp"></iframe>
			</div>
		</div> 
	</div>
