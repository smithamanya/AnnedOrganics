...
<!-- Mirrored from www.w3schools.com/asp/showasp.asp?filename=demo_vb_foreach by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:00:43 GMT -->
<head>
...
<div class="container">
	<div class="textareacontainer">
		<div class="textarea">
			...
			<div class="iframewrapper">
				<iframe id="iframeSource" frameborder="0" src="showaspcode5a5f.asp?source=demo_vb_foreach"></iframe>
			</div>
		</div>
	</div>
	<div class="iframecontainer">
		<div class="iframe">
			...
			<div class="iframewrapper">
				<iframe id="iframeResult" frameborder="0" src="demo_vb_foreach.asp"></iframe>
			</div>
		</div> 
	</div>
