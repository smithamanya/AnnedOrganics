...
<!-- Mirrored from www.w3schools.com/asp/ev_conn_execute.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:51:43 GMT -->
<head>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>cursortyp </td>
    <td>   Specifies the type of cursor to be used. One of the <a href="#cursortypeenum">CursorTypeEnum</a>
      values      
    </td>
  </tr>
  <tr>
    <td>locktyp </td>
    <td>   Specifies the type of lock to be used. One of the <a href="#locktypeenum">LockTypeEnum</a>
      values      
    </td>
  </tr>
  <tr>
    <td>options </td>
    <td>   One or more of the <a href="#commandtypeenum"> CommandTypeEnum</a> or
  ...
  <tr>
    <td>status </td>
    <td>   An <a href="#eventstatusenum">EventStatusEnum</a> value      
    </td>
  </tr>
  <tr>
    <td>objcomm </td>
