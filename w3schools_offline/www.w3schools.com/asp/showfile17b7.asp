...
<!-- Mirrored from www.w3schools.com/asp/showfile.asp?filename=demo_getfilename by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:01:06 GMT -->
<head>
...
<div class="container">
  <div class="textareacontainer">
    <div class="textarea">
      ...
      <div class="iframewrapper">
        <iframe id="iframeSource" frameborder="0" src="showaspcodeef7d.asp?source=demo_getfilename"></iframe>
      </div>
    </div>
  </div>
  <div class="iframecontainer">
    <div class="iframe">
      ...
      <div class="iframewrapper">
        <iframe id="iframeResult" frameborder="0" src="demo_getfilename.htm"></iframe>
      </div>
    </div> 
  </div>
