...
<!-- Mirrored from www.w3schools.com/asp/met_rs_getrows.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:51:58 GMT -->
<head>
...
<table class="w3-table-all notranslate">
    ...
    <tr>
      <td>rows</td>
      <td>   Optional. A <a href="#getrowsoptionenum">GetRowsOptionEnum</a>
    ...
    <tr>
      <td>start</td>
      <td>   
        <p>   Optional. What record to start on, a record number or a <a href="#bookmarkenum"> BookmarkEnum</a>
        value</td>
    </tr>
    <tr>
      <td>fields</td>
