...
<!-- Mirrored from www.w3schools.com/asp/prop_para_attributes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 11:51:48 GMT -->
<head>
...
<hr>
<a href="ado_ref_parameter.html"><img class="navup" src="../images/up.gif" alt="Parameter Object Reference" /> Complete Parameter Object Reference</a>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>The Attributes property has read/write permissions on a Connection
      object. Its value can be the sum of one or more <a href="#XactAttributeEnum">XactAttributeEnum</a>  values.
      Default value is 0</td>
  </tr>
  <tr>
    <td>Parameter </td>
    <td>   The Attributes property has read/write permissions on a Parameter
      object. Its value can be the sum of one or more <a href="#ParameterAttributesEnum">ParameterAttributesEnum</a> values.
  ...
  <tr>
    ...
    <td>   <p>The Attributes property has read/write permissions when
      ...
      existing Recordset. Its value can be the sum of one or more <a href="#FieldAttributeEnum">FieldAttributeEnum</a> 
      values
</p>
  ...
  <tr>
    ...
    <td>   The Attributes property is read-only for a Property
      object. Its value can be the sum of one or more <a href="#PropertyAttributesEnum">PropertyAttributesEnum</a>
      values
    </td>
  </tr>
</table>
