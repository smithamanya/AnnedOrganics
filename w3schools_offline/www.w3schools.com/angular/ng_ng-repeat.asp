...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-repeat.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:54 GMT -->
<head>

<title>Angular ng-repeat Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-repeat</code></span> Directive</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="angular_ref_directives.html">« 
	AngularJS Reference</a></div>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Write one header for each item in the records array:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;body ng-app="myApp" ng-controller="myCtrl"&gt;<br><br>&lt;h1 ng-repeat="x in 
	records"&gt;{{x}}&lt;/h1&gt;<br><br>&lt;script&gt;<br>var app = angular.module("myApp", 
	[]);<br>app.controller("myCtrl", function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.records 
	= [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "Alfreds Futterkiste",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Berglunds snabbköp",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "Centro 
	comercial Moctezuma",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "Ernst 
	Handel",<br>&nbsp;&nbsp;&nbsp; ]<br>});<br>&lt;/script&gt;<br><br>&lt;/body&gt;</div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit55d2.html?filename=try_ng_ng-repeat">
	Try it yourself »</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-repeat</code> directive repeats a set of HTML, a given number of 
times.</p>
<p>The set of HTML will be repeated once per item in a collection.</p>
<p>The collection must be an array or an object.</p>
<p><strong>Note:</strong> Each instance of the repetition is given its own 
scope, which consist of the current item.</p>
<p>If you have an collection of objects, the <code>ng-repeat</code> directive is 
perfect for making a HTML table, displaying one table row for each object, 
and one table data for each object property. See example below.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-repeat="<em>expression</em>"&gt;&lt;/<em>element</em>&gt;</div></div>
<p>Supported by all HTML elements.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression that specifies how to loop the collection.<br><br>Legal 
	Expression examples:<br><br><code>x in records</code><em><br><br></em><code>
	(key, value) in myObj<br><br>x in records track by $id(x)</code></td>
    </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Write one table row for each item in the records array:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;table ng-controller="myCtrl" border="1"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;tr ng-repeat="x 
	in records"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;td&gt;{{x.Name}}&lt;/td&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&lt;td&gt;{{x.Country}}&lt;/td&gt; <br>&nbsp;&nbsp;&nbsp; &lt;/tr&gt;<br>&lt;/table&gt;<br><br>
	&lt;script&gt;<br>var app = angular.module("myApp", []);<br>app.controller("myCtrl", 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.records = [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Name" : "Alfreds Futterkiste",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Country" : "Germany"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; },{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Name" : "Berglunds snabbköp",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Country" : "Sweden"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; },{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Name" : "Centro comercial Moctezuma",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Country" : "Mexico"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; },{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Name" : "Ernst Handel",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Country" : "Austria"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	]<br>});<br>&lt;/script&gt;</div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6346.html?filename=try_ng_ng-repeat2">
	Try it yourself »</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Write one table row for each property in an object:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;table ng-controller="myCtrl" border="1"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;tr ng-repeat="(x, 
	y) in myObj"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;td&gt;{{x}}&lt;/td&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&lt;td&gt;{{y}}&lt;/td&gt; <br>&nbsp;&nbsp;&nbsp; &lt;/tr&gt;<br>&lt;/table&gt;<br><br>&lt;script&gt;<br>
	var app = angular.module("myApp", []);<br>app.controller("myCtrl", 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.myObj = {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Name" : "Alfreds Futterkiste",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	"Country" : "Germany",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "City" 
	: "Berlin"<br>&nbsp;&nbsp;&nbsp; }<br>});<br>&lt;/script&gt;</div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit9905.html?filename=try_ng_ng-repeat3">
	Try it yourself »</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-repeat.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:56 GMT -->
</html>