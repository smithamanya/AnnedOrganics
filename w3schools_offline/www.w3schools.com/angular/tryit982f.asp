...
<!-- Mirrored from www.w3schools.com/angular/tryit.asp?filename=try_ng_events by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:27 GMT -->
<head>
...
<button ng-click="toggle()">Show user</button>
...
<p>Click the button to show/hide the user information.</p>
