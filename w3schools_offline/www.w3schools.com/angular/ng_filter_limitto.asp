...
<!-- Mirrored from www.w3schools.com/angular/ng_filter_limitto.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:18 GMT -->
<head>

<title>Angular limitTo Filter</title>
...
<h1>AngularJS <span class="color_h1"><code>limitTo</code></span> Filter</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Display only the first three items of an array:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;sizeCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in cars | limitTo : 3&quot;&gt;{{x}}&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>
	var app = angular.module('myApp', []);<br>app.controller('sizeCtrl', 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.cars = [&quot;Audi&quot;, &quot;BMW&quot;, 
	&quot;Dodge&quot;, &quot;Fiat&quot;, &quot;Ford&quot;, &quot;Volvo&quot;];<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitebb2.html?filename=try_ng_ref_limitto">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>limitTo</code> filter returns an array or a string containing only 
a specified number of elements.</p>
<p>When the <code>limitTo</code> filter is used for arrays, it returns an array 
containing only the specified number of items.</p>
<p>When the <code>limitTo</code> filter is used for strings, it returns a string 
containing, only the specified number of characters.</p>
<p>When the <code>limitTo</code> filter is used for numbers, it returns a string 
containing only the specified number of digits.</p>
<p>Use negative numbers to return elements starting from the end of the element, 
instead of the beginning.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate jsHigh"><div>
	{{ <em>object</em> | limitTo : <em>
	limit</em> : <em>
	begin</em> }}</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><em>limit</em></td>
    <td>&nbsp;A number, specifying how many 
	elements to return</td>
    </tr>
	<tr>
    <td><em>begin</em></td>
    <td>Optional. A number specifying where to 
	begin the limitation. Default is 0</td>
    </tr>
    </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Display the <em>last</em> three items of the array:</p>
<div class="w3-code notranslate htmlHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryite85d.html?filename=try_ng_ref_limitto_end">Try it yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Display three items, starting at position 1:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;sizeCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in cars | limitTo : 3 : 1&quot;&gt;{{x}}&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>
	var app = angular.module('myApp', []);<br>app.controller('sizeCtrl', 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.cars = [&quot;Audi&quot;, &quot;BMW&quot;, 
	&quot;Dodge&quot;, &quot;Fiat&quot;, &quot;Ford&quot;, &quot;Volvo&quot;];<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3525.html?filename=try_ng_ref_limitto_begin">Try it yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Display the first three characters of the string:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;sizeCtrl&quot;&gt;<br><br>&lt;h1&gt;{{txt | limitTo : 
	3}}&lt;/h1&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', 
	[]);<br>app.controller('sizeCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; 
	$scope.txt = &quot;Hello, welcome to AngularJS&quot;;<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3062.html?filename=try_ng_ref_limitto_string">Try it yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Display the first three digits og the number:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;sizeCtrl&quot;&gt;<br><br>&lt;h1&gt;{{phone | limitTo : 
	3}}&lt;/h1&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', 
	[]);<br>app.controller('sizeCtrl', function($scope) {<br>$scope.phone = 
	&quot;123456789&quot;;<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3f6b.html?filename=try_ng_ref_limitto_number">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
...
<!-- Mirrored from www.w3schools.com/angular/ng_filter_limitto.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:22 GMT -->
</html>