...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-change.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:25 GMT -->
<head>

<title>Angular ng-change Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-change</code></span> Directive</h1>
<div class="chapter">
...
<div class="htmlHigh">
    &lt;body ng-app=&quot;myApp&quot;&gt;<br><br>&lt;div ng-controller=&quot;myCtrl&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;input type=&quot;text&quot; ng-change=&quot;myFunc()&quot; ng-model=&quot;myValue&quot; /&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;p&gt;The input field has changed {{count}} times.&lt;/p&gt;<br>&lt;/div&gt;<br><br>
	&lt;script&gt;<br></div>
<div class="jsHigh">
	angular.module('myApp', [])<br>.controller('myCtrl', ['$scope', 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.count = 0;<br>&nbsp;&nbsp;&nbsp; 
	$scope.myFunc = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	$scope.count++;<br>&nbsp;&nbsp;&nbsp; };<br>}]);<br></div>
<div class="htmlHigh">&lt;/script&gt;<br><br>&lt;/body&gt;<br></div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3482.html?filename=try_ng_ng-change">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-change</code> directive tells AngularJS what to do when the 
value of an HTML element changes.</p>
<p>The <code>ng-change</code> directive requires a <code>ng-model</code> 
directive to be present.</p>
<p>The <code>ng-change</code> directive from AngularJS will not override the element's original onchange event,
both the <code>ng-change</code> expression and the original onchange event will be executed.</p>
<p>The <code>ng-change</code> event is triggered at every change in the value. 
It will not wait until all changes are made, or when the input field loses 
focus.</p>
<p>The <code>ng-change</code> event is only triggered if there is a actual 
change in the input value, and not if the change was made from a JavaScript.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-change=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
<p>Supported by &lt;input&gt;, &lt;select&gt;, and&nbsp; &lt;textarea&gt;.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when an element's value changes.</td>
    </tr>
  </table>
</div>
<hr>
