...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-csp.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:33 GMT -->
<head>

<title>Angular ng-csp Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-csp</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Change the way AngularJS behaves regarding &quot;eval&quot; and inline styles:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;body ng-app=&quot;&quot; ng-csp&gt;<br>...<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita0e0.html?filename=try_ng_ng-csp">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-csp</code> directive is used to change the security policy of AngularJS.</p>
<p>With the <code>ng-csp</code> directive set, AngularJS will not run any eval 
functions, and it will not inject any inline styles.</p>
<p>Setting the value of the <code>ng-csp</code> directive to <code>no-unsafe-eval</code>, 
will stop AngularJS from running any eval functions, but allow injecting inline 
styles.</p>
<p>Setting the value of the <code>ng-csp</code> directive to <code>
no-inline-style</code>, will stop AngularJS from injecting any inline styles, 
but allow eval functions.</p>
<p>Using the <code>ng-csp</code> directive is necessary when developing apps for 
Google Chrome Extensions or Windows Apps.</p>
<p><strong>Note:</strong> The <code>ng-csp</code> directive does not affect 
...
evaluation time up to 30%.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-csp=&quot;no-unsafe-eval | no-inline-style&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>no-unsafe-eval<br>no-inline-style</td>
    <td>The value can be empty, meaning neither eval or inline styles are 
	allowed.<br>The value can be one of the two values described.<br>The value 
	can be both values, separated by a semicolon, but that will have the same 
	meaning as an empty value.</td>
    </tr>
  </table>
</div>
<hr>
