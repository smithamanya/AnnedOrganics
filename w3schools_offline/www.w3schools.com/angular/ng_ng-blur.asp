...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-blur.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:24 GMT -->
<head>

<title>Angular ng-blur Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-blur</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Execute an expresson when the input field loses focus (onblur):</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;input ng-blur=&quot;count = count + 1&quot; ng-init=&quot;count=0&quot; /&gt;<br><br>
	&lt;h1&gt;{{count}}&lt;/h1&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitfe5a.html?filename=try_ng_ng-blur">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-blur</code> directive tells AngularJS what to do when an HTML element loses focus.</p>
<p>The <code>ng-blur</code> directive from AngularJS will not override the element's original onblur event,
both the <code>ng-blur</code> expression and the original onblur event will be executed.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-blur=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when an element loses focus.</td>
    </tr>
  </table>
</div>
<hr>
