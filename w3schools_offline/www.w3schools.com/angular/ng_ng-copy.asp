...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-copy.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:32 GMT -->
<head>

<title>Angular ng-copy Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-copy</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Execute an expresson when the text of the input field is being copied:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit4c4d.html?filename=try_ng_ng-copy">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-copy</code> directive tells AngularJS what to do when an HTML element 
is being copied.</p>
<p>The <code>ng-copy</code> directive from AngularJS will not override the element's original oncopy event,
both the <code>ng-copy</code> expression and the original oncopy event will be executed.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-copy=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when the text of an element is being copied.</td>
    </tr>
  </table>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-copy.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:33 GMT -->
</html>