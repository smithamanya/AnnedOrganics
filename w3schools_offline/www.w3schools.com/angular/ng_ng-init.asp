...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-init.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:40 GMT -->
<head>

<title>Angular ng-init Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-init</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Create a variable when initiating the application:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;div ng-app=&quot;&quot; ng-init=&quot;myText='Hello World!'&quot;&gt;<br><br>&lt;h1&gt;{{myText}}&lt;/h1&gt;<br></div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit4c0c.html?filename=try_ng_ng-init">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-init</code> directive evaluates the given expression(s).</p>
<p>The <code>ng-init</code> directive can add some unnecessary logic into the scope, and you are 
recommended to do your evaluations in a controller instead, see the <code>
<a href="ng_ng-controller.asp">ng-controller</a></code> directive.</p>

<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-init=&quot;<em>expression</em>&quot; &gt;&lt;/<em>element</em>&gt;</div></div>
