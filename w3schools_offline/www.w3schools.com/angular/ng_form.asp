...
<!-- Mirrored from www.w3schools.com/angular/ng_form.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:04 GMT -->
<head>

<title>Angular form Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>form</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>This form's &quot;valid state&quot; will not be consider &quot;true&quot;, as long as the required 
input field is empty:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;form name=&quot;myForm&quot;&gt;<br>&lt;input name=&quot;myInput&quot; ng-model=&quot;myInput&quot; required&gt;<br>
	&lt;/form&gt;<br><br>&lt;p&gt;The forms's valid state is:&lt;/p&gt;<br>&lt;h1&gt;{{myForm.$valid}}&lt;/h1&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita4f0.html?filename=try_ng_ref_form">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>AngularJS modifies the default behavior of the <code>&lt;form&gt;</code> element.</p>
<p>Forms inside an AngularJS application are given certain properties. These 
properties describes the current state of the form.</p>
<p>Forms have the following states:</p>
<ul>
	<li><code>$pristine</code> No fields have been modified yet</li>
	<li><code>$dirty</code> One or more have been modified</li>
	<li><code>$invalid</code> The form content is not valid</li>
	<li><code>$valid</code> The form content is valid</li>
	<li><code>$submitted</code> The form is submitted</li>
</ul>
<p>The value of each state represents a Boolean value, and is either <code>true</code> 
or <code>false</code>.</p>
<p>Forms in AngularJS prevents the default action, which is submitting the form 
to the server, if the action attribute is not specified.</p>
<hr>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;form name=&quot;<em>formname</em>&quot;&gt;&lt;/form&gt;</div></div>
<p>Forms are being referred to by using the value of the name attribute.</p>


<hr>
<h2>CSS Classes</h2>
<p>Forms inside an AngularJS application are given certain <em>classes</em>. These 
classes can be used to style forms according to their state.</p>
<p>The following classes are added:</p>
<ul>
	<li><code>ng-pristine</code> No fields has not been modified yet</li>
	<li><code>ng-dirty</code> One or more fields has been modified</li>
	<li><code>ng-valid</code> The form content is valid</li>
	<li><code>ng-invalid</code> The form content is not valid</li>
...
<div class="cssHigh">
	form.ng-pristine {<br>&nbsp;&nbsp;&nbsp; background-color: lightblue;<br>}<br>
	form.ng-dirty {<br>&nbsp;&nbsp;&nbsp; background-color: pink;<br>}<br>
</div>
<div class="htmlHigh">
&lt;/style&gt;
</div>
</div>
<a class="w3-btn w3-margin-bottom"href="tryit06fb.html?filename=try_ng_ref_form_classes" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_form.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:05 GMT -->
</html>