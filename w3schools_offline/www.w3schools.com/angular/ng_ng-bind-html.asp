...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-bind-html.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:22 GMT -->
<head>

<title>Angular ng-bind-html Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-bind-html</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Bind the innerHTML of the &lt;p&gt; element to the variable <em>myText</em>:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;script 
	src=&quot;http://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular.min.js&quot;&gt;&lt;/script&gt;<br>
	&lt;script 
	src=&quot;//ajax.googleapis.com/ajax/libs/angularjs/1.5.0-beta.2/angular-sanitize.js&quot;&gt;&lt;/script&gt;<br>
	&lt;body&gt;<br><br>&lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;myCtrl&quot;&gt;<br><br>&nbsp;&nbsp;&nbsp; 
	&lt;p ng-bind-html=&quot;myText&quot;&gt;&lt;/p&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = 
	angular.module(&quot;myApp&quot;, ['ngSanitize']);<br>app.controller(&quot;myCtrl&quot;, 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.myText = &quot;My name is: 
	&lt;h1&gt;John Doe&lt;/h1&gt;&quot;;<br>});<br>&lt;/script&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit34e6.html?filename=try_ng_ng-bind-html">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p style="margin-top: 19px">The <code>ng-bind-html</code> directive is a secure 
way of binding content to an HTML element.</p>
<p style="margin-top: 19px">When you are letting AngularJS write HTML in your 
application, you should check the HTML for dangerous code. By including the 
&quot;angular-santize.js&quot; module in your application you can do so by running the 
HTML code through the ngSanitize function.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-bind-html=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Specifies a variable, or an expression to evaluate.</td>
    </tr>
  </table>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-bind-html.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:23 GMT -->
</html>