...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-cloak.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:31 GMT -->
<head>

<title>Angular ng-cloak Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-cloak</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Prevent the application from flicker at page load:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;div ng-app=&quot;&quot;&gt;<br><br>&lt;p ng-cloak&gt;{{ 5 + 5 }}&lt;/p&gt;<br><br>&lt;/div&gt;<br></div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit81ae.html?filename=try_ng_ng-cloak">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-cloak</code> directive prevents the document from showing unfinished AngularJS code while AngularJS is being loaded.</p>
<p>AngularJS applications can make HTML documents flicker when the 
application is being loaded, showing the AngularJS code for a second, before all 
code are executed. Use the <code>ng-cloak</code> directive to prevent this.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-cloak&gt;&lt;/<em>element</em>&gt;</div></div>
<p>Supported by all HTML elements.</p>
<hr>
<h2>Parameter Values</h2>
<p>The <code>ng-cloak</code> directive has no parameters.</p>
