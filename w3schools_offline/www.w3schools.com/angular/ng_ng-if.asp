...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-if.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:38 GMT -->
<head>

<title>Angular ng-if Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-if</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Uncheck a checkbox to remove a section:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    Keep HTML: &lt;input type=&quot;checkbox&quot; ng-model=&quot;myVar&quot; 
	ng-init=&quot;myVar = true&quot;&gt;<br>&lt;div 
	ng-if=&quot;myVar&quot;&gt;<br>
	&lt;h1&gt;Welcome&lt;/h1&gt;<br>&lt;p&gt;Welcome to my home.&lt;/p&gt;<br>
	&lt;hr&gt;<br>&lt;/div&gt;<br></div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitf7ea.html?filename=try_ng_ng-if">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-if</code> directive removes the HTML element if the expression evaluates to false.</p>
<p>If the if statement evaluates to true, a copy of the Element is added in the DOM.</p>
<p>The <code>ng-if</code> directive is different from the ng-hide which hides the display of the element, were the ng-if directive completely removes the
element from the DOM.</p><hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-if=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression that will completely remove the element if it returns
	true. If it returns true, a copy of the element will be inserted instead.</td>
    </tr>
  </table>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-if.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:39 GMT -->
</html>