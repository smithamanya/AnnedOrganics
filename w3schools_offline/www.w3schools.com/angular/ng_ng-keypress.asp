...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-keypress.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:41 GMT -->
<head>

<title>Angular ng-keypress Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-keypress</code></span> Directive</h1>
<div class="chapter">
...
<div class="w3-code notranslate htmlHigh">
    ...
    &lt;input ng-keypress=&quot;count = count + 1&quot; ng-init=&quot;count=0&quot; /&gt;<br><br>
	&lt;h1&gt;{{count}}&lt;/h1&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita504.html?filename=try_ng_ng-keydown">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-keypress</code> directive tells AngularJS what to do when the 
keyboard is used on the specific HTML element.</p>
<p>The <code>ng-keypress</code> directive from AngularJS will not override the element's original onkeypress event, both will be executed.</p>
...
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-keypress=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when a key is pressed.</td>
    </tr>
  </table>
</div>
<hr>
