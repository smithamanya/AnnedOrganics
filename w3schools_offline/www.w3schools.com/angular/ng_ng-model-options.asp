...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-model-options.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:44 GMT -->
<head>

<title>Angular ng-model-options Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-model-options</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Wait with the data-binding until the field loses focus:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;myCtrl&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input ng-model=&quot;name&quot; 
	ng-model-options=&quot;{updateOn: 'blur'}&quot;&gt;<br>
	&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', []);<br>
	app.controller('myCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.name 
	= &quot;John Doe&quot;;<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitdb4d.html?filename=try_ng_ng-model-options">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-model-options</code> directive is used to control the binding of an HTML form element 
and a variable 
in the scope.</p>
<p>You can specify that the binding should wait for a specific event to occur, 
or wait a specific number of milliseconds, and more, see the legal values listed 
in the parameter values below.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-model-options=&quot;<em>option</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
<p>Supported by &lt;input&gt;, &lt;select&gt;, and &lt;textarea&gt; elements.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><em>option</em></td>
    <td>An object specifying what options the data-binding must follow. Legal 
	objects are:<br><br>{updateOn: '<em>event</em>'} specifies that the binding 
	should happen when the specific event occur.<br><br>{debounce : 1000} 
	specifies how many milliseconds to wait with the binding.<br><br>{allowInvalid 
	: true|false} specify if the binding can happen if the value di not 
	validate.<br><br>{getterSetter : true|false} specifies if functions bound to 
	the model should be treated as getters/setters.<br><br>{timezone : '0100'} 
	Specifies what timezone should be used when working with the Date object.</td>
    </tr>
  </table>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-model-options.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:45 GMT -->
</html>