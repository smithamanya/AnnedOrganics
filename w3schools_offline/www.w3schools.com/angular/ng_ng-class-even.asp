...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-class-even.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:27 GMT -->
<head>

<title>Angular ng-class-even Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-class-even</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Set class=&quot;striped&quot; for every other (even) table row:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;table ng-controller=&quot;myCtrl&quot;&gt;<br>&lt;tr ng-repeat=&quot;x in records&quot; 
	ng-class-even=&quot;'striped'&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;td&gt;{{x.Name}}&lt;/td&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;td&gt;{{x.Country}}&lt;/td&gt; <br>&lt;/tr&gt;<br>&lt;/table&gt;<br></div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita078.html?filename=try_ng_ng-class-even">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-class-even</code> directive dynamically binds one or more CSS 
classes to an HTML element, but will take effect only on every other (even) 
appearence of the HTML element.</p>
<p>The <code>ng-class-even</code> directive will only work if it is used 
together with the <code>ng-repeat</code> directive.</p>
<p>The <code>ng-class-even</code> directive is perfect for styling items in a 
list or rows in a table, but it can be used on any HTML element.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-class-even=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-class-even.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:28 GMT -->
</html>