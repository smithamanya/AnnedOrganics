...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-app.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:19 GMT -->
<head>

<title>Angular ng-app Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-app</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Let the body element become the root element for the AngularJS application:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;body ng-app=&quot;&quot;&gt;<br><br>&lt;p&gt;My first expression: {{ 5 + 5 
	}}&lt;/p&gt;<br><br>&lt;/body&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitb875.html?filename=try_ng_ng-app">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-app</code> directive tells AngularJS that this is the root element of the 
AngularJS application.</p>
<p>All AngularJS applications must have a root element.</p>
<p>You can only have one <code>ng-app</code> directive in your HTML document. If more than 
one <code>ng-app</code> directive appears, the first appearance will be used.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-app=&quot;<em>modulename</em>&quot;&gt;<br>...<br><em>&nbsp; content inside the ng-app 
	root element can contain AngularJS code<br></em>...<br>&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Optional. Specifies the name of a module to load with the application</td>
    </tr>
  </table>
</div>
<hr>
<div class="w3-example">
<h3>Example</h3>
<p>Load a module to run in the application</p>
...
<div class="htmlHigh">&lt;/div&gt;<br><br>
&lt;script&gt;<br>
</div>
<div class="jsHigh">
var app = angular.module(&quot;myApp&quot;, []);<br>
	app.controller(&quot;myCtrl&quot;, function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.firstName = 
	&quot;John&quot;;<br>&nbsp;&nbsp;&nbsp; $scope.lastName = &quot;Doe&quot;;<br>});<br>
</div>
<div class="htmlHigh">&lt;/script&gt;<br></div>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit86bc.html?filename=try_ng_ng-app_module">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-app.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:21 GMT -->
</html>