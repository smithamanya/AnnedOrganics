...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-mousedown.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:45 GMT -->
<head>

<title>Angular ng-mousedown Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-mousedown</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Execute an expression when a mouse click occurs:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-mousedown=&quot;count = count + 1&quot; ng-init=&quot;count=0&quot;&gt;Click me!&lt;/div&gt;<br>
	<br>&lt;h1&gt;{{count}}&lt;/h1&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitef39.html?filename=try_ng_ng-mousedown">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-mousedown</code> directive tells AngularJS what to do when a 
mouse button is clicked on the specific HTML element.</p>
<p>The <code>ng-mousedown</code> directive from AngularJS will not override the element's original onmousedown event, both will be executed.</p>
...
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-mousedown=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when a mouse button is clicked.</td>
    </tr>
  </table>
</div>
<hr>
