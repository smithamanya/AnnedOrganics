...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-cut.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:34 GMT -->
<head>

<title>Angular ng-cut Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-cut</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Execute an expresson when the text of the input field is being cut:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit5021.html?filename=try_ng_ng-cut">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-cut</code> directive tells AngularJS what to do when you cut the text of an HTML element.</p>
<p>The <code>ng-cut</code> directive from AngularJS will not override the element's original oncut event,
both the <code>ng-cut</code> expression and the original oncut event will be executed.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-cut=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when the text of an element is being cut.</td>
    </tr>
  </table>
</div>
<hr>
