...
<!-- Mirrored from www.w3schools.com/angular/ng_textarea.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:07 GMT -->
<head>

<title>Angular textarea Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>textarea</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>An textarea with data-binding:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;textarea ng-model=&quot;myTextarea&quot;&gt;&lt;/textarea&gt;<br>
	<br>&lt;p&gt;The value of the textarea field is:&lt;/p&gt;<br>&lt;h1&gt;{{myTextarea}}&lt;/h1&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita956.html?filename=try_ng_ref_textarea">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>AngularJS modifies the default behavior of <code>&lt;textarea&gt;</code> elements, 
but only if the <code>ng-model</code> attribute is present.</p>
<p>They provide data-binding, which means they are part of the AngularJS model, 
and can be referred to, and updated, both in AngularJS functions and in the DOM.</p>
<p>They provide validation. Example: an <code>&lt;textarea&gt;</code> element with 
a <code>required</code> attribute, has the <code>$valid</code> state set to
<code>false</code> as long as it is empty.</p>
<p>They also provide state control. AngularJS holds the current state of all 
textarea elements.</p>
<p>Textarea fields have the following states:</p>
<ul>
	<li><code>$untouched</code> The field has not been touched yet</li>
	<li><code>$touched</code> The field has been touched</li>
	<li><code>$pristine</code> The field has not been modified yet</li>
	<li><code>$dirty</code> The field has been modified</li>
	<li><code>$invalid</code> The field content is not valid</li>
	<li><code>$valid</code> The field content is valid</li>
</ul>
<p>The value of each state represents a Boolean value, and is either <code>true</code> 
of <code>false</code>.</p>
<hr>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;textarea ng-model=&quot;<em>name</em>&quot;&gt;&lt;/textarea&gt;</div></div>
<p>Textarea elements are being referred to by using the value of the <code>ng-model</code> attribute.</p>


<hr>
<h2>CSS Classes</h2>
<p><code>&lt;textarea&gt;</code> elements inside an AngularJS application are given certain <em>classes</em>. These 
classes can be used to style textarea elements according to their state.</p>
<p>The following classes are added:</p>
<ul>
	<li><code>ng-untouched</code> The field has not been touched yet</li>
	<li><code>ng-touched</code> The field has been touched</li>
	<li><code>ng-pristine</code> The field has not been&nbsp; modified yet</li>
	...
	<li><code>ng-valid-<em>key</em></code> One <em>key</em> for each validation. 
	Example: <code>ng-valid-required</code>, useful when there are more than one 
	thing that must be validated</li>
	<li><code>ng-invalid-<em>key</em></code> Example: <code>ng-invalid-required</code></li>
</ul>
<p>The classes are removed if the value they represent is <code>false</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Apply styles for valid and invalid textarea elements, using standard CSS:</p>
<div class="w3-code notranslate">
<div class="htmlHigh">
	&lt;style&gt;<br>
</div>
<div class="cssHigh">
	textarea.ng-invalid {<br>&nbsp;&nbsp;&nbsp; background-color: pink;<br>
	}<br>
	textarea.ng-valid {<br>&nbsp;&nbsp;&nbsp; background-color: lightgreen;<br>
	}<br>
</div>
<div class="htmlHigh">
&lt;/style&gt;
...
<a class="w3-btn w3-margin-bottom"href="tryit141d.html?filename=try_ng_ref_textarea_classes" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/angular/ng_textarea.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:08 GMT -->
</html>