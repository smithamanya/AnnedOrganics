...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-mouseover.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:49 GMT -->
<head>

<title>Angular ng-mouseover Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-mouseover</code></span> Directive</h1>
<div class="chapter">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita336.html?filename=try_ng_ng-mouseover">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-mouseover</code> directive tells AngularJS what to do when a 
mouse cursor moves over the specific HTML element.</p>
<p>The <code>ng-mouseover</code> directive from AngularJS will not override the element's original onmouseover event, both will be executed.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-mouseover=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
