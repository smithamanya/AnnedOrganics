...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-paste.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:52 GMT -->
<head>

<title>Angular ng-paste Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-paste</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Execute an expression when text is pasted into the the input:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryite817.html?filename=try_ng_ng-paste">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-paste</code> directive tells AngularJS what to do when text is 
pasted into an HTML element.</p>
<p>The <code>ng-paste</code> directive from AngularJS will not override the element's original onpaste event,
both will be executed.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;<em>element</em> ng-paste=&quot;<em>expression</em>&quot;&gt;&lt;/<em>element</em>&gt;</div></div>
<p>Supported by &lt;input&gt;, &lt;select&gt;, and &lt;textarea&gt; and other 
editable elements</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>An expression to execute when text is being pasted into an element.</td>
    </tr>
  </table>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-paste.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:53 GMT -->
</html>