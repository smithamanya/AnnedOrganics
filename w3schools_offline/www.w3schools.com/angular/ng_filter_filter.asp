...
<!-- Mirrored from www.w3schools.com/angular/ng_filter_filter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:14 GMT -->
<head>

<title>Angular filter Filter</title>
...
googletag.pubads().setTargeting("content","angular");
...
<a href='../html/default.html' class='w3-hide-small' title='HTML Tutorial'>HTML</a><a href='../css/default.html' class='w3-hide-small' title='CSS Tutorial'>CSS</a><a href='../js/default.html' class='w3-hide-small' title='JavaScript Tutorial'>JAVASCRIPT</a><a href='../sql/default.html' class='w3-hide-small' title='SQL Tutorial'>SQL</a><a href='../php/default.html' class='w3-hide-small' title='PHP Tutorial'>PHP</a><a href='../bootstrap/default.html' class='w3-hide-small' title='Bootstrap Tutorial'>BOOTSTRAP</a><a href='../jquery/default.html' class='w3-hide-small' title='jQuery Tutorial'>JQUERY</a><a href='default.html' class='w3-hide-small' title='Angular Tutorial'>ANGULAR</a><a href='../xml/default.html' class='w3-hide-small' title='XML Tutorial'>XML</a></div>
...
<a target="_top" href="default.html">Angular HOME</a>
<a target="_top" href="angular_intro.html">Angular Intro</a>
<a target="_top" href="angular_expressions.html">Angular Expressions</a>
<a target="_top" href="angular_modules.html">Angular Modules</a>
<a target="_top" href="angular_directives.html">Angular Directives</a>
<a target="_top" href="angular_model.html">Angular Model</a>
<a target="_top" href="angular_controllers.html">Angular Controllers</a>
<a target="_top" href="angular_scopes.html">Angular Scopes</a>
<a target="_top" href="angular_filters.html">Angular Filters</a>
<a target="_top" href="angular_http.html">Angular Http</a>
<a target="_top" href="angular_tables.html">Angular Tables</a>
<a target="_top" href="angular_sql.html">Angular SQL</a>
<a target="_top" href="angular_htmldom.html">Angular DOM</a>
<a target="_top" href="angular_events.html">Angular Events</a>
<a target="_top" href="angular_forms.html">Angular Forms</a>
<a target="_top" href="angular_validation.html">Angular Validation</a>
<a target="_top" href="angular_api.html">Angular API</a>
<a target="_top" href="angular_w3css.html">Angular W3.CSS</a>
<a target="_top" href="angular_includes.html">Angular Includes</a>
<a target="_top" href="angular_animations.html">Angular Animations</a>
<a target="_top" href="angular_application.html">Angular Application</a>
<br>
<h2 class="left">Examples</h2>
<a target="_top" href="angular_examples.html">Angular Examples</a>
<br>
<h2 class="left">Reference</h2>
<a target="_top" href="angular_ref_directives.html">Angular Reference</a><br><br></div></div>&nbsp;</div>
<div class='w3-rest'>
...
<h1>AngularJS <span class="color_h1"><code>filter</code></span> Filter</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="angular_ref_directives.html">&laquo; AngularJS Reference</a></div>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Display the items that contains the letter &quot;A&quot;:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;arrCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in cars | filter : 'A'&quot;&gt;{{x}}&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>
	var app = angular.module('myApp', []);<br>app.controller('arrCtrl', 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.cars = [&quot;Aston Martin&quot;, 
	&quot;Audi&quot;, &quot;Bentley&quot;, &quot;BMW&quot;, &quot;Bugatti&quot;];<br>});<br>&lt;/script&gt;</div>
	<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitae58.html?filename=try_ng_ref_filter">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>filter</code> filter allows us to filter an array, and return an 
array containing only the matching items.</p>
<p>This filter can only be used for arrays.</p>
<hr>
...
<div class="w3-code w3-border notranslate jsHigh"><div>
	{{ 
	<em>
	arrayexpression</em> | filter : <em>expression</em> : <em>
	comparator</em> }}</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td style="background-color:#f9f9f9"><em>expression</em></td>
    <td style="background-color:#f9f9f9">The expression used when selecting 
	items from the array. The expression can be of type:<br><br>String: The 
	array items that match the string will be returned.<br><br>Object: The object 
	is a pattern to search for in the array. Example: <code>{&quot;name&quot; : &quot;H&quot;, 
	&quot;city&quot;: &quot;London&quot;}</code> will return the array items with a name 
	containing the letter &quot;A&quot;, where the city contains the word &quot;Berlin&quot;. See 
	example below.<br><br>Function: A function which will be called for each array item, 
	and items where the function returns true will be in the 
	result array.
	</td>
    </tr>
    <tr>
    <td><em>comparator</em></td>
    <td>Optional. Defines how strict the comparison should be. The value can be:<br>
	<br>true : Returns a match only if the value of the array item is exactly 
	what we compare it with.<br><br>false : Returns a match if the value of the 
	array item <em>contains</em> what we compare it with. This comparison is not case sensitiv. 
	This is the default value.<br><br>function : A function where we can define 
	what will be considered a match or not.</td>
    </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use an object as a filter:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;arrCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in customers | filter : {'name' : 'O', 'city' : 'London'}&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
	{{x.name + &quot;, &quot; + x.city}}<br>&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = 
	angular.module('myApp', []);<br>app.controller('arrCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; 
	$scope.customers = [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {&quot;name&quot; : 
	&quot;Alfreds Futterkiste&quot;, &quot;city&quot; : &quot;Berlin&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;Around the Horn&quot;, &quot;city&quot; : &quot;London&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;B's Beverages&quot;, &quot;city&quot; : &quot;London&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;Bolido Comidas preparadas&quot;, &quot;city&quot; : &quot;Madrid&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;Bon app&quot;, &quot;city&quot; : &quot;Marseille&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;Bottom-Dollar Marketse&quot; ,&quot;city&quot; : &quot;Tsawassen&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;Cactus Comidas para llevar&quot;, &quot;city&quot; : &quot;Buenos Aires&quot;}<br>&nbsp;&nbsp;&nbsp; 
	];<br>});<br>
	&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2ce3.html?filename=try_ng_ref_filter_object">Try it yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Do a &quot;strict&quot; comparison, which does not return a match unless the value is
<em>exactly</em> the same as the expression:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;arrCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in customers | filter : 'London' : true&quot;&gt;<br>&nbsp;&nbsp;&nbsp; {{x.name + &quot;, &quot; + x.city}}<br>&lt;/li&gt;<br>
	&lt;/ul&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', 
	[]);<br>app.controller('arrCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.customers = [<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	{&quot;name&quot; : &quot;London Food&quot;, &quot;city&quot; : &quot;London&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {&quot;name&quot; : &quot;London Catering&quot;, 
	&quot;city&quot; : &quot;London City&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {&quot;name&quot; : &quot;London Travel&quot;, &quot;city&quot; : &quot;Heathrow, 
	London&quot;}<br>&nbsp;&nbsp;&nbsp; ];<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit8158.html?filename=try_ng_ref_filter_strict">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
<p>AngularJS Tutorial: <a href="angular_filters.html">Angular Filters</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="angular_ref_directives.html">&laquo; AngularJS Reference</a></div>
</div>
...
<a href="default.html">Angular Tutorial</a><br>
...
<a href="angular_ref_directives.html">AngularJS Reference</a><br>
</div>
</div>
<div class="w3-col l3 m6 s12">
<div class="top10">
...
<a href='default.html'>Learn AngularJS</a>
...
<a href='angular_ref_directives.html'>AngularJS Reference</a>
...
<a href='angular_examples.html' target='_top'>AngularJS Examples</a>
...
<!-- Mirrored from www.w3schools.com/angular/ng_filter_filter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:16 GMT -->
</html>