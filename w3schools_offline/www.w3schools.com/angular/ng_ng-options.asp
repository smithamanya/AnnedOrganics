...
<!-- Mirrored from www.w3schools.com/angular/ng_ng-options.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:23:52 GMT -->
<head>

<title>Angular ng-options Directive</title>
...
<h1>AngularJS <span class="color_h1"><code>ng-options</code></span> Directive</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Fill options in a dropdown list by using the items of an array:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;myCtrl&quot;&gt;<br>&lt;select ng-model=&quot;selectedName&quot; 
	ng-options=&quot;item for item in names&quot;&gt;&lt;/select&gt;<br>&lt;/div&gt;<br><br>&lt;script&gt;<br>
	var app = angular.module('myApp', []);<br>app.controller('myCtrl', 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.names = [&quot;Emil&quot;, &quot;Tobias&quot;, 
	&quot;Linus&quot;];<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita900.html?filename=try_ng_ng-options">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>ng-options</code> directive fills a &lt;select&gt; element with 
&lt;options&gt;.</p>
<p>The <code>ng-options</code> directive uses an array to fill the dropdown 
list. In many cases it would be better to use the <code>ng-repeat</code> 
directive, but you have more flexibility when using the <code>ng-options</code> 
directive.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate htmlHigh"><div>
	&lt;select ng-options=&quot;<em>array expression</em>&quot;&gt;&lt;/select&gt;</div></div>
<p>Supported by the &lt;select&gt; element.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><i>array expression</i></td>
    <td>An expression that selects the specified parts of an array to fill the 
	select element.<br><br>Legal expressions:<br><br><em>label</em> for <em>
	value</em> in <em>array</em><br><br><em>select</em> as <em>label</em> for
	<em>value</em> in <em>array<br><br>label </em>group by<em> group</em> for
	<em>value</em> in <em>array<br><br>label</em> disabled when <em>disable</em> 
	for <em>value</em> in <em>array<br><br>label</em> group by <em>group</em> 
	for <em>value</em> in <em>array</em> track by <em>expression<br><br>label</em> 
	disabled when <em>disable</em> for <em>value</em> in <em>array</em> track by
	<em>expression<br><br>label</em> for <em>value</em> in <em>array</em> | 
	orderBy <em>expression</em> track by <em>expression<br><br></em></td>
    </tr>
  </table>
</div>
