...
<!-- Mirrored from www.w3schools.com/angular/ng_filter_orderby.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:24 GMT -->
<head>

<title>Angular orderBy Filter</title>
...
<h1>AngularJS <span class="color_h1"><code>orderBy</code></span> Filter</h1>
<div class="chapter">
...
<h3>Example</h3>
<p>Display the items alphabetically:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;orderCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in cars | orderBy&quot;&gt;{{x}}&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var 
	app = angular.module('myApp', []);<br>app.controller('orderCtrl', 
	function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.cars = [&quot;Dodge&quot;, &quot;Fiat&quot;, 
	&quot;Audi&quot;, &quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;];<br>});<br>&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryite24e.html?filename=try_ng_ref_orderby">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code>orderBy</code> filter allows us to sort an array.</p>
<p>By default, strings are sorted alphabetically, and numbers are sorted 
numerically.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate jsHigh"><div>
	{{ <em>array</em> | orderBy : <em>
	expression</em> : <em>
	reverse</em> }}</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>The expression used to determine the order. The expression can be of 
	type:<br><br>String: If the array is an array of objects, you can sort the 
	array by the value of one of the object properties. See the examples below.<br><br>Function: You can 
	create a function to organize the sorting.<br><br>Array: Use an array if you 
	need more than one object property to determine the sorting order. The array 
	items can be both strings and functions. </td>
    </tr>
	<tr>
    <td><em>reverse</em></td>
    <td>Optional. Set to true if you want to reverse the order of the array.</td>
    </tr>
    </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Sort the array by &quot;city&quot;:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;orderCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in customers | orderBy : 'city'&quot;&gt;{{x.name + &quot;, &quot; + x.city}}&lt;/li&gt;<br>&lt;/ul&gt;<br>
	<br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', []);<br>
	app.controller('orderCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.customers 
	= [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {&quot;name&quot; : &quot;Bottom-Dollar 
	Marketse&quot; ,&quot;city&quot; : &quot;Tsawassen&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	{&quot;name&quot; : &quot;Alfreds Futterkiste&quot;, &quot;city&quot; : &quot;Berlin&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	{&quot;name&quot; : &quot;B's Beverages&quot;, &quot;city&quot; : &quot;London&quot;}<br>&nbsp;&nbsp;&nbsp; ];<br>
	});<br>
	&lt;/script&gt;<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitb016.html?filename=try_ng_ref_orderby_object">Try it yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Sort the array by &quot;city&quot;, in descending order:</p>
<div class="w3-code notranslate htmlHigh">
  
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;orderCtrl&quot;&gt;<br><br>&lt;ul&gt;<br>&lt;li ng-repeat=&quot;x 
	in customers | orderBy : '<strong>-city'&quot;</strong>&gt;{{x.name + &quot;, &quot; + x.city}}&lt;/li&gt;<br>&lt;/ul&gt;<br>
	<br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', []);<br>
	app.controller('orderCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.customers 
	= [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {&quot;name&quot; : &quot;Bottom-Dollar 
	Marketse&quot; ,&quot;city&quot; : &quot;Tsawassen&quot;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit5c5e.html?filename=try_ng_ref_orderby_desc">Try it yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
...
<!-- Mirrored from www.w3schools.com/angular/ng_filter_orderby.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:26 GMT -->
</html>