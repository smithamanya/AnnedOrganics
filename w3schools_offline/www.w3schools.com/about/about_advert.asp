...
<!-- Mirrored from www.w3schools.com/about/about_advert.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:19 GMT -->
<head>
...
xmlhttp.open("POST.html","../adform_sup.html",true);
...
<a target="_top" href="default.html">About W3Schools</a>
<a target="_top" href="about_copyright.html">About Copyright</a>
<a target="_top" href="about_privacy.html">About Privacy</a>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="about_privacy.html">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="default.html">Next &raquo;</a></div>
</div>
<hr>
<h2>Advertising Prices and Other Questions:</h2>

<div class="w3-container" id="ad_form">
    <form class="w3-form">
      <div class="w3-input-group">
        <label for="ad_name">Name:</label>
        <input type="text" id="ad_name" name="ad_name" class="w3-input" placeholder="Your name" />
      </div>
      <div class="w3-input-group">
        <label for="ad_company">Company:</label>
        <input type="text" id="ad_company" name="ad_company" class="w3-input" placeholder="Your companyname" />
      </div>
      <div class="w3-input-group">
        <label for="ad_email">Contact E-mail:</label>
        <input type="email" id="ad_email" name="ad_email" class="w3-input" placeholder="Your e-mail address" />
      </div>
      <div class="w3-input-group">
        <label for="ad_desc">Ad description / Requirement / Question:</label>
        <textarea name="ad_desc" id="ad_desc" style="width:100%;height:200px;"></textarea>
      </div>
      <div class="w3-input-group">
        <input type="button" value=" Submit " onclick="sendAdform()" />
      </div>
    </form>
</div>
...
<div class="w3-col l3 m3 s12">
<a href="default.html" target="_top">ABOUT</a>
</div>
</div>
<hr>
...
<a href="about_copyright.html">Copyright 1999-2016</a> by Refsnes Data. All Rights Reserved.<br><br>
<a href="../index.html">
...
<!-- Mirrored from www.w3schools.com/about/about_advert.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:37:21 GMT -->
</html>