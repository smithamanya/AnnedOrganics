...
<!-- Mirrored from www.w3schools.com/sql/func_date_format.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:15 GMT -->
<head>
...
<hr>
<a href="sql_dates.html"><img class="navup" src="../images/up.gif" alt="SQL Dates" /> MySQL Date Functions</a>
<hr>
...
<tr><td>%D</td><td>Day of month with English suffix (0th, 1st, 2nd, 3rd, …)</td></tr>
...
<tr><td>%X</td><td>Year for the week where Sunday is the first day of week, four digits, used with %V</td></tr>
<tr><td>%x</td><td>Year for the week where Monday is the first day of week, four digits, used with %v</td></tr>
