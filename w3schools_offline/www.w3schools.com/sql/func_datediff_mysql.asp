...
<!-- Mirrored from www.w3schools.com/sql/func_datediff_mysql.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:15 GMT -->
<head>
...
<div class="w3-code w3-border notranslate"><div>
SELECT DATEDIFF('2014-11-30','2014-11-29') AS DiffDate</div></div>
...
<p>The following SELECT statement:</p>
<div class="w3-code w3-border notranslate"><div>
SELECT DATEDIFF('2014-11-29','2014-11-30') AS DiffDate</div></div>
