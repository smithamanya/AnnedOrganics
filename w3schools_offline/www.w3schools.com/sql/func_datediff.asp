...
<!-- Mirrored from www.w3schools.com/sql/func_datediff.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:15 GMT -->
<head>
...
<div class="w3-code w3-border notranslate"><div>
SELECT DATEDIFF(day,'2014-06-05','2014-08-05') AS DiffDate</div></div>
<p>Result:</p>
...
<p>We use the following SELECT statement:</p>
<div class="w3-code w3-border notranslate"><div>
SELECT DATEDIFF(day,'2014-08-05','2014-06-05') AS DiffDate</div></div>
