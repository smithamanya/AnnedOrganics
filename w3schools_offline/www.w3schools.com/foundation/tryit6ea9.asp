...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_txt_hn&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:59 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Headings</h2>
  <p>Heading elements have different font-size in different screens. Below, the default font-size is in bold, while the other number applies when the screen is more than 40.0625em wide (tablets and desktops). Resize the browser window to see the effect.</p>
  <h1>h1 heading (<strong>2.125rem</strong> - 2.75rem)</h1>
  <h2>h2 heading (<strong>1.6875rem</strong> - 2.3125rem)</h2>
  <h3>h3 heading (<strong>1.375rem</strong> - 1.6875rem)</h3>
  <h4>h4 heading (<strong>1.125rem</strong> - 1.4375rem)</h4>
  <h5>h5 heading (1.125rem)</h5>
