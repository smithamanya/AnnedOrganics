...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_modal_nested2&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>A Modal Inside A Modal</h2>
  <!-- Trigger the modal -->
  <button type="button" class="button" data-reveal-id="myModal">Open Modal</button>

  <!-- The First Modal -->
  <div id="myModal" class="reveal-modal" data-reveal>
    <h2>First Modal</h2>
    <p>Open the second modal with the button below. This time, the first modal will NOT close (stays in the background of the second modal).</p>
    <p><a href="#" data-reveal-id="secondModal" class="button success" style="text-decoration:none;">Open Second Modal</a></p>
  ...
  <div id="secondModal" class="reveal-modal" data-reveal data-options="multiple_opened:true;">
    ...
    <p>See the difference? The second modal lays on top of the first modal. If you close this modal, you'll see the first modal again.</p>
    <a class="close-reveal-modal">&times;</a>
  </div>
</div>
