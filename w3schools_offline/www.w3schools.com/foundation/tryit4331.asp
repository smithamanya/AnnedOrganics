...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_large-text-center&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:01 GMT -->
<head>
...
<p>The <code>.large-text-center</code> class centers the text for screens wider than 64.0625em. Resize the browser window to see the effect.</p>
<p class="large-text-center" style="color:red;">Some Example Text</p>
