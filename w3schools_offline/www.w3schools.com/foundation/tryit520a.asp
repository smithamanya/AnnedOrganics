...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_thumbnail&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:35 GMT -->
<head>
...
<div style="padding:20px">
  <h2>Thumbnail</h2>
  <p>The <code>.th</code> class shapes the image to a thumbnail. It will also add a light blue outline around the image on hover.</p>
  <p><strong>Note:</strong> Images in Foundation are responsive by default. Resize the browser window to see the effect.</p>       
