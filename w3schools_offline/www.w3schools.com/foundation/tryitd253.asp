...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_slider_range&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Custom Range</h2>
  <p>By default, the minimum and maximum value of range sliders are "0" to "100". Add the data-options <code>start</code> and <code>end</code> to change this. In this example, you can only select a value between "1" and "20":</p>
