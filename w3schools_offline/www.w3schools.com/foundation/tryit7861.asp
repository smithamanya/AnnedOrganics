...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_medium-text-center&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:01 GMT -->
<head>
...
<p>The <code>.medium-text-center</code> class centers the text for screens wider than 40.0625em. Resize the browser window to see the effect.</p>
<p class="medium-text-center" style="color:red;">Some Example Text</p>
