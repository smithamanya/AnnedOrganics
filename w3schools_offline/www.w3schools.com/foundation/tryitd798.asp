...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_tooltips_pos&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<h2>Tooltips</h2>
<p>By default, the tooltip will appear on the bottom of the element (.tip-bottom). Use .tip-top, .tip-left or .tip-right to position the tooltip:</p>
<p><strong>Note:</strong> On small screens, the tooltip will appear on the bottom with a 100% full-width.</p>
