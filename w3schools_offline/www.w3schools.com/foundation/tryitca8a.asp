...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_slider_value&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Display Slider Value</h2>
  <p>Display the slider value in an element with a id that matches the <code>data-options="display_selector:#id"</code> attribute of div. Drag the handle to see the effect:</p>
