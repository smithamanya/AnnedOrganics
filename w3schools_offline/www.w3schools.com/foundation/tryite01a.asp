...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_modal_nested&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  ...
  <div id="myModal" class="reveal-modal" data-reveal>
    <h2>First Modal</h2>
    <p>The button below will open a new modal. If you open the new modal, foundation will close this modal (the first) and slide the new one into place over the first modal.</p>
    <p><a href="#" data-reveal-id="secondModal" class="button success">Open Second Modal</a></p>
  ...
  <div id="secondModal" class="reveal-modal" data-reveal>
    ...
    <p>Easy peasy! Out with the old and in with the new!</p>
    <p>Foundation replaces the first modal with the new (second) modal.</p>
    <a class="close-reveal-modal">&amp;times;</a>
  </div>
</div>
