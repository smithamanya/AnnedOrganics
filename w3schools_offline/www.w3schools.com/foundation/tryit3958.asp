...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_ex3&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:32 GMT -->
<head>
...
<div class="row">
  ...
  <p>In this example, create a 25%/75% split on large devices (laptops/desktops) and a 50%/50% split on small devices (mobile/small tablets).</p>
