...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_xlarge-only-text-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:00 GMT -->
<head>
...
<p>The <code>.xlarge-only-text-left</code> class aligns the text to the left for screen widths between 90.0625em and 120em. Resize the browser window to see the effect.</p>
<p class="text-right xlarge-only-text-left" style="color:red;">Some Example Text</p>
<p><strong>Note:</strong> Text is always left-aligned by default, in HTML. So this class has no meaning if the text is not aligned elsewhere. Therefore, we have also added the .text-right class in this example.
