...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_large-only-text-right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:01 GMT -->
<head>
...
<p>The <code>.large-only-text-right</code> class aligns the text to the right for screen widths between 64.0625em and 90em. Resize the browser window to see the effect.</p>
