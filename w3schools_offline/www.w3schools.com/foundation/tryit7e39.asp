...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_js_magellan_active&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:39 GMT -->
<head>
...
<h5 class="subheader">The <code>active_class</code> option specifies the class used for active links in the magellan bar. Default is .active. In this example, we set it to .test (look what .test do in the style section above):</h5>
<hr>
