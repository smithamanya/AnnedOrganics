...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_modal&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Modal</h2>
  <p>A modal is a dialog box that is displayed on top of the current page on click:</p>
