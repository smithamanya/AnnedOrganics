...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_incomplete&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:43 GMT -->
<head>
...
<div class="row">
  ...
  <p>If there's a row that does not add up to 12 columns, Foundation will automatically float the last element to the right and fill the remaining space. Optionally, add the <code>.end</code> class to the last element to float the element to the left:</p>
