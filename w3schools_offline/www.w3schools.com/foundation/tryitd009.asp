...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_sidenav_active&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:38 GMT -->
<head>
...
<div style="padding:20px;">
  <h3>Side Nav</h3>
  <p>The .active class highlights the current page link.</p>
  <p>The .divider class separates the links with a horizontal border.</p>
</div>
