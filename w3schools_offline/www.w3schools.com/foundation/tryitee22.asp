...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_slider_value_grid&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div class="row">
  <h2>Slider Value Grid</h2>
  <p>You can also use the grid to display the slider value next to the slider:</p>
