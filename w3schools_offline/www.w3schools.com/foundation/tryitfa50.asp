...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_topbar_left_right&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:38 GMT -->
<head>
...
<div style="padding:20px;">
  <h3>Left & Right Aligned Topbar</h3>
  <p>An example of left and right aligned buttons.</p>
  <p><strong>Note:</strong> On smaller screens, the topbar and replaced by a button in the top right corner (try to re-size this window).</p>
  <p>Only when the button is clicked, the navigation bar will be displayed - and the links are LEFT-aligned by default.</p>
</div>
