...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_ex2&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:32 GMT -->
<head>
...
<div class="row">
  ...
  <p>In this example, we show how to get two various-width columns starting at tables and scaling to desktops. On mobile phones, the columns will automatically stack.</p>
  <p>Resize the browser window to see the effect.</p>
  <div class="medium-4 columns" style="background-color:yellow;">.medium-4</div>
  <div class="medium-8 columns" style="background-color:pink;">.medium-8</div>
</div>
