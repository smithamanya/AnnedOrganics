...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_js_magellan_threshold&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:39 GMT -->
<head>
...
<h3>Magellan Options</h3>
<h5 class="subheader">The <code>threshold</code> option specifies when the magellan bar should stay in a fixed position. The number is calculated from when the scrolling hits the magellan div. Default is 0 (auto). In this example, we set it to 100:</h5>
<hr>

<div data-magellan-expedition="fixed" data-options="threshold:100">
  <dl class="sub-nav">
...
<a name="page2"></a>
<p>Try to scroll this section and look at the navigation bar while scrolling! Also try to scroll upwards.</p>
