...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_txt_blockquote&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:59 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Blockquotes</h2>
  <p>The blockquote element is used to present content from another source (notice the gray left border):</p>
  <blockquote>
    <p>For 50 years, WWF has been protecting the future of nature. The world's leading conservation organization, WWF works in 100 countries and is supported by 1.2 million members in the United States and close to 5 million globally.</p>
    <cite>From WWF's website</cite>
  </blockquote>
</div>
