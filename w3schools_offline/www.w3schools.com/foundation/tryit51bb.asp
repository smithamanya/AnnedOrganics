...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_js_magellan_destination&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:39 GMT -->
<head>
...
<h5 class="subheader">The <code>destination_threshold</code> option specifies the number of pixels from the top for when the links in the navigation list should turn active (blue background). Default is 20. In this example, we set it to 60:</h5>
<hr>
