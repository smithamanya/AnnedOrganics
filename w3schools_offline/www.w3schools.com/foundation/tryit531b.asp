...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_topbar_dropdown&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:38 GMT -->
<head>
...
<div style="padding:20px;">
  <h3>Topbar With Dropdown</h3>
  <p>This example adds a dropdown menu for the "Dropdown" button in the topbar.</p>
</div>
