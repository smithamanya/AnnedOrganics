...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_slider&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:40 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Range Sliders</h2>
  <p>The .range-slider-handle class creates the actual handle, and .range-slider-active-segment adds a gray color behind the handle:</p>
