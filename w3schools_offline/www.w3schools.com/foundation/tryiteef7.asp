...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_xxlarge-text-center&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:02 GMT -->
<head>
...
<p>The <code>.xxlarge-text-center</code> class centers the text for screens wider than 120em. Resize the browser window to see the effect.</p>
<p class="xxlarge-text-center" style="color:red;">Some Example Text</p>
