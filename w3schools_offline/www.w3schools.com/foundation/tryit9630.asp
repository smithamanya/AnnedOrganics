...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_equalizer_xxlarge&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:42 GMT -->
<head>
...
<div class="row" data-equalizer data-equalizer-mq="xxlarge-up">
  <h2>Responsive Equalizer</h2>
  <p>In this example, we have added the <code>data-equalizer-mq="xxlarge-up"</code> attribute, which will create an equal height container for XXL screens and wider (120.063em and up). Resize the browser window to see the effect (if your screen is wide enough).</p> 
  <div class="medium-4 columns panel" data-equalizer-watch>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
      <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>  
      <p><strong>I am the tallest element. The other elements use my height.</strong></p> 
  </div>
  <div class="medium-4 columns panel" data-equalizer-watch>
