...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_slider_step&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Steps</h2>
  <p>By default, steps (the legal number intervals) in range sliders are &quot;1&quot;. Add the <code>step</code> data-option to change the step value. In this example, the step is 25. Drag the handle to see the effect:</p>
