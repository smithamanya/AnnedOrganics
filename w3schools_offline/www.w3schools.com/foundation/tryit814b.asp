...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_table_responsive&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:32 GMT -->
<head>
...
<p>Add a div element with overflow-x:auto around the table to make it responsive.</p>
<p>Resize the browser window to see the effect (adds a vertical scrollbar to the table when there's not enough room).</p>
