...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_stacked_to_hor&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:42 GMT -->
<head>
...
<div class="row">
  ...
  <p>A simple "stacked-to-horizontal" two-column layout example.</p>
  <p>Resize the browser window to see the effect.</p>
  <div class="medium-6 columns" style="background-color:yellow;">.medium-4</div>
  <div class="medium-6 columns" style="background-color:pink;">.medium-4</div>
</div>
