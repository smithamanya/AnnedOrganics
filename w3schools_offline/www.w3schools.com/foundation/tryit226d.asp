...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_container&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:42 GMT -->
<head>
...
<p>Wrap a container around the .row to specify a background-color that spans the entire width of the page:</p>
