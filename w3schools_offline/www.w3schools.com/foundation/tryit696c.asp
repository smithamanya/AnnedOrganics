...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_sidenav_grid&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:38 GMT -->
<head>
...
<div class="row">
  ...
  <div class="medium-8 columns">
    <h1>Side Nav</h1>
    <p>In this example we put the side nav in a grid and we gave it a gray background color.</p>
    <p><strong>Note:</strong> On smaller screens, the side nav will now stack horizontally, due to the grid (100% width).</p>
    <p>Try to re-size the browser window to see the effect.</p>
    <p>This behavior can be changed with javascript or media queries.</p>
  </div>
</div>
