...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_center&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:43 GMT -->
<head>
...
<div class="row">
  <h2>Grid - Centering Columns</h2>
  <p>Center columns with the <code>.small-centered</code> class. Medium and large devices inherits small centering, but you can also specify centering for only large devices with the <code>.large-centered</code> class. To uncenter on large screens, use <code>.large-uncentered</code>.</p>
  <p>We have made many different examples. Resize the browser window to see the effect:</p>
