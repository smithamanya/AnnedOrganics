...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_xxlarge-text-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:00 GMT -->
<head>
...
<p>The <code>.xxlarge-text-left</code> class aligns the text to the left for screens wider than 120em. Resize the browser window to see the effect.</p>
<p class="text-right xxlarge-text-left" style="color:red;">Some Example Text</p>
