...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_switches_grouped&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:40 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Grouped Switches</h2>
  <p>Each radio button must contain the same value of the name attribute, if you want to group switches together. This will make each switch turn off the other one(s):</p>
  <form>
    <div class="switch">
