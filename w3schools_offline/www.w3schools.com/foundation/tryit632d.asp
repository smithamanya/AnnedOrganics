...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_slider_default_value&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Default Slider Value</h2>
  <p>By default, the slider handle is placed in the middle of the slider (which is often the number "50"). Add the <code>data-options=&quot;initial: <em>num</em>&quot;</code> attribute to change the default value:</p>
