...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_visibility_show&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:44 GMT -->
<head>
...
<h2>Show Elements by Screen Size</h2>
<p><strong>Note:</strong> Resize the browser window to see the effect.</p>
...
<p class="show-for-xlarge-only">I am is shown only on an xlarge screen.</p>
<p class="show-for-xxlarge-up">I am is shown on xxlarge screens and up.</p>
