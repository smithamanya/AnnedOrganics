...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_small-only-text-center&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:01 GMT -->
<head>
...
<p>The <code>.small-text-only-center</code> class centers the text ONLY for small screens (below 40em in width). Resize the browser window to see the effect.</p>
<p class="small-only-text-center" style="color:red;">Some Example Text</p>
