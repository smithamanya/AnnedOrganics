...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_small-text-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:00 GMT -->
<head>
...
<p>The <code>.small-text-left</code> class aligns the text to the left for all screen sizes. Resize the browser window to see the effect.</p>
<p class="small-text-left">Left-aligned text</p>
