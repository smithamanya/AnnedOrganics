...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_large-only-text-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:00 GMT -->
<head>
...
<p>The <code>.large-only-text-left</code> class aligns the text to the left for screen widths between 64.0625em and 90em. Resize the browser window to see the effect.</p>
<p class="text-right large-only-text-left" style="color:red;">Some Example Text</p>
