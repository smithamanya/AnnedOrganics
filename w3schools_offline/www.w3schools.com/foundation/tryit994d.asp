...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_2unequal&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:43 GMT -->
<head>
...
<div class="row">
  <h2>Grid - Two Unequal Columns</h2>
  <p>In this example, we show how to create two columns of unequal width on all devices (33.3%/66% split for phones, tablets, laptops and desktops).</p>
