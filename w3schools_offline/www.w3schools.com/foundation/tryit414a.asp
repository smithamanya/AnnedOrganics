...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_medium-text-left&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:00 GMT -->
<head>
...
<p>The <code>.medium-text-left</code> class aligns the text to the left for screens wider than 40.0625em. Resize the browser window to see the effect.</p>
<p class="text-right medium-text-left" style="color:red;">Some Example Text</p>
