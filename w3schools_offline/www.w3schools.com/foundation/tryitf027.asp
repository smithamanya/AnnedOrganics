...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_modal_size&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<div style="padding:20px;">
  <h2>Modal Sizes</h2>
  <p>Change the size of the modal with one of the following classes:</p>
  <ul>
    <li><code>.tiny</code>: Sets the width to 30%</li>
    <li><code>.small</code>: Sets the width to 40%</li>
    <li><code>.medium</code>: Sets the width to 60%</li>
    <li><code>.large</code>: Sets the width to 70%</li>
    <li><code>.xlarge</code>: Sets the width to 95%</li>
    <li><code>.full</code>: Sets the width AND height to 100%</li>
  </ul>
  
  <button type="button" class="button" data-reveal-id="myModal">Open Tiny Modal</button>
  
  <div id="myModal" class="reveal-modal tiny" data-reveal>
    <h2>Tiny Modal</h2>
    <p>This is a tiny modal. Try to change the size of the modal with another class.</p>
