...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_forms_label_inline&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:40 GMT -->
<head>
...
<form>
  <div class="row">
    <h2>Inline Label</h2>
    <p><strong>Tip:</strong> Remove the .right class if you want the label to appear more to the left.</p>
    <div class="small-8">
      <div class="row">
