...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_joyride&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:41 GMT -->
<head>
...
<h2>Joyride Example</h2>
<p>The joyride will start on page load.</p>
...
<ol class="joyride-list" data-joyride>
  <li data-id="first">
    <p>This is a Joyride. You can close it by clicking the "x" icon in the right top corner.</p>
    <p>Notice the buttons below. They will take you to the next (or previous) stop in your ride.</p>
  </li>
  <li data-id="second">
    <h4>Second Stop</h4>
    <p>FYI! Any valid HTML will work inside the Joyride.</p>
  </li>
  <li data-button="End">
    <h4>End Stop</h4>
