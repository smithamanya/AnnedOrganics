...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_maxwidth&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:42 GMT -->
<head>
...
<p>By default, Fundation's grid system has a max-width of 62.5rem. You can override this with CSS by setting a new max-width (higher or lower). <strong>Resize</strong> the browser window to see the effect:</p>
<hr>

<div class="row">
  <p>Basic Row (max-width:62.5rem):</p>
