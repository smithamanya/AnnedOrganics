...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_equalizer_large&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:42 GMT -->
<head>
...
<div class="row" data-equalizer data-equalizer-mq="large-up">
  ...
  <p>In this example, we have added the <code>data-equalizer-mq="large-up"</code> attribute, which will create an equal height container for large screens and wider (64.063em and up). Resize the browser window to see the effect.</p> 
