...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_ref_js_magellan_fixedtop&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:39 GMT -->
<head>
...
<h5 class="subheader">The <code>fixed_top</code> option specifies how far from the top the magellan bar should be, in pixels. Default is 0 (the topmost point). In this example, we set it to 50:</h5>
<hr>
