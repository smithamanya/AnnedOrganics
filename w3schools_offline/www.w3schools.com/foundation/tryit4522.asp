...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_forms_prepostfix3&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:40 GMT -->
<head>
...
<form>
  <div class="row">
    <h2>Rounded Prefix/Postfix Labels</h2>
    <p>Radius Prefix/Postfix Labels:</p>
  ...
  <div class="row">
    <p>Rounded Prefix/Postfix Buttons:</p>
    <div class="large-6 columns">
