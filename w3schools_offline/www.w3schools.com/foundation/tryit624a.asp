...
<!-- Mirrored from www.w3schools.com/foundation/tryit.asp?filename=tryfoundation_grid_3equal&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:54:43 GMT -->
<head>
...
<div class="row">
  <h2>Grid - Three Equal Columns</h2>
  <p>In this example, we show how to create three equal-width columns starting at tablets and scaling to desktops. On mobile phones, the columns will automatically stack.</p>
