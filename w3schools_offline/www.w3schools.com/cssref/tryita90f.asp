...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_flex-wrap by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:32 GMT -->
<head>
...
<p>Click the "Try it" button to set the value of the flexWrap property to "nowrap".</p>

<button onclick="myFunction()">Try it</button>

<p><b>Note:</b> Internet Explorer 10 and earlier versions earlier versions do not support the flexWrap property.</p>

<p><b>Note:</b> Safari 6.1 (and newer) supports an alternative, the WebkitFlexWrap property.</p>
