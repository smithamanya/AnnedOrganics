...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_cursor&preval=row-resize by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:12 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                cursor:<br><br>
				<input type="hidden" id="preselectedValue" value="row-resize" />
