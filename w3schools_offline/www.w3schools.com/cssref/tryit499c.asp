...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_margin-right by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:17 GMT -->
<head>
...
<p>Click the "Try it" button to change the right margin of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.marginRight = "100px";
}
</script>
