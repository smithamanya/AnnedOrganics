...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_outline-offset by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:44 GMT -->
<head>
...
<p>Gradually change the outline-offset property from 0 to 50px and back to 0:<p>
<div id="myDIV"></div>

<p>The outline-offset property is <em>animatable</em> in CSS.</p>
