...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_column-gap by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:59 GMT -->
<head>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="1px" checked='checked' /><label for="value_1">1px</label></div>
