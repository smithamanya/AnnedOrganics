...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_border-collapse&preval=separate by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:14 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.borderCollapse=val;
		
	var x="border-collapse:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                border-collapse:<br><br>
				<input type="hidden" id="preselectedValue" value="separate" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="separate" /><label for="value_1">separate</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="collapse" /><label for="value_2">collapse</label></div>
	...
	<table style="border:1px solid black;margin:5px;" id="myTable">
		...
		<tr>
			...
			<pre id="styleDIV">
table#myTable {<br>    border-collapse:<span id='enlargecssprop'>separate</span>;<br>}<br></pre>
		</div>
