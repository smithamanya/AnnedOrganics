...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_padding by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:04 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.padding=val;
		
	var x="padding:<span id='enlargecssprop'>" + val + "</span>";
	var y="div#myBox {<br>    background-color:yellow;<br>    width:100px;<br>    ###CSSPROP###;<br>}<br>";
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_8" value="10px 1px 15px 50px" /><label for="value_8">10px 1px 15px 50px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_9" value="10px 50px" /><label for="value_9">10px 50px</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<div id="myBox">Play with different padding values for this yellow DIV element.</div>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div#myBox {<br>    background-color:yellow;<br>    width:100px;<br>    padding:<span id='enlargecssprop'>0px</span>;<br>}<br></pre>
		</div>
