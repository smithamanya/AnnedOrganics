...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_outline by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:38 GMT -->
<head>
...
<p>Click the "Try it" button to add an outline border to the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.outline = "blue dotted 5px";
}
</script>
