...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_list-style-type by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:49 GMT -->
<head>
...
<p>Click the "Try it" button to change the type of the list-item marker:</p>
...
<script>
function myFunction() {
    document.getElementById("myUL").style.listStyleType = "square";
}
</script>
