...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_padding by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:04 GMT -->
<head>
...
<p>Click the "Try it" button to change the padding property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.padding = "100px 20px";
}
</script>
