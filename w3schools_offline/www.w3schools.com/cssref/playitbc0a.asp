...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_float&preval=right by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:33 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.cssFloat=val;
		
	var x="float:<span id='enlargecssprop'>" + val + "</span>";
	var y="div#myDIV {<br>    width:100px;<br>    background-color:red;<br>    ###CSSPROP###;<br>}<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<span>Another span element.</span>
			...
			<pre id="styleDIV">
div#myDIV {<br>    width:100px;<br>    background-color:red;<br>    float:<span id='enlargecssprop'>none</span>;<br>}<br></pre>
		</div>
