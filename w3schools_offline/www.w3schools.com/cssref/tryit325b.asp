...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_font by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:35 GMT -->
<head>
...
<p>Click the "Try it" button to change the font property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.font = "italic small-caps bold 16px arial, sans-serif";
}
</script>
