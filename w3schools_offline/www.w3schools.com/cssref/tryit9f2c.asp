...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-left-color by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:57 GMT -->
<head>
...
<p>Gradually change the border-left-color property from coral to lightblue then back:<p>
<div id="myDIV"></div>

<p>The border-left-color is <em>animatable</em> in CSS.</p>
