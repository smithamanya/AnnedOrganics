...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_animation-play-state&preval=paused by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:10 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.animationPlayState=val;
		
			document.getElementById(s).style.WebkitAnimationPlayState=val;
		
			document.getElementById(s).style.MozAnimationPlayState=val;
		
	var x="animation-play-state:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                animation-play-state:<br><br>
				<input type="hidden" id="preselectedValue" value="paused" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="paused" /><label for="value_1">paused</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="running" /><label for="value_2">running</label></div>
	...
	<div id="myDIV"></div>
			...
			<pre id="styleDIV">
div#myDIV {<br>    animation-play-state:<span id='enlargecssprop'>running</span>;<br>}<br></pre>
		</div>
