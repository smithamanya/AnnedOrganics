...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_overflow-y&preval=scroll by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:03 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.overflowY=val;
		
	var x="overflow-y:<span id='enlargecssprop'>" + val + "</span>";
	var y="#myDIV {<br>    width:150px;<br>    height:200px;<br>    ###CSSPROP###;<br>}<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myDIV">
		<img src="img_tree.gif"/>
			...
			<pre id="styleDIV">
#myDIV {<br>    width:150px;<br>    height:200px;<br>    overflow-y:<span id='enlargecssprop'>visible</span>;<br>}<br></pre>
		</div>
