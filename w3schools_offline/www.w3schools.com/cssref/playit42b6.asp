...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_transform_scalex by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:57 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="scaleX(1.1)" checked='checked' /><label for="value_1">scaleX(1.1)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="scaleX(1.5)" /><label for="value_2">scaleX(1.5)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="scaleX(2)" /><label for="value_3">scaleX(2)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="scaleX(3)" /><label for="value_4">scaleX(3)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="scaleX(0.5)" /><label for="value_5">scaleX(0.5)</label></div>
	...
	<div id="myDIV">myDIV</div>
			...
			<pre id="styleDIV">
#myDIV {<br>    background-color:lightblue;<br>    transform:<span id='enlargecssprop'>scaleX(1.1)</span>;<br>}<br></pre>
		</div>
