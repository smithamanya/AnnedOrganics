...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_columns by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:07 GMT -->
<head>
...
<p>Click the "Try it" button to split the text into three columns, minimum 100 pixels each:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.WebkitColumns = "100px 3"; // Code for Chrome, Safari, and Opera
