...
<!-- Mirrored from www.w3schools.com/cssref/css_functions.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:55 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_selectors.html">&laquo; Previous</a></div>
...
<h2>CSS Functions</h2>
<p>The &quot;CSS&quot; column indicates in which CSS version the function is defined (CSS1, CSS2, 
or CSS3).</p>
...
<table class="w3-table-all notranslate">
  <tr>
	...
	<tr>
    <td><a href="func_attr.html">attr()</a></td>
    <td>Returns the value of an attribute of the selected element </td>
    <td>2</td>
  </tr>
	<tr>
    <td><a href="func_calc.html">calc()</a></td>
    <td>Allows you to perform calculations to determine CSS property values</td>
    <td>3</td>
  </tr>  
  <tr>
    <td><a href="func_linear-gradient.html">linear-gradient()</a></td>
    <td>Creates an &quot;image&quot; which represents a linear gradient of colors</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_radial-gradient.html">radial-gradient()</a></td>
    <td>Creates an &quot;image&quot; which represents a gradient of colors radiating from the center of the gradient</td>
    <td>3</td>
  </tr>
  <tr>
    <td><a href="func_repeating-linear-gradient.html">repeating-linear-gradient()</a></td>
    <td>Creates an &quot;image&quot; consisting of repeating gradients</td>
    <td>3</td>
  </tr>
  <tr>
    <td>repeating-radial-gradient()</td>
    <td>Similarly to radial-gradient(), but it automatically repeats the color stops infinitely in both directions</td>
    <td>3</td>
  </tr>
  </table>
</div>
...
<!-- Mirrored from www.w3schools.com/cssref/css_functions.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:45:02 GMT -->
</html>