...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:39 GMT -->
<head>
...
<p>Gradually change the border-width property from 1px to 15px then back:<p>
<div id="myDIV"></div>

<p>The border-width is <em>animatable</em> in CSS.</p>
