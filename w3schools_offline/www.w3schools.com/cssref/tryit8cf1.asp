...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-right-color by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:11 GMT -->
<head>
...
<p>Gradually change the border-right-color property from coral to lightblue then back:<p>
<div id="myDIV"></div>

<p>The border-right-color is <em>animatable</em> in CSS.</p>
