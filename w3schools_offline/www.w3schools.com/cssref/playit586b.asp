...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_min-width&preval=150px by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:29 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.minWidth=val;
		
	var x="min-width:<span id='enlargecssprop'>" + val + "</span>";
	var y="width:10px;<br>    ###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="150px" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="100%" /><label for="value_1">100%</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="50%" /><label for="value_2">50%</label></div>
	...
	Click the radiobuttons
			...
			<pre id="styleDIV">
div {
    width:10px;<br>    min-width:<span id='enlargecssprop'>100%</span>;<br>}</pre>
		</div>
