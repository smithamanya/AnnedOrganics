...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_border-left-style&preval=groove by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:00 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.borderLeftStyle=val;
		
	var x="border-left-style:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="resultcontainer">
			...
			<pre id="styleDIV">
div {
    border-width:5px;	<br>    border-left-style:<span id='enlargecssprop'>none</span>;<br>}</pre>
		</div>
