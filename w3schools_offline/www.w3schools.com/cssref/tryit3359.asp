...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_border-bottom-color by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:03 GMT -->
<head>
...
<p>Click the "Try it" button to change the border-bottom-color property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.borderBottomColor = "lightblue";
}
</script>
