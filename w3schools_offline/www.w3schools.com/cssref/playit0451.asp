...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_text-decoration-style&preval=dashed by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:42 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.textDecorationStyle=val;
		
			document.getElementById(s).style.MozTextDecorationStyle=val;
		
	var x="text-decoration-style:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                text-decoration-style:<br><br>
				<input type="hidden" id="preselectedValue" value="dashed" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="solid" /><label for="value_1">solid</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="double" /><label for="value_2">double</label></div>
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="wavy" /><label for="value_5">wavy</label></div>
	...
	<p><b>Note:</b> The text-decoration-style property is not supported in any of the major browsers.</p>
...
Hello world!
			...
			<pre id="styleDIV">
#myDIV {<br>    text-decoration: underline;<br>    text-decoration-style:<span id='enlargecssprop'> solid</span>;<br>}<br></pre>
		</div>
