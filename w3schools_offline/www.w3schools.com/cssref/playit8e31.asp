...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_backface-visibility&preval=hidden by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:13 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.backfaceVisibility=val;
		
			document.getElementById(s).style.WebkitBackfaceVisibility=val;
		
			document.getElementById(s).style.MozBackfaceVisibility=val;
		
	var x="backface-visibility:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myDIV">HELLO</div>
			...
			<pre id="styleDIV">
div#myDIV {<br>    backface-visibility:<span id='enlargecssprop'>visible</span>;<br>}<br></pre>
		</div>
