...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_text-align&preval=right by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:31 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.textAlign=val;
		
	var x="text-align:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                text-align:<br><br>
				<input type="hidden" id="preselectedValue" value="right" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="left" /><label for="value_1">left</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="right" /><label for="value_2">right</label></div>
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="justify" /><label for="value_4">justify</label></div>
	...
	This text is where you will see the result of the selected text-align property.
			...
			<pre id="styleDIV">
div {
    text-align:<span id='enlargecssprop'>left</span>;<br>}</pre>
		</div>
