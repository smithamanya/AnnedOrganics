...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_line-height by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:30 GMT -->
<head>
...
<p>Click the "Try it" button to set the line-height property of the DIV element to 20 pixels:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.lineHeight = "30px";
}
</script>
