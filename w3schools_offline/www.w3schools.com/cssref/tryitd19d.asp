...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_border-top-style by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:34 GMT -->
<head>
...
<p>Click the "Try it" button to change the border-top-style property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.borderTopStyle = "dashed";
}
</script>
