...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_flex-basis&preval=auto by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:26 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.flexBasis=val;
		
			document.getElementById(s).style.WebkitFlexBasis=val;
		
			document.getElementById(s).style.MozFlexBasis=val;
		
	var x="flex-basis:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="auto" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="20px" /><label for="value_3">20px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="40px" /><label for="value_4">40px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="80px" /><label for="value_5">80px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_6" value="200px" /><label for="value_6">200px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_7" value="auto" /><label for="value_7">auto</label></div>
				...
				<div id="pfooter"><footer><p><b>Note:</b> Internet Explorer 10 and earlier versions and Safari 5 and earlier versions do not support the flex-basis property.</p></footer></div>
		</div>
	...
	<div id="main">
		...
		<div style="background-color:lightgrey;">5</div>
			...
			<pre id="styleDIV">
div#myBlueDiv {<br>    flex-basis:<span id='enlargecssprop'> 1</span>;<br>}<br></pre>
		</div>
