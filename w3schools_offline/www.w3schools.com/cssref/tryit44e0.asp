...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_bottom by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:42 GMT -->
<head>
...
<p>Gradually change the bottom property from 0px from the bottom to 300px then back:<p>
<div id="myDIV">
  <h1>myDIV</h1>
</div>

<p>The bottom property is <em>animatable</em> in CSS.</p>
