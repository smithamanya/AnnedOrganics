...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-bottom-left-radius by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:04 GMT -->
<head>
...
<p>Gradually change the border-bottom-left-radius property from 0 to 50px then back:<p>
<div id="myDIV"></div>

<p>The border-bottom-left-radius is <em>animatable</em> in CSS.</p>
