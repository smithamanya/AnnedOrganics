...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_clip by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:54 GMT -->
<head>
...
<p>Click the "Try it" button to clip the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.clip = "rect(0px,50px,50px,0px)";
}
</script>
