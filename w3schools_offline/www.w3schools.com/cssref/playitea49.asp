...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_text-decoration by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:34 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.textDecoration=val;
		
	var x="text-decoration:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	You can change the text-decoration by clicking on one of the properties on the left.
			...
			<pre id="styleDIV">
div {
    text-decoration:<span id='enlargecssprop'>none</span>;<br>}</pre>
		</div>
