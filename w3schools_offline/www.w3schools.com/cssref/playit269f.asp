...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_top_percent&preval=10%25 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:55 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<p><b>Note:</b> To "top" positioning elements using % (percent) values, use position:absolute.</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div#myBox {<br>    background-color:yellow;<br>    width:100px;<br>    position:absolute;<br>    top:<span id='enlargecssprop'>auto</span>;<br>}<br></pre>
		</div>
