...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_column-width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:06 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.columnWidth=val;
		
			document.getElementById(s).style.WebkitColumnWidth=val;
		
			document.getElementById(s).style.MozColumnWidth=val;
		
	var x="column-width:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="100px" /><label for="value_3">100px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="200px" /><label for="value_4">200px</label></div>
		...
		Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.
			...
			<pre id="styleDIV">
div {
    column-width:<span id='enlargecssprop'>auto</span>;<br>}</pre>
		</div>
