...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_cursor&preval=vertical-text by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:13 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                cursor:<br><br>
				<input type="hidden" id="preselectedValue" value="vertical-text" />
