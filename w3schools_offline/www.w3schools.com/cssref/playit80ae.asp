...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_unicode-bidi&preval=bidi-override by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:09 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.unicodeBidi=val;
		
	var x="unicode-bidi:<span id='enlargecssprop'>" + val + "</span>";
	var y="direction:rtl;<br>    ###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                unicode-bidi:<br><br>
				<input type="hidden" id="preselectedValue" value="bidi-override" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="embed" /><label for="value_2">embed</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="bidi-override" /><label for="value_3">bidi-override</label></div>
	...
	Override text direction.
			...
			<pre id="styleDIV">
div {
    direction:rtl;<br>    unicode-bidi:<span id='enlargecssprop'>normal</span>;<br>}</pre>
		</div>
