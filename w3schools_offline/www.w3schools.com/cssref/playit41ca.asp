...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_table-layout by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:30 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.tableLayout=val;
		
	var x="table-layout:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="fixed" /><label for="value_2">fixed</label></div>
	...
	<table border="1" id="myTable" width="100%">
		...
		<tr>
			...
			<pre id="styleDIV">
table#myTable {<br>    table-layout:<span id='enlargecssprop'>auto</span>;<br>}<br></pre>
		</div>
