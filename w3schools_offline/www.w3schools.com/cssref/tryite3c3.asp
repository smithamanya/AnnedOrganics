...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_background-color by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:35 GMT -->
<head>
...
<p>Click the "Try it" button to set the background-color property of the DIV element to "lightblue":</p>
