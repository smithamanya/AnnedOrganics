...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_ul_list-style-type&preval=circle by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:49 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="circle" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="disc" /><label for="value_1">disc</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="circle" /><label for="value_2">circle</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="none" /><label for="value_3">none</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="square" /><label for="value_4">square</label></div>
	...
	<ul id="myList">
		...
		<li>See the result</li>
			...
			<pre id="styleDIV">
ul#myList {<br>    list-style-type:<span id='enlargecssprop'>disc</span>;<br>}<br></pre>
		</div>
