...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_font-variant&preval=small-caps by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:47 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.fontVariant=val;
		
	var x="font-variant:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                font-variant:<br><br>
				<input type="hidden" id="preselectedValue" value="small-caps" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="small-caps" /><label for="value_2">small-caps</label></div>
	...
	<p>Change font variant by clicking the radiobuttons</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div {
    font-variant:<span id='enlargecssprop'>normal</span>;<br>}</pre>
		</div>
