...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_text-overflow&preval=ellipsis by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:45 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.textOverflow=val;
		
	var x="text-overflow:<span id='enlargecssprop'>" + val + "</span>";
	var y="#myDIV {<br>    overflow:hidden;<br>    ###CSSPROP###;<br>}<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="ellipsis" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="clip" /><label for="value_1">clip</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="ellipsis" /><label for="value_2">ellipsis</label></div>
	...
	Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
			...
			<pre id="styleDIV">
#myDIV {<br>    overflow:hidden;<br>    text-overflow:<span id='enlargecssprop'>clip</span>;<br>}<br></pre>
		</div>
