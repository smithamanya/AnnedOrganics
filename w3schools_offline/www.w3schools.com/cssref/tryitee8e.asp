...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_column-rule-color by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:01 GMT -->
<head>
...
<p>The column-rule-color is <em>animatable</em> in CSS.</p>
<p><b>Note:</b> CSS Animations do not work in Internet Explorer 9 and earlier versions.</p>

<p>Gradually change the color of the rule between the columns, from red, to blue, and back to red:<p>
<div id="myDIV">
