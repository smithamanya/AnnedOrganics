...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_float by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:33 GMT -->
<head>
...
<p>Click the "Try it" button to float the DIV element to the left:</p>
...
<p><b>Note:</b> The CSS property "float" is called "cssFloat" in JavaScript, because "float" is a reserved word in JavaScript.</p>
