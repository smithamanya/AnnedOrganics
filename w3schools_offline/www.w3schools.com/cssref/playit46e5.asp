...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_padding-top by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:14 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myBox">Play with different padding-top values for this yellow DIV element.</div>
			...
			<pre id="styleDIV">
div#myBox {<br>    background-color:yellow;<br>    width:100px;<br>    padding-top:<span id='enlargecssprop'>0px</span>;<br>}<br></pre>
		</div>
