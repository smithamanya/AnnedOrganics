...
<!-- Mirrored from www.w3schools.com/cssref/css_units.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:45:04 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="css_animatable.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="css_pxtoemconversion.asp">Next Reference &raquo;</a></div>
</div>
<hr>
<h2>CSS Units</h2>
...
<p>There are two types of length units: relative and absolute.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>em</td>
    <td>Relative to the font-size of the element (2em means 2 times the size of the current font)
      <a target="_blank" class="w3-btn btnsmall" href="tryitadcf.html?filename=trycss_unit_em">Try it</a>
	</td>
  </tr>
  <tr>
    <td>ex</td>
    <td>Relative to the x-height of the current font (rarely used)
      <a target="_blank" class="w3-btn btnsmall" href="tryit415f.html?filename=trycss_unit_ex">Try it</a>
    </td>
  </tr>
  <tr>
    <td>ch</td>
  ...
  <tr>
    ...
    <td>Relative to 1% of the width of the viewport*
      <a target="_blank" class="w3-btn btnsmall" href="tryit01d1.html?filename=trycss_unit_vw">Try it</a>
    </td>
  </tr>
  <tr>
    <td>vh</td>
    <td>Relative to 1% of the height of the viewport*
      <a target="_blank" class="w3-btn btnsmall" href="tryitf9f0.html?filename=trycss_unit_vh">Try it</a>    
    </td>
  </tr>
  <tr>
    <td>vmin</td>
    <td>Relative to 1% of viewport's* smaller dimension
      <a target="_blank" class="w3-btn btnsmall" href="tryit7044.html?filename=trycss_unit_vmin">Try it</a>
    </td>
  </tr>
  <tr>
    <td>vmax</td>
    <td>Relative to 1% of viewport's* larger dimension
      <a target="_blank" class="w3-btn btnsmall" href="tryit4a37.html?filename=trycss_unit_vmax">Try it</a>
    </td>
  </tr>
  <tr>
    <td>%</td>
...
<td><b>Tip:</b> The em and rem units are practical in creating perfectly 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>cm</td>
    <td>centimeters
    <a target="_blank" class="w3-btn btnsmall" href="tryit4e65.html?filename=trycss_unit_cm">Try it</a>
    </td>
  </tr>
    <tr>
    <td>mm</td>
    <td>millimeters
    <a target="_blank" class="w3-btn btnsmall" href="tryit834b.html?filename=trycss_unit_mm">Try it</a>  
    </td>
    </tr>
  <tr>
    <td>in</td>
    <td>inches (1in = 96px = 2.54cm)
    <a target="_blank" class="w3-btn btnsmall" href="tryit840b.html?filename=trycss_unit_in">Try it</a>
    </td>
  </tr>
    <tr>
    <td>px *</td>
    <td>pixels (1px = 1/96th of 1in)
    <a target="_blank" class="w3-btn btnsmall" href="tryit1dbd.html?filename=trycss_unit_px">Try it</a> 
    </td>
    </tr>
  <tr>
    <td>pt</td>
    <td>points (1pt = 1/72 of 1in)
    <a target="_blank" class="w3-btn btnsmall" href="tryit9793.html?filename=trycss_unit_pt">Try it</a> 
    </td>
  </tr>
  <tr>
    <td>pc</td>
    <td>picas (1pc = 12 pt)
    <a target="_blank" class="w3-btn btnsmall" href="tryit1589.html?filename=trycss_unit_pc">Try it</a>  
    </td>
  </tr>
</table>
</div>
...
<!-- Mirrored from www.w3schools.com/cssref/css_units.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:45:13 GMT -->
</html>