...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_animation-delay&preval=1s by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:04 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.animationDelay=val;
		
			document.getElementById(s).style.WebkitAnimationDelay=val;
		
			document.getElementById(s).style.MozAnimationDelay=val;
		
	var x="animation-delay:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="1s" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="5s" /><label for="value_3">5s</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="-2s" /><label for="value_4">-2s</label></div>
	...
	<div id="myDIV" class="my1s"></div>
			...
			<pre id="styleDIV">
div#myDIV {<br>    animation-delay:<span id='enlargecssprop'>1s</span>;<br>}<br></pre>
		</div>
