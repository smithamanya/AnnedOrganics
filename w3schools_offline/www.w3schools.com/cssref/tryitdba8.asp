...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_vertical-align by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:11 GMT -->
<head>
...
<p>Gradually change the vertical-align property of the Image element, from 0 to 100px and back to 0:<p>
...
<p>The vertical-align property is <em>animatable</em> in CSS.</p>
<p><strong>Note:</strong> Animation of the vertical-align property is not supported in Chrome.</p>
