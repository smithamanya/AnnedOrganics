...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-rule-style by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:02 GMT -->
<head>
...
<p>Click the "Try it" button to change the style of the column-rule:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.WebkitColumnRuleStyle = "dotted"; // Code for Chrome, Safari, and Opera
    document.getElementById("myDIV").style.MozColumnRuleStyle = "dotted"; // Code for Firefox
