...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_animation-direction by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:05 GMT -->
<head>
...
<p>Click the "Try it" button to reverse the direction of the animation.</p>
...
<p><strong>Note:</strong> The animationDirection property is currently only supported in Firefox.</p>
<div id="myDIV"></div>
