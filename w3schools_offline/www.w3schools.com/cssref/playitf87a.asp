...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_overflow-x&preval=scroll by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:59 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.overflowX=val;
		
	var x="overflow-x:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myDIV">
		<img src="img_tree.gif"/>
			...
			<pre id="styleDIV">
#myDIV {<br>    width:150px;<br>    height:200px;<br>    overflow-x:<span id='enlargecssprop'>visible</span>;<br>}<br></pre>
		</div>
