...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_box-sizing by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:49 GMT -->
<head>
...
<p>Two 150 pixels boxes inside a 300 pixels container. It should fit nicely, but because of the borders and padding, the two boxes take up more space than 150 pixels each. This "problem" can be solved by setting the box-sizing property to "border-box".</p>

<p>Click the "Try it" button to set the box-sizing property of the two boxes to "border-box":</p>
