...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_transform_scaley by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:57 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="scaleY(1.1)" checked='checked' /><label for="value_1">scaleY(1.1)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="scaleY(1.5)" /><label for="value_2">scaleY(1.5)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="scaleY(2)" /><label for="value_3">scaleY(2)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="scaleY(3)" /><label for="value_4">scaleY(3)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="scaleY(0.5)" /><label for="value_5">scaleY(0.5)</label></div>
	...
	<div id="myDIV">myDIV</div>
			...
			<pre id="styleDIV">
#myDIV {<br>    background-color:lightblue;<br>    transform:<span id='enlargecssprop'>scaleY(1.1)</span>;<br>}<br></pre>
		</div>
