...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_padding-bottom by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:06 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.paddingBottom=val;
		
	var x="padding-bottom:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<div id="myBox">Play with different padding-bottom values for this yellow DIV element.</div>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div#myBox {<br>    background-color:yellow;<br>    width:100px;<br>    padding-bottom:<span id='enlargecssprop'>0px</span>;<br>}<br></pre>
		</div>
