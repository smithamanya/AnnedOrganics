...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_caption-side&preval=bottom by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:50 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.captionSide=val;
		
	var x="caption-side:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="bottom" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="top" /><label for="value_1">top</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="bottom" /><label for="value_2">bottom</label></div>
	...
	<table border="1" id="myTable">
		...
		<tr>
			...
			<pre id="styleDIV">
table#myTable {<br>    caption-side:<span id='enlargecssprop'>top</span>;<br>}<br></pre>
		</div>
