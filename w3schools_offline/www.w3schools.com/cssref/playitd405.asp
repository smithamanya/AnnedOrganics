...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_column-span&preval=all by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:05 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.columnSpan=val;
		
			document.getElementById(s).style.WebkitColumnSpan=val;
		
			document.getElementById(s).style.MozColumnSpan=val;
		
	var x="column-span:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                column-span:<br><br>
				<input type="hidden" id="preselectedValue" value="all" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="all" /><label for="value_2">all</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="initial" /><label for="value_3">initial</label></div>
							
				</form>
				<div id="pfooter"><footer><b>Note:</b> IE 9 and earlier, and Firefox do not support the column-span property.</footer></div>
		</div>
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<div id="myDIV">
		<h1 id="myH1">Lorem ipsum dolor sit amet</h1>
		Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.
			...
			<pre id="styleDIV">
#myH1 {<br>    column-span:<span id='enlargecssprop'>1</span>;<br>}<br></pre>
		</div>
