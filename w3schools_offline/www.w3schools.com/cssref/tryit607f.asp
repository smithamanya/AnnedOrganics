...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_margin by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:53 GMT -->
<head>
...
<p>Click the "Try it" button to change the margins of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.margin = "100px 50px";
}
</script>
