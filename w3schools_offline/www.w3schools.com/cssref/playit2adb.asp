...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_margin-top by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:20 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.marginTop=val;
		
	var x="margin-top:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myBox">myBox</div>
			...
			<pre id="styleDIV">
div#myBox {<br>    background-color:red;<br>    margin-top:<span id='enlargecssprop'>auto</span>;<br>}<br></pre>
		</div>
