...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_font-style&preval=oblique by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:44 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.fontStyle=val;
		
	var x="font-style:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                font-style:<br><br>
				<input type="hidden" id="preselectedValue" value="oblique" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="italic" /><label for="value_2">italic</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="oblique" /><label for="value_3">oblique</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<h1>Play with different font styles!</h1>
	<p>Try different font styles by clicking the radiobuttons</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div {
    font-style:<span id='enlargecssprop'>normal</span>;<br>}</pre>
		</div>
