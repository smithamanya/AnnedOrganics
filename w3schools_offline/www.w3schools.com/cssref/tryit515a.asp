...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-bottom-color by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:03 GMT -->
<head>
...
<p>Gradually change the border-bottom-color property from black to blue then back:<p>
<div id="myDIV"></div>

<p>The border-bottom-color is <em>animatable</em> in CSS.</p>
