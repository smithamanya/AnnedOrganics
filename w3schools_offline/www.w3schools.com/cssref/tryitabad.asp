...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-rule by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:00 GMT -->
<head>
...
<p>Click the "Try it" button to set the column-rule property the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.WebkitColumnRule = "3px outset lightblue"; // Code for Chrome, Safari, and Opera
    document.getElementById("myDIV").style.MozColumnRule = "3px outset lightblue"; // Code for Firefox
    document.getElementById("myDIV").style.columnRule = "3px outset lightblue";
}
</script>
