...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_column-gap&preval=normal by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:59 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.columnGap=val;
		
			document.getElementById(s).style.WebkitColumnGap=val;
		
			document.getElementById(s).style.MozColumnGap=val;
		
	var x="column-gap:<span id='enlargecssprop'>" + val + "</span>";
	var y="column-count:3;<br>    ###CSSPROP###;<br>";
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="normal" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="1px" /><label for="value_1">1px</label></div>
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="normal" /><label for="value_5">normal</label></div>
		...
		Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.</div></div>
			...
			<pre id="styleDIV">
div {
    column-count:3;<br>    column-gap:<span id='enlargecssprop'>1px</span>;<br>}</pre>
		</div>
