...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_border-style&preval=hidden by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:24 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.borderStyle=val;
		
	var x="border-style:<span id='enlargecssprop'>" + val + "</span>";
	var y="border-width:5px;	<br>    ###CSSPROP###;<br>";
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="hidden" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_11" value="dotted solid double dashed" /><label for="value_11">dotted solid double dashed</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_12" value="dotted solid" /><label for="value_12">dotted solid</label></div>
		...
		<div class="resultcontainer">
			...
			<pre id="styleDIV">
div {
    border-width:5px;	<br>    border-style:<span id='enlargecssprop'>none</span>;<br>}</pre>
		</div>
