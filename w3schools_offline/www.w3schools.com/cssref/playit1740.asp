...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_min-height by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:27 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.minHeight=val;
		
	var x="min-height:<span id='enlargecssprop'>" + val + "</span>";
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="60px" checked='checked' /><label for="value_1">60px</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="80px" /><label for="value_2">80px</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<p>Change this DIV's min-height by clicking the radiobuttons on the left.</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div {
    height:auto;<br>    min-height:<span id='enlargecssprop'>60px</span>;<br>}</pre>
		</div>
