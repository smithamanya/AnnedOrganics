...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_transform_translatey by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:57 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="translateY(10px)" checked='checked' /><label for="value_1">translateY(10px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="translateY(20px)" /><label for="value_2">translateY(20px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="translateY(50px)" /><label for="value_3">translateY(50px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="translateY(100px)" /><label for="value_4">translateY(100px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="translateY(-25px)" /><label for="value_5">translateY(-25px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_6" value="none" /><label for="value_6">none</label></div>
	...
	<div id="myDIV">myDIV</div>
			...
			<pre id="styleDIV">
#myDIV {<br>    background-color:lightblue;<br>    transform:<span id='enlargecssprop'>translateY(10px)</span>;<br>}<br></pre>
		</div>
