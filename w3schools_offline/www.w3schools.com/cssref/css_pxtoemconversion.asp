...
<!-- Mirrored from www.w3schools.com/cssref/css_pxtoemconversion.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:45:13 GMT -->
<head>
...
<ul>
<li>Set a default pixel size (usually 16px)</li>
...
<p class="clearfix"></p>
<button class="btn btn-lg btn-info" onclick="myFunction()"><span style="top:4px;"class="glyphicon glyphicon-transfer"> </span> Convert</button>
<hr>
...
<td><strong>What is the difference between PX, EM and Percent?</strong><br>Pixel 
...
Look at <a href="css_units.asp">CSS Units</a> for more 
