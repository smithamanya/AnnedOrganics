...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-count by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:57 GMT -->
<head>
...
<p>Click the "Try it" button to set the column-count property of the DIV element to "3":</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.WebkitColumnCount = "3"; // Code for Chrome, Safari, and Opera
