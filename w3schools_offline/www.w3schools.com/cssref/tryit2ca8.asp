...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_word-spacing by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:34 GMT -->
<head>
...
<p>The word-spacing property is <em>animatable</em> in CSS.</p>
<p><strong>Note:</strong> CSS Animations do not work in Internet Explorer 9 and earlier versions.</p>

<p>Gradually change the word-spacing property of the DIV element from "normal", up to 50px, and back to "normal":<p>
<div id="myDIV">
