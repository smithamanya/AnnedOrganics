...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_list-style by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:41 GMT -->
<head>
...
<script>
function myFunction() {
    document.getElementById("myUL").style.listStyle = "decimal inside";
}
</script>
