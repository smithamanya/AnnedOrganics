...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_border-left-width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:04 GMT -->
<head>
...
<p>Click the "Try it" button to change the border-left-width property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.borderLeftWidth = "5px";
}
</script>
