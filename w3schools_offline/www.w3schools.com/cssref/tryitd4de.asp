...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-bottom-right-radius by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:06 GMT -->
<head>
...
<p>Gradually change the border-bottom-right-radius property from 0 to 50px then back:<p>
<div id="myDIV"></div>

<p>The border-bottom-right-radius is <em>animatable</em> in CSS.</p>
