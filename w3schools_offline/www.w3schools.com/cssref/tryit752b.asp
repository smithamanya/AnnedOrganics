...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-gap by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:59 GMT -->
<head>
...
<p>Click the "Try it" button to set the gap between the columns of the DIV element to 50 pixels:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.WebkitColumnGap = "50px"; // Code for Chrome, Safari, and Opera
