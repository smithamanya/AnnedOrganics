...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_text-transform by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:50 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.textTransform=val;
		
	var x="text-transform:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="capitalize" /><label for="value_2">capitalize</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="uppercase" /><label for="value_3">uppercase</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="lowercase" /><label for="value_4">lowercase</label></div>
	...
	This example demonstrates different text-transforms.
			...
			<pre id="styleDIV">
div {
    text-transform:<span id='enlargecssprop'>none</span>;<br>}</pre>
		</div>
