...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_margin&preval=auto by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:54 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.margin=val;
		
	var x="margin:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="auto" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_9" value="10px 1px" /><label for="value_9">10px 1px</label></div>
	...
	<div id="myBox">myBox</div>
			...
			<pre id="styleDIV">
div#myBox {<br>    background-color:red;<br>    margin:<span id='enlargecssprop'>auto</span>;<br>}<br></pre>
		</div>
