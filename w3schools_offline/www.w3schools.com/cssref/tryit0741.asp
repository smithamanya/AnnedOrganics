...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_border-left by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:37 GMT -->
<head>
...
<p>Click the "Try it" button to change the border-left property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.borderLeft = "3px dotted lightblue";
}
</script>
