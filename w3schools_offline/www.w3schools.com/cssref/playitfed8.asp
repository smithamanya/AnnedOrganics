...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_visibility&preval=hidden by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:13 GMT -->
<head>
	...
	var y="div#myDIV {<br>    background-color:yellow;<br>    ###CSSPROP###;<br>}<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myDIV">myDIV element.</div>
	<div>Another DIV element.</div>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div#myDIV {<br>    background-color:yellow;<br>    visibility:<span id='enlargecssprop'>visible</span>;<br>}<br></pre>
		</div>
