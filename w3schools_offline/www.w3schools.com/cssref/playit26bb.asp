...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_border-image by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:19 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="url(border.png) 30 stretch" checked='checked' /><label for="value_1">url(border.png) 30 stretch</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="url(border.png) 30 repeat" /><label for="value_2">url(border.png) 30 repeat</label></div>
	...
	<b>Note:</b> Internet Explorer 10, and earlier versions, do not support the border-image property.
			...
			<pre id="styleDIV">
#myDIV {<br>    border: 15px solid transparent;<br>    padding: 15px;<br>    border-image:<span id='enlargecssprop'> url(border.png) 30 stretch</span>;<br>    }<br></pre>
		</div>
