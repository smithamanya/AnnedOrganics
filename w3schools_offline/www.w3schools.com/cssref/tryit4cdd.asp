...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_transition-property by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:07 GMT -->
<head>
...
<p>Click the "Try it" button and mouse over the DIV element again. The changes will still happen, but only the width and height will change gradually.</p>
