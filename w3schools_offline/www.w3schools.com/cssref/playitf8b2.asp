...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_empty-cells&preval=show by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:21 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.emptyCells=val;
		
	var x="empty-cells:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                empty-cells:<br><br>
				<input type="hidden" id="preselectedValue" value="show" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="show" /><label for="value_1">show</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="hide" /><label for="value_2">hide</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<p><b>Note:</b>There are an empty table cell in the table.<br/>What happens when you change the property value to hide/show:</p>
	<table border="1" id="myTable">
		...
		<tr>
			...
			<pre id="styleDIV">
table#myTable {<br>    empty-cells:<span id='enlargecssprop'>show</span>;<br>}<br></pre>
		</div>
