...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_padding-bottom by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:06 GMT -->
<head>
...
<p>Gradually change the padding-bottom, from 0px to 50px and back to 0px:<p>
<div id="myDIV">
...
<p>The padding-bottom property is <em>animatable</em> in CSS.</p>
