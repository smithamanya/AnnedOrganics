...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_max-width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:25 GMT -->
<head>
...
<p>Click the "Try it" button to make sure that the DIV element's width never exceeds 600 pixels:</p>
...
<div id="myDIV">
  ...
  <p>The width of this DIV element is as wide as the parent element allows it to be (100%).</p>

  <p>Try resizing the browser window to see that width of this DIV element will grow/shrink along width the resizing.</p>

  <p>But if you click the "Try it" button, yo will make sure that this DIV element does not exceed 600 pixels in width.</p>
</div>
