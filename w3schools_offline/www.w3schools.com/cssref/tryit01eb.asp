...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_border-bottom-width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:10 GMT -->
<head>
...
<p>Gradually change the border-bottom-width property from 0 to 50px then back:<p>
<div id="myDIV"></div>

<p>The border-bottom-width is <em>animatable</em> in CSS.</p>
