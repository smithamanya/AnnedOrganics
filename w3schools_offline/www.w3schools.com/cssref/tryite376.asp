...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_animation-duration by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:06 GMT -->
<head>
...
<p><strong>Note:</strong> The animationDuration property is only supported in Firefox.</p>
<div id="myDIV"></div>
