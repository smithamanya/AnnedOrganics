...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_white-space by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:25 GMT -->
<head>
...
<p>Click the "Try it" button to make sure that the text inside the DIV element never wraps:</p>
