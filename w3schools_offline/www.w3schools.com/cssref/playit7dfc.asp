...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_width&preval=150px by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:27 GMT -->
<head>
	...
	var x="width:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                width:<br><br>
				<input type="hidden" id="preselectedValue" value="150px" />
		...
		<div class="resultcontainer">
			...
			<pre id="styleDIV">
div {
    width:<span id='enlargecssprop'>auto</span>;<br>}</pre>
		</div>
