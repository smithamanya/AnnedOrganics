...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-fill by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:59 GMT -->
<head>
...
<p><strong>Note:</strong> The column-fill and the columnFill property is currently only supported in Firefox with the -moz- (Moz) prefix.</p>

<p>Click the "Try it" button to set the column-fill property of the DIV element to "auto":</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.MozColumnFill = "auto"; /* Code for Firefox */
