...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_margin-top by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:20 GMT -->
<head>
...
<p>Gradually change the margin-top, from 0px to 50px and back to 0px:<p>
<div id="myDIV">
This is my DIV element.
</div>

<p>The margin-top property is <em>animatable</em> in CSS.</p>
