...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_visibility_collapse by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:13 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.visibility=val;
		
	var x="visibility:<span id='enlargecssprop'>" + val + "</span>";
	var y="table#myTABLE {<br>    background-color:yellow;<br>    ###CSSPROP###;<br>}<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="collapse" /><label for="value_3">collapse</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<p>This example demonstrates how the visibility property behaves on TABLE elelements:</p>
	...
	<p><b>Note:</b> The value "collapse" can only be used on TABLE elements.</p>
	<p><b>Note:</b> The TABLE does only "collapse" in IE and Firefox.</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
table#myTABLE {<br>    background-color:yellow;<br>    visibility:<span id='enlargecssprop'>visible</span>;<br>}<br></pre>
		</div>
