...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_margin-right&preval=auto by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:17 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.marginRight=val;
		
	var x="margin-right:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="myBox">myBox</div>
			...
			<pre id="styleDIV">
div#myBox {<br>    background-color:red;<br>    margin-right:<span id='enlargecssprop'>auto</span>;<br>}<br></pre>
		</div>
