...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_transform_translatex by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:57 GMT -->
<head>
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="translateX(10px)" checked='checked' /><label for="value_1">translateX(10px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="translateX(20px)" /><label for="value_2">translateX(20px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="translateX(50px)" /><label for="value_3">translateX(50px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_4" value="translateX(100px)" /><label for="value_4">translateX(100px)</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_5" value="translateX(-25px)" /><label for="value_5">translateX(-25px)</label></div>
	...
	<div id="myDIV">myDIV</div>
			...
			<pre id="styleDIV">
#myDIV {<br>    background-color:lightblue;<br>    transform:<span id='enlargecssprop'>translateX(10px)</span>;<br>}<br></pre>
		</div>
