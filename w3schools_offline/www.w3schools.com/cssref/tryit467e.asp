...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_anim_background-size by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:51 GMT -->
<head>
...
<p>Gradually change the background-size from "10px 10px" to "125px 125px", and back to "10px 10px":<p>
<div id="myDIV"></div>

<p>The background-size property is <em>animatable</em> in CSS.</p>
