...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_height by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:57 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.height=val;
		
	var x="height:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_3" value="200px" /><label for="value_3">200px</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<p>Try changing this DIV's height by clicking the radiobuttons on the left.</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div {
    height:<span id='enlargecssprop'>auto</span>;<br>}</pre>
		</div>
