...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_letter-spacing by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:14 GMT -->
<head>
...
<p>Click the "Try it" button to set the letter-spacing property of the DIV element to 3 pixels:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.letterSpacing = "3px";
}
</script>
