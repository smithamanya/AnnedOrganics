...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-rule-width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:03 GMT -->
<head>
...
<p>Click the "Try it" button to change the width of the column-rule:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.WebkitColumnRuleWidth = "10px"; // Code for Chrome, Safari, and Opera
    document.getElementById("myDIV").style.MozColumnRuleWidth = "10px"; // Code for Firefox
