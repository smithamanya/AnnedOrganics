...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_font-variant by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:47 GMT -->
<head>
...
<p>Click the "Try it" button to transform text of the DIV element into "small-caps":</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.fontVariant = "small-caps";
}
</script>
