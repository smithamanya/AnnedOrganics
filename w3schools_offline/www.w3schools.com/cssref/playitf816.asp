...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_list-style-position&preval=outside by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:47 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.listStylePosition=val;
		
	var x="list-style-position:<span id='enlargecssprop'>" + val + "</span>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                list-style-position:<br><br>
				<input type="hidden" id="preselectedValue" value="outside" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="inside" /><label for="value_1">inside</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="outside" /><label for="value_2">outside</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<ul id="myList">
		<li>Change the list style position</li>
		<li>See the result</li>
			...
			<pre id="styleDIV">
ul#myList {<br>    list-style-position:<span id='enlargecssprop'>inside</span>;<br>}<br></pre>
		</div>
