...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss_js_border by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:19:54 GMT -->
<head>
...
<p>Click the "Try it" button to change the border property of the DIV element:</p>
...
<script>
function myFunction() {
    document.getElementById("myDIV").style.border = "15px dotted lightblue";
}
</script>
