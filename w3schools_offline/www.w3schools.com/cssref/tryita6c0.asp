...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_column-span by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:04 GMT -->
<head>
...
<p>Click the "Try it" button to make the H2 element span over all columns:</p>
...
<p><strong>Note:</strong> The columnSpan property is not supported in Firefox.</p>
