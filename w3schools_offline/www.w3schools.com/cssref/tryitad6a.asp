...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_border-image-repeat by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:20:31 GMT -->
<head>
...
<p id="main">This element uses an image as a border.</p>

<p>Click the "Try it" button to change the value of the borderImageWidth property.</p>
...
<p><b>Note:</b> Internet Explorer 10, and earlier versions, do not support the border-image-repeat property.</p>
