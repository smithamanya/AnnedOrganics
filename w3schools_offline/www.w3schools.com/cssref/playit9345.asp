...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_opacity by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:35 GMT -->
<head>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
				...
				<input type="hidden" id="preselectedValue" value="" />
    				...
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="0.9" checked='checked' /><label for="value_1">0.9</label></div>
