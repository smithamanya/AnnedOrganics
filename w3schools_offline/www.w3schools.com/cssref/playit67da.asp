...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_z-index by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:38 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.zIndex=val;
		
	var x="z-index:<span id='enlargecssprop'>" + val + "</span>";
	var y="div#myBox {<br>    position:absolute;<br>    background-color:red;<br>    ###CSSPROP###;<br>}<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div style="position:absolute">
		...
		<div style="width:100px;height:100px;position:absolute;background-color:yellow;top:80px;left:80px;z-index:3;opacity:0.5;border:1px solid #333333;">z-index 3</div>
			...
			<pre id="styleDIV">
div#myBox {<br>    position:absolute;<br>    background-color:red;<br>    z-index:<span id='enlargecssprop'>auto</span>;<br>}<br></pre>
		</div>
