...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_text-align-last by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:33 GMT -->
<head>
...
<p>Click the "Try it" button to change the text-align-last property of the DIV element</p>
...
<p><b>Note:</b> The textAlignLast property is currently only supported in Internet Explorer 
and Firefox (using the MozTextAlignLast property).</p>
