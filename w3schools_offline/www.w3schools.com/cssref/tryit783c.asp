...
<!-- Mirrored from www.w3schools.com/cssref/tryit.asp?filename=trycss3_js_justify-content by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:23:06 GMT -->
<head>
...
<p>Click the "Try it" button to set the value of the justifyContent property to "space-between"</p>

<button onclick="myFunction()">Try it</button>

<script>
function myFunction() {
    document.getElementById("main").style.WebkitJustifyContent = "space-between"; // Code for Safari 6.1+
    document.getElementById("main").style.justifyContent = "space-between";
}
</script>

<p><b>Note:</b> Internet Explorer 10 and earlier versions do not support the justifyContent property.</p>

<p><b>Note:</b> Safari 6.1 (and newer) supports an alternative, the WebkitJustifyContent property.</p>
