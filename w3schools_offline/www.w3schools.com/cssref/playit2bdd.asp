...
<!-- Mirrored from www.w3schools.com/cssref/playit.asp?filename=playcss_direction&preval=rtl by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:16 GMT -->
<head>
	...
	function change_position(val)
	{
		...
		document.getElementById(s).style.direction=val;
		
	var x="direction:<span id='enlargecssprop'>" + val + "</span>";
	var y="###CSSPROP###;<br>";
...
<script type='text/javascript'>googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428407818244-0'); });</script>
	...
	<div id="container" class="container">
		...
		<div class="codecontainer">
                ...
                direction:<br><br>
				<input type="hidden" id="preselectedValue" value="rtl" />
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_1" value="ltr" /><label for="value_1">ltr</label></div>
				
    				<div class="radio"><input autocomplete="off" type="radio" name="radio_position" onclick="click_position(this)" id="value_2" value="rtl" /><label for="value_2">rtl</label></div>
		...
		<div class="resultcontainer">
			...
			<div id="demoParent">
				<div id="demoDIV"><div>
	<p>Change the direction of the text by clicking on the two different direction values</p>
</div></div>
			</div>
			<div class="demoHeader">CSS Code:</div>
			<pre id="styleDIV">
div {
    direction:<span id='enlargecssprop'>ltr</span>;<br>}</pre>
		</div>
