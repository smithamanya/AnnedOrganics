...
<!-- Mirrored from www.w3schools.com/css/tryit.asp?filename=trycss_pos_overflow_auto by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:28:06 GMT -->
<head>
...
<div>You can use the overflow property when you want to have better control of the layout. Try to change the overflow property to: visible, hidden, scroll, or inherit and see what happens. The default value is visible.</div>
