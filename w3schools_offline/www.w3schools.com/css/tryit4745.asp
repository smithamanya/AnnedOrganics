...
<!-- Mirrored from www.w3schools.com/css/tryit.asp?filename=trycss_buttons_width by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:44:43 GMT -->
<head>
...
<p><strong>Tip:</strong> Use pixels if you want to set a fixed width and use percent for responsive buttons (e.g. 50% of its parent element).</p>
