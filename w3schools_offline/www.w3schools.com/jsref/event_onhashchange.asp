...
<!-- Mirrored from www.w3schools.com/jsref/event_onhashchange.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:20 GMT -->
<head>

<title>onhashchange Event</title>
...
<h1><span class="color_h1">onhashchange</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the anchor part has been changed:</p>
<div class="w3-code notranslate htmlHigh">
&lt;body onhashchange=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit6028.html?filename=tryjsref_onhashchange" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onhashchange event occurs when there has been changes to the anchor part 
(begins with a '#' symbol) of the current URL.</p>
<p>An example of what an anchor part actually is: Assume that the current URL is<br>
http://www.example.com/test.htm#part2 - The anchor part of this URL would be 
#part2.</p>
<p>To invoke this event, you can:</p>
<ul>
	<li>Change the anchor part by setting the <a href="prop_loc_hash.asp">
	location.hash</a> or <a href="prop_loc_href.asp">location.href</a> property 
	of the <a href="obj_location.asp">Location Object</a></li>
	<li>Navigate to the current page with a different bookmark (Use the &quot;back&quot; 
	or &quot;forward&quot; buttons)</li>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">onhashchange</td>
    <td>5.0&nbsp;</td>
    <td>8.0</td>
    <td>3.6</td>
    <td>5.0</td>
...
&lt;<i>element</i> onhashchange=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit55d0.html?filename=tryjsref_onhashchange_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onhashchange=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitc521.html?filename=tryjsref_onhashchange_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;hashchange&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitf85a.html?filename=tryjsref_onhashchange_addeventlistener">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>How to assign the &quot;onhashchange&quot; event to the window object:</p>
<div class="w3-code notranslate jsHigh">
	window.onhashchange = myFunction;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit17a4.html?filename=tryjsref_onhashchange_win">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onhashchange.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:29 GMT -->
</html>
