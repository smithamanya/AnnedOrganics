...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_label.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:14 GMT -->
<head>
<title>HTML DOM Label Object</title>
...
<h1>HTML DOM <span class="color_h1">Label</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_keygen.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_legend.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Label Object</h2>
<p>The Label object represents an HTML &lt;label&gt; element.</p>
<h3>Access a Label Object</h3>
<p>You can access a &lt;label&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myLabel");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitc565.html?filename=tryjsref_label_get">Try it</a>	
</div>
</div>

<h3>Create a Label Object</h3>
<p>You can create a &lt;label&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("LABEL");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryita431.html?filename=tryjsref_label_create">Try it</a>	
</div>
</div>

<h2>Label Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>control</td>
    <td>Returns the labeled control</td>
  </tr>
  <tr>
    <td><a href="prop_label_form.html">form</a></td>
    <td>Returns a reference to the form that contains the label</td>
  </tr>
  <tr>
    <td><a href="prop_label_htmlfor.html">htmlFor</a></td>
    <td>Sets or returns the value of the for attribute of a label</td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The Label object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_forms.html">HTML Forms</a></p>
<p>HTML reference: <a href="../tags/tag_label.html">HTML &lt;label&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_label.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:17 GMT -->
</html>