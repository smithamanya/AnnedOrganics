...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_all.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:10:41 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_document.html">&laquo; Previous</a></div>
...
<p>Element objects can have <strong>child nodes</strong> of type element nodes, text nodes, or comment nodes.</p>
<p>A <strong>NodeList object</strong> represents a list of nodes, like an HTML element's collection of child nodes.</p>
<p>Elements can also have attributes. Attributes are attribute nodes (See next chapter).</p>
<hr>
...
<tr>
    <td><a href="prop_html_accesskey.html"><i>element</i>.accessKey</a></td>
    <td>Sets or returns the accesskey attribute of an element</td>
</tr>
<tr>
    <td><a href="met_element_addeventlistener.html"><i>element</i>.addEventListener()</a></td>
    <td>Attaches an event handler to the specified element</td>
</tr>
<tr>
	<td><a href="met_node_appendchild.html"><i>element</i>.appendChild()</a></td>
	<td>Adds a new child node, to an element, as the last child node</td>
</tr>
<tr>
	<td><a href="prop_node_attributes.html"><i>element</i>.attributes</a></td>
	<td>Returns a NamedNodeMap of an element's attributes</td>
</tr>
<tr>
	<td><a href="met_html_blur.html"><i>element</i>.blur()</a></td>
	<td>Removes focus from an element</td>
</tr>
<tr>
	<td><a href="prop_element_childelementcount.html"><i>element</i>.childElementCount</a></td>
	<td>Returns the number of child elements an element has</td>
</tr>
<tr>
	<td><a href="prop_node_childnodes.html"><i>element</i>.childNodes</a></td>
	<td>Returns a collection of an element's child nodes (including text and 
	comment nodes)</td>
</tr>
<tr>
	<td><a href="prop_element_children.html"><i>element</i>.children</a></td>
	<td>Returns a collection of an element's child element (excluding text and 
	comment nodes)</td>
</tr>
<tr>
    <td><a href="prop_element_classlist.html"><i>element</i>.classList</a></td>
    <td>Returns the class name(s) of an element</td>
</tr>
<tr>
    <td><a href="prop_html_classname.html"><i>element</i>.className</a></td>
    <td>Sets or returns the value of the class attribute of an element</td>
</tr>
<tr>
	<td><a href="met_html_click.html"><i>element</i>.click()</a></td>
	<td>Simulates a mouse-click on an element</td>
</tr>
<tr>
    <td><a href="prop_element_clientheight.html"><i>element</i>.clientHeight</a></td>
    <td>Returns the height of an element, including padding</td>
</tr>
<tr>
    <td><a href="prop_element_clientleft.html"><i>element</i>.clientLeft</a></td>
    <td>Returns the width of the left border of an element</td>
</tr>
<tr>
    <td><a href="prop_element_clienttop.html"><i>element</i>.clientTop</a></td>
    <td>Returns the width of the top border of an element</td>
</tr>
<tr>
    <td><a href="prop_element_clientwidth.html"><i>element</i>.clientWidth</a></td>
    <td>Returns the width of an element, including padding</td>
</tr>
<tr>
	<td><a href="met_node_clonenode.html"><i>element</i>.cloneNode()</a></td>
	<td>Clones an element</td>
</tr>
<tr>
	<td><a href="met_node_comparedocumentposition.html"><i>element</i>.compareDocumentPosition()</a></td>
	<td>Compares the document position of two elements</td>
</tr>
<tr>
	<td><a href="met_node_contains.html"><i>element</i>.contains()</a></td>
	<td>Returns true if a node is a descendant of a node, otherwise false</td>
</tr>
<tr>
	<td><a href="prop_html_contenteditable.html"><i>element</i>.contentEditable</a></td>
	<td>Sets or returns whether the content of an element is editable or not</td>
</tr>
<tr>
    <td><a href="prop_html_dir.html"><i>element</i>.dir</a></td>
    <td>Sets or returns the value of the dir attribute of an element</td>
</tr>
<tr>
	<td><a href="prop_node_firstchild.html"><i>element</i>.firstChild</a></td>
	<td>Returns the first child node of an element</td>
</tr>
<tr>
	<td><a href="prop_element_firstelementchild.html"><i>element</i>.firstElementChild</a></td>
	<td>Returns the first child element of an element</td>
</tr>
<tr>
	<td><a href="met_html_focus.html"><i>element</i>.focus()</a></td>
	<td>Gives focus to an element</td>
</tr>
<tr>
	<td><a href="met_element_getattribute.html"><i>element</i>.getAttribute()</a></td>
	<td>Returns the specified attribute value of an element node</td>
</tr>
<tr>
	<td><a href="met_element_getattributenode.html"><i>element</i>.getAttributeNode()</a></td>
	<td>Returns the specified attribute node</td>
</tr>
<tr>
	<td><a href="met_element_getelementsbyclassname.html"><i>element</i>.getElementsByClassName()</a></td>
	<td>Returns a collection of all child elements with the specified class name</td>
</tr>
<tr>
	<td><a href="met_element_getelementsbytagname.html"><i>element</i>.getElementsByTagName()</a></td>
...
-->
<tr>
	<td><a href="met_element_hasattribute.html"><i>element</i>.hasAttribute()</a></td>
	<td>Returns true if an element has the specified attribute, otherwise false</td>
</tr>
<tr>
	<td><a href="met_node_hasattributes.html"><i>element</i>.hasAttributes()</a></td>
	<td>Returns true if an element has any attributes, otherwise false</td>
</tr>
<tr>
	<td><a href="met_node_haschildnodes.html"><i>element</i>.hasChildNodes()</a></td>
	<td>Returns true if an element has any child nodes, otherwise false</td>
</tr>
<tr>
    <td><a href="prop_html_id.html"><i>element</i>.id</a></td>
    <td>Sets or returns the value of the id attribute of an element</td>
</tr>
<tr>
    <td><a href="prop_html_innerhtml.html"><i>element</i>.innerHTML</a></td>
    <td>Sets or returns the content of an element</td>
</tr>
<tr>
	<td><a href="met_node_insertbefore.html"><i>element</i>.insertBefore()</a></td>
	<td>Inserts a new child node before a specified, existing, child node</td>
</tr>
<tr>
	<td><a href="prop_html_iscontenteditable.html"><i>element</i>.isContentEditable</a></td>
	<td>Returns true if the content of an element is editable, otherwise false</td>
</tr>
<tr>
	<td><a href="met_node_isdefaultnamespace.html"><i>element</i>.isDefaultNamespace()</a></td>
	<td>Returns true if a specified namespaceURI is the default, otherwise false</td>
</tr>
<tr>
	<td><a href="met_node_isequalnode.html"><i>element</i>.isEqualNode()</a></td>
	<td>Checks if two elements are equal</td>
</tr>
<tr>
	<td><a href="met_node_issamenode.html"><i>element</i>.isSameNode()</a></td>
	<td>Checks if two elements are the same node</td>
</tr>
<tr>
	<td><a href="met_node_issupported.html"><i>element</i>.isSupported()</a></td>
	<td>Returns true if a specified feature is supported on the element</td>
</tr>
<tr>
    <td><a href="prop_html_lang.html"><i>element</i>.lang</a></td>
    <td>Sets or returns the value of the lang attribute of an element</td>
</tr>
<tr>
	<td><a href="prop_node_lastchild.html"><i>element</i>.lastChild</a></td>
	<td>Returns the last child node of an element</td>
</tr>
<tr>
	<td><a href="prop_element_lastelementchild.html"><i>element</i>.lastElementChild</a></td>
	<td>Returns the last child element of an element</td>
</tr>
<tr>
	<td><a href="prop_node_namespaceuri.html"><i>element</i>.namespaceURI</a></td>
	<td>Returns the namespace URI of an element</td>
</tr>
<tr>
	<td><a href="prop_node_nextsibling.html"><i>element</i>.nextSibling</a></td>
	<td>Returns the next node at the same node tree level</td>
</tr>
<tr>
	<td><a href="prop_element_nextelementsibling.html"><i>element</i>.nextElementSibling</a></td>
	<td>Returns the next element at the same node tree level</td>
</tr>
<tr>
	<td><a href="prop_node_nodename.html"><i>element</i>.nodeName</a></td>
	<td>Returns the name of a node</td>
</tr>
<tr>
	<td><a href="prop_node_nodetype.html"><i>element</i>.nodeType</a></td>
	<td>Returns the node type of a node</td>
</tr>
<tr>
	<td><a href="prop_node_nodevalue.html"><i>element</i>.nodeValue</a></td>
	<td>Sets or returns the value of a node</td>
</tr>
<tr>
	<td><a href="met_node_normalize.html"><i>element</i>.normalize()</a></td>
	<td>Joins adjacent text nodes and removes empty text nodes in an  
	element</td>
</tr>
<tr>
    <td><a href="prop_element_offsetheight.html"><i>element</i>.offsetHeight</a></td>
    <td>Returns the height of an element, including padding, border and 
	scrollbar</td>
</tr>
<tr>
    <td><a href="prop_element_offsetwidth.html"><i>element</i>.offsetWidth</a></td>
...
<tr>
	<td><a href="prop_node_ownerdocument.html"><i>element</i>.ownerDocument</a></td>
	<td>Returns the root element (document object) for an element</td>
</tr>
<tr>
	<td><a href="prop_node_parentnode.html"><i>element</i>.parentNode</a></td>
	<td>Returns the parent node of an element</td>
</tr>
<tr>
	<td><a href="prop_node_parentelement.html"><i>element</i>.parentElement</a></td>
	<td>Returns the parent element node of an element</td>
</tr>
<tr>
	<td><a href="prop_node_previoussibling.html"><i>element</i>.previousSibling</a></td>
	<td>Returns the previous node at the same node tree level</td>
</tr>
<tr>
	<td><a href="prop_element_previouselementsibling.html"><i>element</i>.previousElementSibling</a></td>
	<td>Returns the previous element at the same node tree level</td>
</tr>
<tr>
    <td><a href="met_element_queryselector.html"><i>element</i>.querySelector()</a></td>
    <td>Returns the first child element that matches a specified CSS selector(s) of an element</td>
</tr>
<tr>
    <td><a href="met_element_queryselectorall.html"><em>element</em>.querySelectorAll()</a></td>
    <td>Returns all child elements that matches a 
	specified CSS selector(s) of an element</td>
</tr>
<tr>
	<td><a href="met_element_removeattribute.html"><i>element</i>.removeAttribute()</a></td>
	<td>Removes a specified attribute from an element</td>
</tr>
<tr>
	<td><a href="met_element_removeattributenode.html"><i>element</i>.removeAttributeNode()</a></td>
	<td>Removes a specified attribute node, and returns the removed node</td>
</tr>
<tr>
	<td><a href="met_node_removechild.html"><i>element</i>.removeChild()</a></td>
	<td>Removes a child node from an element</td>
</tr>
<tr>
	<td><a href="met_node_replacechild.html"><i>element</i>.replaceChild()</a></td>
	<td>Replaces a child node in an element</td>
</tr>
<tr>
	<td><a href="met_element_removeeventlistener.html"><i>element</i>.removeEventListener()</a></td>
	<td>Removes an event handler that has been attached with the addEventListener() method</td>
</tr>
<tr>
    <td><a href="prop_element_scrollheight.html"><i>element</i>.scrollHeight</a></td>
    <td>Returns the entire height of an element, including padding</td>
</tr>
<tr>
    <td><a href="prop_element_scrollleft.html"><i>element</i>.scrollLeft</a></td>
    <td>Sets or returns the number of pixels an element's content is scrolled 
	horizontally</td>
</tr>
<tr>
    <td><a href="prop_element_scrolltop.html"><i>element</i>.scrollTop</a></td>
    <td>Sets or returns the number of pixels an element's content is scrolled 
	vertically</td>
</tr>
<tr>
    <td><a href="prop_element_scrollwidth.html"><i>element</i>.scrollWidth</a></td>
    <td>Returns the entire width of an element, including padding</td>
</tr>
<tr>
    <td><a href="met_element_setattribute.html"><i>element</i>.setAttribute()</a></td>
	<td>Sets or changes the specified attribute, to the specified value</td>
</tr>
<tr>
	<td><a href="met_element_setattributenode.html"><i>element</i>.setAttributeNode()</a></td>
...
-->
<tr>
    <td><a href="prop_html_style.html"><i>element</i>.style</a></td>
    <td>Sets or returns the value of the style attribute of an element</td>
</tr>
<tr>
    <td><a href="prop_html_tabindex.html"><i>element</i>.tabIndex</a></td>
    <td>Sets or returns the value of the tabindex attribute of an element</td>
</tr>
<tr>
	<td><a href="prop_element_tagname.html"><i>element</i>.tagName</a></td>
	<td>Returns the tag name of an element</td>
</tr>
<tr>
	<td><a href="prop_node_textcontent.html"><i>element</i>.textContent</a></td>
	<td>Sets or returns the textual content of a node and its 
	descendants</td>
</tr>
<tr>
    <td><a href="prop_html_title.html"><i>element</i>.title</a></td>
...
<tr>
	<td><a href="met_nodelist_item.html"><em>nodelist</em>.item()</a></td>
	<td>Returns the node at the specified index in a NodeList</td>
</tr>
<tr>
	<td><a href="prop_nodelist_length.html"><em>nodelist</em>.length</a></td>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_all.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:11:26 GMT -->
</html>