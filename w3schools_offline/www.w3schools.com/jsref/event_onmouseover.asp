...
<!-- Mirrored from www.w3schools.com/jsref/event_onmouseover.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:46 GMT -->
<head>
...
<p>The onmouseover event occurs when the mouse pointer is moved onto an element, or 
onto one of its children.</p>
<p><strong>Tip:</strong> This event is often used together with the
<a href="event_onmouseout.asp">onmouseout</a> event, which occurs when a user 
moves the mouse pointer out of an element.</p>
<hr>
...
&lt;<i>element</i> onmouseover=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit7326.html?filename=tryjsref_onmouseover_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onmouseover=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit8bbd.html?filename=tryjsref_onmouseover_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;mouseover&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit30fe.html?filename=tryjsref_onmouseover_addeventlistener">Try it</a> </div></div>
