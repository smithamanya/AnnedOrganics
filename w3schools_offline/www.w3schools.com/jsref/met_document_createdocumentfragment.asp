...
<!-- Mirrored from www.w3schools.com/jsref/met_document_createdocumentfragment.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:52 GMT -->
<head>
...
<h3>Example</h3>
<p>Create a documentFragment node and append a child to it (a list item).
...
<a target="_blank" href="tryit0f62.html?filename=tryjsref_document_createdocfrag" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">createDocumentFragment()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="tecspec">
  <tr>
	...
	<td>A DocumentFragment object, representing the created DocumentFragment 
	node</td>
  </tr>
<tr>
