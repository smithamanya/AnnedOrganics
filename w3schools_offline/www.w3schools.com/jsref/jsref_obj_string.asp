...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_string.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:06:53 GMT -->
<head>
<title>JavaScript String Reference</title>
...
<h1>JavaScript <span class="color_h1">String Reference</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="default.html">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jsref_obj_number.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>JavaScript Strings</h2>
<p>A JavaScript string stores a series of characters like &quot;John Doe&quot;.</p>
<p>A string can be any text inside double or single quotes:</p>
...
<p>String indexes are zero-based: The first character is in position 0, the 
second in 1, and so on.</p>

<p>For a tutorial about Strings, read our <a href="../js/js_strings.html">JavaScript String Tutorial</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_constructor_string.html">constructor</a></td>
    <td>Returns the string's constructor function</td>
  </tr>
  <tr>
    <td><a href="jsref_length_string.html">length</a></td>
    <td>Returns the length of a string</td>
  </tr>
  <tr>
    <td><a href="jsref_prototype_string.html">prototype</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_substring.html">substring()</a></td>
    <td>Extracts the characters from a string, between two specified indices</td>
  </tr>
  <tr>
    <td><a href="jsref_tolocalelowercase.html">toLocaleLowerCase()</a></td>
    <td>Converts a string to lowercase letters, according to the host's locale</td>
  </tr>
  <tr>
    <td><a href="jsref_tolocaleuppercase.html">toLocaleUpperCase()</a></td>
    <td>Converts a string to uppercase letters, according to the host's locale</td>
  </tr>
  <tr>
    <td><a href="jsref_tolowercase.html">toLowerCase()</a></td>
    <td>Converts a string to lowercase letters</td>
  </tr>
  <tr>
    <td><a href="jsref_tostring_string.html">toString()</a></td>
    <td>Returns the value of a String object</td>
  </tr>
  <tr>
    <td><a href="jsref_touppercase.html">toUpperCase()</a></td>
    <td>Converts a string to uppercase letters</td>
  </tr>
  <tr>
    <td><a href="jsref_trim_string.html">trim()</a></td>
    <td>Removes whitespace from both ends of a string</td>
  </tr>
  <tr>
    <td><a href="jsref_valueof_string.html">valueOf()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_anchor.html">anchor()</a></td>
    <td>Creates an anchor</td>
  </tr>
  <tr>
    <td><a href="jsref_big.html">big()</a></td>
    <td>Displays a string using a big font</td>
  </tr>
  <tr>
    <td><a href="jsref_blink.html">blink()</a></td>
    <td>Displays a blinking string</td>
  </tr>
  <tr>
    <td><a href="jsref_bold.html">bold()</a></td>
    <td>Displays a string in bold</td>
  </tr>
  <tr>
    <td><a href="jsref_fixed.html">fixed()</a></td>
    <td>Displays a string using a fixed-pitch font</td>
  </tr>
  <tr>
    <td><a href="jsref_fontcolor.html">fontcolor()</a></td>
    <td>Displays a string using a specified color</td>
  </tr>
  <tr>
    <td><a href="jsref_fontsize.html">fontsize()</a></td>
    <td>Displays a string using a specified size</td>
  </tr>
  <tr>
    <td><a href="jsref_italics.html">italics()</a></td>
    <td>Displays a string in italic</td>
  </tr>
  <tr>
    <td><a href="jsref_link.html">link()</a></td>
    <td>Displays a string as a hyperlink</td>
  </tr>
  <tr>
    <td><a href="jsref_small.html">small()</a></td>
    <td>Displays a string using a small font</td>
  </tr>
  <tr>
    <td><a href="jsref_strike.html">strike()</a></td>
    <td>Displays a string with a strikethrough</td>
  </tr>
  <tr>
    <td><a href="jsref_sub.html">sub()</a></td>
    <td>Displays a string as subscript text</td>
  </tr>
  <tr>
    <td><a href="jsref_sup.html">sup()</a></td>
...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_string.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:07:15 GMT -->
</html>
