...
<!-- Mirrored from www.w3schools.com/jsref/event_onreset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:20 GMT -->
<head>
...
<h1><span class="color_h1">onreset</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a form is reset:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;form onreset=&quot;myFunction()&quot;&gt;<br>&nbsp; Enter name: &lt;input type=&quot;text&quot;&gt;<br>&nbsp; 
	&lt;input type=&quot;reset&quot;&gt;<br>&lt;/form&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita5b5.html?filename=tryjsref_onreset">Try it yourself &raquo;</a>
</div>
...
<p>The onreset event occurs when a form is reset.</p>
<hr>
...
&lt;<i>element</i> onreset=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit87cb.html?filename=tryjsref_onreset_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onreset=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitbe9f.html?filename=tryjsref_onreset_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;reset&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitf2ba.html?filename=tryjsref_onreset_addeventlistener">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Display the text that was inserted in a text field before it was reset:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.getElementById(&quot;myInput&quot;);<br>alert(&quot;Before reset, the text 
	was: &quot; + x.value);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit5437.html?filename=tryjsref_onreset2">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using the reset() method of the HTML DOM Form Object to reset the form. When 
this happens, the onreset event fires, which will trigger an alert function.</p>
<div class="w3-code notranslate jsHigh">
	// Reset the value of all elements in a form with id=&quot;myForm&quot;<br>function 
	myResetFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myForm&quot;).reset();<br>}<br><br>// Alert some text 
	when the form is reset<br>function myAlertFunction() {<br>&nbsp;&nbsp;&nbsp; 
	alert(&quot;The form was reset&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit0eeb.html?filename=tryjsref_onreset3">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onreset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:27 GMT -->
</html>