...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_reset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:56 GMT -->
<head>

<title>HTML DOM Input Reset Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Reset</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_range.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_search.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Reset Object</h2>
<p>The Input Reset object represents an HTML &lt;input&gt; element with 
type=&quot;reset&quot;.</p>
<h3>Access an Input Reset Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;reset&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myReset");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitbb78.html?filename=tryjsref_reset_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;reset&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Reset Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;reset&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;reset&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit3fe7.html?filename=tryjsref_reset_create">Try it</a>	
</div>
</div>

<h2>Input Reset Object Properties</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="prop_reset_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a reset button should automatically get focus when the page loads</td>
  </tr>
   <tr>
    <td>defaultValue</td>
    <td>Sets or returns the default value of a reset button</td>
  </tr>
  <tr>
    <td><a href="prop_reset_disabled.html">disabled</a></td>
    <td>Sets or returns whether the reset button is disabled, or not</td>
    </tr>  
  <tr>
    <td><a href="prop_reset_form.html">form</a></td>
    <td>Returns a reference to the form that contains the reset button</td>
  </tr>
  <tr>
    <td><a href="prop_reset_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a reset button</td>
  </tr>
  <tr>
    <td><a href="prop_reset_type.html">type</a></td>
    <td>Returns which type of form element the reset button is</td>
  </tr>
  <tr>
    <td><a href="prop_reset_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of the reset button</td>
  </tr>
</table>

<!--
<h2>Input Reset Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_reset_blur.asp">blur()</a></td>
    <td>Removes focus from a reset button</td>
  </tr>
  <tr>
    <td><a href="met_reset_focus.asp">focus()</a></td>
    <td>Gives focus to a reset button</td>
  </tr>
</table>
-->

<h2>Standard Properties and Events</h2>
<p>The Input Reset object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_reset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:18:01 GMT -->
</html>