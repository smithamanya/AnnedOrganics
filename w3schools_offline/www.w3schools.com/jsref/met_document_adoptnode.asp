...
<!-- Mirrored from www.w3schools.com/jsref/met_document_adoptnode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:40 GMT -->
<head>

<title>HTML DOM adoptNode() Method</title>
...
<h1>HTML DOM <span class="color_h1">adoptNode()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Adopt the first &lt;h1&gt; element that appears in an iframe (another document):</p>
<div class="w3-code notranslate jsHigh">
	...
	x = document.adoptNode(h);</div>
<a target="_blank" href="tryit2364.html?filename=tryjsref_document_adoptnode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The adoptNode() method adopts a node from another document.</p>
<p>The adopted node can be of all node types.</p>
<p><strong>Note:</strong> All child nodes (descendants), if any, of the adopted node, are also adopted.</p>
<p><strong>Note:</strong> The original node (and its child nodes, if any) is removed from the other document.</p>
<p><strong>Tip:</strong> Use the <a href="met_document_importnode.asp">document.importNode()</a> method to copy a node, without removing it, from another document.</p>
<p><strong>Tip:</strong> Use the <a href="met_node_clonenode.html"><em>element</em>.cloneNode()</a> method to copy a node, without removing it, from the current document.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the method.</p>
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">adoptNode()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>3.0</td>
    <td>Yes</td>
...
document.adoptNode(<em>node</em>)</div>
</div>
...
<td><em>node</em>&nbsp;</td>
<td>Node object</td>
<td>Required. The node from another document. Can be of any node type</td>
</tr>
</table>
...
<table class="tecspec">
  <tr>
	...
	<td>A Node object, representing the adopted node</td>
  </tr>
  <tr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_adoptnode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:41 GMT -->
</html>
