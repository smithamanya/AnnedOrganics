...
<!-- Mirrored from www.w3schools.com/jsref/event_onbeforeprint.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:13:30 GMT -->
<head>
...
<h1><span class="color_h1">onbeforeprint</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a page is about to be printed:</p>
<div class="w3-code notranslate htmlHigh">
&lt;body onbeforeprint=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit1efa.html?filename=tryjsref_onbeforeprint" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onbeforeprint event occurs when a page is about to be printed (before the 
print dialogue box appears).</p>
<p><strong>Tip:</strong> The onbeforeprint event is the opposite of the
<a href="event_onafterprint.asp">onafterprint</a> event.</p>
<hr>
...
&lt;<i>element</i> onbeforeprint=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit391c.html?filename=tryjsref_onbeforeprint_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onbeforeprint=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit87aa.html?filename=tryjsref_onbeforeprint_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;beforeprint&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitc58d.html?filename=tryjsref_onbeforeprint_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onbeforeprint.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:13:56 GMT -->
</html>
