...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_opacity.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:24:35 GMT -->
<head>

<title>HTML DOM Style opacity Property</title>
...
<h1>Style <span class="color_h1">opacity</span> Property</h1>
<p><a href="dom_obj_style.asp"><img class="navup" src="../images/up.gif" alt="Style Object Reference" /> 
Style Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Make a DIV element transparent:</p>
<div class="w3-code notranslate jsHigh">
	document.getElementById("myDIV").style.opacity = "0.5";</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit4941.html?filename=tryjsref_style_opacity">
...
<p>The opacity property sets or returns the opacity level of an element.</p>
<p>The opacity-level of an element describes the transparency-level, where 1 is not transperant at all, 0.5 is 50% see-through, and 0 is completely transparent.</p>
<hr>
...
<p><strong>Note:</strong> IE8 and earlier supports an alternative, the filter property.</p>
<hr>

<h2>Syntax</h2>
<p>Return the opacity property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.opacity
</div></div>
<p>Set the opacity property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.opacity="<i>number</i>|initial|inherit"
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the opacity-level of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_opacity.html">opacity property</a></p>
<hr>

<a href="dom_obj_style.asp"><img class="navup" src="../images/up.gif" alt="Style Object Reference" /> 
Style Object</a>
</div>
