...
<!-- Mirrored from www.w3schools.com/jsref/met_document_queryselector.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:34 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">querySelector()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get the first element in the document with class=&quot;example&quot;:</p>
<div class="w3-code notranslate jsHigh">
	document.querySelector(&quot;.example&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit8715.html?filename=tryjsref_document_queryselector_class">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The querySelector() method returns the first element that matches a specified
<em>CSS selector(s)</em> in the document.</p>
<p><strong>Note:</strong> The querySelector() method only returns the first 
element that matches the specified selectors. To return all the matches, use the 
<a href="met_document_queryselectorall.asp">querySelectorAll()</a> method instead.</p>
<p>If the selector matches an ID in document that is used several times (Note 
that an &quot;id&quot; should be unique within a page and should not used more than once), 
it returns the first matching element.</p>
...
document.querySelector(<em>CSS selectors</em>)</div></div>
...
etc.<br><br>For multiple selectors, separate each selector with a comma. The 
returned element depends on which element that is first found in the document 
(See &quot;More Examples&quot;).<br><br>
...
<tr>
	<th>Return Value:</th>
	<td>A NodeList object, representing the first element that matches the specified CSS selector(s). If no 
	matches are found, null is returned. Throws a SYNTAX_ERR 
	exception if the specified selector(s) is invalid.</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the first &lt;p&gt; element in the document:</p>
<div class="w3-code notranslate jsHigh">
	document.querySelector(&quot;p&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3d37.html?filename=tryjsref_document_queryselector_p">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Get the first &lt;p&gt; element in the document with class=&quot;example&quot;:</p>
<div class="w3-code notranslate jsHigh">
	document.querySelector(&quot;p.example&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6bbd.html?filename=tryjsref_document_queryselector_elementclass">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
	<p>Change the text of an element with id=&quot;demo&quot;:</p>
<div class="w3-code notranslate jsHigh">
	document.querySelector(&quot;#demo&quot;).innerHTML = &quot;Hello World!&quot;;<br>
</div>
<a target="_blank" href="tryit95ea.html?filename=tryjsref_document_queryselector" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Get the first &lt;p&gt; element in the document where the parent is a &lt;div&gt; 
element.</p>
<div class="w3-code notranslate jsHigh">
	document.querySelector(&quot;div &gt; p&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitcddc.html?filename=tryjsref_document_queryselector_gt">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Get the first &lt;a&gt; element in the document that has a &quot;target&quot; attribute:</p>
<div class="w3-code notranslate jsHigh">
	document.querySelector(&quot;a[target]&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit30ea.html?filename=tryjsref_document_queryselector_attribute">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates how multiple selectors work.</p>
	<p>Assume that you have two elements: a &lt;h2&gt; and a &lt;h3&gt; element.</p>
	<p>The following code will add a background color to the first &lt;h2&gt; element 
	in the document:</p>
<div class="w3-code notranslate jsHigh">
	&lt;h2&gt;A h2 element&lt;/h2&gt;<br>&lt;h3&gt;A h3 element&lt;/h3&gt;<br><br>document.querySelector(&quot;h2, 
	h3&quot;).style.backgroundColor = &quot;red&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit66b6.html?filename=tryjsref_document_queryselector_multiple">Try it yourself &raquo;</a>
	<p>However, if the &lt;h3&gt; element was placed before the &lt;h2&gt; element in the 
	document. The &lt;h3&gt; element is the one that will get the red background 
	color.</p>
<div class="w3-code notranslate jsHigh">
	&lt;h3&gt;A h3 element&lt;/h3&gt;<br>&lt;h2&gt;A h2 element&lt;/h2&gt;<br><br>document.querySelector(&quot;h2, 
	h3&quot;).style.backgroundColor = &quot;red&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1f8f.html?filename=tryjsref_document_queryselector_multiple2">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>JavaScript Reference: <a href="met_element_queryselector.html"><em>element</em>.querySelector()</a></p>
<p>HTML DOM Reference: <a href="met_document_queryselectorall.asp">document.querySelectorAll()</a></p>
<p>JavaScript Reference: <a href="met_element_queryselectorall.html"><em>element</em>.querySelectorAll()</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_queryselector.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:39 GMT -->
</html>
