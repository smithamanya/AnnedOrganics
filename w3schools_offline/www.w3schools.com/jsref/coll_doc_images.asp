...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_images.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:19 GMT -->
<head>
...
<h3>Example</h3>
<p>Find out how many &lt;img&gt; elements there are in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.images.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	3</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1b60.html?filename=tryjsref_doc_images">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The images collection returns a collection of all &lt;img&gt; elements in the document.</p>
<p><b>Note:</b> The elements in the collection are sorted as they appear in the source code.</p>
<p><strong>Note:</strong> The images collection does not return a collection of &lt;input&gt; elements with type=&quot;image&quot;.</p>
<p><strong>Tip:</strong> Also look at the <a href="dom_obj_image.asp">Image Object</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;img&gt; elements in the collection.<br><br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;img&gt; element from the collection with the specified index 
  ...
  <tr>
    ...
    <td>Returns the &lt;img&gt; element from the collection with the specified id.<br><br>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>An HTMLCollection Object, representing all &lt;img&gt; elements in the 
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
<p>Get the URL of the first &lt;img&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.images[0].src;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/klematis.jpg</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3ea5.html?filename=tryjsref_doc_images3">Try it yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
	<p>Get the URL of the first &lt;img&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.images.item(0).src;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/klematis.jpg</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitecf2.html?filename=tryjsref_doc_images4">Try it yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
	<p>Get the URL of the &lt;img&gt; element with id=&quot;myImg&quot; in the 
	document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.images.namedItem(&quot;myImg&quot;).src;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/smiley.gif</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitaed9.html?filename=tryjsref_doc_images5">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
	<p>Add a black dotted border to the first &lt;img&gt; element in the document:</p>
<div class="w3-code notranslate jsHigh">
	document.images[0].style.border = &quot;10px dotted black&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2ec7.html?filename=tryjsref_doc_images6">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all &lt;img&gt; elements in the document, and output the URL 
(src) of each image:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.images;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; 
	i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x[i].src + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/klematis.jpg<br>http://www.w3schools.com/jsref/klematis2.jpg<br>
	http://www.w3schools.com/jsref/smiley.gif</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit4c24.html?filename=tryjsref_doc_images2">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript reference: <a href="dom_obj_image.asp">HTML DOM Image Object</a></p>
<p>HTML tutorial: <a href="../html/html_images.html">HTML Images</a></p>
<p>HTML reference: <a href="../tags/tag_img.html">HTML &lt;img&gt; tag</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_images.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:23 GMT -->
</html>