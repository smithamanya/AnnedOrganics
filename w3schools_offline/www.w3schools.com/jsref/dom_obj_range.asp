...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_range.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:42 GMT -->
<head>
<title>HTML DOM Input Range Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Range </span>Object</h1>
<div class="chapter">
...
<h2>Input Range Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input Range Object is new in HTML5.</div></p>
<p>The Input Range object represents an HTML &lt;input&gt; element with 
type=&quot;range&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;range&quot; are not 
supported in Internet Explorer 9 and earlier versions.</span></p>
<h3>Access an Input Range Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;range&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myRange");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit3d0c.html?filename=tryjsref_range_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;range&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Range Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;range&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;range&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitd434.html?filename=tryjsref_range_create">Try it</a>	
</div>
</div>

<h2>Input Range Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a slider control should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_range_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_disabled.html">disabled</a></td>
    <td>Sets or returns whether a slider control is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_range_form.html">form</a></td>
    <td>Returns a reference to the form that contains the slider control</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute of the slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_min.html">min</a></td>
    <td>Sets or returns the value of the min attribute of the slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_step.html">step</a></td>
    <td>Sets or returns the value of the step attribute of the slider control</td>
  </tr>
  <tr>
    <td><a href="prop_range_type.html">type</a></td>
    <td>Returns which type of form element the slider control is</td>
  </tr>
  <tr>
    <td><a href="prop_range_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a slider control</td>
  </tr>
</table>

<h2>Input Range Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_range_stepdown.html">stepDown()</a></td>
    <td>Decrements the value of the slider control by a specified number</td>
    </tr>
  <tr>
    <td><a href="met_range_stepup.html">stepUp()</a></td>
    <td>Increments the value of the slider control by a specified number</td>
    </tr>
</table>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_range_blur.asp">blur()</a></td>
    <td>Removes focus from a slider control</td>
  </tr>
  <tr>
    <td><a href="met_range_focus.asp">focus()</a></td>
    <td>Gives focus to a slider control</td>
  </tr>
</table>
-->

<h2>Standard Properties and Events</h2>
<p>The Input Range object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_range.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:55 GMT -->
</html>