...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_script.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:24 GMT -->
<head>
<title>HTML DOM Script Object</title>
...
<h1>HTML DOM <span class="color_h1">Script</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_samp.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_section.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Script Object</h2>
<p>The Script object represents an HTML &lt;script&gt; element.</p>
<h3>Access a Script Object</h3>
<p>You can access a &lt;script&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myScript");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit6784.html?filename=tryjsref_script_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access a &lt;script&gt; element by using the <a href="coll_doc_scripts.asp">scripts</a> collection.</p>

<h3>Create a Script Object</h3>
<p>You can create a &lt;script&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("SCRIPT");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit795e.html?filename=tryjsref_script_create">Try it</a>	
</div>
</div>

<h2>Script Object Properties</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="prop_script_async.html">async</a></td>
    <td>Sets or returns whether a script should be executed asynchronously as 
	soon as it is available</td>
  </tr>    
  <tr>
    <td><a href="prop_script_charset.html">charset</a></td>
    <td>Sets or returns the value of the charset attribute of a script</td>
  </tr> 
  <tr>
    <td class="html5badge">crossOrigin</td>
    <td>Sets or returns the the CORS settings of a script</td>
  </tr> 
  <tr>
    <td><a href="prop_script_defer.html">defer</a></td>
    <td>Sets or returns whether a script should be executed when the page has 
	finished parsing</td>
  </tr> 
  <tr>
    <td><a href="prop_script_src.html">src</a></td>
    <td>Sets or returns the value of the src attribute of a script</td>
  </tr> 
  <tr>
    <td><a href="prop_script_text.html">text</a></td>
    <td>Sets or returns the contents of all the text nodes that are children of 
	a script</td>
  </tr> 
  <tr>
    <td><a href="prop_script_type.html">type</a></td>
    <td>Sets or returns the value of the type attribute of a script</td>
  </tr> 
</table>

<h2>Standard Properties and Events</h2>
<p>The Script object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_script.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:30 GMT -->
</html>