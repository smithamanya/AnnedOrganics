...
<!-- Mirrored from www.w3schools.com/jsref/met_document_importnode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:24 GMT -->
<head>
...
<h3>Example</h3>
<p>Return the first &lt;h1&gt; element that appears in an iframe (another 
document):</p>
...
<a target="_blank" href="tryite438.html?filename=tryjsref_document_importnode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>If the second parameter is set to true, the nodes&#39;s child nodes (descendants) will also be imported.</p>
<p><strong>Note:</strong> The original node is not removed from the other document. The imported node is a copy of the original. </p>
<p><strong>Tip:</strong> Use the <a href="met_document_adoptnode.asp">document.adoptNode()</a> method to remove and import a node from another document.</p>
<p><strong>Tip:</strong> Use the <a href="met_node_clonenode.html"><em>element</em>.cloneNode()</a> 
method to copy a node from the current document.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">importNode()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>1.0</td>
    <td>Yes</td>
...
document.importNode(<em>node</em>,<em>deep</em>)</div>
</div>
...
<td><em>deep</em></td>
<td>Boolean</td>
<td>Required. If set to false, only the node itself is imported, if set to true, all child nodes (descendants) are also imported</td>
</tr>
</table>
...
<tr>
	...
	<td>A Node object, representing the imported node</td>
</tr>
<tr>
