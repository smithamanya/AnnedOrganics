...
<!-- Mirrored from www.w3schools.com/jsref/event_onresize.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:15:26 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita335.html?filename=tryjsref_onresize">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onresize event occurs when the browser window has been resized.</p>
<p><strong>Tip:</strong> To get the size of an element, use the clientWidth, 
clientHeight, <a href="prop_win_innerheight.html">innerWidth</a>,
<a href="prop_win_innerheight.html">innerHeight</a>,
<a href="prop_win_outerheight.html">outerWidth</a>,
<a href="prop_win_outerheight.html">outerHeight</a>, offsetWidth and/or 
offsetHeight properties.</p>
<hr>
...
&lt;<i>element</i> onresize=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitea55.html?filename=tryjsref_onresize_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onresize=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit4ad9.html?filename=tryjsref_onresize_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;resize&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit9342.html?filename=tryjsref_onresize_addeventlistener">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using the addEventListener() method to attach the &quot;resize&quot; event on the 
window object.</p>
<div class="w3-code notranslate jsHigh">
	window.addEventListener(&quot;resize&quot;, myFunction);<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitcbc9.html?filename=tryjsref_onresize_window">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onresize.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:15:39 GMT -->
</html>
