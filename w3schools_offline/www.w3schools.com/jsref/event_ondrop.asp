...
<!-- Mirrored from www.w3schools.com/jsref/event_ondrop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:18 GMT -->
<head>

<title>ondrop Event</title>
...
<h1><span class="color_h1">ondrop</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a draggable element is dropped in a &lt;div&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;div ondrop="myFunction(event)"&gt;&lt;/div&gt;</div>
<a target="_blank" href="tryit0f9a.html?filename=tryjsref_ondrop" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ondrop event occurs when a draggable element or text selection is dropped 
on a valid drop target.</p>
...
<ul>
  ...
  <li><strong>Events fired on the drop target:
    ...
    <ul>
		...
		<li>ondrop - occurs when the dragged element is dropped on the drop target</li>
	</ul>
  </li>
</ul>
<hr>
...
&lt;<i>element</i> ondrop=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit9ef8.html?filename=tryjsref_ondrop_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondrop=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitceec.html?filename=tryjsref_ondrop_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;drop&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit4be9.html?filename=tryjsref_ondrop_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_ondrop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:23 GMT -->
</html>
