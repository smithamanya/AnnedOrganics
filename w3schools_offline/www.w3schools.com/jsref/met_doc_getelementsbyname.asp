...
<!-- Mirrored from www.w3schools.com/jsref/met_doc_getelementsbyname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:12 GMT -->
<head>
...
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByName(&quot;fname&quot;);<br>
</div>
<a target="_blank" href="tryitfe2e.html?filename=tryjsref_doc_getelementsbyname" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getElementsByName() method returns a collection of all elements in the document with the specified 
name (the <strong>value</strong> of the name attribute), as a NodeList object.</p>
...
info you want.</p>
<p><strong>Note:</strong> In HTML5, the &quot;name&quot; attribute is deprecated and has 
been replaced by the &quot;id&quot; attribute for many elements. Use the
<a href="met_document_getelementbyid.asp">document.getElementById()</a> method where it is appropriate. Also look at the
<a href="met_document_getelementsbyclassname.asp">getElementsByClassName()</a> and
<a href="met_document_getelementsbytagname.asp">getElementsByTagName()</a> 
methods.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">getElementsByName()</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<td><em>name</em></td>
<td>String</td>
<td>Required. The name attribute value of the element you want to access/manipulate</td>
</tr>
</table>
...
<tr>
	<th style="width:17%;">Return Value:</th>
	<td>A NodeList object, representing a collection of elements with the specified name. The elements in the 
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out how many elements there are in the document that have a name 
attribute with the value &quot;animal&quot; (using the length 
property of the NodeList object):</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByName(&quot;animal&quot;).length;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit46e0.html?filename=tryjsref_doc_getelementsbyname_length">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Check all &lt;input&gt; elements with type=&quot;checkbox&quot; in the document that have a name 
attribute with the value &quot;animal&quot;:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.getElementsByName(&quot;animal&quot;);<br>var i;<br>for (i = 0; i &lt; 
	x.length; i++) {<br>&nbsp;&nbsp;&nbsp; if (x[i].type == &quot;checkbox&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	x[i].checked = true;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit9750.html?filename=tryjsref_doc_getelementsbyname_loop">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_doc_getelementsbyname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:14 GMT -->
</html>
