...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_pushbutton.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:13:40 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_br.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_canvas.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Button Object</h2>
<p>The Button object represents an HTML &lt;button&gt; element.</p>
<h3>Access a Button Object</h3>
<p>You can access a &lt;button&gt; element by using getElementById():</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myBtn");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryita503.html?filename=tryjsref_pushbutton_get">Try it</a>	
</div>
</div>

<h3>Create a Button Object</h3>
<p>You can create a &lt;button&gt; element by using the document.createElement() method:</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("BUTTON");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryita28c.html?filename=tryjsref_pushbutton_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="prop_pushbutton_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a button should automatically get focus when the page loads, or not</td>
  </tr>
  <tr>
    <td><a href="prop_pushbutton_disabled.html">disabled</a></td>
    <td>Sets or returns whether a button is disabled, or not</td>
  </tr>
  <tr>
    <td><a href="prop_pushbutton_form.html">form</a></td>
    <td>Returns a reference to the form that contains a button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_pushbutton_formaction.html">formAction</a></td>
    <td>Sets or returns the value of the formaction attribute of a button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_pushbutton_formenctype.html">formEnctype</a></td>
    <td>Sets or returns the value of the formenctype attribute of a button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_pushbutton_formmethod.html">formMethod</a></td>
    <td>Sets or returns the value of the formmethod attribute of a button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_pushbutton_formnovalidate.html">formNoValidate</a></td>
    <td>Sets or returns whether the form-data should be validated or not, on submission</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_pushbutton_formtarget.html">formTarget</a></td>
    <td>Sets or returns the value of the formtarget attribute of a button</td>
  </tr>
  <tr>
    <td><a href="prop_pushbutton_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a button</td>
  </tr>
  <tr>
    <td><a href="prop_pushbutton_type.html">type</a></td>
    <td>Sets or returns the type of a button</td>
  </tr>
  <tr>
    <td><a href="prop_pushbutton_value.html">value</a></td>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_button.html">HTML &lt;button&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_pushbutton.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:13:49 GMT -->
</html>