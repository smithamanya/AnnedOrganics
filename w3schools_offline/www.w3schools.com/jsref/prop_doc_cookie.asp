...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_cookie.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:49 GMT -->
<head>
...
<h3>Example</h3>
<p>Get the cookies associated with the current document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.cookie;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit4f5a.html?filename=tryjsref_doc_cookie">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The cookie property sets or returns all name/value pairs of cookies in the current document.</p>
<p>For more information about cookies, read our <a href="../js/js_cookies.html">JavaScript Cookies Tutorial</a>.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the cookie property:</p>
<div class="w3-code w3-border notranslate"><div>
document.cookie</div></div>
<p>Set the cookie property:</p>
<div class="w3-code w3-border notranslate"><div>
document.cookie=<em>newCookie</em></div></div>
...
<tr>
<td><em>newCookie</em></td>
<td>
A String that specifies a semicolon-separated list of <em>name=value</em> pairs, or one <em>
name=value </em>pair together with any of the following, optional, values:
<ul>
	<li><strong>expires=<em>date</em></strong> - Optional. Specifies the date in GMT format 
	(See the Date.toUTCString method). If not specified, 
	the cookie is deleted when the browser is closed</li><br>
	<li><strong>path=<em>path</em></strong> - Optional. Tells the browser what path to the 
	directory the cookie belongs to, (e.g., '/', '/dir'). <strong>Note:</strong> 
	The path must be absolute. If not specified, the 
	cookie belongs to the current page</li><br>
	<li><strong>domain=<em>domainname</em></strong> - Optional. Specifies the domain of your site 
	(e.g., 'example.com', '.example.com' (includes all subdomains), 
	'subdomain.example.com'). If not specified, the domain of the current 
	document will be used</li><br>
	<li><strong>secure </strong>- Optional. Tells the browser to use a secure 
	protocol (https) for sending the cookie to the server</li>
</ul>
<p>An example of creating a cookie:</p>
<p><div class="w3-code w3-border notranslate"><div>
document.cookie=&quot;username=John Doe; expires=Thu, 18 Dec 2013 12:00:00 UTC; 
path=/&quot;;</div></div></p>
<strong>Note: </strong>The value of a cookie cannot contain commas, 
semicolons or whitespaces. However, you can use the 
<a href="jsref_encodeuricomponent.html">encodeURIComponent()</a> method to ensure 
that they don't</td>
</tr>
</table>
...
<tr>
	...
	<td>A String, containing the name/value pairs of cookies in the 
	document</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<hr>
<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_cookies.html">JavaScript Cookies</a></p>
<hr>
