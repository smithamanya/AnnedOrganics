...
<!-- Mirrored from www.w3schools.com/jsref/event_onwheel.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:46 GMT -->
<head>
...
<h1><span class="color_h1">onwheel</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>When the user rolls the mouse wheel over a &lt;div&gt; element, change its 
font-size:</p>
<div class="w3-code notranslate jsHigh">
	document.getElementById(&quot;myDIV&quot;).addEventListener(&quot;wheel&quot;, myFunction);<br>
	<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; 
	this.style.fontSize = &quot;35px&quot;;<br>}</div>
<a target="_blank" href="tryita0ac.html?filename=tryjsref_onwheel_addeventlistener" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onwheel event occurs when the mouse wheel is rolled 
up or down over an element.</p>
<p>The onwheel event also occurs when the user scrolls or zooms in or out of an 
element by using a touchpad (like the &quot;mouse&quot; of a laptop).</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">onwheel</td>
    <td>31.0</td>
    <td>9.0</td>
    <td>17.0</td>
...
<p><strong>Note:</strong> In IE, the wheel event is only supported with the 
addEventListener() method. There is no onwheel attribute on DOM objects.</p>
<hr>

<h2>Syntax</h2>
<p>In HTML:</p>
<div class="w3-code w3-border notranslate"><div>
&lt;<i>element</i> onwheel=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit9bf4.html?filename=tryjsref_onwheel_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onwheel=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit7415.html?filename=tryjsref_onwheel_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;wheel&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryita0ac.html?filename=tryjsref_onwheel_addeventlistener">Try it</a> </div></div>
...
<table class="tecspec">
  ...
  <tr>
	<th style="width:30%;">DOM Version:</th>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onwheel.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:50 GMT -->
</html>
