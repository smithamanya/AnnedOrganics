...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_columnrulecolor.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:01 GMT -->
<head>

<title>HTML DOM Style columnRuleColor Property</title>
...
<h1>Style <span class="color_h1">columnRuleColor </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit8e44.html?filename=tryjsref_style_columnrulecolor">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The columnRuleColor property specifies the color of the rule between columns.</p>
<hr>
...
<p>The columnRuleColor property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the MozColumnRuleColor property.</p>
<p>Safari and Chrome support an alternative, the WebkitColumnRuleColor property.</p>
<hr>
<h2>Syntax</h2>
<p>Return the columnRuleColor property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnRuleColor </div></div>
<p>Set the columnRuleColor property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnRuleColor=&quot;<i>color</i>|initial|inherit&quot;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> <i>color</i></td>
    <td>Specifies the color of the rule. Look at <a href="../cssref/css_colors_legal.asp">CSS Color Values</a> 
...
<tr>
	...
	<td width="80%">The current color of the element</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the column-rule-color property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<p>CSS reference: <a href="../cssref/css3_pr_column-rule-color.html">column-rule-color property</a></p>
<hr>
