...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_menu.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:32 GMT -->
<head>
<title>HTML DOM Menu Object</title>
...
<h1>HTML DOM <span class="color_h1">Menu</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_mark.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_menuitem.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Menu Object</h2>
<p>The Menu object represents an HTML &lt;menu&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;menu&gt; element is currently 
NOT supported in any of the major browsers.</span></p>
<h3>Access a Menu Object</h3>
<p>You can access a &lt;menu&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myMenu");</span>
</div>
</div>

<h3>Create a Menu Object</h3>
<p>You can create a &lt;menu&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>label</td>
    <td>Sets or returns the value of the label attribute of the menu</td>
  </tr>
  <tr>
    <td>type</td>
    <td>Sets or returns the value of the type attribute of the menu </td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The Menu object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
