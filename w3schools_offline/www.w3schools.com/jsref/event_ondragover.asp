...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragover.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:13 GMT -->
<head>

<title>ondragover Event</title>
...
<h1><span class="color_h1">ondragover</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when an element is being dragged over a drop target:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;div ondragover="myFunction(event)"&gt;&lt;/div&gt;</div>
<a target="_blank" href="tryita976.html?filename=tryjsref_ondragover" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ondragover event occurs when a draggable element or text selection is being 
dragged over a valid drop target.</p>
<p>By default, data/elements cannot be dropped in other elements. To allow a 
drop, we must prevent the default handling of the element. This is done by 
calling the event.preventDefault() method for the ondragover event.</p>
<p>Drag and drop is a very common feature in HTML5. It is when you &quot;grab&quot; an 
object and drag it to a different location. For more information, see our HTML 
Tutorial on <a href="../html/html5_draganddrop.html">HTML5 Drag and Drop</a>.</p>
<p><strong>Note:</strong> To make an element draggable, use the global HTML5
<a href="../tags/att_global_draggable.asp">draggable</a> attribute.</p>
<p><strong>Tip:</strong> Links and images are draggable by default, and do not 
need the draggable attribute.</p>
<p>There are many events that are used, and can occur, in the different stages 
of a drag and drop operation:</p>
<ul>
  <li><strong>Events fired on the draggable target</strong> (the source element)<strong>:
  </strong>
    <ul>
      <li><a href="event_ondragstart.asp">ondragstart</a> - occurs when the user starts to drag an element</li>
      <li><a href="event_ondrag.asp">ondrag</a> - occurs when an element is being dragged</li>
      <li><a href="event_ondragend.asp">ondragend</a> - occurs when the user has finished dragging the element</li>
    </ul>
  </li><br>
  <li><strong>Events fired on the drop target:
    </strong>
    <ul>
		<li><a href="event_ondragenter.asp">ondragenter</a> - occurs when the dragged element enters the drop target</li>
		<li>ondragover - occurs when the dragged element is over the drop target</li>
		<li><a href="event_ondragleave.asp">ondragleave</a> - occurs when the dragged element leaves the drop target</li>
		<li><a href="event_ondrop.asp">ondrop</a> - occurs when the dragged element is dropped on the drop target</li>
	</ul>
  </li>
</ul>
<p><strong>Note:</strong> While dragging an element, the ondragover event fires every 350 milliseconds.</p>
<hr>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">Event</th>
...
&lt;<i>element</i> ondragover=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit6293.html?filename=tryjsref_ondragover_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondragover=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitb197.html?filename=tryjsref_ondragover_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;dragover&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit7b5d.html?filename=tryjsref_ondragover_addeventlistener">Try it</a> </div></div>
<p><strong>Note:</strong> The <a href="met_element_addeventlistener.html">addEventListener()</a> method is not supported in Internet Explorer 8 and earlier versions.</p>
<hr>
...
<table class="tecspec">
  <tr>
    ...
    <tr>
	<th style="width:25%">Cancelable:</th>
	<td>Yes</td>
  </tr>
  <tr>
  ...
  <tr>
	<th style="width:25%">Supported HTML tags:</th>
	<td>All HTML elements</td>
  </tr>
  <tr>
	<th style="width:25%;">DOM Version:</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of ALL possible drag and drop events:</p>
<div class="w3-code notranslate jsHigh">
	&lt;p draggable=&quot;true&quot; id=&quot;dragtarget&quot;&gt;Drag me!&lt;/p&gt;<br><br>&lt;div 
	class=&quot;droptarget&quot;&gt;Drop here!&lt;/div&gt;<br><br>&lt;script&gt;<br>/* ----------------- Events fired on the drag target 
	----------------- */<br><br>
	...
	dragged data<br>&nbsp;&nbsp;&nbsp; event.dataTransfer.setData(&quot;Text&quot;, event.target.id);<br>
	<br>&nbsp;&nbsp;&nbsp; // Output some text when starting to drag the p element<br>
	&nbsp;&nbsp;&nbsp;
	document.getElementById(&quot;demo&quot;).innerHTML = &quot;Started to drag the p 
	element.&quot;;<br><br>&nbsp;&nbsp;&nbsp; // Change the opacity of the 
	draggable element<br>
	&nbsp;&nbsp;&nbsp; event.target.style.opacity = &quot;0.4&quot;;<br>});<br><br>// While dragging the p element, change the color 
	of the output text<br>document.addEventListener(&quot;drag&quot;, function(event) {<br>
	&nbsp;&nbsp;&nbsp;
	document.getElementById(&quot;demo&quot;).style.color = &quot;red&quot;;<br>});<br><br>// Output 
	some text when finished dragging the p element and reset the opacity<br>
	document.addEventListener(&quot;dragend&quot;, function(event) {<br>
	&nbsp;&nbsp;&nbsp;
	document.getElementById(&quot;demo&quot;).innerHTML = &quot;Finished dragging the p 
	element.&quot;;<br>&nbsp;&nbsp;&nbsp; event.target.style.opacity = &quot;1&quot;;<br>});<br><br><br>/* ----------------- Events fired on the drop target 
	----------------- */<br><br>// When the draggable p element enters the 
	droptarget, change the DIVS's border style<br>document.addEventListener(&quot;dragenter&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; if ( 
	event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	event.target.style.border = 
	&quot;3px dotted red&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>});<br><br>// By default, data/elements cannot be dropped in 
	other elements. To allow a drop, we must prevent the default handling of the 
	element<br>document.addEventListener(&quot;dragover&quot;, function(event) {<br>
	&nbsp;&nbsp;&nbsp;
	event.preventDefault();<br>});<br><br>// When the draggable p element leaves 
	the droptarget, reset the DIVS's border style<br>
	document.addEventListener(&quot;dragleave&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; if ( 
	event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	event.target.style.border = &quot;&quot;;<br>
	&nbsp;&nbsp;&nbsp;
	}<br>});<br><br>/* On drop - Prevent the browser default handling of the data 
	(default is open as link on drop)<br>Reset the color of the output text and 
	DIV's border color<br>Get the dragged data with the 
	dataTransfer.getData() method<br>The dragged data is the id of the dragged 
	element (&quot;drag1&quot;)<br>Append the dragged element into the drop element<br>*/<br>
	document.addEventListener(&quot;drop&quot;, function(event) {<br>&nbsp;&nbsp;&nbsp; event.preventDefault();<br>&nbsp;&nbsp;&nbsp; 
	if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).style.color = &quot;&quot;;<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var data = 
	event.dataTransfer.getData(&quot;Text&quot;);<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.appendChild(document.getElementById(data));<br>&nbsp;&nbsp;&nbsp; 
	}<br>});<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitef04.html?filename=tryjsref_ondrag_all">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML Tutorial: <a href="../html/html5_draganddrop.html">HTML5 Drag and Drop</a></p>
<p>HTML Reference: <a href="../tags/att_global_draggable.asp">HTML draggable Attribute</a></p>
<br>

<a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a>
</div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragover.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:17 GMT -->
</html>
