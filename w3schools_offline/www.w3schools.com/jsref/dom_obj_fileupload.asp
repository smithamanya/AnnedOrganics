...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_fileupload.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:45 GMT -->
<head>
<title>HTML DOM Input FileUpload Object</title>
...
<h1>HTML DOM <span class="color_h1">Input FileUpload</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_email.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_hidden.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input FileUpload Object</h2>
<p>The Input FileUpload object represents an HTML &lt;input&gt; element with 
type=&quot;file&quot;.</p>
<h3>Access an Input FileUpload Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;file&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myFile");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryita73e.html?filename=tryjsref_fileupload_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;file&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input FileUpload Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;file&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;file&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit8425.html?filename=tryjsref_fileupload_create">Try it</a>	
</div>
</div>

<h2>Input FileUpload Object Properties</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">
	= Property added in HTML5.</div></p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_fileupload_accept.html">accept</a></td>
    <td>Sets or returns the value of the accept attribute of the file upload button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_fileupload_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a file upload button should automatically get focus upon page load</td>
  </tr>
  <tr>
    <td>defaultValue</td>
    <td>Sets or returns the default value of the file upload button</td>
  </tr> 
  <tr>
    <td><a href="prop_fileupload_disabled.html">disabled</a></td>
    <td>Sets or returns whether the file upload button is disabled, or not</td>
  </tr> 
  <tr>
    <td><a href="prop_fileupload_files.html">files</a></td>
    <td>Returns a FileList object that represents the file or files selected with the file upload button</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_form.html">form</a></td>
    <td>Returns a reference to the form that contains the file upload button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_fileupload_multiple.html">multiple</a></td>
    <td>Sets or returns whether a user is allowed to select more than one file 
	in the file upload field</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of the file upload button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_fileupload_required.html">required</a></td>
    <td>Sets or returns whether a file in the file upload field must be selected 
	before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_type.html">type</a></td>
    <td>Returns which type of form element the file upload button is</td>
  </tr>
  <tr>
    <td><a href="prop_fileupload_value.html">value</a></td>
    <td>Returns the path or the name of the selected file</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Input FileUpload object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_fileupload.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:53 GMT -->
</html>