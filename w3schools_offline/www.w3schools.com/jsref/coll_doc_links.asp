...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_links.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:27 GMT -->
<head>
...
<h3>Example</h3>
<p>Find out how many links there are in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.links.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	5</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita0e6.html?filename=tryjsref_doc_links">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The links collection returns a collection of all links in the document.</p>
<p>The links in the collection represents &lt;a&gt; elements and/or &lt;area&gt; elements with a href attribute.</p>
<p><strong>Note:</strong> If the element is missing the href attribute, nothing is returned.</p>
<p><b>Note:</b> The elements in the collection are sorted as they appear in the source code.</p>
<p><strong>Tip:</strong> Also look at the <a href="dom_obj_anchor.asp">Anchor 
Object</a> and the <a href="dom_obj_area.asp">Area Object</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;a&gt; and/or &lt;area&gt; elements in the collection.<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;a&gt; and/or &lt;area&gt; element from the collection with the specified index 
  ...
  <tr>
    ...
    <td>Returns the &lt;a&gt; and/or &lt;area&gt; element from the collection with the specified id.<br><br>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>An HTMLCollection Object, representing all &lt;a&gt; elements and/or &lt;area&gt; elements in the 
	document. The elements in the collection are sorted as they appear 
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
	<p>Get the URL of the first link (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.links[0].href;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/sun.htm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitc37f.html?filename=tryjsref_doc_links3">Try it yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
	<p>Get the URL of the first link (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.links.item(0).href;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/sun.htm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit18d2.html?filename=tryjsref_doc_links4">Try it yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
	<p>Get the URL of the element with id=&quot;myLink&quot; in the 
	document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.links.namedItem(&quot;myLink&quot;).href;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/html/default.asp</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit606d.html?filename=tryjsref_doc_links5">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
	<p>Add a red border to the first link in the document:</p>
<div class="w3-code notranslate jsHigh">
	document.links[0].style.border = &quot;5px solid red&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit013d.html?filename=tryjsref_doc_links6">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all links in the document, and output the URL (href) of each 
link:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.links;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; 
	i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x[i].href + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">
	http://www.w3schools.com/jsref/sun.htm<br>
	http://www.w3schools.com/jsref/mercur.htm<br>
	http://www.w3schools.com/jsref/venus.htm<br>
	http://www.w3schools.com/html/default.asp<br>
	http://www.w3schools.com/css/default.asp</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1e07.html?filename=tryjsref_doc_links2">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript reference: <a href="dom_obj_anchor.asp">HTML DOM Anchor Object</a></p>
<p>JavaScript reference: <a href="dom_obj_area.asp">HTML DOM Area Object</a></p>
<p>HTML tutorial: <a href="../html/html_links.html">HTML Links</a></p>
<p>HTML reference: <a href="../tags/tag_a.html">HTML &lt;a&gt; tag</a></p>
<p>HTML reference: <a href="../tags/tag_area.html">HTML &lt;area&gt; tag</a></p>
<hr>

<a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a>
</div>
...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_links.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:31 GMT -->
</html>