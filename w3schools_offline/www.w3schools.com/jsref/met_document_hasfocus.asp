...
<!-- Mirrored from www.w3schools.com/jsref/met_document_hasfocus.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:17 GMT -->
<head>

<title>HTML DOM hasFocus() Method</title>
...
<h1>HTML DOM <span class="color_h1">hasFocus()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Output some text if the document has focus:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.getElementById(&quot;demo&quot;);<br>if (document.hasFocus()) {<br>&nbsp;&nbsp;&nbsp; 
	x.innerHTML = &quot;The document has focus.&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; 
	x.innerHTML = &quot;The document DOES NOT have focus.&quot;;<br>}</div>
<a target="_blank" href="tryit3497.html?filename=tryjsref_document_hasfocus" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The hasFocus() method returns a Boolean value indicating whether the document 
(or any element inside the document) has focus.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">hasFocus()</td>
    <td>30.0</td>
    <td>6.0</td>
    <td>3.0</td>
    <td>Yes</td>
...
<table class="tecspec">
  <tr>
	...
	<td>A Boolean value, incidating whether the document or any element in the document has focus:<br><br>
	<ul>
	  <li>true - The document has focus</li>
	  <li>false - The document does not have focus</li>
	</ul>
	</td>
  </tr>
</table>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_hasfocus.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:18 GMT -->
</html>
