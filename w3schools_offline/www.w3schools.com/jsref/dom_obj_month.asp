...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_month.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:58 GMT -->
<head>
<title>HTML DOM Input Month Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Month </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_input_image.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_number.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Month Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input Month Object is new in HTML5.</div></p>
<p>The Input Month object represents an HTML &lt;input&gt; element with 
type=&quot;month&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;month&quot; are not 
supported in Internet Explorer or Firefox.</span></p>
<h3>Access an Input Month Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;month&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myMonth");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit3ccb.html?filename=tryjsref_month_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;month&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Month Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;month&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;month&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit9d7f.html?filename=tryjsref_month_create">Try it</a>	
</div>
</div>

<h2>Input Month Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a month field should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_month_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_disabled.html">disabled</a></td>
    <td>Sets or returns whether a month field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_month_form.html">form</a></td>
    <td>Returns a reference to the form that contains the month field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute of the month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_min.html">min</a></td>
    <td>Sets or returns the value of the min attribute of the month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the month field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_month_required.html">required</a></td>
    <td>Sets or returns whether the month field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_month_step.html">step</a></td>
    <td>Sets or returns the value of the step attribute of the month field</td>
  </tr>
  <tr>
    <td><a href="prop_month_type.html">type</a></td>
    <td>Returns which type of form element the month field is</td>
  </tr>
  <tr>
    <td><a href="prop_month_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a month field</td>
  </tr>
</table>

<h2>Input Month Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_month_stepdown.html">stepDown()</a></td>
    <td>Decrements the value of the month field by a specified number</td>
    </tr>
  <tr>
    <td><a href="met_month_stepup.html">stepUp()</a></td>
    <td>Increments the value of the month field by a specified number</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Input Month object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_month.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:09 GMT -->
</html>