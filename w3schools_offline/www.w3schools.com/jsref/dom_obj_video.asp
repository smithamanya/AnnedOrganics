...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_video.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:43 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">Video</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_var.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="default.html">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Video Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Video Object is new in HTML5.</div></p>
<p>The Video object represents an HTML &lt;video&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;video&gt; element is not 
supported in Internet Explorer 8 and earlier versions.</span></p>
<h3>Access a Video Object</h3>
<p>You can access a &lt;video&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myVideo");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitbe12.html?filename=tryjsref_video_get">Try it</a>	
</div>
</div>

<h3>Create a Video Object</h3>
<p>You can create a &lt;video&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("VIDEO");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit6fcc.html?filename=tryjsref_video_create">Try it</a>	
</div>
</div>

<h2>Video Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_video_audiotracks.html">audioTracks</a></td>
    <td>Returns an AudioTrackList object representing available audio tracks</td>
  </tr>
  <tr>
    <td><a href="prop_video_autoplay.html">autoplay</a></td>
    <td>Sets or returns whether a video should start playing as soon as it is ready</td>
  </tr>
  <tr>
    <td><a href="prop_video_buffered.html">buffered</a></td>
    <td>Returns a TimeRanges object representing the buffered parts of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_controller.html">controller</a></td>
    <td>Returns the MediaController object representing the current media controller of 
	a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_controls.html">controls</a></td>
    <td>Sets or returns whether a video should have controls displayed (play/pause etc)</td>
  </tr>
   <tr>
    <td>crossOrigin</td>
    <td>Sets or returns the CORS settings of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_currentsrc.html">currentSrc</a></td>
    <td>Returns the URL of the current video</td>
  </tr>
  <tr>
    <td><a href="prop_video_currenttime.html">currentTime</a></td>
    <td>Sets or returns the current playback position in a video (in seconds)</td>
  </tr>
  <tr>
    <td><a href="prop_video_defaultmuted.html">defaultMuted</a></td>
    <td>Sets or returns whether the video should be muted by default</td>
  </tr>
  <tr>
    <td><a href="prop_video_defaultplaybackrate.html">defaultPlaybackRate</a></td>
    <td>Sets or returns whether the default playback speed of the video</td>
  </tr>
  <tr>
    <td><a href="prop_video_duration.html">duration</a></td>
    <td>Returns the length of a video (in seconds)</td>
  </tr>
  <tr>
    <td><a href="prop_video_ended.html">ended</a></td>
    <td>Returns whether the playback of the video has ended</td>
  </tr>
  <tr>
    <td><a href="prop_video_error.html">error</a></td>
    <td>Returns a MediaError object representing the error state of the video</td>
  </tr>
  <tr>
    <td><a href="prop_video_height.html">height</a></td>
    <td>Sets or returns the value of the height attribute of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_loop.html">loop</a></td>
    <td>Sets or returns whether the video should start playing over again, every time it is finished</td>
  </tr>
  <tr>
    <td><a href="prop_video_mediagroup.html">mediaGroup</a></td>
    <td>Sets or returns the name of the media group the video(s) is a part of</td>
  </tr>
  <tr>
    <td><a href="prop_video_muted.html">muted</a></td>
    <td>Sets or returns whether the sound of a video should be turned off</td>
  </tr>
  <tr>
    <td><a href="prop_video_networkstate.html">networkState</a></td>
    <td>Returns the current network state of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_paused.html">paused</a></td>
    <td>Sets or returns whether a video is paused</td>
  </tr>
  <tr>
    <td><a href="prop_video_playbackrate.html">playbackRate</a></td>
    <td>Sets or returns the speed of the video playback</td>
  </tr>
  <tr>
    <td><a href="prop_video_played.html">played</a></td>
    <td>Returns a TimeRanges object representing the played parts of the video</td>
  </tr>
  <tr>
    <td><a href="prop_video_poster.html">poster</a></td>
    <td>Sets or returns the value of the poster attribute of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_preload.html">preload</a></td>
    <td>Sets or returns the value of the preload attribute of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_readystate.html">readyState</a></td>
    <td>Returns the current ready state of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_seekable.html">seekable</a></td>
    <td>Returns a TimeRanges object representing the seekable parts of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_seeking.html">seeking</a></td>
    <td>Returns whether the user is currently seeking in the video</td>
  </tr>
  <tr>
    <td><a href="prop_video_src.html">src</a></td>
    <td>Sets or returns the value of the src attribute of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_startdate.html">startDate</a></td>
    <td>Returns a Date object representing the current time offset</td>
  </tr>
  <tr>
    <td><a href="prop_video_texttracks.html">textTracks</a></td>
    <td>Returns a TextTrackList object representing the available text tracks</td>
  </tr>
  <tr>
    <td><a href="prop_video_videotracks.html">videoTracks</a></td>
    <td>Returns a VideoTrackList object representing the available video tracks</td>
  </tr>
  <tr>
    <td><a href="prop_video_volume.html">volume</a></td>
    <td>Sets or returns the audio volume of a video</td>
  </tr>
  <tr>
    <td><a href="prop_video_width.html">width</a></td>
    <td>Sets or returns the value of the width attribute of a video</td>
  </tr>
</table>

<h2>Video Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_video_addtexttrack.html">addTextTrack()</a></td>
    <td>Adds a new text track to the video</td>
  </tr>
  <tr>
    <td><a href="met_video_canplaytype.html">canPlayType()</a></td>
    <td>Checks whether the browser can play the specified video type</td>
  </tr>
  <tr>
    <td><a href="met_video_load.html">load()</a></td>
    <td>Re-loads the video element</td>
  </tr>
  <tr>
    <td><a href="met_video_play.html">play()</a></td>
    <td>Starts playing the video</td>
  </tr>
  <tr>
    <td><a href="met_video_pause.html">pause()</a></td>
    <td>Pauses the currently playing video</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Video object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html5_video.html">HTML5 video</a></p>
<p>HTML reference: <a href="../tags/tag_video.html">HTML &lt;video&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_video.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:22:11 GMT -->
</html>