...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transitiondelay.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:01 GMT -->
<head>

<title>HTML DOM Style transitionDelay Property</title>
...
<h1>Style <span class="color_h1">transitionDelay </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit35ca.html?filename=tryjsref_style_transitiondelay">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The transitionDelay property specifies when the transition effect will start.</p>
<p>The transitionDelay value is defined in seconds (s) or milliseconds (ms).</p>
<hr>
...
<p>The transitionDelay property is supported in Internet Explorer 10, Firefox, Opera, 
and Chrome.</p>
<p>Safari supports an alternative, the WebkitTransitionDelay property.</p>
<hr>
<h2>Syntax</h2>
<p>Return the transitionDelay property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transitionDelay </div></div>
<p>Set the transitionDelay property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transitionDelay=&quot;<i>time</i>|initial|inherit&quot;
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the transition-delay property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_transition-delay.html">transition-delay property</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transitiondelay.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:02 GMT -->
</html>