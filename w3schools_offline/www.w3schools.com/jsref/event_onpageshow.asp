...
<!-- Mirrored from www.w3schools.com/jsref/event_onpageshow.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:38 GMT -->
<head>
...
<h1><span class="color_h1">onpageshow</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a user navigates to a webpage:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;body onpageshow=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryite9b7.html?filename=tryjsref_onpageshow" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The onpageshow event occurs when a user navigates to a webpage.</p>
<p>The onpageshow event is similar to the <a href="event_onload.asp">onload</a> event, except that it occurs 
...
<p>To find out if a page is loaded directly from the server or if the page is 
cached, you can use the <a href="event_pagetransition_persisted.html">persisted</a> property of the PageTransitionEvent object. 
This property returns true if the page is cached by the browser, and false 
otherwise (see &quot;More Examples&quot; below).</p>
<hr>
...
&lt;<i>element</i> onpageshow=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit8e09.html?filename=tryjsref_onpageshow_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onpageshow=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit6fba.html?filename=tryjsref_onpageshow_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;pageshow&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit3b2e.html?filename=tryjsref_onpageshow_addeventlistener">Try it</a> </div></div>
<p><strong>Note:</strong> The <a href="met_element_addeventlistener.html">addEventListener()</a> method is not supported in Internet Explorer 
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out whether the page was cached by the browser:</p>
<div class="w3-code notranslate jsHigh">
	function myFunction(event) { <br>&nbsp;&nbsp;&nbsp; alert(event.persisted);<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit10dc.html?filename=tryjsref_onpageshow_persisted">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onpageshow.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:15:26 GMT -->
</html>
