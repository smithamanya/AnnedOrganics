...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_keygen.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:09 GMT -->
<head>
<title>HTML DOM Keygen Object</title>
...
<h1>HTML DOM <span class="color_h1">Keygen</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_kbd.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_label.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Keygen Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The Keygen Object is new in HTML5.</div></p>
<p>The Keygen object represents an HTML &lt;keygen&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;keygen&gt; element is not supported in Internet Explorer.</span></p>
<h3>Access a Keygen Object</h3>
<p>You can access a &lt;keygen&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myKeygen");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit203f.html?filename=tryjsref_keygen_get">Try it</a>	
</div>
</div>

<h3>Create a Keygen Object</h3>
<p>You can create a &lt;keygen&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("KEYGEN");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryita30a.html?filename=tryjsref_keygen_create">Try it</a>	
</div>
</div>

<h2>Keygen Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_keygen_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a keygen field automatically gets focus when the page loads, or not</td>
  </tr>
  <tr>
    <td>challenge</td>
    <td>Sets or returns the value of the challenge attribute of a keygen field</td>
  </tr>
  <tr>
    <td><a href="prop_keygen_disabled.html">disabled</a></td>
    <td>Sets or returns whether a keygen field is disabled, or not</td>
  </tr>
  <tr>
    <td><a href="prop_keygen_form.html">form</a></td>
    <td>Returns a reference to the form that contains the keygen field</td>
  </tr>
  <tr>
    <td><a href="prop_keygen_keytype.html">keytype</a></td>
    <td>Sets or returns the value of the keytype attribute of a keygen field</td>
  </tr>
  <tr>
    <td><a href="prop_keygen_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a keygen field</td>
  </tr>
  <tr>
    <td><a href="prop_keygen_type.html">type</a></td>
    <td>Returns which type of form element the keygen field is</td>
  </tr>

</table>
<h2>Standard Properties and Events</h2>
<p>The Keygen object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_forms.html">HTML Forms</a></p>
<p>HTML reference: <a href="../tags/tag_keygen.html">HTML &lt;keygen&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_keygen.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:14 GMT -->
</html>