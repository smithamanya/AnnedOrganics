...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transformstyle.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:59 GMT -->
<head>

<title>HTML DOM Style transformStyle Property</title>
...
<h1>Style <span class="color_h1">transformStyle </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit82d9.html?filename=tryjsref_style_transformstyle">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The transformStyle property sets or returnd how nested elements are rendered in 3D space.</p>
<p><b>Note:</b> This property must be used together with the <a href="prop_style_transform.asp">transform</a> property.</p>
<hr>
...
<p>The transformStyle property is supported in Firefox.</p>
<p>Chrome, Safari, and Opera support an alternative, the WebkitTransformStyle property.</p>
<hr>


<h2>Syntax</h2>
<p>Return the transformStyle property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transformStyle </div></div>
<p>Set the transformStyle property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transformStyle=&quot;flat|preserve-3d|initial|inherit&quot;
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the transform-style property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<p>CSS reference: <a href="../cssref/css3_pr_transform-style.html">transform-style property</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transformstyle.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:26:00 GMT -->
</html>