...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_filter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:24 GMT -->
<head>

<title>HTML DOM Style filter Property</title>
...
<h1>Style <span class="color_h1">filter</span> Property</h1>
<p><a href="dom_obj_style.asp"><img class="navup" src="../images/up.gif" alt="Style Object Reference" /> Style Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Change the color of an image to black and white (100% grayscale):</p>
<div class="w3-code notranslate jsHigh">
	// Code for Chrome, Safari and Opera<br>
	document.getElementById(&quot;myImg&quot;).style.WebkitFilter = &quot;grayscale(100%)&quot;;<br>
	<br>// Standard syntax (does not work in any of the major browsers yet)<br>document.getElementById(&quot;myImg&quot;).style.filter 
	= &quot;grayscale(100%)&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2a60.html?filename=tryjsref_style_filter">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The filter property adds visual effects (like blur and saturation) to images.</p>
<hr>
...
WebkitFilter property.</p>
<hr>

<h2>Syntax</h2>
<p>Return the filter property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.filter</div></div>
<p>Set the filter property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.filter=&quot;none | blur() | brightness() | contrast() | drop-shadow() | grayscale() | hue-rotate() 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
	...
	not specified, the color depends on the browser (often black).<br>
	<strong>Tip:</strong> This filter is similar to the
	<a href="../cssref/css3_pr_box-shadow.html">box-shadow</a> property.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>opacity(<em>%</em>)</td>
    <td>Sets the opacity level for the image. The opacity-level describes the transparency-level, where:<br>
	<br>0% is completely transparent.<br>100% (1) is default and represents the original image (no transparency).<br> <br><strong>Note:</strong> Negative values are 
	not allowed.<br><strong>Tip:</strong> This filter is similar to
	<a href="../cssref/css3_pr_opacity.html">opacity</a> property.</td>
  </tr>
  <tr>
	...
	provides 
	super-saturated results. <br> <br>
	<strong>Note:</strong> Negative values are not allowed.</td>
  </tr>
  <tr>
    <td>sepia(<em>%</em>)</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_filter.html">filter property</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_filter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:25 GMT -->
</html>