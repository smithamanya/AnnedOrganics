...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_image.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:15:33 GMT -->
<head>
...
<div class="next"><a class="chapter" href="dom_obj_ins.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Image Object</h2>
<p>The Image object represents an HTML &lt;img&gt; element.</p>
<h3>Access an Image Object</h3>
<p>You can access an &lt;img&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myImg");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitdef0.html?filename=tryjsref_img_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access an &lt;img&gt; element by using the <a href="coll_doc_images.asp">images</a> collection.</p>

<h3>Create an Image Object</h3>
<p>You can create an &lt;img&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("IMG");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit6f78.html?filename=tryjsref_img_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_img_alt.html">alt</a></td>
  ...
  <tr>
    <td><a href="prop_img_complete.html">complete</a></td>
    <td>Returns whether or not the browser is finished loading an image</td>
  </tr>
  <tr>
    <td class="html5badge">crossOrigin</td>
    <td>Sets or returns the CORS settings of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_height.html">height</a></td>
  ...
  <tr>
    <td><a href="prop_img_ismap.html">isMap</a></td>
    <td>Sets or returns whether an image should be part of a server-side image-map, or not</td>
  </tr>
  <tr>
    <td>longDesc</td>
   ...
   <tr>
    <td><a href="prop_img_naturalheight.html">naturalHeight</a></td>
    <td>Returns the original height of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_naturalwidth.html">naturalWidth</a></td>
    <td>Returns the original width of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_src.html">src</a></td>
    <td>Sets or returns the value of the src attribute of an image</td>
  </tr>
  <tr>
    <td><a href="prop_img_usemap.html">useMap</a></td>
  ...
  <tr>
    <td><a href="prop_img_width.html">width</a></td>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_image.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:15:39 GMT -->
</html>