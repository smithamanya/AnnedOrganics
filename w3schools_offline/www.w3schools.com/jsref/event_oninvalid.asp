...
<!-- Mirrored from www.w3schools.com/jsref/event_oninvalid.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:16 GMT -->
<head>
...
<h1><span class="color_h1">oninvalid</span> Event</h1>
...
<h3>Example</h3>
<p>Alert some text if an input field is invalid:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;input type=&quot;text&quot; oninvalid=&quot;alert('You must fill out the form!');&quot; required&gt;</div>
<a target="_blank" href="tryit4634.html?filename=tryjsref_oninvalid" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The oninvalid event occurs when a submittable &lt;input&gt; element is invalid.</p>
<p>For example, the input field is invalid if the required attribute is set and 
the field is empty (the required attribute specifies that the input field 
must be filled out before submitting the form).</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the event.</p>
...
&lt;<i>element</i> oninvalid=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit4634.html?filename=tryjsref_oninvalid">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.oninvalid=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryite3ce.html?filename=tryjsref_oninvalid_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;invalid&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit6525.html?filename=tryjsref_oninvalid_addeventlistener">Try it</a> </div></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Alert some text if an input field contains less than 6 characters:</p>
<div class="w3-code notranslate htmlHigh">
	Name: &lt;input type=&quot;text&quot; id=&quot;myInput&quot; name=&quot;fname&quot; pattern=&quot;.{6,}&quot;&gt;<br><br>
	&lt;script&gt;<br>document.getElementById(&quot;myInput&quot;).addEventListener(&quot;invalid&quot;, 
	myFunction);<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Must contain 6 or 
	more characters&quot;);<br>}<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit2ae9.html?filename=tryjsref_oninvalid2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Alert some text if an input field contains a number that is less than 2 or 
greater than 5:</p>
<div class="w3-code notranslate htmlHigh">
	Number: &lt;input type=&quot;number&quot; id=&quot;myInput&quot; 
	name=&quot;quantity&quot; min=&quot;2&quot; max=&quot;5&quot;&gt;<br><br>&lt;script&gt;<br>document.getElementById(&quot;myInput&quot;).addEventListener(&quot;invalid&quot;, 
	myFunction);<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;You must pick a 
	number between 2 and 5. You chose: &quot; + this.value);<br>}<br>&lt;/script&gt;</div>
<a target="_blank" href="tryite89d.html?filename=tryjsref_oninvalid3" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_validation.html">JavaScript Forms</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_oninvalid.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:20 GMT -->
</html>
