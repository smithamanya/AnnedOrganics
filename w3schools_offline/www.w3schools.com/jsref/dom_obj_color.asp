...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_color.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:15:54 GMT -->
<head>
<title>HTML DOM Input Color Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Color </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_checkbox.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_date.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Color Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">
	The Input Color Object is new in HTML5.</div></p>
<p>The Input Color object represents an HTML &lt;input&gt; element with 
type=&quot;color&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;color&quot; are not supported in 
Internet Explorer or Safari.</span></p>
<h3>Access an Input Color Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;color&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myColor");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitd68a.html?filename=tryjsref_color_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;color&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Color Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;color&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;color&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit5eda.html?filename=tryjsref_color_create">Try it</a>	
</div>
</div>

<h2>Input Color Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a color 
	picker</td>
  </tr>
  <tr>
    <td><a href="prop_color_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a color picker should automatically get focus 
	when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_color_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a color picker</td>
  </tr>
  <tr>
    <td><a href="prop_color_disabled.html">disabled</a></td>
    <td>Sets or returns whether a color picker is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_color_form.html">form</a></td>
    <td>Returns a reference to the form that contains the color picker</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the &lt;datalist&gt; element that contains the color picker</td>
  </tr>
  <tr>
    <td><a href="prop_color_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a color picker</td>
  </tr>
  <tr>
    <td><a href="prop_color_type.html">type</a></td>
    <td>Returns which type of form element the color picker is</td>
  </tr>
  <tr>
    <td><a href="prop_color_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a color picker</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Input Color object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_color.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:00 GMT -->
</html>