...
<!-- Mirrored from www.w3schools.com/jsref/prop_document_doctype.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:59 GMT -->
<head>
...
<h3>Example</h3>
	<p>Get the doctype name of an HTML document:</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.doctype.name;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	html</div>
<a target="_blank" href="tryit1ca0.html?filename=tryjsref_document_doctype" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The doctype property returns the doctype of the HTML document, as a DocumentType object.</p>
<p>The DocumentType object has a name property, which returns the name of the 
doctype.</p>
...
<tr>
	...
	<td>The document's doctype, as a DocumentType object</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<hr>
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_doctype.html">HTML &lt;!DOCTYPE&gt; Declaration</a></p>
<hr>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>
</div>
