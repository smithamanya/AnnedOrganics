...
<!-- Mirrored from www.w3schools.com/jsref/event_onclick.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:48 GMT -->
<head>
...
<p><a class="navupa" style="width:170px;" href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>
...
<a target="_blank" href="tryitfe1c.html?filename=tryjsref_onclick" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
&lt;<i>element</i> onclick=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitb634.html?filename=tryjsref_onclick_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onclick=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit4a13.html?filename=tryjsref_onclick_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;click&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit6341.html?filename=tryjsref_onclick_addeventlistener">Try it</a> </div></div>
...
&lt;head&gt;, &lt;html&gt;, &lt;iframe&gt;, &lt;meta&gt;, &lt;param&gt;, &lt;script&gt;, 
	&lt;style&gt;, and &lt;title&gt;</td>
  </tr>
  <tr>
...
<div class="tryit_ex" style="margin-top:40px;">
...
<div class="w3-example">
<h3>Example</h3>
<p>Click on a &lt;button&gt; element to display the current day, date and time:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;button onclick=&quot;getElementById('demo').innerHTML=Date()&quot;&gt;What 
	is the time?&lt;/button&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit7a34.html?filename=tryjsref_onclick_date">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Click on a &lt;p&gt; element to change its text color to red:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;p id=&quot;demo&quot; onclick=&quot;myFunction()&quot;&gt;Click me to change my text color.&lt;/p&gt;<br>
	<br>&lt;script&gt;<br><span style="color:#A52A2A;">function</span> myFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(<span style="color:mediumblue;">&quot;demo&quot;</span>).style.color = <span style="color:mediumblue;">&quot;red&quot;</span>;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitcba5.html?filename=tryjsref_onclick_color">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Another example on how to change the color of a &lt;p&gt; element by clicking on it:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;p id=&quot;demo&quot; onclick=&quot;myFunction(this, 'red')&quot;&gt;Click me to change my text 
	color.&lt;/p&gt;<br><br>&lt;script&gt;<br><span style="color:#A52A2A;">function</span> myFunction(elmnt,clr) {<br>&nbsp;&nbsp;&nbsp; 
	elmnt.style.color = clr;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit14fd.html?filename=tryjsref_onclick_color2">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Click on a button to copy some text from an input field to another input 
field:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;button onclick=&quot;myFunction()&quot;&gt;Copy Text&lt;/button&gt;<br><br>&lt;script&gt;<br>
	<span style="color:#A52A2A;">function</span> myFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(<span style="color:mediumblue;">&quot;field2&quot;</span>).value = 
	document.getElementById(<span style="color:mediumblue;">&quot;field1&quot;</span>).value;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit5c72.html?filename=tryjsref_onclick_copy">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Assign the "onclick" event to the window object:</p>
<div class="w3-code notranslate jsHigh">
	window.onclick = myFunction;<br><br>// If the user clicks in the window, set 
	the background color of &lt;body&gt; to yellow<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementsByTagName(&quot;BODY&quot;)[0].style.backgroundColor = &quot;yellow&quot;;<br>
	}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit9f44.html?filename=tryjsref_onclick_win">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using onclick to create a dropdown button:</p>
<div class="w3-code notranslate jsHigh">
	// Get the button, and when the user clicks on it, execute myFunction<br>
	document.getElementById(&quot;myBtn&quot;).onclick = function() {myFunction()};<br>
	<br>/* myFunction toggles between adding and removing the show class, which 
	is used to hide and show the dropdown content */<br>function myFunction() {<br>&nbsp; 
	document.getElementById(&quot;myDropdown&quot;).classList.toggle(&quot;show&quot;);<br>}<br><br>
	// Close the dropdown if the user clicks outside of it<br>window.onclick = 
	function(event) {<br>&nbsp; if (!event.target.matches('.dropbtn')) {<br><br>&nbsp;&nbsp;&nbsp; 
	var dropdowns = document.getElementsByClassName(&quot;dropdown-content&quot;);<br>&nbsp;&nbsp;&nbsp; 
	var i;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; dropdowns.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	var openDropdown = dropdowns[i];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (openDropdown.classList.contains('show')) 
	{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	openDropdown.classList.remove('show');<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
	}<br>&nbsp; }<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit935d.html?filename=tryjsref_onclick_dropdown">Try it yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="event_ondblclick.asp">ondblclick event</a></p>
<p>HTML DOM reference: <a href="event_onmousedown.asp">onmousedown event</a></p>
<p>HTML DOM reference: <a href="event_onmouseup.asp">onmouseup event</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onclick.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:55 GMT -->
</html>
