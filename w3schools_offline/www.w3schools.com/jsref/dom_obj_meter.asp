...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_meter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:36 GMT -->
<head>
<title>HTML DOM Meter Object</title>
...
<h1>HTML DOM <span class="color_h1">Meter</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_meta.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_nav.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Meter Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The Meter Object is new in HTML5.</div></p>

<p>The Meter object represents an HTML &lt;meter&gt; element.</p>
<p><strong>Note:</strong> The &lt;meter&gt; element is not supported 
in Internet Explorer or Safari 5, and earlier versions.</p>
<h3>Access a Meter Object</h3>
<p>You can access a &lt;meter&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myMeter");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit44e0.html?filename=tryjsref_meter_get">Try it</a>	
</div>
</div>

<h3>Create a Meter Object</h3>
<p>You can create a &lt;meter&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("METER");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitec78.html?filename=tryjsref_meter_create">Try it</a>	
</div>
</div>

<h2>Meter Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_meter_high.html">high</a></td>
    <td>Sets or returns the value of the high attribute in a gauge</td>
  </tr>
  <tr>
    <td>labels</td>
    <td>Returns a list of &lt;label&gt; elements that are labels for the gauge</td>
  </tr>
  <tr>
    <td><a href="prop_meter_low.html">low</a></td>
    <td>Sets or returns the value of the low attribute in a gauge</td>
  </tr>
  <tr>
    <td><a href="prop_meter_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute in a gauge</td>
  </tr>
  <tr>
    <td><a href="prop_meter_min.html">min</a></td>
    <td>Sets or returns the value of the min attribute in a gauge</td>
  </tr>
  <tr>
    <td><a href="prop_meter_optimum.html">optimum</a></td>
    <td>Sets or returns the value of the optimum attribute in a gauge</td>
  </tr>
  <tr>
    <td><a href="prop_meter_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute in a gauge</td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The Meter object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_meter.html">HTML &lt;meter&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_meter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:43 GMT -->
</html>