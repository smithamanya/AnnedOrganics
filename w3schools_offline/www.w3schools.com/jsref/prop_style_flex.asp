...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_flex.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:25 GMT -->
<head>

<title>HTML DOM Style flex Property</title>
...
<h1>Style <span class="color_h1">flex</span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryitfe15.html?filename=tryjsref_style_flex">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The flex property sets or returns the length of the item, relative to the rest of the
flexibel items inside the same container.</p>

<p>The flex property is a shorthand for the flexGrow, flexShrink, and the flexBasis properties.</p>
...
<p><strong>Note:</strong> The flex property is not supported IE 9 or earlier, in IE 10 this property is supported with the prefix MS. 
IE11 and newer versions fully support the flex property (do not need the ms 
prefix).</p>
<p><strong>Note:</strong> Safari 6.1+ supports an alternative, the WebkitFlex 
property.</p>
<hr>

<h2>Syntax</h2>
<p>Return the flex property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.flex</div></div>
<p>Set the flex property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.flex=&quot;<i>flex-grow</i> <i>flex-shrink</i> <i>flex-basis</i>|auto|initial|inherit&quot;
</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>initial</td>
    <td>Same as 0 1 auto. <a href="../cssref/css_initial.asp">Read about <em>initial</em></a></td>
    </tr>
	<tr>
    <td>none</td>
...
<tr>
	...
	<td width="80%">0 1 auto</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the flex property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_flex.html">flex property</a></p>
