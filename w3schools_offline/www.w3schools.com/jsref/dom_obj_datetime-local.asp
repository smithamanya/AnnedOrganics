...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_datetime-local.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:21 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">Input DatetimeLocal </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_datetime.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_email.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input DatetimeLocal Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input DatetimeLocal Object is new in HTML5.</div></p>
<p>The Input DatetimeLocal object represents an HTML &lt;input&gt; element with 
type=&quot;datetime-local&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;datetime-local&quot; are not 
supported in Internet Explorer or Firefox.</span></p>
<h3>Access an Input DatetimeLocal Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;datetime-local&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myLocalDate");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit859f.html?filename=tryjsref_datetime-local_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;datetime-local&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input DatetimeLocal Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;datetime-local&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;datetime-local&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryite20b.html?filename=tryjsref_datetime-local_create">Try it</a>	
</div>
</div>

<h2>Input DatetimeLocal Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a local datetime field should automatically get 
	focus upon page load</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_disabled.html">disabled</a></td>
    <td>Sets or returns whether a local datetime field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_datetime-local_form.html">form</a></td>
    <td>Returns a reference to the form that contains the local datetime field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute of the local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_min.html">min</a></td>
    <td>Sets or returns the value of the min attribute of the local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the local datetime field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_required.html">required</a></td>
    <td>Sets or returns whether the local datetime field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_step.html">step</a></td>
    <td>Sets or returns the value of the step attribute of the local datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_type.html">type</a></td>
    <td>Returns which type of form element the local datetime field is</td>
  </tr>
  <tr>
    <td><a href="prop_datetime-local_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a local datetime field</td>
  </tr>
</table>

<h2>Input DatetimeLocal Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_datetime-local_stepdown.html">stepDown()</a></td>
    <td>Decrements the value of the datetime field by a specified number</td>
    </tr>
  <tr>
    <td><a href="met_datetime-local_stepup.html">stepUp()</a></td>
    <td>Increments the value of the datetime field by a specified number</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Input DatetimeLocal object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_forms.html">HTML Forms</a></p>
<p>HTML reference: <a href="../tags/tag_input.html">HTML &lt;input&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_datetime-local.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:32 GMT -->
</html>