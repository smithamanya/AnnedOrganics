...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transformorigin.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:58 GMT -->
<head>

<title>HTML DOM Style transformOrigin Property</title>
...
<h1>Style <span class="color_h1">transformOrigin </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryita7e5.html?filename=tryjsref_style_transformorigin">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The transformOrigin property allows you to change the position on transformed elements.</p>
...
<a href="prop_style_transform.asp">transform</a> 
property.</p>
<hr>
...
<p>The transformOrigin property is supported in Internet Explorer 10, Firefox, 
and Opera.</p>
<p>Internet Explorer 9 supports an alternative, the msTransformOrigin property, but only for 2D-transforms.</p>
<p>Chrome, Safari, and Opera support an alternative, the WebkitTransformOrigin property, 
for both 2D- and 3D-transfoms.</p>
<hr>

<h2>Syntax</h2>
<p>Return the transformOrigin property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transformOrigin </div></div>
<p>Set the transformOrigin property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transformOrigin=&quot;<i>x-axis y-axis z-axis</i>|initial|inherit&quot;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>z-axis</i></td>
    <td>Defining where the view is placed at the z-axis (for 3D transforms). Possible values:<ul>
		<li><i>length</i></li>
	</ul>
	</td>
  </tr>
...
<tr>
	...
	<td width="80%">50% 50% 0</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the transform-origin property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<hr>
<h2>Related Pages</h2>
<p>JavaScript Style Object: <a href="prop_style_transform.asp">transform property</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_transform-origin.html">transform-origin property</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transformorigin.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:59 GMT -->
</html>