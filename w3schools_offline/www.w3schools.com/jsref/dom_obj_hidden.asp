...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_hidden.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:53 GMT -->
<head>
<title>HTML DOM Input Hidden Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Hidden</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_fileupload.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_input_image.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Hidden Object</h2>
<p>The Input Hidden object represents an HTML &lt;input&gt; element with 
type=&quot;hidden&quot;.</p>
<h3>Access an Input Hidden Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;hidden&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myInput");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit5520.html?filename=tryjsref_hidden_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;hidden&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Hidden Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;hidden&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;hidden&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitdf3a.html?filename=tryjsref_hidden_create">Try it</a>	
</div>
</div>

<h2>Input Hidden Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>defaultValue</td>
    <td>Sets or returns the default value of the hidden input field</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_form.html">form</a></td>
    <td>Returns a reference to the form that contains the hidden input field</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of the hidden input field</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_type.html">type</a></td>
    <td>Returns which type of form element a hidden input field is</td>
  </tr>
  <tr>
    <td><a href="prop_hidden_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of the hidden input field</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Input Hidden object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_hidden.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:58 GMT -->
</html>