...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_url.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:18:43 GMT -->
<head>
<title>HTML DOM Input URL Object</title>
...
<h1>HTML DOM <span class="color_h1">Input URL </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_input_time.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_week.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input URL Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input URL Object is new in HTML5.</div></p>
<p>The Input URL object represents an HTML &lt;input&gt; element with type=&quot;url&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;url&quot; are not 
supported in Internet Explorer 9 (and earlier versions), or Safari.</span></p>
<h3>Access an Input URL Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;url&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myUrl");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitc09f.html?filename=tryjsref_url_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;url&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input URL Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;url&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;url&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitd450.html?filename=tryjsref_url_create">Try it</a>	
</div>
</div>

<h2>Input URL Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_url_autocomplete.html">autocomplete</a></td>
    <td>Sets or returns the value of the autocomplete attribute of a URL 
	field</td>
  </tr>
  <tr>
    <td><a href="prop_url_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a URL field should automatically get focus 
	when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_url_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_disabled.html">disabled</a></td>
    <td>Sets or returns whether a URL field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_url_form.html">form</a></td>
    <td>Returns a reference to the form that contains the URL field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_maxlength.html">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of a URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_pattern.html">pattern</a></td>
    <td>Sets or returns the value of the pattern attribute of a URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_placeholder.html">placeholder</a></td>
    <td>Sets or returns the value of the placeholder attribute of a URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the URL field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_url_required.html">required</a></td>
    <td>Sets or returns whether the URL field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_url_size.html">size</a></td>
    <td>Sets or returns the value of the size attribute of the URL field</td>
  </tr>
  <tr>
    <td><a href="prop_url_type.html">type</a></td>
    <td>Returns which type of form element the URL field is</td>
  </tr>
  <tr>
    <td><a href="prop_url_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a URL field</td>
  </tr>
</table>

<!--
<h2>Input URL Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_url_blur.asp">blur()</a></td>
    <td>Removes focus from a URL field</td>
  </tr>
  <tr>
    <td><a href="met_url_focus.asp">focus()</a></td>
    <td>Gives focus to a URL field</td>
  </tr>
</table>
-->

<h2>Standard Properties and Events</h2>
<p>The Input URL object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_url.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:18:56 GMT -->
</html>