...
<!-- Mirrored from www.w3schools.com/jsref/met_document_addeventlistener.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:35 GMT -->
<head>

<title>HTML DOM addEventListener() Method</title>
...
<h1>HTML DOM <span class="color_h1">addEventListener()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
	<p>Attach a click event to the document. When 
	the user clicks anywhere in the document, output &quot;Hello World&quot; in a &lt;p&gt; element with 
	id=&quot;demo&quot;:</p>
<div class="w3-code notranslate jsHigh">
	document.addEventListener(&quot;click&quot;, function(){<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello World&quot;;<br>});</div>
<a target="_blank" href="tryit958e.html?filename=tryjsref_document_addeventlistener" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="met_document_removeeventlistener.asp">
document.removeEventListener()</a> method to remove an event 
handler that has been attached with the addEventListener() method.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_addeventlistener.html"><em>
element.</em>addEventListener()</a> method to attach an event handler to a 
specified element.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully 
...
versions, you can use the <strong>attachEvent()</strong> method to attach event 
handlers (see &quot;More Examples&quot; below for a cross-browser solution).</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	document.addEventListener(<em>event</em>, <em>function</em>, 
	<em>useCapture</em>)
</div></div>
...
<tr>
<td><em>event</em></td>
<td>Required. A String that specifies the name of the event.<br><br><strong>Note:</strong> Do 
not use the &quot;on&quot; prefix. For example, use &quot;click&quot; instead of &quot;onclick&quot;.<br><br>For a list of all HTML DOM events, look at our complete <a href="dom_obj_event.asp">HTML DOM Event Object Reference</a>.</td>
</tr>
<tr>
<td><em>function</em></td>
<td>Required. Specifies the function to run when the event occurs. <br><br>When 
...
For example, the &quot;click&quot; event belongs to the MouseEvent object.</td>
</tr>
<tr>
<td><em>useCapture</em></td>
<td>
Optional. A Boolean value that specifies whether the event should be 
executed in the capturing or in the bubbling phase. <br><br>Possible values:
<ul>
	<li>true - The event handler is executed in the capturing phase</li>
	<li>false- Default. The event handler is executed in the bubbling phase</li>
</ul>
	</td>
</tr>
</table>
...
<table class="tecspec">
  <tr>
	...
	<td>DOM Level 2 Events</td>
  </tr>
  <tr>
	<th style="width:18%;">Return Value:</th>
	<td>No return value</td>
  </tr>
  <tr>
	<th style="width:18%;">Changelog:</th>
	<td>The useCapture parameter became optional in Firefox 6 and Opera 11.60 
	(has always been optional for Chrome, IE and Safari)</td>
  </tr>
</table>
...
<div class="w3-code notranslate jsHigh">
	...
	myFunction);<br><br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello World&quot;;<br>
	}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit00e5.html?filename=tryjsref_document_addeventlistener2">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>You can add many events to the document, without overwriting existing events.</p>
	<p>This example demonstrates how to add two click events to the document:</p>
<div class="w3-code notranslate jsHigh">
	document.addEventListener(&quot;click&quot;, 
	myFunction);<br>document.addEventListener(&quot;click&quot;, someOtherFunction);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit097a.html?filename=tryjsref_document_addeventlistener3">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>You can add events of different types to the document.</p>
	<p>This example demonstrates how to add many events to the document:</p>
<div class="w3-code notranslate jsHigh">
	document.addEventListener(&quot;mouseover&quot;, myFunction);<br>document.addEventListener(&quot;click&quot;, someOtherFunction);<br>
	document.addEventListener(&quot;mouseout&quot;, someOtherFunction);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitffb0.html?filename=tryjsref_document_addeventlistener4">Try it yourself &raquo;</a>
</div>
<br>
...
specified function with the parameters:</p>
<div class="w3-code notranslate jsHigh">
	document.addEventListener(&quot;click&quot;, function() {<br>&nbsp;&nbsp;&nbsp; 
	myFunction(p1, p2);<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1398.html?filename=tryjsref_document_addeventlistener_param">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the background color of the document's &lt;body&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	document.addEventListener(&quot;click&quot;, function(){<br>&nbsp;&nbsp;&nbsp; 
	document.body.style.backgroundColor = &quot;red&quot;;<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2cd1.html?filename=tryjsref_document_addeventlistener5">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using the removeEventListener() method to remove an event handler that has 
been attached with the addEventListener() method:</p>
<div class="w3-code notranslate jsHigh">
	// Attach an event handler to the document<br>document.addEventListener(&quot;mousemove&quot;, 
	myFunction);<br><br>// Remove the event handler from the document<br>
	document.removeEventListener(&quot;mousemove&quot;, myFunction);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryite24e.html?filename=tryjsref_document_addeventlistener_remove">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>For browsers that don't support the addEventListener() method, you can use 
the attachEvent() method.</p>
	<p>This example demonstrates a cross-browser solution:</p>
<div class="w3-code notranslate jsHigh">
	if (document.addEventListener) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// For all major browsers, except IE 8 and earlier<br>&nbsp;&nbsp;&nbsp; 
	document.addEventListener(&quot;click&quot;, myFunction);<br>} else if (document.attachEvent) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // For IE 8 and earlier versions<br>&nbsp;&nbsp;&nbsp; 
	document.attachEvent(&quot;onclick&quot;, myFunction);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd00b.html?filename=tryjsref_document_addeventlistener_crossbrowser">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_eventlistener.html">HTML DOM EventListener</a></p>
<p>HTML DOM Reference: <a href="met_element_addeventlistener.html"><em>element</em>.addEventListener()</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_addeventlistener.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:40 GMT -->
</html>
