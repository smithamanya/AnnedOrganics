...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragstart.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:18 GMT -->
<head>

<title>ondragstart Event</title>
...
<h1><span class="color_h1">ondragstart</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the user starts to drag a &lt;p&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
&lt;p draggable="true" ondragstart="myFunction(event)"&gt;Drag me!&lt;/p&gt;</div>
...
<p>The ondragstart event occurs when the user starts to drag an element or text 
selection.</p>
...
<ul>
  <li><strong>Events fired on the draggable target</strong> (the source element)<strong>:
    ...
    <ul>
      <li>ondragstart - occurs when the user starts to drag an element</li>
...
&lt;<i>element</i> ondragstart=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitc1d3.html?filename=tryjsref_ondragstart_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondragstart=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit3b6a.html?filename=tryjsref_ondragstart_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;dragstart&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit0745.html?filename=tryjsref_ondragstart_addeventlistener">Try it</a> </div></div>
