...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_global.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:09:28 GMT -->
<head>
<title>JavaScript Global Reference</title>
...
<h1>JavaScript <span class="color_h1">Global Reference</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jsref_obj_regexp.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jsref_type_conversion.asp">Next Reference &raquo;</a></div>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_infinity.html">Infinity</a></td>
    <td>A numeric value that represents positive/negative infinity</td>
    </tr>
  <tr>
    <td><a href="jsref_nan.html">NaN</a></td>
    <td>&quot;Not-a-Number&quot; value</td>
    </tr>
  <tr>
    <td><a href="jsref_undefined.html">undefined</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_decodeuri.html">decodeURI()</a></td>
    <td>Decodes a URI</td>
    </tr>
  <tr>
    <td><a href="jsref_decodeuricomponent.html">decodeURIComponent()</a></td>
    <td>Decodes a URI component</td>
    </tr>
  <tr>
    <td><a href="jsref_encodeuri.html">encodeURI()</a></td>
    <td>Encodes a URI</td>
    </tr>
  <tr>
    <td><a href="jsref_encodeuricomponent.html">encodeURIComponent()</a></td>
    <td>Encodes a URI component</td>
    </tr>
  <tr>
    <td><a href="jsref_escape.html">escape()</a></td>
    <td><span class="deprecated">Deprecated in version 1.5.</span> Use <a href="jsref_encodeuri.html">encodeURI()</a> or <a href="jsref_encodeuricomponent.html">encodeURIComponent()</a> 
	instead</td>
    </tr>
  <tr>
    <td><a href="jsref_eval.html">eval()</a></td>
    <td>Evaluates a string and executes it as if it was script code</td>
    </tr>
  <tr>
    <td><a href="jsref_isfinite.html">isFinite()</a></td>
    <td>Determines whether a value is a finite, legal number</td>
    </tr>
  <tr>
    <td><a href="jsref_isnan.html">isNaN()</a></td>
    <td>Determines whether a value is an illegal number</td>
    </tr>
  <tr>
    <td><a href="jsref_number.html">Number()</a></td>
    <td>Converts an object's value to a number</td>
    </tr>
  <tr>
    <td><a href="jsref_parsefloat.html">parseFloat()</a></td>
    <td>Parses a string and returns a floating point number</td>
    </tr>
  <tr>
    <td><a href="jsref_parseint.html">parseInt()</a></td>
    <td>Parses a string and returns an integer</td>
    </tr>
  <tr>
    <td><a href="jsref_string.html">String()</a></td>
    <td>Converts an object's value to a string</td>
    </tr>
  <tr>
    <td><a href="jsref_unescape.html">unescape()</a></td>
    <td><span class="deprecated">Deprecated in version 1.5.</span> Use <a href="jsref_decodeuri.html">decodeURI()</a> or <a href="jsref_decodeuricomponent.html">decodeURIComponent()</a> 
	instead</td>
  </tr>
</table>
</div>
...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_global.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:09:39 GMT -->
</html>