...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_radio.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:35 GMT -->
<head>
<title>HTML DOM Input Radio Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Radio</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_password.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_range.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Radio Object</h2>
<p>The Input Radio object represents an HTML &lt;input&gt; element with 
type=&quot;radio&quot;.</p>
<h3>Access an Input Radio Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;radio&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myRadio");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit6e28.html?filename=tryjsref_radio_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;radio&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Radio Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;radio&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;radio&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit5c93.html?filename=tryjsref_radio_create">Try it</a>	
</div>
</div>

<h2>Input Radio Object Properties</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="prop_radio_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a radio button should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_radio_checked.html">checked</a></td>
    <td>Sets or returns the checked state of a radio button</td>
  </tr>
  <tr>
    <td><a href="prop_radio_defaultchecked.html">defaultChecked</a></td>
    <td>Returns the default value of the checked attribute</td>
  </tr>
  <tr>
    <td>defaultValue</td>
    <td>Sets or returns the default value of a radio button</td>
  </tr>
  <tr>
    <td><a href="prop_radio_disabled.html">disabled</a></td>
    <td>Sets or returns whether the radio button is disabled, or not</td>
    </tr>  
  <tr>
    <td><a href="prop_radio_form.html">form</a></td>
    <td>Returns a reference to the form that contains the radio button</td>
  </tr>
  <tr>
    <td><a href="prop_radio_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a radio button</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_radio_required.html">required</a></td>
    <td>Sets or returns whether the radio button must be checked before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_radio_type.html">type</a></td>
    <td>Returns which type of form element the radio button is</td>
  </tr>
  <tr>
    <td><a href="prop_radio_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of the radio button</td>
  </tr>
</table>
<!--
<h2>Input Radio Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_radio_blur.asp">blur()</a></td>
    <td>Removes focus from a radio button</td>
  </tr>
  <tr>
    <td><a href="met_radio_focus.asp">focus()</a></td>
    <td>Gives focus to a radio button</td>
  </tr>
</table>
-->
<h2>Standard Properties and Events</h2>
<p>The Input Radio object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_radio.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:42 GMT -->
</html>