...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_counterreset.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:10 GMT -->
<head>

<title>HTML DOM Style counterReset Property</title>
...
<h1>Style <span class="color_h1">counterReset </span> Property</h1>
<p><a href="dom_obj_style.asp"><img class="navup" src="../images/up.gif" alt="Style Object Reference" /> Style Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Change the counter-reset property:</p>
<div class="w3-code notranslate jsHigh">
document.body.style.counterReset = &quot;section&quot;;
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1c9f.html?filename=tryjsref_style_counterreset">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The counterReset property creates or resets one or more counters.</p>
<p>The counterReset property is usually used together with the counterIncrement property and the content property.</p>
<hr>
...
<p>The counterReset property is supported in all major browsers.</p>
<p><b>Note:</b> IE8 supports the counterReset property only if a !DOCTYPE is specified.</p>
<hr>

<h2>Syntax</h2>
<p>Return the counterReset property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.counterReset </div></div>
<p>Set the counterReset property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.counterReset=&quot;none|<i>name number</i>|initial|inherit&quot;
</div></div>
