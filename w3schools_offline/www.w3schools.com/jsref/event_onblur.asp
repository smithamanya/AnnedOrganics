...
<!-- Mirrored from www.w3schools.com/jsref/event_onblur.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:15:39 GMT -->
<head>
...
<a target="_blank" href="tryit0209.html?filename=tryjsref_onblur" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p>The onblur event is most often used with form validation code (e.g. when the user 
leaves a form field).</p>
<p><b>Tip:</b> The onblur event is the opposite of the
<a href="event_onfocus.asp">onfocus</a> event.</p>
<p><strong>Tip: </strong>The onblur event is similar to the
<a href="event_onfocusout.html">onfocusout</a> event. The main difference is that the onblur event does not bubble. Therefore, if 
...
the optional <em>useCapture</em> parameter 
of the <a href="met_element_addeventlistener.html">addEventListener()</a> 
method for the onblur event.</p>
<hr>
...
&lt;<i>element</i> onblur=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitbc01.html?filename=tryjsref_onblur_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onblur=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryite590.html?filename=tryjsref_onblur_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;blur&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit3a01.html?filename=tryjsref_onblur_addeventlistener">Try it</a> </div></div>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>ALL HTML elements, EXCEPT: &lt;base&gt;, &lt;bdo&gt;, &lt;br&gt;, &lt;head&gt;, &lt;html&gt;, 
	&lt;iframe&gt;, &lt;meta&gt;, &lt;param&gt;, &lt;script&gt;, &lt;style&gt;, and &lt;title&gt;</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using &quot;onblur&quot; together with the &quot;onfocus&quot; event:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;input type=&quot;text&quot; onfocus=&quot;focusFunction()&quot; onblur=&quot;blurFunction()&quot;&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit5e10.html?filename=tryjsref_onblur_onfocus">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p style="height: 17px">Event delegation: setting the <em>useCapture</em> parameter of 
addEventListener() to true:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;form id=&quot;myForm&quot;&gt;<br>&nbsp; &lt;input type=&quot;text&quot; id=&quot;myInput&quot;&gt;<br>&lt;/form&gt;<br>
	<br>&lt;script&gt;<br>var x = document.getElementById(&quot;myForm&quot;);<br>
	x.addEventListener(&quot;focus&quot;, myFocusFunction, <strong>true</strong>);<br>
	x.addEventListener(&quot;blur&quot;, myBlurFunction, <strong>true</strong>);<br><br>
	function myFocusFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myInput&quot;).style.backgroundColor = &quot;yellow&quot;; <br>}<br>
	<br>function myBlurFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myInput&quot;).style.backgroundColor = &quot;&quot;; <br>}<br>
	&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6b7d.html?filename=tryjsref_onfocus_eventdelegation">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p style="height: 17px">Event delegation: using the focusin event (not supported 
by Firefox):</p>
<div class="w3-code notranslate htmlHigh">
	&lt;form id=&quot;myForm&quot;&gt;<br>&nbsp; &lt;input type=&quot;text&quot; id=&quot;myInput&quot;&gt;<br>&lt;/form&gt;<br>
	<br>&lt;script&gt;<br>var x = document.getElementById(&quot;myForm&quot;);<br>
	x.addEventListener(&quot;focusin&quot;, myFocusFunction);<br>
	x.addEventListener(&quot;focusout&quot;, myBlurFunction);<br><br>function 
	myFocusFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myInput&quot;).style.backgroundColor = &quot;yellow&quot;; <br>}<br>
	<br>function myBlurFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myInput&quot;).style.backgroundColor = &quot;&quot;; <br>}<br>
	&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita32e.html?filename=tryjsref_onfocusin_eventdelegation">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onblur.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:15:45 GMT -->
</html>
