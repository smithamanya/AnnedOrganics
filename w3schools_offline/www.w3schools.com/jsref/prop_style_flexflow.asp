...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_flexflow.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:28 GMT -->
<head>

<title>HTML DOM Style flexFlow Property</title>
...
<h1>Style <span class="color_h1">flexFlow</span> Property</h1>
<p><a href="dom_obj_style.asp"><img class="navup" src="../images/up.gif" alt="Style Object Reference" /> Style Object</a></p>
<div class="w3-example">
<h3>Example</h3>
<p>Make the flexible items display in columns, and no wrapping:</p>
<div class="w3-code notranslate jsHigh">
document.getElementById(&quot;main&quot;).style.flexFlow = &quot;column nowrap&quot;;</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3d0d.html?filename=tryjsref_style_flexflow">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The flexFlow property is a shorthand property for the flexDirection and the flexWrap properties.</p>

<p>The flexDirection property specifies the direction of the flexible items.</p>
<p>The flexWrap property specifies whether the flexible items should wrap or not.</p>

<p><b>Note:</b> If the elements are not flexible items, the flexFlow property has no effect.</p>
<hr>
...
<p>The flexFlow property is supported in IE10+, Firefox, Opera, and Chrome.</p>
<p><strong>Note:</strong> Safari 6.1+ supports an alternative, the 
WebkitFlexFlow property.</p>
<hr>

<h2>Syntax</h2>
<p>Return the flexFlow property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.flexFlow </div></div>
<p>Set the flexFlow property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.flexFlow=&quot;<i>flex-direction</i> <i>flex-wrap</i>|initial|inherit&quot;
</div></div>
...
<tr>
	...
	<td width="80%">row nowrap</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the flex-flow property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_flex-flow.html">flex-flow property</a></p>
...
<p>HTML DOM STYLE Reference: <a href="prop_style_flexgrow.asp">flexGrow property</a></p>
