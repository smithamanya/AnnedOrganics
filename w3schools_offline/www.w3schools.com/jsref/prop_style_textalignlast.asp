...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_textalignlast.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:33 GMT -->
<head>

<title>HTML DOM Style textAlignLast Property</title>
...
<h1>Style <span class="color_h1">textAlignLast </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryitc14e.html?filename=tryjsref_style_textalignlast">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The textAlignLast property specifies how to align the last line of a text.</p>
<p><strong>Note:</strong> The textAlignLast property will only work for elements with the text-align property set to "justify".</p>
<hr>
...
<p>The textAlignLast property is only supported in Internet Explorer.</p>
<p>Firefox supports an alternative, the MozTextAlignLast property.</p>
<p>The values "start" and "end" are not supported in Internet Explorer.</p>
<hr>

<h2>Syntax</h2>
<p>Return the textAlignLast property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.textAlignLast </div></div>
<p>Set the textAlignLast property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.textAlignLast=&quot;auto|left|right|center|justify|start|end|initial|inherit&quot;
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the text-align-last property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_text-align-last.html">text-align-last property</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_textalignlast.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:34 GMT -->
</html>