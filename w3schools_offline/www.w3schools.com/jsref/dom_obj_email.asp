...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_email.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:32 GMT -->
<head>
<title>HTML DOM Input Email Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Email </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_datetime-local.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_fileupload.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Email Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input Email Object is new in HTML5.</div></p>
<p>The Input Email object represents an HTML &lt;input&gt; element with type=&quot;email&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;email&quot; are not 
supported in Internet Explorer 9 (and earlier versions), or Safari.</span></p>
<h3>Access an Input Email Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;email&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myEmail");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitc59f.html?filename=tryjsref_email_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;email&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Email Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;email&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;email&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit7516.html?filename=tryjsref_email_create">Try it</a>	
</div>
</div>

<h2>Input Email Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_email_autocomplete.html">autocomplete</a></td>
    <td>Sets or returns the value of the autocomplete attribute of an email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether an email field should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_email_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of an email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_disabled.html">disabled</a></td>
    <td>Sets or returns whether an email field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_email_form.html">form</a></td>
    <td>Returns a reference to the form that contains the email field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_maxlength.html">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of an email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_multiple.html">multiple</a></td>
    <td>Sets or returns whether a user is allowed to enter more than one email address in the email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of an email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_pattern.html">pattern</a></td>
    <td>Sets or returns the value of the pattern attribute of an email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_placeholder.html">placeholder</a></td>
    <td>Sets or returns the value of the placeholder attribute of an email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the email field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_email_required.html">required</a></td>
    <td>Sets or returns whether the email field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_email_size.html">size</a></td>
    <td>Sets or returns the value of the size attribute of the email field</td>
  </tr>
  <tr>
    <td><a href="prop_email_type.html">type</a></td>
    <td>Returns which type of form element the email field is</td>
  </tr>
  <tr>
    <td><a href="prop_email_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of an email field</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The Input Email object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_email.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:45 GMT -->
</html>