...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_frame.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:15:26 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_i.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_image.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>IFrame Object</h2>
<p>The IFrame object represents an HTML &lt;iframe&gt; element.</p>
<h3>Access an IFrame Object</h3>
<p>You can access an &lt;iframe&gt; element by using getElementById():</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myFrame");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitafc8.html?filename=tryjsref_iframe_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access an &lt;iframe&gt; element by using the
<a href="prop_win_frames.html">window.frames</a> property.</p>

<h3>Create an IFrame Object</h3>
<p>You can create an &lt;iframe&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("IFRAME");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit5f49.html?filename=tryjsref_iframe_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
	...
	<a href="prop_style_cssfloat.asp">style.cssFloat</a> instead.</span> <br>Sets or returns the value of the align attribute in an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_contentdocument.html">contentDocument</a></td>
    <td>Returns the document object generated by an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_contentwindow.html">contentWindow</a></td>
    <td>Returns the window object generated by an iframe</td>
  </tr>
  <tr>
    <td>frameBorder</td>
    <td><span class="deprecated">Not supported in HTML5. Use
	<a href="prop_style_border.asp">style.border</a> 
	instead.</span> <br>Sets or returns the value of the frameborder attribute in an iframe</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>marginHeight</td>
    <td><span class="deprecated">Not supported in HTML5. Use 
	<a href="prop_style_margin.asp">style.margin</a> instead.</span> <br>Sets or returns the value of the marginheight attribute in an iframe</td>
  </tr>
  <tr>
    <td>marginWidth</td>
    <td><span class="deprecated">Not supported in HTML5. Use 
	<a href="prop_style_margin.asp">style.margin</a>  
	instead.</span> <br>Sets or returns the value of the marginwidth attribute in an iframe</td>
  </tr>
  <tr>
    <td><a href="prop_frame_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute in an iframe</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_iframe_sandbox.html">sandbox</a></td>
    <td>Returns the value of the sandbox attribute in an iframe</td>
  </tr>
  <tr>
    <td>scrolling</td>
  ...
  <tr>
    <td class="html5badge"><a href="prop_iframe_seamless.html">seamless</a></td>
    <td>Sets or returns whether an iframe should look like it is a part of the 
	containing document (no borders or scrollbars), or not</td>
  </tr>
  <tr>
    <td><a href="prop_frame_src.html">src</a></td>
    <td>Sets or returns the value of the src attribute in an iframe</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_frame_srcdoc.html">srcdoc</a></td>
    <td>Sets or returns the value of the srcdoc attribute in an iframe</td>
  </tr>
  <tr>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_iframe.html">HTML &lt;iframe&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_frame.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:15:32 GMT -->
</html>