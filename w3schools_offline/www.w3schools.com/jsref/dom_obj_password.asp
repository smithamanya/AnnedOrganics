...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_password.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:22 GMT -->
<head>
<title>HTML DOM Input Password Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Password</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_number.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_radio.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Password Object</h2>
<p>The Input Password object represents an HTML &lt;input&gt; element with 
type=&quot;password&quot;.</p>
<h3>Access an Input Password Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;password&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myPsw");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryita3ba.html?filename=tryjsref_password_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;password&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Password Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;password&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;password&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit5e65.html?filename=tryjsref_password_create">Try it</a>	
</div>
</div>

<h2>Input Password Object Properties</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge">autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a password field</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_password_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a password field should automatically get focus 
	when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_password_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_disabled.html">disabled</a></td>
    <td>Sets or returns whether the password field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_password_form.html">form</a></td>
    <td>Returns a reference to the form that contains the password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_maxlength.html">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a password field</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_password_pattern.html">pattern</a></td>
    <td>Sets or returns the value of the pattern attribute of a password field</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_password_placeholder.html">placeholder</a></td>
    <td>Sets or returns the value of the placeholder attribute of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_readonly.html">readOnly</a></td>
    <td>Sets or returns whether a password field is read-only, or not</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_password_required.html">required</a></td>
    <td>Sets or returns whether the password field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_password_size.html">size</a></td>
    <td>Sets or returns the value of the size attribute of a password field</td>
  </tr>
  <tr>
    <td><a href="prop_password_type.html">type</a></td>
    <td>Returns which type of form element a password field is</td>
  </tr>
  <tr>
    <td><a href="prop_password_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of the password field</td>
  </tr>
  </table>

<h2>Input Password Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_password_select.html">select()</a></td>
    <td>Selects the content of a password field</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Input Password object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_password.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:35 GMT -->
</html>