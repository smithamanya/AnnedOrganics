...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_tablerow.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:12 GMT -->
<head>
...
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myTr");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit1fdc.html?filename=tryjsref_tr_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access a &lt;tr&gt; element by searching through the <a href="coll_table_rows.html">rows</a> collection of a table.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit36b9.html?filename=tryjsref_tr_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="coll_tr_cells.html">cells</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_tablerow_rowindex.html">rowIndex</a></td>
    <td>Returns the position of a row in the <a href="coll_table_rows.html">rows</a> 
    collection of a table</td>
  </tr>
  <tr>
    <td><a href="prop_tablerow_sectionrowindex.html">sectionRowIndex</a></td>
    <td>Returns the position of a row in the <a href="coll_table_rows.html">rows</a> 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_tablerow_deletecell.html">deleteCell()</a></td>
    <td>Deletes a cell from the current table row</td>
  </tr>
  <tr>
    <td><a href="met_tablerow_insertcell.html">insertCell()</a></td>
    <td>Inserts a cell into the current table row</td>
  </tr>
  </table>

<h2>Standard Properties and Events</h2>
<p>The TableRow object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_tables.html">HTML Tables</a></p>
<p>HTML reference: <a href="../tags/tag_tr.html">HTML &lt;tr&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_tablerow.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:17 GMT -->
</html>