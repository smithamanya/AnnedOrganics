...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_select.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:31 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_section.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_small.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Select Object</h2>
<p>The Select object represents an HTML &lt;select&gt; element.</p>
<h3>Access a Select Object</h3>
<p>You can access a &lt;select&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("mySelect");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitd782.html?filename=tryjsref_select_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access a Select object by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create a Select Object</h3>
<p>You can create a &lt;select&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("SELECT");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitb279.html?filename=tryjsref_select_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="coll_select_options.html">options</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_select_disabled.html">disabled</a></td>
    <td>Sets or returns whether the drop-down list is disabled, or not</td>
    </tr>    
  <tr>
    <td><a href="prop_select_form.html">form</a></td>
    <td>Returns a reference to the form that contains the drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_length.html">length</a></td>
    <td>Returns the number of &lt;option&gt; elements in a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_multiple.html">multiple</a></td>
    <td>Sets or returns whether more than one option can be selected from the 
	drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_selectedindex.html">selectedIndex</a></td>
    <td>Sets or returns the index of the selected option in a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_size.html">size</a></td>
    <td>Sets or returns the value of the size of a drop-down list</td>
  </tr>
  <tr>
    <td><a href="prop_select_type.html">type</a></td>
    <td>Returns which type of form element a drop-down list is</td>
  </tr>
    <tr>
    <td><a href="prop_select_value.html">value</a></td>
    <td>Sets or returns the value of the selected option in a drop-down list</td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_select_add.html">add()</a></td>
    <td>Adds an option to a drop-down list</td>
    </tr>
  <tr>
    <td><a href="met_select_remove.html">remove()</a></td>
...
<p>HTML reference: <a href="../tags/tag_select.html">HTML &lt;select&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_select.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:40 GMT -->
</html>