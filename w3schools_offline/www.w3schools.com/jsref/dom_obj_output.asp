...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_output.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:04 GMT -->
<head>
<title>HTML DOM Output Object</title>
...
<h1>HTML DOM <span class="color_h1">Output </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_option.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_paragraph.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Output Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Output Object is new in HTML5.</div></p>
<p>The Output object represents an HTML &lt;output&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;output&gt; element is not 
supported in Internet Explorer.</span></p>
<h3>Access an Output Object</h3>
<p>You can access an &lt;output&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myOutput");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit8607.html?filename=tryjsref_output_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access an &lt;output&gt; element by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Output Object</h3>
<p>You can create an &lt;output&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("OUTPUT");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit042a.html?filename=tryjsref_output_create">Try it</a>	
</div>
</div>

<h2>Output Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>defaultValue</td>
    <td>Sets or returns the default value of an &lt;output&gt; element</td>
  </tr>
  <tr>
    <td><a href="prop_output_form.html">form</a></td>
    <td>Returns a reference to the form that contains the &lt;output&gt; element</td>
  </tr>
  <tr>
    <td><a href="prop_output_htmlfor.html">htmlFor</a></td>
    <td>Returns the value of the for attribute of an &lt;output&gt; element</td>
  </tr>
  <tr>
    <td>labels</td>
    <td>Returns a list of &lt;label&gt; elements associated with the &lt;output&gt; element</td>
  </tr>
  <tr>
    <td><a href="prop_output_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of an &lt;output&gt; element</td>
  </tr>
  <tr>
    <td><a href="prop_output_type.html">type</a></td>
    <td>Returns which type of HTML element the Output object represents</td>
  </tr>
  <tr>
    <td><a href="prop_output_value.html">value</a></td>
    <td>Sets or returns the value of an &lt;output&gt; element</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Output object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_output.html">HTML &lt;output&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_output.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:09 GMT -->
</html>