...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_textarea.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:17 GMT -->
<head>
...
<div class="next"><a class="chapter" href="dom_obj_time.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Textarea Object</h2>
<p>The Textarea object represents an HTML &lt;textarea&gt; element.</p>
<h3>Access a Textarea Object</h3>
<p>You can access a &lt;textarea&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myTextarea");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitf92b.html?filename=tryjsref_textarea_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access a &lt;textarea&gt; element by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create a Textarea Object</h3>
<p>You can create a &lt;textarea&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("TEXTAREA");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitf286.html?filename=tryjsref_textarea_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="prop_textarea_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a text area should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_cols.html">cols</a></td>
    <td>Sets or returns the value of the cols attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a text area</td>
  </tr>
    <tr>
    <td><a href="prop_textarea_disabled.html">disabled</a></td>
    <td>Sets or returns whether the text area is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_textarea_form.html">form</a></td>
    <td>Returns a reference to the form that contains the text area</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_textarea_maxlength.html">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a text area</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_textarea_placeholder.html">placeholder</a></td>
    <td>Sets or returns the value of the placeholder attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the contents of a text area is 
    read-only</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_textarea_required.html">required</a></td>
    <td>Sets or returns whether the text area must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_rows.html">rows</a></td>
    <td>Sets or returns the value of the rows attribute of a text area</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_type.html">type</a></td>
    <td>Returns the type of the form element the text area is</td>
  </tr>
  <tr>
    <td><a href="prop_textarea_value.html">value</a></td>
    <td>Sets or returns the contents of a text area</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="prop_textarea_wrap.html">wrap</a></td>
    <td>Sets or returns the value of the wrap attribute of a text area</td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_textarea_select.html">select()</a></td>
...
<p>HTML reference: <a href="../tags/tag_textarea.html">HTML &lt;textarea&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_textarea.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:28 GMT -->
</html>