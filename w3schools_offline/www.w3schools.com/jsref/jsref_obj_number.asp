...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_number.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:07:15 GMT -->
<head>
<title>JavaScript Number Reference</title>
...
<h1>JavaScript <span class="color_h1">Number Reference</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="jsref_obj_string.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="jsref_operators.asp">Next Reference &raquo;</a></div>
</div>
<hr>
...
<p>For a tutorial about JavaScript numbers, read our <a href="../js/js_numbers.html">
JavaScript Number Tutorial</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_constructor_number.html">constructor</a></td>
    <td>Returns the function that created JavaScript's Number prototype</td>
  </tr>
  <tr>
    <td><a href="jsref_max_value.html">MAX_VALUE</a></td>
    <td>Returns the largest number possible in JavaScript</td>
  </tr>
  <tr>
    <td><a href="jsref_min_value.html">MIN_VALUE</a></td>
    <td>Returns the smallest number possible in JavaScript</td>
  </tr>
  <tr>
    <td><a href="jsref_negative_infinity.html">NEGATIVE_INFINITY</a></td>
    <td>Represents negative infinity (returned on overflow)</td>
    </tr>
  <tr>
    <td><a href="jsref_number_nan.html">NaN</a></td>
    <td>Represents a "Not-a-Number" value</td>
    </tr>
  <tr>
    <td><a href="jsref_positive_infinity.html">POSITIVE_INFINITY</a></td>
    <td>Represents infinity (returned on overflow)</td>
  </tr>
  <tr>
    <td><a href="jsref_prototype_num.html">prototype</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_toexponential.html">toExponential(x)</a></td>
    <td>Converts a number into an exponential notation</td>
  </tr>
	<tr>
    <td><a href="jsref_tofixed.html">toFixed(x)</a></td>
    <td>Formats a number with x numbers of digits after the decimal point</td>
  </tr>
  <tr>
    <td><a href="jsref_toprecision.html">toPrecision(x)</a></td>
    <td>Formats a number to x length</td>
  </tr>
  <tr>
    <td><a href="jsref_tostring_number.html">toString()</a></td>
    <td>Converts a number to a string</td>
  </tr>
  <tr>
    <td><a href="jsref_valueof_number.html">valueOf()</a></td>
...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_number.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:07:22 GMT -->
</html>
