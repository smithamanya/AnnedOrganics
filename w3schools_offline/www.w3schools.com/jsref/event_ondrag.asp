...
<!-- Mirrored from www.w3schools.com/jsref/event_ondrag.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:03 GMT -->
<head>

<title>ondrag Event</title>
...
<h1><span class="color_h1">ondrag</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a &lt;p&gt; element is being dragged:</p>
<div class="w3-code notranslate htmlHigh">
&lt;p draggable="true" ondrag="myFunction(event)"&gt;Drag me!&lt;/p&gt;</div>
<a target="_blank" href="tryit32f8.html?filename=tryjsref_ondrag" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ondrag event occurs when an element or text selection is being dragged.</p>
...
<ul>
  <li><strong>Events fired on the draggable target</strong> (the source element)<strong>:
    ...
    <ul>
      ...
      <li>ondrag - occurs when an element is being dragged</li>
...
<p><strong>Note:</strong> While dragging an element, the ondrag event fires every 
350 milliseconds.</p>
<hr>
...
&lt;<i>element</i> ondrag=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit4468.html?filename=tryjsref_ondrag_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondrag=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitc357.html?filename=tryjsref_ondrag_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;drag&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit553e.html?filename=tryjsref_ondrag_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_ondrag.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:06 GMT -->
</html>
