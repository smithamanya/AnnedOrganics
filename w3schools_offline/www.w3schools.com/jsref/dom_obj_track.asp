...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_track.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:33 GMT -->
<head>
<title>HTML DOM Track Object</title>
...
<h1>HTML DOM <span class="color_h1">Track</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_title.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_u.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Track Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">
The Track Object is new in HTML5.</div></p>
<p>The Track object represents an HTML &lt;track&gt; element.</p>
<h3>Access a Track Object</h3>
<p>You can access a &lt;track&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myTrack");</span>
</div>
</div>
<h3>Create a Track Object</h3>
<p>You can create a &lt;track&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_track_default.html">default</a></td>
    <td>Sets or returns the default state of the track</td>
  </tr>
  <tr>
    <td><a href="prop_track_kind.html">kind</a></td>
    <td>Sets or returns the value of the kind attribute of the track</td>
  </tr>
  <tr>
    <td><a href="prop_track_label.html">label</a></td>
    <td>Sets or returns the value of the label attribute of the track</td>
  </tr>
  <tr>
    <td><a href="prop_track_readystate.html">readyState</a></td>
    <td>Returns the current state of the track resource</td>
  </tr>
  <tr>
    <td><a href="prop_track_src.html">src</a></td>
    <td>Sets or returns the value of the src attribute of the track</td>
  </tr>
  <tr>
    <td><a href="prop_track_srclang.html">srclang</a></td>
    <td>Sets or returns the value of the srclang attribute of the track</td>
  </tr>
  <tr>
    <td>track</td>
    <td>Returns a TextTrack object representing the track element's text track 
	data</td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The Track object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_track.html">HTML &lt;track&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_track.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:21:37 GMT -->
</html>