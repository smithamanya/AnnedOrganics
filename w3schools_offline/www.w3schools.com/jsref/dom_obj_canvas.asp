...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_canvas.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:13:49 GMT -->
<head>
<title>HTML DOM Canvas Object</title>
...
<h1>HTML DOM <span class="color_h1">Canvas</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_pushbutton.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_caption.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Canvas Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The Canvas Object is new in HTML5.</div></p>

<p>The HTML5 &lt;canvas&gt; tag is used to draw graphics, on the fly, with JavaScript.</p>

<h3>Access a Canvas Object</h3>
<p>You can access a &lt;canvas&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myCanvas");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitd1d0.html?filename=tryjsref_canvas_get">Try it</a>	
</div>
</div>

<h3>Create a Canvas Object</h3>
<p>You can create a &lt;canvas&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("CANVAS");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit7985.html?filename=tryjsref_canvas_create">Try it</a>	
</div>
</div>

<p><strong>Note:</strong> The &lt;canvas&gt; element has no drawing abilities of its own (it is only 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_createlineargradient.html">
	createLinearGradient()</a></td>
    <td>Creates a linear gradient (to use on canvas content)</td>
  </tr>
  <tr>
    <td><a href="canvas_createpattern.html">createPattern()</a></td>
    <td>Repeats a specified element in the specified direction</td>
  </tr>
  <tr>
    <td><a href="canvas_createradialgradient.html">createRadialGradient()</td>
    <td>Creates a radial/circular gradient (to use on canvas content)</td>
  </tr>
  <tr>
    <td><a href="canvas_addcolorstop.html">addColorStop()</a></td>
...
<table class="w3-table-all notranslate">
  <tr>
	...
	<tr>
    <td><a href="canvas_linecap.html">lineCap</a></td>
    <td>Sets or returns the style of the end caps for a line</td>
  </tr>
	<tr>
    <td><a href="canvas_linejoin.html">lineJoin</a></td>
    <td>Sets or returns the type of corner created, when two lines meet</td>
  </tr>
	<tr>
    <td><a href="canvas_linewidth.html">lineWidth</a></td>
    <td>Sets or returns the current line width</td>
  </tr>
	<tr>
    <td><a href="canvas_miterlimit.html">miterLimit</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_rect.html">rect()</a></td>
    <td>Creates a rectangle</td>
  </tr>
  <tr>
   <td><a href="canvas_fillrect.html">fillRect()</a></td>
    <td>Draws a "filled" rectangle</td>
  </tr>
  <tr>
    <td><a href="canvas_strokerect.html">strokeRect()</a></td>
    <td>Draws a rectangle (no fill)</td>
  </tr>
  <tr>
    <td><a href="canvas_clearrect.html">clearRect()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_scale.html">scale()</a></td>
    <td>Scales the current drawing bigger or smaller</td>
  </tr>
  <tr>
    <td><a href="canvas_rotate.html">rotate()</a></td>
    <td>Rotates the current drawing</td>
  </tr>
  <tr>
    <td><a href="canvas_translate.html">translate()</a></td>
    <td>Remaps the (0,0) position on the canvas</td>
  </tr>
  <tr>
    <td><a href="canvas_transform.html">transform()</a></td>
    <td>Replaces the current transformation matrix for the drawing</td>
  </tr>
  <tr>
    <td><a href="canvas_settransform.html">setTransform()</a></td>
    <td>Resets the current transform to the identity matrix. Then runs <a href="canvas_transform.html">
	transform()</a></td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_font.html">font</a></td>
    <td>Sets or returns the current font properties for text content</td>
  </tr>
  <tr>
    <td><a href="canvas_textalign.html">textAlign</a></td>
    <td>Sets or returns the current alignment for text content</td>
  </tr>
  <tr>
    <td><a href="canvas_textbaseline.html">textBaseline</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_filltext.html">fillText()</a></td>
    <td>Draws "filled" text on the canvas</td>
  </tr>
  <tr>
    <td><a href="canvas_stroketext.html">strokeText()</a></td>
    <td>Draws text on the canvas (no fill)</td>
  </tr>
  <tr>
    <td><a href="canvas_measuretext.html">measureText()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_drawimage.html">drawImage()</a></td>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="canvas_imagedata_width.html">width</a></td>
    <td>Returns the width of an ImageData object</td>
    </tr>
	<tr>
    <td><a href="canvas_imagedata_height.html">height</a></td>
    <td>Returns the height of an ImageData object</td>
    </tr>
	<tr>
    <td><a href="canvas_imagedata_data.html">data</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_createimagedata.html">createImageData()</a></td>
    <td>Creates a new, blank ImageData object</td>
  </tr>
  <tr>
    <td><a href="canvas_getimagedata.html">getImageData()</a></td>
    <td>Returns an ImageData object that copies the pixel data for the specified 
	rectangle on a canvas</td>
  </tr>
  <tr>
    <td><a href="canvas_putimagedata.html">putImageData()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="canvas_globalalpha.html">globalAlpha</a></td>
    <td>Sets or returns the current alpha or transparency value of the drawing</td>
  </tr>
  <tr>
    <td><a href="canvas_globalcompositeoperation.html">globalCompositeOperation</a></td>
...
<p>The canvas object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html5_canvas.html">HTML5 Canvas</a></p>
<p>HTML reference: <a href="../tags/tag_canvas.html">HTML &lt;canvas&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_canvas.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:14:28 GMT -->
</html>