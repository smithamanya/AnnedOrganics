...
<!-- Mirrored from www.w3schools.com/jsref/met_document_queryselectorall.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:39 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">querySelectorAll()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Get all elements in the document with class=&quot;example&quot;:</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.querySelectorAll(&quot;.example&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit06d1.html?filename=tryjsref_document_queryselectorall_class">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The querySelectorAll() method returns all elements in the document that 
matches a specified CSS selector(s), as a static NodeList object.</p>
<p>The NodeList object represents a collection of nodes. The nodes can be 
accessed by index numbers. The index starts at 0.</p>
<p><strong>Tip:</strong> You can use the <a href="prop_nodelist_length.html">
length</a> property of the NodeList object to determine the number of elements 
that matches the specified selector, then you can loop through all elements and 
extract the info you want.</p>
<p>For more information about CSS Selectors, visit our
<a href="../css/css_syntax.html">CSS Selectors Tutorial</a> and our
<a href="../cssref/css_selectors.html">CSS Selectors Reference</a>.</p>
<hr/>

<h2>Browser Support</h2>
<p>The numbers in the table specifies the first browser version that fully 
supports the method.</p>
...
<p><strong>Note:</strong> Internet Explorer 8 has support for CSS2 selectors. 
IE9 and later versions have support for CSS3 as well.</p>
<hr>
<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
document.querySelectorAll(<em>CSS selectors</em>)</div></div>
...
<tr>
<td><em>CSS selectors</em></td>
<td>String</td>
<td>Required. Specifies one or more CSS selectors to match the element. These are used to select HTML 
elements based on their id, classes, types, attributes, values of attributes, 
etc.<br><br>For multiple selectors, separate each selector with a comma.<br><br>
<strong>Tip:</strong> For a list of all CSS Selectors, look at our
<a href="../cssref/css_selectors.html">CSS Selectors Reference</a>.</td>
</tr>
</table>
...
<tr>
	...
	<td>Selectors Level 1 Document Object</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A NodeList object, representing all elements in the document that matches the specified CSS selector(s). The NodeList is a static collection, meaning that 
	changes in the DOM has NO effect in the collection. Throws a SYNTAX_ERR 
	exception if the selector(s) is invalid</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get all &lt;p&gt; elements in the document, and set the background color of the 
first &lt;p&gt; element (index 0):</p>
<div class="w3-code notranslate jsHigh">
	// Get all &lt;p&gt; elements in the document<br>var x = 
	document.querySelectorAll(&quot;p&quot;); <br><br>// Set the 
	background color of the first &lt;p&gt; element<br>
	x[0].style.backgroundColor = &quot;red&quot;;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1ee5.html?filename=tryjsref_document_queryselectorall_p">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Get all &lt;p&gt; elements in the document with class=&quot;example&quot;, and set the background of the 
first &lt;p&gt; element:</p>
<div class="w3-code notranslate jsHigh">
	// Get all &lt;p&gt; elements in the document with class=&quot;example&quot;<br>var x =
	document.querySelectorAll(&quot;p.example&quot;); <br><br>// Set the 
	background color of the first &lt;p&gt; element with class=&quot;example&quot; (index 
	0)<br>
	x[0].style.backgroundColor = &quot;red&quot;;&nbsp; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit85d8.html?filename=tryjsref_document_queryselectorall_p_class">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many elements with class=&quot;example&quot; there are in the document (using the length 
property of the NodeList object):</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.querySelectorAll(&quot;.example&quot;).length;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita940.html?filename=tryjsref_document_queryselectorall_length">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of all elements in the document with 
class=&quot;example&quot;:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.querySelectorAll(&quot;.example&quot;);<br>var i;<br>for (i = 0; 
	i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = 
	&quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit06b4.html?filename=tryjsref_document_queryselectorall_loop">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of all &lt;p&gt; elements in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.querySelectorAll(&quot;p&quot;);<br>var i;<br>for (i = 0; 
	i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = 
	&quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitbad6.html?filename=tryjsref_document_queryselectorall_loop_p">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the border of all &lt;a&gt; elements in the document that have a &quot;target&quot; 
attribute:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.querySelectorAll(&quot;a[target]&quot;);<br>var i;<br>for (i = 0; 
	i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.border = &quot;10px solid red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitcd5c.html?filename=tryjsref_document_queryselectorall_loop_target">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of every &lt;p&gt; element where the parent is a &lt;div&gt; 
element:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.querySelectorAll(&quot;div &gt; p&quot;);<br>var i;<br>for (i = 0; 
	i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = 
	&quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd285.html?filename=tryjsref_document_queryselectorall_gt">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the background color of all &lt;h2&gt;, &lt;div&gt; and &lt;span&gt; elements in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.querySelectorAll(&quot;h2, div, span&quot;);<br>var i;<br>for (i = 0; 
	i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = 
	&quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2351.html?filename=tryjsref_document_queryselectorall_multiple">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="../css/css_syntax.html">CSS Selectors</a></p>
<p>CSS Reference: <a href="../cssref/css_selectors.html">CSS Selectors Reference</a></p>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_nodelist.html">JavaScript HTML DOM Node List</a></p>
<p>HTML DOM Reference: <a href="met_document_queryselector.asp">document.querySelector()</a></p>
<p>HTML DOM Reference: <a href="met_element_queryselectorall.html"><em>element</em>.querySelectorAll()</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_queryselectorall.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:45 GMT -->
</html>
