...
<!-- Mirrored from www.w3schools.com/jsref/met_doc_write.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:54 GMT -->
<head>
...
<h3>Example</h3>
<p>Write some text directly to the HTML document:</p>
<div class="w3-code notranslate jsHigh">
document.write(&quot;Hello World!&quot;);<br>
</div>
<a target="_blank" href="tryit1113.html?filename=tryjsref_doc_write" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p>The write() method is mostly used for testing: If it is used after an HTML 
document is fully loaded, it will delete all existing HTML.</p>
<p><strong>Note:</strong> When this method is not used for testing, it is often 
used to write some text to an output stream opened by the
<a href="met_doc_open.asp">document.open()</a> method. See &quot;More Examples&quot; 
below.</p>
<p><strong>Tip:</strong> The <a href="met_doc_writeln.asp">document.writeln()</a> 
...
<div class="w3-example">
<h3>Example</h3>
<p>Write HTML elements with text directly to the HTML document:</p>
<div class="w3-code notranslate jsHigh">
document.write(&quot;&lt;h1&gt;Hello World!&lt;/h1&gt;&lt;p&gt;Have a nice day!&lt;/p&gt;&quot;);<br>
</div>
<a target="_blank" href="tryit55bd.html?filename=tryjsref_doc_write2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Write the Date object directly to the HTML document:</p>
<div class="w3-code notranslate jsHigh">
	document.write(Date());<br>
</div>
<a target="_blank" href="tryit322f.html?filename=tryjsref_doc_write3" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using document.write() after an HTML document is fully loaded, will delete 
all existing HTML.</p>
	<p>In this example we illustrate what happens when we put document.write() 
	inside a function. When the function is invoked, all HTML elements will be 
	overwritten and replaced with the new, specified text:</p>
<div class="w3-code notranslate jsHigh">
	// This should be avoided:<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.write(&quot;Hello 
	World!&quot;);<br>}<br>
</div>
<a target="_blank" href="tryitd336.html?filename=tryjsref_doc_write4" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
	document.open();<br>document.write(&quot;&lt;h1&gt;Hello World&lt;/h1&gt;&quot;);<br>
	document.close();<br>
</div>
<a target="_blank" href="tryit63b3.html?filename=tryjsref_doc_write5" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
	...
	tall!&lt;/p&gt;&quot;);</div>
<a target="_blank" href="tryit26fc.html?filename=tryjsref_win_open3" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>
...
&lt;pre&gt;<br>
&lt;script&gt;<br>
document.write(<span style="color:mediumblue">&quot;Hello World!&quot;</span>);<br>
document.write(<span style="color:mediumblue">&quot;Have a nice day!&quot;</span>);<br>
&lt;/script&gt;<br>
&lt;/pre&gt;<br>
<br>
<br>
...
&lt;pre&gt;<br>
&lt;script&gt;<br>
document.writeln(<span style="color:mediumblue">&quot;Hello World!&quot;</span>);<br>
document.writeln(<span style="color:mediumblue">&quot;Have a nice day!&quot;</span>);<br>
&lt;/script&gt;<br>
&lt;/pre&gt;<br>
<br>
&lt;/body&gt;</div>
<a target="_blank" href="tryit4137.html?filename=tryjsref_doc_writeln" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Write some text directly to the HTML document, with a new line after each 
statement (using &lt;br&gt;):</p>
<div class="w3-code notranslate jsHigh">
document.write(&quot;Hello World! &lt;br&gt;&quot;);<br>document.write(&quot;Have a nice day!&quot;);<br>
</div>
<a target="_blank" href="tryit323d.html?filename=tryjsref_doc_write6" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_doc_write.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:58 GMT -->
</html>
