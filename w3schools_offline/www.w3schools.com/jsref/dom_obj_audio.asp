...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_audio.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:13:04 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">Audio</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_aside.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_b.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Audio Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Audio Object is new in HTML5.</div></p>
<p>The Audio object represents an HTML &lt;audio&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;audio&gt; element is not 
supported in Internet Explorer 8 and earlier versions.</span></p>
<h3>Access an Audio Object</h3>
<p>You can access an &lt;audio&gt; element by using getElementById():</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myAudio");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit325b.html?filename=tryjsref_audio_get">Try it</a>	
</div>
</div>

<h3>Create an Audio Object</h3>
<p>You can create an &lt;audio&gt; element by using the document.createElement() method:</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("AUDIO");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit4613.html?filename=tryjsref_audio_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_audio_audiotracks.html">audioTracks</a></td>
    <td>Returns an AudioTrackList object representing available audio tracks</td>
  </tr>
  <tr>
    <td><a href="prop_audio_autoplay.html">autoplay</a></td>
    <td>Sets or returns whether the audio should start playing as soon as it is ready</td>
  </tr>
  <tr>
    <td><a href="prop_audio_buffered.html">buffered</a></td>
    <td>Returns a TimeRanges object representing the buffered parts of an audio</td>
  </tr>
  <tr>
    <td><a href="prop_audio_controller.html">controller</a></td>
    <td>Returns the MediaController object representing the current media 
	controller of an audio</td>
  </tr>
  <tr>
    <td><a href="prop_audio_controls.html">controls</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_audio_addtexttrack.html">addTextTrack()</a></td>
    <td>Adds a new text track to the audio</td>
  </tr>
  <tr>
    <td><a href="met_audio_canplaytype.html">canPlayType()</a></td>
  ...
  <tr>
    <td><a href="met_audio_play.html">play()</a></td>
    <td>Starts playing the audio</td>
  </tr>
  <tr>
    <td><a href="met_audio_pause.html">pause()</a></td>
    <td>Pauses the currently playing audio</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Audio object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html5_audio.html">HTML5 audio</a></p>
<p>HTML reference: <a href="../tags/tag_audio.html">HTML &lt;audio&gt; tag</a></p>
<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_aside.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_b.asp">Next Reference &raquo;</a></div>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_audio.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:13:29 GMT -->
</html>