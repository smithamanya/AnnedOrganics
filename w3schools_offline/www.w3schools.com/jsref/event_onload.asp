...
<!-- Mirrored from www.w3schools.com/jsref/event_onload.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:30 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitbe98.html?filename=tryjsref_onload">Try it yourself &raquo;</a>
<br>
</div>
...
CSS files, etc.).</p>
<p>The onload event can be used to check the visitor's browser type and browser 
version, and load the proper version of the web page based on the information.</p>
<p>The onload event can also be used to deal with cookies (see &quot;More Examples&quot; 
below).</p>
<hr>
...
&lt;<i>element</i> onload=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryita467.html?filename=tryjsref_onload_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onload=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitd2a9.html?filename=tryjsref_onload_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;load&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitef37.html?filename=tryjsref_onload_addeventlistener">Try it</a> </div></div>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>&lt;body&gt;, &lt;frame&gt;, &lt;iframe&gt;, &lt;img&gt;, &lt;input type=&quot;image&quot;&gt;, 
&lt;link&gt;, &lt;script&gt;, &lt;style&gt;</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using onload on an &lt;img&gt; element. Alert &quot;Image is loaded&quot; immediately after 
an image has been loaded:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;img src=&quot;w3javascript.gif&quot; onload=&quot;loadImage()&quot; width=&quot;100&quot; height=&quot;132&quot;&gt;<br>
	<br>&lt;script&gt;<br>function loadImage() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;Image is 
	loaded&quot;);<br>}<br>
	&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryite03a.html?filename=tryjsref_img_onload">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using the onload event to deal with cookies:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;body onload=&quot;checkCookies()&quot;&gt;<br><br>&lt;script&gt;<br>
	function checkCookies() {<br>&nbsp;&nbsp;&nbsp; var text = &quot;&quot;;<br><br>&nbsp;&nbsp;&nbsp; 
	if (navigator.cookieEnabled == true) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	text = &quot;Cookies are enabled.&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	text = &quot;Cookies are not enabled.&quot;;<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;demo&quot;).innerHTML = text;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd25c.html?filename=tryjsref_onload_cookies">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onload.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:35 GMT -->
</html>
