...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_dialog.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:14:47 GMT -->
<head>
<title>HTML DOM Dialog Object</title>
...
<h1>HTML DOM <span class="color_h1">Dialog</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_dfn.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_div.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Dialog Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The Dialog Object is new in HTML5.</div></p>
<p>The Dialog object represents an HTML &lt;dialog&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;dialog&gt; element is currently only supported in 
Chrome 37+, Safari 6+ and Opera 24+.</span></p>
<h3>Access a Dialog Object</h3>
<p>You can access a &lt;dialog&gt; element by using getElementById():</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myDialog");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitde22.html?filename=tryjsref_dialog_get">Try it</a>	
</div>
</div>

<h3>Create a Dialog Object</h3>
<p>You can create a &lt;dialog&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("DIALOG");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitc270.html?filename=tryjsref_dialog_create">Try it</a>	
</div>
</div>

<h2>Dialog Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_dialog_open.html">open</a></td>
    <td>Sets or returns whether a dialog should be open or not</td>
  </tr>
  <tr>
    <td>returnValue</td>
    <td>Sets or returns the dialog's return value</td>
  </tr>
</table>

<h2>Dialog Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_dialog_close.html">close()</a></td>
    <td>Closes the dialog</td>
  </tr>
  <tr>
    <td><a href="met_dialog_show.html">show()</a></td>
    <td>Shows the dialog</td>
  </tr>
  <tr>
    <td><a href="met_dialog_showmodal.html">showModal()</a></td>
    <td>Shows the dialog and makes it the top-most modal dialog</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Dialog object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_dialog.html">HTML &lt;dialog&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_dialog.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:14:50 GMT -->
</html>