...
<!-- Mirrored from www.w3schools.com/jsref/event_onbeforeunload.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:13:56 GMT -->
<head>
...
<h1><span class="color_h1">onbeforeunload</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the page is about to be unloaded:</p>
<div class="w3-code notranslate htmlHigh">
&lt;body onbeforeunload=&quot;return myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit8ce3.html?filename=tryjsref_onbeforeunload" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onbeforeunload event occurs when the document is about to be unloaded. </p>
...
<p>The default message that appears in the confirmation box, is different in 
different browsers. However, the standard message is something like &quot;Are you 
sure you want to leave this page?&quot;. This message cannot be removed.</p>
<p>However, you can write a custom message together with the default message. 
See the first example on this page.</p>
<p><strong>Note:</strong> If the onbeforeunload event is not assigned to the 
&lt;body&gt; element, you must assign/attach the event on the window object, and use 
the returnValue property to create a custom message (see syntax examples below).</p>
<p><strong>Note:</strong> In Firefox, only the default message will be displayed 
(not the custom message (if any)).</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">onbeforeunload</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
&lt;<i>element</i> onbeforeunload=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit00a6.html?filename=tryjsref_onbeforeunload_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onbeforeunload=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit376b.html?filename=tryjsref_onbeforeunload_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;beforeunload&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitcbdb.html?filename=tryjsref_onbeforeunload_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onbeforeunload.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:03 GMT -->
</html>
