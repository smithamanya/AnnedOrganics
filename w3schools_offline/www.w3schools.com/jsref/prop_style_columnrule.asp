...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_columnrule.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:00 GMT -->
<head>

<title>HTML DOM Style columnRule Property</title>
...
<h1>Style <span class="color_h1">columnRule </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6d58.html?filename=tryjsref_style_columnrule">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The columnRule property is a shorthand property for setting all the columnRule* properties.</p>
<p>The columnRule property sets the width, style, and color of the rule between columns.</p>
<hr>
...
<p>The columnRule property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the MozColumnRule property.</p>
<p>Safari and Chrome support an alternative, the WebkitColumnRule property.</p>
<hr>
<h2>Syntax</h2>
<p>Return the columnRule property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnRule </div></div>
<p>Set the columnRule property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnRule=&quot;<i>column-rule-width column-rule-style column-rule-color</i>|initial|inherit&quot;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> <i><a href="prop_style_columnrulewidth.asp">columnRuleWidth</a></i></td>
    <td>Sets the width of the rule between columns. Default value is medium</td>
  </tr>
  <tr>
    <td> <i><a href="prop_style_columnrulestyle.asp">columnRuleStyle</a></i></td>
    <td>Sets the style of the rule between columns. Default value is none</td>
  </tr>
  <tr>
    <td> <i><a href="prop_style_columnrulecolor.asp">columnRuleColor</a></i></td>
...
<tr>
	...
	<td width="80%">medium none <em>color</em></td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the column-rule property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS3 tutorial: <a href="../css/css3_multiple_columns.html">CSS3 Multiple Columns</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_column-rule.html">column-rule property</a></p>
<hr>
