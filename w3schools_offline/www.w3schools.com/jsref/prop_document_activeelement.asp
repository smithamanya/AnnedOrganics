...
<!-- Mirrored from www.w3schools.com/jsref/prop_document_activeelement.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:34 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">activeElement</span> Property</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
	<p>Get the currently focused element in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.activeElement.tagName;</div>
<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
	BUTTON</div>
<a target="_blank" href="tryitad93.html?filename=tryjsref_document_activeelement" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The activeElement property returns the currently focused element in the 
document.</p>
<p><strong>Note:</strong> This property is read-only.</p>
<p><strong>Tip:</strong> To give focus to an element, use the
<a href="met_html_focus.html"><em>element</em>.focus()</a> method.</p>
<p><strong>Tip: </strong>To find out if the document has focus, use the
<a href="met_document_hasfocus.asp">document.hasFocus()</a> method.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">activeElement</td>
    <td>2.0</td>
    <td>4.0</td>
    <td>3.0</td>
    <td>4.0</td>
...
document.activeElement</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
<tr>
	<th style="width:20%">Return Value:</th>
	<td>A reference to the element object in the document that has focus</td>
</tr>
</table>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_document_activeelement.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:35 GMT -->
</html>
