...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_perspectiveorigin.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:21 GMT -->
<head>

<title>HTML DOM Style perspectiveOrigin Property</title>
...
<h1>Style <span class="color_h1">perspectiveOrigin </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit0362.html?filename=tryjsref_style_perspectiveorigin">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The perspectiveOrigin property defines where a 3D element is based in the x- 
and the y-axis. This property allows you to change the bottom position of 3D 
elements.</p>
<p>When defining the perspectiveOrigin property for an element, it is the CHILD elements 
that are positioned, NOT the element itself.</p>
<p><b>Note:</b> This property must be used together with the 
<a href="prop_style_perspective.asp">perspective</a> property, and only affects 3D 
...
<p>The perspectiveOrigin property is supported in IE10+ and Firefox.</p>
<p>Chrome, Safari, and Opera support an alternative, the WebkitPerspecitveOrigin property.</p>
<hr>

<h2>Syntax</h2>
<p>Return the perspectiveOrigin property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.perspectiveOrigin </div></div>
<p>Set the perspectiveOrigin property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.perspectiveOrigin=&quot;<i>x-axis y-axis</i>|initial|inherit&quot;
</div></div>
...
<tr>
	...
	<td width="80%">50% 50%</td>
</tr>
<tr>
	<th>Return Value:</th>
	<td>A String, representing the perspective-origin property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<hr>
<h2>Related Pages</h2>
<p>JavaScript Style Object: <a href="prop_style_perspective.asp">perspective property</a></p>
<p>CSS reference: <a href="../cssref/css3_pr_perspective-origin.html">perspective-origin property</a></p>
<hr>
