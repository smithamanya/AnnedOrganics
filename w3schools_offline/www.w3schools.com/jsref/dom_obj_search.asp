...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_search.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:18:01 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">Input Search </span>Object</h1>
<div class="chapter">
...
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input Search Object is new in HTML5.</div></p>
<p>The Input Search object represents an HTML &lt;input&gt; element with 
type=&quot;search&quot;.</p>
<h3>Access an Input Search Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;search&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("mySearch");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit3661.html?filename=tryjsref_search_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;search&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Search Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;search&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;search&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit3616.html?filename=tryjsref_search_create">Try it</a>	
</div>
</div>

<h2>Input Search Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_search_autocomplete.html">autocomplete</a></td>
    <td>Sets or returns the value of the autocomplete attribute of a search 
	field</td>
  </tr>
  <tr>
    <td><a href="prop_search_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a search field should automatically get focus 
	when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_search_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_disabled.html">disabled</a></td>
    <td>Sets or returns whether a search field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_search_form.html">form</a></td>
    <td>Returns a reference to the form that contains the search field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_maxlength.html">maxLength</a></td>
    <td>Sets or returns the value of the maxlength attribute of a search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_pattern.html">pattern</a></td>
    <td>Sets or returns the value of the pattern attribute of a search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_placeholder.html">placeholder</a></td>
    <td>Sets or returns the value of the placeholder attribute of a search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the search field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_search_required.html">required</a></td>
    <td>Sets or returns whether the search field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_search_size.html">size</a></td>
    <td>Sets or returns the value of the size attribute of the search field</td>
  </tr>
  <tr>
    <td><a href="prop_search_type.html">type</a></td>
    <td>Returns which type of form element the search field is</td>
  </tr>
  <tr>
    <td><a href="prop_search_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a search field</td>
  </tr>
</table>

<!--
<h2>Input Search Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="met_search_blur.asp">blur()</a></td>
    <td>Removes focus from a search field</td>
  </tr>
  <tr>
    <td><a href="met_search_focus.asp">focus()</a></td>
    <td>Gives focus to a search field</td>
  </tr>
</table>
-->

<h2>Standard Properties and Events</h2>
<p>The Input Search object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_search.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:18:12 GMT -->
</html>