...
<!-- Mirrored from www.w3schools.com/jsref/met_document_removeeventlistener.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:47 GMT -->
<head>

<title>HTML DOM removeEventListener() Method</title>
...
<h1>HTML DOM <span class="color_h1">removeEventListener()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
	<p>Remove a &quot;mousemove&quot; event that has been attached with 
...
<a target="_blank" href="tryite24e.html?filename=tryjsref_document_addeventlistener_remove" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The document.removeEventListener() method removes an event handler that has been 
attached with the <a href="met_document_addeventlistener.asp">document.addEventListener()</a> 
method.</p>
<p><strong>Note:</strong> To remove event handlers, the function specified with 
the addEventListener() method must be an external, &quot;named&quot; function, like in the example 
above (myFunction).</p>
<p>Anonymous functions, like &quot;document.removeEventListener(&quot;<em>event</em>&quot;, 
function(){ <em>myScript</em> });&quot; will not work.</p>
<p><strong>Tip:</strong> Use the <a href="met_element_addeventlistener.html"><em>
element</em>.addEventListener()</a> and
<a href="met_element_removeeventlistener.html"><em>element</em>.removeEventListener()</a> 
methods to add/remove event handlers to/from a specified element.</p>
<hr>
...
<p><strong>Note:</strong> The removeEventListener() method is not supported in 
Internet Explorer 8 and earlier versions, and Opera 6.0 and earlier versions. However, for these specific browser 
versions, you can use the <strong>detachEvent()</strong> method to remove event 
handlers that have been attached with the attachEvent() method (see &quot;More Examples&quot; 
below for a cross-browser solution).</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
	document.removeEventListener(<em>event</em>, <em>function</em>, 
	<em>useCapture</em>)
</div></div>
...
<tr>
<td><em>event</em></td>
<td>Required. A String that specifies the name of the event to remove.<br><br><strong>Note:</strong> Do 
not use the &quot;on&quot; prefix. For example, use &quot;click&quot; instead of &quot;onclick&quot;.<br><br><strong>Tip:</strong> For a list of all HTML DOM events, look at our complete <a href="dom_obj_event.asp">HTML DOM Event Object Reference</a>.</td>
</tr>
<tr>
<td><em>function</em></td>
<td>Required. Specifies the function to remove.</td>
</tr>
<tr>
<td><em>useCapture</em></td>
<td>
Optional. A Boolean value that specifies the event phase 
to remove the event handler from.<br><br>Possible values:
<ul>
	<li>true - Removes the event handler from the capturing phase</li>
	<li>false- Default. Removes the event handler from the bubbling phase</li>
</ul>
<strong>Note:</strong>
	If the event handler was attached two times, one with capturing and one 
	bubbling, each must be removed separately.
	</td>
</tr>
</table>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>The useCapture parameter became optional in Firefox 6 and Opera 12.0 
...
<div class="w3-example">
<h3>Example</h3>
<p>For browsers that do not support the removeEventListener() method, you can use 
the detachEvent() method.</p>
	<p>This example demonstrates a cross-browser solution:</p>
<div class="w3-code notranslate jsHigh">
	if (document.removeEventListener) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// For all major browsers, except IE 8 and earlier<br>&nbsp;&nbsp;&nbsp; 
	document.removeEventListener(&quot;mousemove&quot;, myFunction);<br>} else if (document.detachEvent) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // For IE 8 and earlier versions<br>&nbsp;&nbsp;&nbsp; 
	document.detachEvent(&quot;onmousemove&quot;, myFunction);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1329.html?filename=tryjsref_document_removeeventlistener_crossbrowser">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Tutorial: <a href="../js/js_htmldom_eventlistener.html">HTML DOM EventListener</a></p>
<p>JavaScript Reference: <a href="met_element_removeeventlistener.html"><em>element</em>.removeEventListener()</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_removeeventlistener.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:48 GMT -->
</html>
