...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_anchors.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:41 GMT -->
<head>
...
<h3>Example</h3>
	<p>Find out how many &lt;a&gt; elements there are in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.anchors.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	3</div>
<a target="_blank" href="tryit2517.html?filename=tryjsref_doc_anchors" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The anchors collection returns a collection of all &lt;a&gt; elements in the document 
that have a name attribute.</p>
<p><span class="deprecated"><strong>Note:</strong> The name attribute of the &lt;a&gt; element is not supported in HTML5.</span></p>
<p>The elements in the collection are sorted as they appear in the source 
code.</p>
<p><strong>Tip:</strong> Also look at the <a href="dom_obj_anchor.asp">Anchor 
Object</a> and <a href="coll_doc_links.asp">document.links</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;a&gt; elements in the collection.<br><br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;a&gt; element from the collection with the specified index 
  ...
  <tr>
    ...
    <td>Returns the &lt;a&gt; element from the collection with the specified id.<br><br>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>An HTMLCollection Object, representing all &lt;a&gt; elements in the 
	document that have a name attribute. The elements in the collection are sorted as they appear 
...
<div class="w3-example">
<h3>Example</h3>
	<p>Get the HTML content of the first &lt;a&gt; element in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x =
...
<div class="w3-code notranslate">
	HTML Tutorial</div>
<a target="_blank" href="tryit31b7.html?filename=tryjsref_doc_anchors2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_anchors.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:43 GMT -->
</html>