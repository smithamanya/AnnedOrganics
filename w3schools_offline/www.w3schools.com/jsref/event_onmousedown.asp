...
<!-- Mirrored from www.w3schools.com/jsref/event_onmousedown.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:23 GMT -->
<head>
...
<a target="_blank" href="tryite7d3.html?filename=tryjsref_onmousedown" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<ol>
	<li>onmousedown</li>
	<li><a href="event_onmouseup.asp">onmouseup</a></li>
	<li><a href="event_onclick.asp">onclick</a></li>
</ol>
<p>The order of events related to the onmousedown event (for the right mouse button):</p>
<ol>
	<li>onmousedown</li>
	<li><a href="event_onmouseup.asp">onmouseup</a></li>
	<li><a href="event_oncontextmenu.asp">oncontextmenu</a></li>
</ol>
<hr>
...
&lt;<i>element</i> onmousedown=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitd878.html?filename=tryjsref_onmousedown_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onmousedown=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit1f97.html?filename=tryjsref_onmousedown_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;mousedown&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitb675.html?filename=tryjsref_onmousedown_addeventlistener">Try it</a> </div></div>
...
<p><a href="tryit6866.html?filename=tryjsref_onmousedown_param" target="_blank">
Trigger a function with parameters when the button is pressed down</a><br>
When the mouse button is pressed down over a &lt;p&gt; element, change its color to red.</p>

<p><a target="_blank" href="tryitf69d.html?filename=tryjsref_onmousedown2">Alert which mouse button that was pressed</a><br>
Alert which mouse button the user pressed.</p>

<p><a target="_blank" href="tryitdc34.html?filename=tryjsref_event_srcelement">Alert the element the user clicked on</a><br>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onmousedown.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:35 GMT -->
</html>
