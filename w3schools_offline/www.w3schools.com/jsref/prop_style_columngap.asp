...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_columngap.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:59 GMT -->
<head>

<title>HTML DOM Style columnGap Property</title>
...
<h1>Style <span class="color_h1">columnGap </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit17b8.html?filename=tryjsref_style_columngap">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The columnGap property specifies the gap between the columns.</p>
...
<p>The columnGap property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the MozColumnGap property.</p>
<p>Safari and Chrome support an alternative, the WebkitColumnGap property.</p>
<p><strong>Note:</strong> The columnGap property is not supported in Internet Explorer 9 and earlier versions.&nbsp;&nbsp;</p>
<hr>
<h2>Syntax</h2>
<p>Return the columnGap property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnGap </div></div>
<p>Set the columnGap property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnGap=&quot;<i>length</i>|normal|initial|inherit&quot;
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the column-gap property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<p>CSS reference: <a href="../cssref/css3_pr_column-gap.html">column-gap property</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_columngap.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:22:00 GMT -->
</html>