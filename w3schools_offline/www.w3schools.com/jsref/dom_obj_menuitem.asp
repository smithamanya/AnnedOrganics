...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_menuitem.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:19:32 GMT -->
<head>
<title>HTML DOM MenuItem Object</title>
...
<h1>HTML DOM <span class="color_h1">MenuItem</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_menu.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_meta.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>MenuItem Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">
The MenuItem Object is new in HTML5.</div></p>
<p>The MenuItem object represents an HTML &lt;menuitem&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;menuitem&gt; element is currently 
ONLY supported in Firefox.</span></p>
<h3>Access a MenuItem Object</h3>
<p>You can access a &lt;menuitem&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myMenuItem");</span>
</div>
</div>
	
<h3>Create a MenuItem Object</h3>
<p>You can create a &lt;menuitem&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
...
<h2>MenuItem Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>checked</td>
    <td>Sets or returns whether the menu item should be checked</td>
  </tr>
  <tr>
    <td>command</td>
    <td>Sets or returns the value of the command attribute of the menu item</td>
  </tr>
  <tr>
    <td>default</td>
    <td>Sets or returns whether the menu item should be the default command</td>
  </tr>
  <tr>
    <td>disabled</td>
    <td>Sets or returns whether the menu item should be disabled</td>
  </tr>
  <tr>
    <td>icon</td>
    <td>Sets or returns an image that represents the menu item</td>
  </tr>
  <tr>
    <td>label</td>
    <td>Sets or returns the value of the label attribute of the menu 
	item</td>
  </tr>
  <tr>
    <td>radiogroup</td>
    <td>Sets or returns the value of the radiogroup attribute of the menu item</td>
  </tr>
  <tr>
    <td>type</td>
    <td>Sets or returns the value of the type attribute of the menu item</td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The MenuItem object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_menuitem.html">HTML &lt;menitemu&gt; tag</a></p>
