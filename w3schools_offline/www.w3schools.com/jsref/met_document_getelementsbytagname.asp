...
<!-- Mirrored from www.w3schools.com/jsref/met_document_getelementsbytagname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:14 GMT -->
<head>
...
<h3>Example</h3>
	<p>Get all elements in the document with the specified tag name:</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByTagName(&quot;LI&quot;);<br>
</div>
<a target="_blank" href="tryitedf3.html?filename=tryjsref_document_getelementsbytagname" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getElementsByTagName() method returns a collection of all elements in the document with the specified tag name, as a NodeList object.</p>
<p>The NodeList object represents a collection of nodes. The nodes can be accessed by index numbers. The index starts 
at 0.</p>
<p><strong>Tip:</strong> The parametervalue "*" returns all elements in the 
document.</p>
...
<tr>
	...
	<td>A NodeList object, representing a collection of elements with the specified tag name. The elements in the returned collection are sorted as they appear in the source code.</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find out how many &lt;li&gt; elements there are in the document (using the length 
property of the NodeList object):</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByTagName(&quot;LI&quot;).length;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6891.html?filename=tryjsref_document_getelementsbytagname_length">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the HTML content of the first &lt;p&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	document.getElementsByTagName(&quot;P&quot;)[0].innerHTML = &quot;Hello World!&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitc10b.html?filename=tryjsref_document_getelementsbytagname2">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the background color of all &lt;p&gt; elements in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.getElementsByTagName(&quot;P&quot;);<br>var i;<br>for (i = 0; i &lt; 
	x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = &quot;red&quot;;<br>
	}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit85df.html?filename=tryjsref_document_getelementsbytagname3">Try it yourself &raquo;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitb5d9.html?filename=tryjsref_document_getelementsbytagname_all">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript Reference: <a href="met_element_getelementsbytagname.html"><em>element</em>.getElementsByTagName()</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_getelementsbytagname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:17 GMT -->
</html>
