...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragend.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:06 GMT -->
<head>

<title>ondragend Event</title>
...
<h1><span class="color_h1">ondragend</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the user has finished dragging a &lt;p&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
&lt;p draggable="true" ondragend="myFunction(event)"&gt;Drag me!&lt;/p&gt;</div>
<a target="_blank" href="tryitcfa7.html?filename=tryjsref_ondragstart" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ondragend event occurs when the user has finished dragging an element or 
text selection.</p>
...
<ul>
  <li><strong>Events fired on the draggable target</strong> (the source element)<strong>:
    ...
    <ul>
      ...
      <li>ondragend - occurs when the user has finished dragging the element</li>
    </ul>
  </li><br>
...
&lt;<i>element</i> ondragend=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryitc1d3.html?filename=tryjsref_ondragstart_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondragend=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit3b6a.html?filename=tryjsref_ondragstart_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;dragend&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit0745.html?filename=tryjsref_ondragstart_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragend.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:08 GMT -->
</html>
