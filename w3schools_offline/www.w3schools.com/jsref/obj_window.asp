...
<!-- Mirrored from www.w3schools.com/jsref/obj_window.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:09:57 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="jsref_type_conversion.asp">&laquo; Previous</a></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="prop_win_closed.html">closed</a></td>
    <td>Returns a Boolean value indicating whether a window has been closed or 
	not</td>
  </tr>
  <tr>
    <td><a href="prop_win_defaultstatus.html">defaultStatus</a></td>
    <td>Sets or returns the default text in the statusbar of a window</td>
  </tr>
  <tr>
    <td><a href="dom_obj_document.html">document</a></td>
    <td>Returns the Document object for the window (<a href="dom_obj_document.html">See Document object</a>)</td>
  </tr>
  <tr>
    <td><a href="prop_win_frameElement.html">frameElement</a></td>
    <td>Returns the &lt;iframe&gt; element in which the current window is inserted</td>
  </tr>
  <tr>
    <td><a href="prop_win_frames.html">frames</a></td>
  ...
  <tr>
    <td><a href="prop_win_innerheight.html">innerHeight</a></td>
    <td>Returns the inner height of a window's content area</td>
  </tr>
  <tr>
    <td><a href="prop_win_innerheight.html">innerWidth</a></td>
    <td>Returns the inner width of a window's content area</td>
  </tr>
  <tr>
    <td><a href="prop_win_length.html">length</a></td>
    <td>Returns the number of &lt;iframe&gt; elements in the current window</td>
  </tr>
  <tr>
    <td>localStorage</td>
    <td>Returns a reference to the local storage object used to store data. Stores data with no expiration date</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="prop_win_name.html">name</a></td>
  ...
  <tr>
    <td><a href="prop_win_screenleft.html">screenLeft</a></td>
    <td>Returns the horizontal coordinate of the window relative to the screen</td>
  </tr>
  <tr>
    <td><a href="prop_win_screenleft.html">screenTop</a></td>
    <td>Returns the vertical coordinate of the window relative to the screen</td>
  </tr>
  <tr>
    <td><a href="prop_win_screenx.html">screenX</a></td>
    <td>Returns the horizontal coordinate of the window relative to the screen</td>
  </tr>
  <tr>
    <td><a href="prop_win_screenx.html">screenY</a></td>
    <td>Returns the vertical coordinate of the window relative to the screen</td>
  </tr>
  <tr>
    <td>sessionStorage</td>
    <td>Returns a reference to the local storage object used to store data. Stores data for one session (lost when the browser tab is closed)</td>
  </tr>
  <tr>
    <td>scrollX</td>
    <td>An alias of <a href="prop_win_pagexoffset.html">pageXOffset</a></td>
  </tr>
  <tr>
    <td>scrollY</td>
    <td>An alias of <a href="prop_win_pagexoffset.html">pageYOffset</a></td>
  </tr>
  <tr>
    <td><a href="prop_win_self.html">self</a></td>
    <td>Returns the current window</td>
  </tr>
  <tr>
    <td><a href="prop_win_status.html">status</a></td>
    <td>Sets or returns the text in the statusbar of a window</td>
  </tr>
  <tr>
    <td><a href="prop_win_top.html">top</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="met_win_alert.html">alert()</a></td>
    <td>Displays an alert box with a message and an OK button</td>
  </tr>
  <tr>
    <td><a href="met_win_atob.html">atob()</a></td>
    <td>Decodes a base-64 encoded string</td>
  </tr>
  <tr>
    <td><a href="met_win_blur.html">blur()</a></td>
    <td>Removes focus from the current window</td>
    </tr>
  <tr>
    <td><a href="met_win_btoa.html">btoa()</a></td>
    <td>Encodes a string in base-64</td>
  </tr>
  <tr>
    <td><a href="met_win_clearinterval.html">clearInterval()</a></td>
    <td>Clears a timer set with setInterval()</td>
  </tr>
  <tr>
    <td><a href="met_win_cleartimeout.html">clearTimeout()</a></td>
    <td>Clears a timer set with setTimeout()</td>
  </tr>
  <tr>
    <td><a href="met_win_close.html">close()</a></td>
    <td>Closes the current window</td>
  </tr>
  <tr>
    <td><a href="met_win_confirm.html">confirm()</a></td>
    <td>Displays a dialog box with a message and an OK and a Cancel button</td>
  </tr>
  <tr>
    <td><a href="met_win_createpopup.html">createPopup()</a></td>
    <td>Creates a pop-up window</td>
  </tr>
  <tr>
    <td><a href="met_win_focus.html">focus()</a></td>
  ...
  <tr>
    <td><a href="met_win_moveby.html">moveBy()</a></td>
    <td>Moves a window relative to its current position</td>
  </tr>
  <tr>
    <td><a href="met_win_moveto.html">moveTo()</a></td>
    <td>Moves a window to the specified position</td>
  </tr>
  <tr>
    <td><a href="met_win_open.html">open()</a></td>
    <td>Opens a new browser window</td>
  </tr>
  <tr>
    <td><a href="met_win_print.html">print()</a></td>
    <td>Prints the content of the current window</td>
  </tr>
  <tr>
    <td><a href="met_win_prompt.html">prompt()</a></td>
    <td>Displays a dialog box that prompts the visitor for input</td>
  </tr>
  <tr>
    <td><a href="met_win_resizeby.html">resizeBy()</a></td>
    <td>Resizes the window by the specified pixels</td>
  </tr>
  <tr>
    <td><a href="met_win_resizeto.html">resizeTo()</a></td>
    <td>Resizes the window to the specified width and height</td>
  </tr>
  <tr>
    <td>scroll()</td>
    <td><span class="deprecated">Deprecated.</span> This method has been replaced by the <a href="met_win_scrollto.html">scrollTo()</a> method.</td>
  </tr>
  <tr>
    <td><a href="met_win_scrollby.html">scrollBy()</a></td>
    <td>Scrolls the document by the specified number of pixels</td>
  </tr>
  <tr>
    <td><a href="met_win_scrollto.html">scrollTo()</a></td>
    <td>Scrolls the document to the specified coordinates</td>
  </tr>
  <tr>
    <td><a href="met_win_setinterval.html">setInterval()</a></td>
    <td>Calls a function or evaluates an expression at specified intervals (in 
	milliseconds)</td>
  </tr>
  <tr>
    <td><a href="met_win_settimeout.html">setTimeout()</a></td>
    <td>Calls a function or evaluates an expression after a specified number of 
	milliseconds</td>
  </tr>
  <tr>
    <td><a href="met_win_stop.html">stop()</a></td>
...
<!-- Mirrored from www.w3schools.com/jsref/obj_window.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:10:20 GMT -->
</html>