...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_body.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:44 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">body</span> Property</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Change the background color of the current document:</p>
<div class="w3-code notranslate jsHigh">
	document.body.style.backgroundColor = &quot;yellow&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitefa2.html?filename=tryjsref_doc_body">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The body property sets or returns the document's body.</p>
<p><strong>On return</strong>, this property returns the <strong>&lt;body&gt;</strong> element of the current document.</p>
<p><strong>On set</strong>, this property overwrites all child elements inside the existing &lt;body&gt; element, and replaces it with the new, specified content.</p>
<p><strong>Tip:</strong> The difference between this property and the
<a href="prop_document_documentelement.asp">document.documentElement</a> property, is that the 
document.body element returns the &lt;body&gt; element, while the 
document.documentElement returns the &lt;html&gt; element.</p>
<hr>
...
<h2>Syntax</h2>
<p>Return the body property:</p>
<div class="w3-code w3-border notranslate"><div>
	document.body</div></div>
<p>Set the body property:</p>
<div class="w3-code w3-border notranslate"><div>
	document.body=<em>newContent</em></div></div>
...
<table class="w3-table-all notranslate">
	...
	<tr>
		<td><em>newContent</em></td>
		<td>
		Specifies the new content for &lt;body&gt;</td>
	</tr>
</table>
...
<table class="tecspec">
  <tr>
	...
	<td>A reference to the Body Object, which represents a &lt;body&gt; element, 
	or null if the element does not exist</td>
  </tr>
  <tr>
	<th>DOM Version</th>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get the HTML content of the current document:</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.body.innerHTML;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitb0e9.html?filename=tryjsref_doc_body_innerhtml">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the HTML content of the current document (will overwrite all existing 
HTML elements inside &lt;body&gt;):</p>
<div class="w3-code notranslate jsHigh">
	document.body.innerHTML = &quot;Some new HTML content&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitdab2.html?filename=tryjsref_doc_body_set">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Create a &lt;p&gt; element with some text and append it to the document's body:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.createElement(&quot;P&quot;);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Create a &lt;p&gt; 
	element<br>var t = document.createTextNode(&quot;This is a 
	paragraph.&quot;);&nbsp;&nbsp;&nbsp; // Create a text node<br>x.appendChild(t);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Append the text to &lt;p&gt;<br>document.body.appendChild(x);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Append &lt;p&gt; to &lt;body&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit0b34.html?filename=tryjsref_doc_body_append">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_body.html">HTML &lt;body&gt; tag</a></p>
<p>JavaScript reference: <a href="dom_obj_body.asp">HTML DOM Body Object</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_body.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:47 GMT -->
</html>
