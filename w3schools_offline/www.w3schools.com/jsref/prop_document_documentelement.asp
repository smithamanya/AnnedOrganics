...
<!-- Mirrored from www.w3schools.com/jsref/prop_document_documentelement.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:00 GMT -->
<head>
...
<h3>Example</h3>
	<p>Return the documentElement of the document, as a node name:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.documentElement.nodeName;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	HTML</div>
<a target="_blank" href="tryit78bc.html?filename=tryjsref_document_documentelement" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The documentElement property returns the documentElement of the document, as an Element object.</p>
<p>For HTML documents the returned object is the <strong>&lt;html&gt;</strong> element.</p>
...
<a href="prop_doc_body.asp">document.body</a> property, is that the 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">documentElement</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<tr>
	...
	<td>The document's documentElement, as an Element object</td>
</tr>
<tr>
	<th>DOM Version</th>
...
<p>JavaScript reference: <a href="dom_obj_html.asp">HTML DOM HTML Object</a></p>
<hr>
