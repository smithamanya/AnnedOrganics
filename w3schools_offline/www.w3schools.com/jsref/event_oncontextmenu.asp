...
<!-- Mirrored from www.w3schools.com/jsref/event_oncontextmenu.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:00 GMT -->
<head>
...
<h1><span class="color_h1">oncontextmenu</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the user right-clicks on a &lt;div&gt; element with a 
context menu:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;div oncontextmenu=&quot;myFunction()&quot; contextmenu=&quot;mymenu&quot;&gt;</div>
<a target="_blank" href="tryit3c17.html?filename=tryjsref_oncontextmenu" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The oncontextmenu event occurs when the user right-clicks on an element to 
open the context menu.</p>
<p><strong>Note:</strong> Although the oncontextmenu event is supported in all 
browsers, the <a href="../tags/att_global_contextmenu.asp">contextmenu</a> 
attribute is currently only supported in Firefox.</p>
<hr>
...
&lt;<i>element</i> oncontextmenu=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit34b7.html?filename=tryjsref_oncontextmenu_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.oncontextmenu=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryite456.html?filename=tryjsref_oncontextmenu_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;contextmenu&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitdf58.html?filename=tryjsref_oncontextmenu_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_oncontextmenu.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:09 GMT -->
</html>
