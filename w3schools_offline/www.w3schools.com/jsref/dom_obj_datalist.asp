...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_datalist.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:14:37 GMT -->
<head>
<title>HTML DOM Datalist Object</title>
...
<h1>HTML DOM <span class="color_h1">Datalist </span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_colgroup.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_dd.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Datalist Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Datalist Object is new in HTML5.</div></p>
<p>The Datalist object represents an HTML &lt;datalist&gt; element.</p>
<p><span class="marked"><strong>Note:</strong> The &lt;datalist&gt; element is not 
supported in Internet Explorer 9 (and earlier versions), or Safari.</span></p>
<h3>Access a Datalist Object</h3>
<p>You can access a &lt;datalist&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myDatalist");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit1782.html?filename=tryjsref_datalist_get">Try it</a>	
</div>
</div>

<h3>Create a Datalist Object</h3>
<p>You can create a &lt;datalist&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement("DATALIST");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit3c86.html?filename=tryjsref_datalist_create">Try it</a>	
</div>
</div>

<h2>Datalist Object Collections</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="coll_datalist_options.html">options</a></td>
    <td>Returns a collection of all the options in a datalist</td>
  </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Datalist object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML tutorial: <a href="../html/html_forms.html">HTML Forms</a></p>
<p>HTML reference: <a href="../tags/tag_datalist.html">HTML &lt;datalist&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_datalist.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:14:39 GMT -->
</html>