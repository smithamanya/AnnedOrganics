...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_readystate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:45 GMT -->
<head>
...
<h3>Example</h3>
<p>Get the loading status of the current document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.readyState;<br>
</div>
<p>The result of <em>x</em> could be:</p>
<div class="w3-code notranslate">
	complete</div>
<a target="_blank" href="tryit7b7f.html?filename=tryjsref_doc_readystate" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The readyState property returns the (loading) status of the current document.</p>
<p><strong>Note:</strong> This property is read-only.<br></p>
<hr>
...
document.readyState</div></div>
<h2>Technical Details</h2>
<table class="tecspec">
  <tr>
	<th style="width:20%">Return Value:</th>
	<td>A String, representing the status of the current document.<br><br>One of 
	five values:
<ul>
	<li>uninitialized - Has not started loading yet</li>
	<li>loading - Is loading</li>
	<li>loaded - Has been loaded</li>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_readystate.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:46 GMT -->
</html>
