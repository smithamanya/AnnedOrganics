...
<!-- Mirrored from www.w3schools.com/jsref/prop_loc_hash.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:03 GMT -->
<head>
...
<h3>Example</h3>
<p>Return the anchor part of a URL. Assume that the current URL is http://www.example.com/test.htm#part2:</p>
...
<p>The hash property sets or returns the anchor part of a URL, including the hash 
sign (#).</p>
<p><strong>Note:</strong> When this property is used to set the anchor part, 
...
<td>String</td>
<td>Specifies the anchor part of a URL</td>
</tr>
</table>
...
<tr>
	...
	<td>A String, representing the anchor part of the URL, including the hash sign (#)</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the anchor part:</p>
<div class="w3-code notranslate jsHigh">
	location.hash = &quot;part5&quot;;</div>
<a target="_blank" href="tryit5b71.html?filename=tryjsref_loc_hash_set" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/prop_loc_hash.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:08 GMT -->
</html>