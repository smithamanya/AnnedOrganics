...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragenter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:08 GMT -->
<head>

<title>ondragenter Event</title>
...
<h1><span class="color_h1">ondragenter</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a draggable element enters a drop target:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;div ondragenter="myFunction(event)"&gt;&lt;/div&gt;</div>
<a target="_blank" href="tryit100f.html?filename=tryjsref_ondragenter" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ondragenter event occurs when a draggable element or text selection 
enters a valid drop target.</p>
<p>The ondragenter and ondragleave events can help the user to understand that a 
...
drop target, and removing the color when the element is moved out of the target.</p>
...
<ul>
  ...
  <li><strong>Events fired on the drop target:
    ...
    <ul>
		<li>ondragenter - occurs when the dragged element enters the drop target</li>
		<li><a href="event_ondragover.asp">ondragover</a> - occurs when the dragged element is over the drop target</li>
...
&lt;<i>element</i> ondragenter=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit9ada.html?filename=tryjsref_ondragenter_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondragenter=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit5666.html?filename=tryjsref_ondragenter_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;dragenter&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitc8cd.html?filename=tryjsref_ondragenter_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragenter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:13 GMT -->
</html>
