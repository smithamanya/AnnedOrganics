...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_datetime.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:12 GMT -->
<head>
<title>HTML DOM Input Datetime Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Datetime </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_date.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_datetime-local.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Datetime Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input Datetime Object is new in HTML5.</div></p>
<p>The Input Datetime object represents an HTML &lt;input&gt; element with type=&quot;datetime&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;datetime&quot; 
are not supported in Chrome, Internet Explorer, Firefox or Opera 15 and newer. Partial support in 
Safari. Full support in Opera 12 and earlier versions.</span></p>
<h3>Access an Input Datetime Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;datetime&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myDatetime");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitbdd4.html?filename=tryjsref_datetime_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;datetime&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Datetime Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;datetime&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;datetime&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit5797.html?filename=tryjsref_datetime_create">Try it</a>	
</div>
</div>

<h2>Input Datetime Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a datetime field should automatically get focus 
	when the page loads</td>
  </tr>
  <tr>
    <td>defaultValue</td>
    <td>Sets or returns the default value of a datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_disabled.html">disabled</a></td>
    <td>Sets or returns whether a datetime field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_datetime_form.html">form</a></td>
    <td>Returns a reference to the form that contains the datetime field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute of the datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_min.html">min</a></td>
    <td>Sets or returns the value of the min attribute of the datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the datetime field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_required.html">required</a></td>
    <td>Sets or returns whether the datetime field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td>step</td>
    <td>Sets or returns the value of the step attribute of the datetime field</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_type.html">type</a></td>
    <td>Returns which type of form element the datetime field is</td>
  </tr>
  <tr>
    <td><a href="prop_datetime_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a datetime field</td>
  </tr>
</table>

<h2>Input Datetime Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
...
<p>The Input Datetime object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_datetime.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:16:21 GMT -->
</html>