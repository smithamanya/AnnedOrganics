...
<!-- Mirrored from www.w3schools.com/jsref/event_ononline.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:38 GMT -->
<head>

<title>ononline Event</title>
...
<h1><span class="color_h1">ononline</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the browser starts to work online:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;body ononline=&quot;myFunction()&quot;&gt;</div>
...
<p>The ononline event occurs when the browser starts to work online.</p>
<p><strong>Tip:</strong> The ononline event is the opposite of the 
<a href="event_onoffline.asp">onoffline</a> 
event.</p>
...
&lt;<i>element</i> ononline=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit1422.html?filename=tryjsref_ononline">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ononline=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitf191.html?filename=tryjsref_ononline_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;online&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit954e.html?filename=tryjsref_ononline_addeventlistener">Try it</a> </div></div>
