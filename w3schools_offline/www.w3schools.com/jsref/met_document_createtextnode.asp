...
<!-- Mirrored from www.w3schools.com/jsref/met_document_createtextnode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:56 GMT -->
<head>
...
<a target="_blank" href="tryitcfff.html?filename=tryjsref_document_createtextnode" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>

<p>HTML elements often consists of both an element node <em>and</em> a text node.</p>
<p>To create a header (e.g. &lt;h1&gt;), you must create both an &lt;h1&gt; element <em>and</em> a text 
node:</p>

<div class="w3-example">
<h3>Example</h3>
	<p>Create a &lt;h1&gt; element with some text:</p>
<div class="w3-code notranslate jsHigh">
	var h = document.createElement(&quot;H1&quot;)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Create a &lt;h1&gt; element<br>
	var t = document.createTextNode("Hello World");&nbsp;&nbsp;&nbsp;&nbsp; // 
	Create a text node<br>
	h.appendChild(t);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	// Append the text to &lt;h1&gt;</div>
	<p>The result will be:</p>
<div class="w3-code notranslate">
<h1 style="margin:0px;">Hello World</h1>
</div>
<a target="_blank" href="tryit85f3.html?filename=tryjsref_document_createtextnode2" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> Use the <a href="met_document_createelement.asp">
createElement()</a> method to create an Element Node with the specified name.</p>
<p><strong>Tip:</strong> After the Text Node is created, use the
...
<tr>
	...
	<td>A Text Node object with the created Text Node</td>
</tr>
</table>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_createtextnode.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:59 GMT -->
</html>
