...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_columncount.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:21:58 GMT -->
<head>

<title>HTML DOM Style columnCount Property</title>
...
<h1>Style <span class="color_h1">columnCount </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit15a7.html?filename=tryjsref_style_columncount">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The columnCount property specifies the number of columns an element should be divided into.</p>
<hr>
...
<p>The columnCount property is supported in Internet Explorer 10 and Opera.</p>
<p>Firefox supports an alternative, the MozColumnCount property.</p>
<p>Safari and Chrome support an alternative, the WebkitColumnCount property.</p>
<p><strong>Note:</strong> The columnCount property is not supported in Internet Explorer 9 and earlier versions.</p>
<hr>
<h2>Syntax</h2>
<p>Return the columnCount property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnCount </div></div>
<p>Set the columnCount property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.columnCount=&quot;<i>number</i>|auto|initial|inherit&quot;
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the column-count property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<p>CSS reference: <a href="../cssref/css3_pr_column-count.html">column-count property</a></p>
<hr>
