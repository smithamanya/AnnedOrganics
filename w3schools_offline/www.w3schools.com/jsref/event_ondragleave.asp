...
<!-- Mirrored from www.w3schools.com/jsref/event_ondragleave.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:17:13 GMT -->
<head>

<title>ondragleave Event</title>
...
<h1><span class="color_h1">ondragleave</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when a draggable element is moved out of a drop target:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;div ondragleave="myFunction(event)"&gt;&lt;/div&gt;</div>
...
<p>The ondragleave event occurs when a draggable element or text selection 
leaves a valid drop target.</p>
...
<ul>
  ...
  <li><strong>Events fired on the drop target:
    ...
    <ul>
		...
		<li>ondragleave - occurs when the dragged element leaves the drop target</li>
...
&lt;<i>element</i> ondragleave=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit9ada.html?filename=tryjsref_ondragenter_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.ondragleave=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryit5666.html?filename=tryjsref_ondragenter_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;dragleave&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryitc8cd.html?filename=tryjsref_ondragenter_addeventlistener">Try it</a> </div></div>
