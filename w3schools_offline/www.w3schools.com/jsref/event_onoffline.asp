...
<!-- Mirrored from www.w3schools.com/jsref/event_onoffline.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:35 GMT -->
<head>

<title>onoffline Event</title>
...
<h1><span class="color_h1">onoffline</span> Event</h1>
<p><a href="dom_obj_event.asp"><img class="navup" src="../images/up.gif" alt="Event Object Reference" /> Event Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute a JavaScript when the browser starts to work offline:</p>
<div class="w3-code notranslate htmlHigh">
	&lt;body onoffline=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit1422.html?filename=tryjsref_ononline" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onoffline event occurs when the browser starts to work offline.</p>
<p><strong>Tip:</strong> The onoffline event is the opposite of the 
<a href="event_ononline.asp">ononline</a> 
event.</p>
<p><strong>Tip:</strong> You can also use the <a href="prop_nav_online.html">navigator.onLine</a> property to find 
out whether the browser is in online or offline mode.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully 
supports the event.</p>
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td><span class="deprecated">Deprecated as of IE11</span><br>8.0</td>
    <td>3.0</td>
    <td><span class="deprecated">Not supported</span></td>
    <td><span class="deprecated">Not supported</span></td>
  </tr>
...
&lt;<i>element</i> onoffline=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit1422.html?filename=tryjsref_ononline">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onoffline=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitf191.html?filename=tryjsref_ononline_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;offline&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit954e.html?filename=tryjsref_ononline_addeventlistener">Try it</a> </div></div>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onoffline.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:14:38 GMT -->
</html>
