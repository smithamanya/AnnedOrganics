...
<!-- Mirrored from www.w3schools.com/jsref/event_onselect.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:30 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit07c7.html?filename=tryjsref_onselect">Try it yourself &raquo;</a>
</div>
...
<p>The onselect event is mostly used on &lt;input type=&quot;text&quot;&gt; or &lt;textarea&gt; 
elements.</p>
<hr>
...
&lt;<i>element</i> onselect=&quot;<i>myScript</i>&quot;&gt;<a target="_blank" class="w3-btn btnsmall" href="tryit4164.html?filename=tryjsref_onselect_html">Try it</a></div></div>
<p>In JavaScript:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.onselect=function(){<i>myScript</i>};<a target="_blank" class="w3-btn btnsmall" href="tryitbce3.html?filename=tryjsref_onselect_dom">Try it</a></div></div>
<p>In JavaScript, using the addEventListener() method:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.addEventListener(&quot;select&quot;, <em>myScript</em>);<a target="_blank" class="w3-btn btnsmall" href="tryit7018.html?filename=tryjsref_onselect_addeventlistener">Try it</a> </div></div>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>&lt;input type=&quot;file&quot;&gt;, &lt;input type=&quot;password&quot;&gt;, &lt;input type=&quot;text&quot;&gt;, 
	&lt;keygen&gt;, and &lt;textarea&gt;</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using the select() method of the HTML DOM Input Text Object to select some content of a text field. When this 
happens, the onselect event fires, which will trigger an alert function.</p>
<div class="w3-code notranslate jsHigh">
	// Select the contents of a text field<br>function mySelectFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;myText&quot;).select();<br>}<br><br>// Alert some text 
	when the text in the text field has been selected<br>function 
	myAlertFunction() {<br>&nbsp;&nbsp;&nbsp; alert(&quot;You selected some text!&quot;);<br>
	}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1883.html?filename=tryjsref_onselect2">Try it yourself &raquo;</a>
</div>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/event_onselect.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:16:34 GMT -->
</html>