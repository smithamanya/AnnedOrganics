...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_number.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:10 GMT -->
<head>
<title>HTML DOM Input Number Object</title>
...
<h1>HTML DOM <span class="color_h1">Input Number </span>Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_month.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_password.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Input Number Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Input Number Object is new in HTML5.</div></p>
<p>The Input Number object represents an HTML &lt;input&gt; element with 
type=&quot;number&quot;.</p>
<p><span class="marked"><strong>Note:</strong> &lt;input&gt; elements with type=&quot;number&quot; are not supported in 
Internet Explorer 9 and earlier versions.</span></p>
<h3>Access an Input Number Object</h3>
<p>You can access an &lt;input&gt; element with type=&quot;number&quot; by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myNumber");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit0cf2.html?filename=tryjsref_number_get">Try it</a>	
</div>
</div>
<p><strong>Tip:</strong> You can also access &lt;input type=&quot;number&quot;&gt; by searching through the <a href="coll_form_elements.html">elements</a> collection of a form.</p>

<h3>Create an Input Number Object</h3>
<p>You can create an &lt;input&gt; element with type=&quot;number&quot; by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.createElement(&quot;INPUT&quot;);<br>x.setAttribute(&quot;type&quot;, &quot;number&quot;);
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitefb3.html?filename=tryjsref_number_create">Try it</a>	
</div>
</div>

<h2>Input Number Object Properties</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>autocomplete</td>
    <td>Sets or returns the value of the autocomplete attribute of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_autofocus.html">autofocus</a></td>
    <td>Sets or returns whether a number field should automatically get focus when the page loads</td>
  </tr>
  <tr>
    <td><a href="prop_number_defaultvalue.html">defaultValue</a></td>
    <td>Sets or returns the default value of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_disabled.html">disabled</a></td>
    <td>Sets or returns whether a number field is disabled, or not</td>
    </tr>
  <tr>
    <td><a href="prop_number_form.html">form</a></td>
    <td>Returns a reference to the form that contains the number field</td>
  </tr>
  <tr>
    <td>list</td>
    <td>Returns a reference to the datalist that contains the number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_min.html">min</a></td>
    <td>Sets or returns the value of the min attribute of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_name.html">name</a></td>
    <td>Sets or returns the value of the name attribute of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_placeholder.html">placeholder</a></td>
    <td>Sets or returns the value of the placeholder attribute of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_readonly.html">readOnly</a></td>
    <td>Sets or returns whether the number field is read-only, or not</td>
  </tr>
  <tr>
    <td><a href="prop_number_required.html">required</a></td>
    <td>Sets or returns whether the number field must be filled out before submitting a form</td>
  </tr>
  <tr>
    <td><a href="prop_number_step.html">step</a></td>
    <td>Sets or returns the value of the step attribute of a number field</td>
  </tr>
  <tr>
    <td><a href="prop_number_type.html">type</a></td>
    <td>Returns which type of form element the number field is</td>
  </tr>
  <tr>
    <td><a href="prop_number_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a number field</td>
  </tr>
</table>

<h2>Input Number Object Methods</h2>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="met_number_stepdown.html">stepDown()</a></td>
    <td>Decrements the value of the input number by a specified number</td>
    </tr>
  <tr>
    <td><a href="met_number_stepup.html">stepUp()</a></td>
    <td>Increments the value of the input number by a specified number</td>
    </tr>
</table>

<h2>Standard Properties and Events</h2>
<p>The Input Number object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_number.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:17:21 GMT -->
</html>