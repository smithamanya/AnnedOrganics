...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_forms.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:04 GMT -->
<head>
...
<h3>Example</h3>
<p>Find out how many &lt;form&gt; elements there are in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.forms.length;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	1</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit8d14.html?filename=tryjsref_doc_forms">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The forms collection returns a collection of all &lt;form&gt; elements in the 
document.</p>
<p><b>Note:</b> The elements in the collection are sorted as they appear in the 
source code.</p>
<p><strong>Tip:</strong> Use the <a href="coll_form_elements.html">elements</a> 
collection of the <a href="dom_obj_form.asp">Form Object</a> to return a collection of all elements in a form.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;form&gt; elements in the collection.<br><br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;form&gt; element from the collection with the specified index 
  ...
  <tr>
    ...
    <td>Returns the &lt;form&gt; element from the collection with the specified id.<br><br>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>An HTMLCollection Object, representing all &lt;form&gt; elements in the 
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
	<p>Get the id of the first &lt;form&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.forms[0].id;</div>
			<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">

	myCarForm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitc1e3.html?filename=tryjsref_doc_forms3">Try it yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
	<p>Get the id of the first &lt;form&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.forms.item(0).id;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	myCarForm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitfa44.html?filename=tryjsref_doc_forms4">Try it yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
	<p>Get the HTML content of the &lt;form&gt; element with id=&quot;myForm&quot; in the 
	document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.forms.namedItem(&quot;myCarForm&quot;).innerHTML;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
Favorite Car: <input type="text" value="Volvo" size="20" readonly></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitcb2d.html?filename=tryjsref_doc_forms5">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all &lt;form&gt; elements in the document, and output the id of each 
form:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.forms;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; 
	i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x[i].id + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">

	myCarForm<br>myColorForm</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd270.html?filename=tryjsref_doc_forms2">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Using the <strong>elements</strong> collection together with document.forms 
to get
<span style="color: rgb(0, 0, 0); font-family: verdana, helvetica, arial, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; display: inline !important; float: none; background-color: rgb(241, 241, 241);">
the value of each element in the form:</span></p>
<div class="w3-code notranslate jsHigh">
	var x = document.forms[0];<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; 
	x.length; i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x.elements[i].value + 
	&quot;&lt;br&gt;&quot;;<br>}</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	Donald<br>Duck<br>Duckburg<br>Submit</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit1fa6.html?filename=tryjsref_doc_forms6">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript reference: <a href="dom_obj_form.asp">HTML DOM Form Object</a></p>
<p>JavaScript reference: <a href="coll_form_elements.html">Form elements Collection</a></p>
<p>HTML tutorial: <a href="../html/html_forms.html">HTML Forms</a></p>
<p>HTML reference: <a href="../tags/tag_form.html">HTML &lt;form&gt; tag</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_forms.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:08 GMT -->
</html>