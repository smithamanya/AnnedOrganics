...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_scripts.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:48 GMT -->
<head>

<title>HTML DOM scripts Collection</title>
...
<h1>HTML DOM <span class="color_h1">scripts</span> Collection</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
<p>Find out how many &lt;script&gt; elements there are in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.scripts.length;</div>
				<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	2</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd6c8.html?filename=tryjsref_doc_scripts">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The scripts collection returns a collection of all &lt;script&gt; elements in the document.</p>
<p><b>Note:</b> The elements in the collection are sorted as they appear in the 
source code.</p>
<p><strong>Tip:</strong> Also look at the <a href="dom_obj_script.asp">Script 
Object</a>.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the collection.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>length</td>
    <td>Returns the number of &lt;script&gt; elements in the collection.<br><br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>[<i>index</i>]</td>
    <td>Returns the &lt;script&gt; element from the collection with the specified index 
  ...
  <tr>
    ...
    <td>Returns the &lt;script&gt; element from the collection with the specified id.<br><br>
...
<table class="tecspec">
  ...
  <tr>
	...
	<td>An HTMLCollection Object, representing all &lt;script&gt; elements in the 
...
<h3>Example</h3>
<p>[<em>index</em>]</p>
	<p>Get the contents of the first &lt;script&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.scripts[0].text;</div>
			<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">

	document.write(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit6518.html?filename=tryjsref_doc_scripts2">Try it yourself &raquo;</a>
</div>
<br>
...
<p>item(<em>index</em>)</p>
	<p>Get the contents of the first &lt;script&gt; element (index 0) in the document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.scripts.item(0).text;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	document.write(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit09c4.html?filename=tryjsref_doc_scripts3">Try it yourself &raquo;</a>
</div>
<br>
...
<p>namedItem(<em>id</em>)</p>
	<p>Get the contents of the &lt;script&gt; element with id=&quot;myScript&quot; in the 
	document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.scripts.namedItem(&quot;myScript&quot;).text;</div>
		<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	function myFunction() { var x = document.scripts.namedItem(&quot;myScript&quot;).text;
	document.getElementById(&quot;demo&quot;).innerHTML = x; }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitf25b.html?filename=tryjsref_doc_scripts4">Try it yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through all &lt;script&gt; elements in the document, and output the id of each 
script:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.scripts;<br>var txt = &quot;&quot;;<br>var i;<br>for (i = 0; i &lt; x.length; 
	i++) {<br>&nbsp;&nbsp;&nbsp; txt = txt + x[i].id + &quot;&lt;br&gt;&quot;;<br>}</div>
<p>The result of <em>txt</em> will be:</p>
<div class="w3-code notranslate">

	myFirstScript<br>mySecondScript</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit61e4.html?filename=tryjsref_doc_scripts5">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>JavaScript reference: <a href="dom_obj_script.asp">HTML DOM Script Object</a></p>
<p>HTML tutorial: <a href="../html/html_scripts.html">HTML Scripts</a></p>
<p>HTML reference: <a href="../tags/tag_script.html">HTML &lt;script&gt; tag</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/coll_doc_scripts.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:52 GMT -->
</html>