...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_referrer.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:46 GMT -->
<head>
...
<h3>Example</h3>
	<p>Return the referrer of the current document:</p>
<div class="w3-code notranslate jsHigh">
	var x = document.referrer;</div>
<p>The result of <em>x</em> will be:</p>
<div class="w3-code notranslate">
	<script>document.write(document.referrer);</script>
</div>
<a target="_blank" href="tryitea8f.html?filename=tryjsref_doc_referrer" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<hr>
...
<tr>
	...
	<td>A String, representing the URL of the document that loaded the 
	current document. Returns the entire URL, including the protocol (like 
	http://). If the current document was not opened through a link (for 
...
<!-- Mirrored from www.w3schools.com/jsref/prop_doc_referrer.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:47 GMT -->
</html>