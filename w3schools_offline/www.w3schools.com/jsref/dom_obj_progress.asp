...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_progress.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:16 GMT -->
<head>
<title>HTML DOM Progress Object</title>
...
<h1>HTML DOM <span class="color_h1">Progress</span> Object</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_pre.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_quote.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Progress Object</h2>
<p><div class="html5badge" style="background-position:left;padding-left:20px;height:18px;">The 
	Progress Object is new in HTML5.</div></p>
<p>The Progress object represents an HTML &lt;progress&gt; element.</p>
<p>The &lt;progress&gt; element represents the progress of a task.</p>
<h3>Access a Progress Object</h3>
<p>You can access a &lt;progress&gt; element by using getElementById():</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementById("myProgress");</span>
<a target="_blank" class="w3-btn btnsmall" href="tryit19d4.html?filename=tryjsref_progress_get">Try it</a>	
</div>
</div>

<h3>Create a Progress Object</h3>
<p>You can create a &lt;progress&gt; element by using the document.createElement() method:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
		var x = document.createElement("PROGRESS");
</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitb413.html?filename=tryjsref_progress_create">Try it</a>	
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>labels</td>
    <td>Returns a list of the progress bar's labels (if any)</td>
  </tr>
  <tr>
    <td><a href="prop_progress_max.html">max</a></td>
    <td>Sets or returns the value of the max attribute of a progress bar</td>
  </tr>
  <tr>
    <td><a href="prop_progress_position.html">position</a></td>
    <td>Returns the current position of the progress bar</td>
  </tr>
  <tr>
    <td><a href="prop_progress_value.html">value</a></td>
    <td>Sets or returns the value of the value attribute of a progress bar</td>
  </tr>
</table>
<h2>Standard Properties and Events</h2>
<p>The Progress object also supports the standard <a href="dom_obj_all.asp">properties</a> and <a href="dom_obj_event.asp">events</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>HTML reference: <a href="../tags/tag_progress.html">HTML &lt;progress&gt; tag</a></p>
...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_progress.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:20:19 GMT -->
</html>