...
<!-- Mirrored from www.w3schools.com/jsref/dom_obj_body.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:13:38 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="dom_obj_blockquote.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="dom_obj_br.asp">Next Reference &raquo;</a></div>
</div>
<hr>

<h2>Body Object</h2>
<p>The Body object represents an HTML &lt;body&gt; element.</p>
<h3>Access a Body Object</h3>
<p>You can access a &lt;body&gt; element by using getElementsByTagName():</p>

<div class="w3-example">
<div class="w3-code notranslate" style="overflow:auto;">
	<span class="jsHigh">
	var x = document.getElementsByTagName("BODY")[0];</span>
<a target="_blank" class="w3-btn btnsmall" href="tryitc9c7.html?filename=tryjsref_body_get">Try it</a>	
</div>
</div>

<p><strong>Tip:</strong> You can also access a &lt;body&gt; element by using the 
<a href="prop_doc_body.asp">document.body</a> property.</p>

<h3>Create a Body Object</h3>
<p>You can create a &lt;body&gt; element by using the document.createElement() method:</p>

<div class="w3-example">
<div class="w3-code notranslate">
	<span class="jsHigh">
	var x = document.createElement("BODY");</span>
</div>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>aLink</td>
    <td><span class="deprecated">Not supported in HTML5. See 
	<a href="../cssref/sel_active.html">CSS :active Selector</a> instead.</span>
	<br>Sets or returns the color of an active link in a document</td>
  </tr>
  <tr>
    <td>background</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_backgroundimage.asp">style.backgroundImage</a> instead.</span><br>
    Sets or returns the background image for a document</td>
  </tr>
  <tr>
    <td>bgColor</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_backgroundcolor.asp">style.backgroundColor</a> instead.</span><br>
    Sets or returns the background color of a document</td>
  </tr>
  <tr>
    <td>link</td>
    <td><span class="deprecated">Not supported in HTML5. See <a href="../cssref/sel_link.html">CSS :link 
	Selector</a> instead.</span> <br>Sets or returns the color of unvisited links in a document</td>
  </tr>
  <tr>
    <td>text</td>
    <td><span class="deprecated">Not supported in HTML5. Use <a href="prop_style_color.asp">style.color</a> instead.</span><br>
    Sets or returns the color of the text in a document</td>
  </tr>
  <tr>
    <td>vLink</td>
    <td><span class="deprecated">Not supported in HTML5. See <a href="../cssref/sel_visited.html">CSS :visited 
	Selector</a> instead.</span>
	<br>Sets or returns the color of visited links in a document</td>
  </tr>
</table>
