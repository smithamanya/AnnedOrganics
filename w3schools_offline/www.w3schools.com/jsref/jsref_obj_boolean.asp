...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_boolean.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:08:52 GMT -->
<head>
...
<h1>JavaScript <span class="color_h1">Boolean Reference</span></h1>
<div class="chapter">
...
<p>JavaScript booleans can have one of two values: <strong>true</strong> or
<strong>false</strong>.</p>
<hr>
<h2>The Boolean() Function</h2>
<p>You can use the Boolean() function to find out if an expression is 
true:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit44cf.html?filename=tryjsref_boolean_expression1" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Or even easier:</p>
...
<div class="w3-code notranslate jsHigh">
(10 &gt; 9) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
also returns true<br>
10 &gt; 9&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
	also returns true
</div>
<a class="w3-btn w3-margin-bottom" href="tryit8622.html?filename=tryjsref_boolean_expression2" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>For a tutorial about booleans, read our
<a href="../js/js_booleans.html">JavaScript Boolean Tutorial</a>.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_constructor_boolean.html">constructor</a></td>
    <td>Returns the function that created JavaScript's Boolean prototype</td>
  </tr>
  <tr>
    <td><a href="jsref_prototype_boolean.html">prototype</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="jsref_tostring_boolean.html">toString()</a></td>
    <td>Converts a boolean value to a string, and returns the result</td>
    </tr>
  <tr>
    <td><a href="jsref_valueof_boolean.html">valueOf()</a></td>
...
<!-- Mirrored from www.w3schools.com/jsref/jsref_obj_boolean.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:08:58 GMT -->
</html>