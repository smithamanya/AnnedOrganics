...
<!-- Mirrored from www.w3schools.com/jsref/prop_style_transform.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 12:25:58 GMT -->
<head>

<title>HTML DOM Style transform Property</title>
...
<h1>Style <span class="color_h1">transform </span> Property</h1>
...
</div><a target="_blank" class="w3-btn w3-margin-bottom" href="tryitff1e.html?filename=tryjsref_style_transform">Try it yourself &raquo;</a>
</div>
<hr>
...
<p>Internet Explorer 9 supports an alternative, the msTransform property (2D transforms only).</p>
<p>Opera, Chrome and Safari support an alternative, the WebkitTransform property (3D 
and 2D transforms).</p>
<hr>

<h2>Syntax</h2>
<p>Return the transform property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transform </div></div>
<p>Set the transform property:</p>
<div class="w3-code w3-border notranslate"><div>
	<em>object</em>.style.transform=&quot;none|<i>transform-functions</i>|initial|inherit&quot;
</div></div>
...
<tr>
	<th>Return Value:</th>
	<td>A String, representing the transform property of an element</td>
</tr>
<tr>
	<th>CSS Version</th>
	<td>CSS3</td>
...
<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="../cssref/css3_pr_transform.html">transform property</a></p>
<hr>
