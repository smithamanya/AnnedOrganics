...
<!-- Mirrored from www.w3schools.com/jsref/met_document_getelementsbyclassname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:09 GMT -->
<head>
...
<h1>HTML DOM <span class="color_h1">getElementsByClassName()</span> Method</h1>
<p><a href="dom_obj_document.html"><img class="navup" src="../images/up.gif" alt="Document Object Reference" /> Document Object</a></p>

<div class="w3-example">
<h3>Example</h3>
	<p>Get all elements with the specified 
	class name:</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByClassName(&quot;example&quot;);<br>
</div>
<a target="_blank" href="tryit9083.html?filename=tryjsref_document_getelementsbyclassname" class="w3-btn w3-margin-bottom">Try it yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The getElementsByClassName() method returns a collection of all elements in the document with the specified 
class name, as a NodeList object.</p>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:25%;font-size:16px;text-align:left;">Method</th>
...
document.getElementsByClassName(<em>classname</em>)</div></div>
...
<td>String</td>
<td>Required. The class name of the elements you want to get. <br><br>To search for 
multiple class names, separate them with spaces, like &quot;test demo&quot;.</td>
</tr>
</table>
...
<tr>
	...
	<td>A NodeList object, representing a collection of elements with the specified class name. The elements in the 
returned collection are sorted as they appear in the source code.</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Get all elements with both the &quot;example&quot; and &quot;color&quot; classes:</p>
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByClassName(&quot;example color&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit95b9.html?filename=tryjsref_document_getelementsbyclassname2">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
	var x =
	document.getElementsByClassName(&quot;example&quot;).length;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit9091.html?filename=tryjsref_document_getelementsbyclassname_length">Try it yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate jsHigh">
	var x = document.getElementsByClassName(&quot;example&quot;);<br>var i;<br>for (i = 0; 
	i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].style.backgroundColor = 
	&quot;red&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit9fae.html?filename=tryjsref_document_getelementsbyclassname_loop">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="../css/css_syntax.html">CSS Selectors</a></p>
<p>CSS Reference: <a href="../cssref/sel_class.html">CSS <em>.class</em> Selector</a></p>
<p>HTML DOM Reference: <a href="met_element_getelementsbyclassname.html"><em>element</em>.getElementsByClassName()</a></p>
<p>HTML DOM Reference: <a href="prop_html_classname.html">className Property</a></p>
<p>HTML DOM Reference: <a href="prop_element_classlist.html">HTML DOM classList Property</a></p>
<p>HTML DOM Reference: <a href="dom_obj_style.asp">HTML DOM Style Object</a></p>
<hr>
...
<!-- Mirrored from www.w3schools.com/jsref/met_document_getelementsbyclassname.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:43:12 GMT -->
</html>
