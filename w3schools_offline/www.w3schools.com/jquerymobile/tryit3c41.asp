...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icon_disc2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:12 GMT -->
<head>
...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content">
    <p>Different icons with a gray circle around them (default):</p> 
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-home ui-btn-icon-notext ui-corner-all ui-shadow">Home</a>
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-grid ui-btn-icon-notext ui-corner-all ui-shadow">Options</a>
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-notext ui-corner-all ui-shadow">Search</a>

    <p>Different icons without the gray background circle:</p>
    <!-- Container div -->
