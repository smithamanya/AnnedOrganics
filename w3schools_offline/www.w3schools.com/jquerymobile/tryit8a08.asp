...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_carat-r by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the "Carat Pointing Right Icon" in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-carat-r ui-btn-icon-left">Carat-r Anchor</a>
    <button class="ui-btn ui-icon-carat-r ui-btn-icon-left">Carat-r Button</button>
    <input type="button" data-icon="carat-r" value="Carat-r Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-carat-r ui-btn-icon-notext">Carat-r Icon</a>
  </div>
</div>
