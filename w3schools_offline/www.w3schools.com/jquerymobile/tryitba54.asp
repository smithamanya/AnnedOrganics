...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_trans_slidedown2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:11 GMT -->
<head>
...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content">
    ...
    <a href="#pagetwo" data-transition="slidedown">Slide down to Dialog Page</a>
  </div>
...
<div data-role="page" data-dialog="true" id="pagetwo">
  ...
  <div data-role="main" class="ui-content">
    ...
    <p><b>Tip:</b> You can also close the dialog box by clicking the X button in header. This will automatically transition back to the page you came from, with the same transition effect (reversed slidedown = slide up) used to open this dialog.</p>
  </div>
