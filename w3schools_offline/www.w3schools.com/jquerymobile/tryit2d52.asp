...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_location by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Location Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-location ui-btn-icon-left">Location Anchor</a>
    <button class="ui-btn ui-icon-location ui-btn-icon-left">Location Button</button>
    <input type="button" data-icon="location" value="Location Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-location ui-btn-icon-notext">Location Icon</a>
  </div>
</div>
