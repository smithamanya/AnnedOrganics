...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_navigation by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Navigation Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-navigation ui-btn-icon-left">Navigation Anchor</a>
    <button class="ui-btn ui-icon-navigation ui-btn-icon-left">Navigation Button</button>
    <input type="button" data-icon="navigation" value="Navigation Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-navigation ui-btn-icon-notext">Navigation Icon</a>
  </div>
</div>
