...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_refresh by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:24 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Refresh Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-refresh ui-btn-icon-left">Refresh Anchor</a>
    <button class="ui-btn ui-icon-refresh ui-btn-icon-left">Refresh Button</button>
    <input type="button" data-icon="refresh" value="Refresh Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-refresh ui-btn-icon-notext">Refresh Icon</a>
  </div>
</div>
