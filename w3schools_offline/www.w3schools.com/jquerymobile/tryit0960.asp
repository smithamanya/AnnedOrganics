...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_carat-l by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the "Carat Pointing Left Icon" in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-carat-l ui-btn-icon-left">Carat-l Anchor</a>
    <button class="ui-btn ui-icon-carat-l ui-btn-icon-left">Carat-l Button</button>
    <input type="button" data-icon="carat-l" value="Carat-l Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-carat-l ui-btn-icon-notext">Carat-l Icon</a>
  </div>
</div>
