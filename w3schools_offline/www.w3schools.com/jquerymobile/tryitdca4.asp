...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_phone by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Phone Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-phone ui-btn-icon-left">Phone Anchor</a>
    <button class="ui-btn ui-icon-phone ui-btn-icon-left">Phone Button</button>
    <input type="button" data-icon="phone" value="Phone Input Button">
    <p>Only the icon:</p>
