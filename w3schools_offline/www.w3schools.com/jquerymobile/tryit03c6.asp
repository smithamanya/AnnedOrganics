...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_heart by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Heart Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-heart ui-btn-icon-left">Heart Anchor</a>
    <button class="ui-btn ui-icon-heart ui-btn-icon-left">Heart Button</button>
    <input type="button" data-icon="heart" value="Heart Input Button">
    <p>Only the icon:</p>
