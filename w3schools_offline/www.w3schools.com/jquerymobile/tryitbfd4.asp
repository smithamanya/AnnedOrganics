...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_edit by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Edit Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-edit ui-btn-icon-left">Edit Anchor</a>
    <button class="ui-btn ui-icon-edit ui-btn-icon-left">Edit Button</button>
    <input type="button" data-icon="edit" value="Edit Input Button">
    <p>Only the icon:</p>
