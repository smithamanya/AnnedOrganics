...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_user by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:24 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the User Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-user ui-btn-icon-left">User Anchor</a>
    <button class="ui-btn ui-icon-user ui-btn-icon-left">User Button</button>
    <input type="button" data-icon="user" value="User Input Button">
    <p>Only the icon:</p>
