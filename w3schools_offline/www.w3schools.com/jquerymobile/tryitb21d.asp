...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_delete by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Delete Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-delete ui-btn-icon-left">Delete Anchor</a>
    <button class="ui-btn ui-icon-delete ui-btn-icon-left">Delete Button</button>
    <input type="button" data-icon="delete" value="Delete Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-delete ui-btn-icon-notext">Delete Icon</a>
  </div>
</div>
