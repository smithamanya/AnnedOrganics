...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_forms_select_iconpos by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:16 GMT -->
<head>
...
<div data-role="page">
  ...
  <div data-role="main" class="ui-content">
    <form method="post" action="http://www.w3schools.com/jquerymobile/demoform.asp">
        <fieldset data-role="controlgroup">
          <legend>In this example, we have changed the icon position to the left side of the select menu (default is right).</legend>
