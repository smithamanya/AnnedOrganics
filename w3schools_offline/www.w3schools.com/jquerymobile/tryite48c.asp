...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_alert by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:21 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Alert Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-alert ui-btn-icon-left">Alert Anchor</a>
    <button class="ui-btn ui-icon-alert ui-btn-icon-left">Alert Button</button>
    <input type="button" data-icon="alert" value="Alert Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-alert ui-btn-icon-notext">Alert Icon</a>
  </div>
</div>
