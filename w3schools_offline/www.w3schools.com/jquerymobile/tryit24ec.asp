...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_header_footer_icons by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:13 GMT -->
<head>
...
<div data-role="page">
  <div data-role="header">
    <a href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-home ui-btn-icon-notext">Home</a>
    <h1>Welcome To My Homepage</h1>
    <a href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-search ui-btn-icon-notext">Search</a>
  </div>
  ...
  <div data-role="footer" style="text-align:center;">
    <div data-role="controlgroup" data-type="horizontal">
      <a href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-comment ui-btn-icon-notext">Comment page</a>
      <a href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-delete ui-btn-icon-notext">Delete page</a>
      <a href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-phone ui-btn-icon-notext">Call me</a>
    </div>
  </div>
</div>
