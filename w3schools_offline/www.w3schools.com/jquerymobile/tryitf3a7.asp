...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_star by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:24 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Star Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-star ui-btn-icon-left">Star Anchor</a>
    <button class="ui-btn ui-icon-star ui-btn-icon-left">Star Button</button>
    <input type="button" data-icon="star" value="Star Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-star ui-btn-icon-notext">Star Icon</a>
  </div>
</div>
