...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_carat-u by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the "Carat Pointing Up Icon" in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-carat-u ui-btn-icon-left">Carat-u Anchor</a>
    <button class="ui-btn ui-icon-carat-u ui-btn-icon-left">Carat-u Button</button>
    <input type="button" data-icon="carat-u" value="Carat-u Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-carat-u ui-btn-icon-notext">Carat-u Icon</a>
  </div>
</div>
