...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_themes_split by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:18 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <h2>Split Buttons Example</h2>
    <ul data-role="listview" data-inset="true" data-split-theme="b">
      <li data-role="divider" data-theme="a">Browsers</li>
      <li>
        <a href="#">
        <img src="chrome.png">
        <h2>Google Chrome</h2>
...
<div data-role="page" id="download">
  ...
  <h3>Split Button Example</h3>
    ...
    <a href="#" class="ui-btn ui-btn-b ui-btn-inline ui-shadow ui-corner-all ui-mini ui-icon-check ui-btn-icon-left" data-rel="back">Download</a>
