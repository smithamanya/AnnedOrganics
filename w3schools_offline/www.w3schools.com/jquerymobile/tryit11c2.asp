...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_clock by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Clock Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-clock ui-btn-icon-left">Clock Anchor</a>
    <button class="ui-btn ui-icon-clock ui-btn-icon-left">Clock Button</button>
    <input type="button" data-icon="clock" value="Clock Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-clock ui-btn-icon-notext">Clock Icon</a>
  </div>
</div>
