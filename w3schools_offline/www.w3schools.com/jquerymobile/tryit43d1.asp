...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_comment by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Comment Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-comment ui-btn-icon-left">Comment Anchor</a>
    <button class="ui-btn ui-icon-comment ui-btn-icon-left">Comment Button</button>
    <input type="button" data-icon="comment" value="Comment Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-comment ui-btn-icon-notext">Comment Icon</a>
  </div>
</div>
