...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_forbidden by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Forbidden Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-forbidden ui-btn-icon-left">Forbidden Anchor</a>
    <button class="ui-btn ui-icon-forbidden ui-btn-icon-left">Forbidden Button</button>
    <input type="button" data-icon="forbidden" value="Forbidden Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-forbidden ui-btn-icon-notext">Forbidden Icon</a>
  </div>
</div>
