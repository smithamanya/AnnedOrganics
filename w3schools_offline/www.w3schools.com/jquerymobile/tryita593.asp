...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icon_alt2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:12 GMT -->
<head>
...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content">
    ...
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-left">White icon (default)</a>  
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-notext ui-corner-all ui-shadow">White icon (default)</a>

    <p>A black "search" icon (class="ui-alt-icon"):</p>
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-left ui-alt-icon">Black icon</a>   
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-notext ui-corner-all ui-shadow ui-alt-icon">Black icon</a>
    
    <p>A black "search" icon without the gray background circle (class="ui-nodisc-icon ui-alt-icon"):</p>
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-left ui-nodisc-icon ui-alt-icon">Black icon</a>   
    <a href="#anylink" class="ui-btn ui-btn-inline ui-icon-search ui-btn-icon-notext ui-corner-all ui-shadow ui-nodisc-icon ui-alt-icon">Black icon</a>
  </div>
