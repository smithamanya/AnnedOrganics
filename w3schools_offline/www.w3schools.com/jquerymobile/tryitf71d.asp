...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_power by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:24 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Power Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-power ui-btn-icon-left">Power Anchor</a>
    <button class="ui-btn ui-icon-power ui-btn-icon-left">Power Button</button>
    <input type="button" data-icon="power" value="Power Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-power ui-btn-icon-notext">Power Icon</a>
  </div>
</div>
