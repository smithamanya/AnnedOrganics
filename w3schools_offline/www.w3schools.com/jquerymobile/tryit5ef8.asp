...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_audio by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:21 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Audio Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-audio ui-btn-icon-left">Audio Anchor</a>
    <button class="ui-btn ui-icon-audio ui-btn-icon-left">Audio Button</button>
    <input type="button" data-icon="audio" value="Audio Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-audio ui-btn-icon-notext">Audio Icon</a>
  </div>
</div>
