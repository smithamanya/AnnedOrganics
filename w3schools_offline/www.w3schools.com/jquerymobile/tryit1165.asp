...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_mail by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    ...
    <a href="#" class="ui-btn ui-icon-mail ui-btn-icon-left">Mail Anchor</a>
    <button class="ui-btn ui-icon-mail ui-btn-icon-left">Mail Button</button>
    <input type="button" data-icon="mail" value="Mail Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-mail ui-btn-icon-notext">Mail Icon</a>
  </div>
</div>
