...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_arrow-u-r by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:21 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the "arrow pointing upwards to the right icon" in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-arrow-u-r ui-btn-icon-left">Arrow-u-r Anchor</a>
    <button class="ui-btn ui-icon-arrow-u-r ui-btn-icon-left">Arrow-u-r Button</button>
    <input type="button" data-icon="arrow-u-r" value="Arrow-u-r Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-arrow-u-r ui-btn-icon-notext">Arrow-u-r Icon</a>
  </div>
</div>
