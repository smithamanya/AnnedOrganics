...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_cloud by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Cloud Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-cloud ui-btn-icon-left">Cloud Anchor</a>
    <button class="ui-btn ui-icon-cloud ui-btn-icon-left">Cloud Button</button>
    <input type="button" data-icon="cloud" value="Cloud Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-cloud ui-btn-icon-notext">Cloud Icon</a>
  </div>
</div>
