...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_tag by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:24 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Tag Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-tag ui-btn-icon-left">Tag Anchor</a>
    <button class="ui-btn ui-icon-tag ui-btn-icon-left">Tag Button</button>
    <input type="button" data-icon="tag" value="Tag Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-tag ui-btn-icon-notext">Tag Icon</a>
  </div>
</div>
