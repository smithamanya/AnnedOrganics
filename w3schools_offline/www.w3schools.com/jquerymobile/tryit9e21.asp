...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_back by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Back Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-back ui-btn-icon-left">Back Anchor</a>
    <button class="ui-btn ui-icon-back ui-btn-icon-left">Back Button</button>
    <input type="button" data-icon="back" value="Back Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-back ui-btn-icon-notext">Back Icon</a>
  </div>
</div>
