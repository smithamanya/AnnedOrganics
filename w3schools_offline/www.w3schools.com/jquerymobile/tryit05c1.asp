...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_arrow-d-l by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:21 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the "arrow pointing downwards to the left icon" in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-arrow-d-l ui-btn-icon-left">Arrow-d-l Anchor</a>
    <button class="ui-btn ui-icon-arrow-d-l ui-btn-icon-left">Arrow-d-l Button</button>
    <input type="button" data-icon="arrow-d-l" value="Arrow-d-l Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-arrow-d-l ui-btn-icon-notext">Arrow-d-l Icon</a>
  </div>
</div>
