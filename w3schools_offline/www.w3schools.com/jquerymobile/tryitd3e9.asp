...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_arrow-d by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the "arrow pointing down icon" in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-arrow-d ui-btn-icon-left">Arrow-d Anchor</a>
    <button class="ui-btn ui-icon-arrow-d ui-btn-icon-left">Arrow-d Button</button>
    <input type="button" data-icon="arrow-d" value="Arrow-d Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-arrow-d ui-btn-icon-notext">Arrow-d Icon</a>
  </div>
</div>
