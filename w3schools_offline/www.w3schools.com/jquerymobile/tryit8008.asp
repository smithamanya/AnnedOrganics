...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_check by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:22 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Check Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-check ui-btn-icon-left">Check Anchor</a>
    <button class="ui-btn ui-icon-check ui-btn-icon-left">Check Button</button>
    <input type="button" data-icon="check" value="Check Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-check ui-btn-icon-notext">Check Icon</a>
  </div>
</div>
