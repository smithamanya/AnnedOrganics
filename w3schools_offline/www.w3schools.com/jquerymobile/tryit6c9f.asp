...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_grid by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Grid Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-grid ui-btn-icon-left">Grid Anchor</a>
    <button class="ui-btn ui-icon-grid ui-btn-icon-left">Grid Button</button>
    <input type="button" data-icon="grid" value="Grid Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-grid ui-btn-icon-notext">Grid Icon</a>
  </div>
</div>
