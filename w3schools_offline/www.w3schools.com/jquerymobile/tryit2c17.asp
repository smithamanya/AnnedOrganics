...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icons_info by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:58:23 GMT -->
<head>
...
<div data-role="page" id="pageone">
  <div data-role="main" class="ui-content">
    <p>An example of the Info Icon in different buttons.</p>
    <a href="#" class="ui-btn ui-icon-info ui-btn-icon-left">Info Anchor</a>
    <button class="ui-btn ui-icon-info ui-btn-icon-left">Info Button</button>
    <input type="button" data-icon="info" value="Info Input Button">
    <p>Only the icon:</p>
    <a href="#" class="ui-btn ui-corner-all ui-icon-info ui-btn-icon-notext">Info Icon</a>
  </div>
</div>
