...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_lists_collapsible_popup by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:14 GMT -->
<head>
...
<div data-role="page">
  ...
  <div data-role="main" class="ui-content">
    <h2>My Phonebook</h2>
    <a href="#myPopup" data-rel="popup" class="ui-btn ui-btn-inline ui-corner-all ui-icon-gear ui-btn-icon-left">Choose a name</a>

    <div data-role="popup" id="myPopup" class="ui-content">
      <h3>Choose a name</h3>
      <div data-role="collapsible-set" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" style="width:270px;">
