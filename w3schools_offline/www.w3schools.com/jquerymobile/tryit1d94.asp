...
<!-- Mirrored from www.w3schools.com/jquerymobile/tryit.asp?filename=tryjqmob_icon_notext by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:28:58 GMT -->
<head>
...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content">
    <p>A button with only the icon and no text:</p>
    <a href="#" class="ui-btn ui-icon-search ui-btn-icon-notext">Search</a>
    <p>A button with only the icon and no text - added rounded corners and some shadow:</p>
