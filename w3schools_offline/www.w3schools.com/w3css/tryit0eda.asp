...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_buttons_hover by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:52:57 GMT -->
<head>
...
<p>
<input type="button" class="w3-btn w3-red" value="Button">
<input type="button" class="w3-btn w3-red" value="Button" disabled>
</p>
