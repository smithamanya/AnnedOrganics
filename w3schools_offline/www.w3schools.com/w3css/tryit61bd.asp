...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_grid_rest&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:03 GMT -->
<head>
...
<div class="w3-row">
  <div class="w3-quarter w3-red"><p>quarter</p></div>
  <div class="w3-half">
    <div class="w3-row">
      <div class="w3-col w3-blue" style="width:75px"><p>75px</p></div>
...
<div class="w3-row">
  ...
  <div class="w3-half">
    <div class="w3-row">
      <div class="w3-col w3-right w3-blue" style="width:75px"><p>75px</p></div>
      <div class="w3-rest w3-green"><p>rest</p></div>
    </div>
  </div>
  <div class="w3-quarter w3-red"><p>quarter</p></div>
...
<div class="w3-row">
  ...
  <div class="w3-half">
    <div class="w3-row">
      <div class="w3-col w3-left w3-blue" style="width:75px"><p>75px</p></div>
      <div class="w3-col w3-right w3-blue" style="width:75px"><p>75px</p></div>
      <div class="w3-rest w3-green"><p>rest</p></div>
    </div>
  </div>
