...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_buttons_shapes by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:52:57 GMT -->
<head>
...
<p><button class="w3-btn w3-xlarge w3-round-small">Round Small</button></p>
<p><button class="w3-btn w3-xlarge w3-round">Round Normal</button></p>
<p><button class="w3-btn w3-xlarge w3-round-large">Round Large</button></p>
<p><button class="w3-btn w3-xlarge w3-round-xlarge">Round xLarge</button></p>
<p><button class="w3-btn w3-xlarge w3-round-xxlarge">Round xxLarge</button></p>
