...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_buttons_sizes by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:52:57 GMT -->
<head>
...
<p><button class="w3-btn w3-tiny w3-red">Tiny</button></p>
<p><button class="w3-btn w3-small w3-red">Small</button></p>
<p><button class="w3-btn w3-red">Normal</button></p>
<p><button class="w3-btn w3-large w3-red">Large</button></p>
<p><button class="w3-btn w3-xlarge w3-red">xLarge</button></p>
<p><button class="w3-btn w3-xxlarge w3-red">xxLarge</button></p>
<p><button class="w3-btn w3-xxxlarge w3-red">xxxLarge</button></p>
<p><button class="w3-btn w3-jumbo w3-red">I am Jumbo</button></p>
