...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_modal_image by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:03 GMT -->
<head>
...
<img src="img_car.png" style="width:30%;cursor:zoom-in"
onclick="document.getElementById('modal01').style.display='block'">

<div id="modal01" class="w3-modal" onclick="this.style.display='none'">
  <img class="w3-modal-content" src="img_car.png" style="width:100%">
</div>
