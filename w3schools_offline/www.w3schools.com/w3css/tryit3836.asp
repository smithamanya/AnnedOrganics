...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_icons_bootstrap by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:00 GMT -->
<head>
...
<button class="w3-btn w3-teal w3-xlarge">Button<i class="w3-margin-left glyphicon glyphicon-home"></i></button>
</div>

<div class="w3-section">
<i class="glyphicon glyphicon-home w3-spin w3-jumbo"></i>
</div>
