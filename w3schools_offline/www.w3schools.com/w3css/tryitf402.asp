...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_icons_google by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:53:00 GMT -->
<head>
...
<p>
<button class="w3-btn w3-teal w3-xlarge">Button<i class="w3-margin-left material-icons">cloud</i></button>
</p>

<p>
<i class="material-icons w3-spin w3-jumbo">cloud</i>
</p>

<div class="w3-padding w3-xlarge w3-teal">
<i class="material-icons w3-xlarge">home</i>
<i class="material-icons w3-xlarge">search</i>
