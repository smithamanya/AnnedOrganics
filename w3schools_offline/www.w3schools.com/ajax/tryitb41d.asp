...
<!-- Mirrored from www.w3schools.com/ajax/tryit.asp?filename=tryajax_responsexml by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:09 GMT -->
<head>
...
function loadDoc() {
  ...
  xhttp.open("GET.html", "cd_catalog.xml", true);
  xhttp.send();
}
</script>
