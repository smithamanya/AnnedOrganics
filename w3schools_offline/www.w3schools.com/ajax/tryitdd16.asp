...
<!-- Mirrored from www.w3schools.com/ajax/tryit.asp?filename=tryajax_get_unique by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:59:09 GMT -->
<head>
...
function loadDoc() {
  ...
  xhttp.open("GET.html", "demo_geta18a.asp?t=" + Math.random(), true);
  xhttp.send();
}
</script>
