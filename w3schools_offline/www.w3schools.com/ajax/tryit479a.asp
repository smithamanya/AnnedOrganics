...
<!-- Mirrored from www.w3schools.com/ajax/tryit.asp?filename=tryajax_suggest_asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:31 GMT -->
<head>
...
function showHint(str) {
  ...
  xhttp.open("GET.html", "gethint03d2.asp?q="+str, true);
  xhttp.send();
}
</script>
