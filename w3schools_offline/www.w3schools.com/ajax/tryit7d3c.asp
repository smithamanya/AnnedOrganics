...
<!-- Mirrored from www.w3schools.com/ajax/tryit.asp?filename=tryajax_suggest_php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:31 GMT -->
<head>
...
function showHint(str) {
  ...
  xhttp.open("GET.html", "gethint03d2.php?q="+str, true);
  xhttp.send();   
}
</script>
