...
<!-- Mirrored from www.w3schools.com/ajax/tryit.asp?filename=tryajax_database by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:29:31 GMT -->
<head>
...
function showCustomer(str) {
  ...
  xhttp.open("GET.html", "getcustomer03d2.asp?q="+str, true);
  xhttp.send();
}
</script>
