...
<!-- Mirrored from www.w3schools.com/googleAPI/default.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:27 GMT -->
<head>
...
<p>Google Maps allows you to display maps on your web site: </p>
<div id="googleMap" style="width:100%;height:380px;"></div>
<hr>
<h2>Google Maps API</h2>

<p>This tutorial is about the Google Maps API (<strong>A</strong>pplication
<strong>P</strong>rogramming <strong>I</strong>nterface).</p>
<p>Google Maps API lets you customize maps, and the information 
on maps.</p>
<table class="lamp"><tr>
<th style="width:34px"><img src="../images/lamp.jpg" alt="Note" style="height:32px;width:32px"></th>
<td>An API is a set of methods and tools that can be used for building software applications.</td>
</tr></table>
