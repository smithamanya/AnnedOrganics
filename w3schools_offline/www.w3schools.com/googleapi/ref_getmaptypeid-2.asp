...
<!-- Mirrored from www.w3schools.com/googleapi/ref_getmaptypeid.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:26 GMT -->
<head>
...
<h3>Example</h3>
<p>Return the current map type:</p>
<div class="w3-code notranslate jsHigh">
map.getMapTypeId();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit51cd.asp?filename=tryhtml_ref_getmaptypeid">Try it yourself &raquo;</a>
</div>
<hr>
