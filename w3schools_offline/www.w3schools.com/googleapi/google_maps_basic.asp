...
<!-- Mirrored from www.w3schools.com/googleAPI/google_maps_basic.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:27 GMT -->
<head>
...
<h2 class="left"><span class="left_h2">Google Maps</span> API</h2>
<a target="_top" href="default.asp">Maps Home</a>
...
<a target="_top" href="google_maps_ref.html">Maps Reference</a>
...
&lt;head&gt;<br>
&lt;script
src=&quot;http://maps.googleapis.com/maps/api/js&quot;&gt;&lt;/script&gt;<br>
&lt;script&gt;<br>
function initialize()
{<br>
&nbsp;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitb2c4.html?filename=tryhtml_map_first">Try it yourself &raquo;</a>
</div>
<p>The rest of this page describes the example above, step by step.</p>
<hr>

<h2>1. Load the Google API</h2>
<p>The Google Maps API is a JavaScript library. It can be added to a web page with 
a &lt;script&gt; tag:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;script src=&quot;http://maps.googleapis.com/maps/api/js&quot;&gt;&lt;/script&gt;</div></div>
<hr>

<h2>2. Set Map Properties</h2>
<p>Create a function to initialize the map:</p>
<div class="w3-example">
 <div class="w3-code notranslate htmlHigh">
  function initialize() {<br>}</div></div>
<p>In the initialize function, create an object (mapProp) to define the 
properties for the map:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
&nbsp;var mapProp = {<br>
&nbsp; center:new google.maps.LatLng(51.508742, -0.120850),<br>&nbsp; zoom: 7,<br>&nbsp; mapTypeId: google.maps.MapTypeId.ROADMAP<br>
};</div></div>
<p>The <strong>center</strong> property specifies where to center the map. Create a
<strong>LatLng</strong> object to center the map on a specific point. Pass the 
coordinates in the order: latitude, longitude.</p>
<p>The <strong>zoom</strong> property specifies the zoom level for the map. zoom: 0 shows a map of the 
Earth fully zoomed out. Higher zoom levels zoom in 
at a higher resolution.</p>
<p>The <strong>mapTypeId</strong> property specifies the map type to display. The following map types are supported:</p>
<ul>
...
<h2>3. Create a Map Container</h2>
<p>Create a &lt;div&gt; element to hold the map. Use CSS to 
size the element:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
...
<td>
The map will always &quot;inherit&quot; its size from its container element.</td>
</tr></table>
<hr>

<h2>4. Create a Map Object</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
var map=new google.maps.Map(document.getElementById(&quot;googleMap&quot;), mapProp);</div></div>
<p>The code above creates a new map inside the &lt;div&gt; element with id=&quot;googleMap&quot;, using 
the parameters that are passed (mapProp).</p>
<hr>

<h2>5. Add an Event Listener to Load the Map</h2>
<p>Add a DOM listener that will execute the initialize() function on window load 
...
<h2>Asynchronously Loading</h2>
<p>It is also possible to load the Google Maps API on demand.</p>
<p>The example below uses window.onload to load the Google Maps API after the 
page has fully loaded.</p>
<p>The loadScript() function creates the Google Maps API &lt;script&gt; tag. 
In addition, the callback=initialize parameter is added to the end of the URL to  
...
&nbsp;
script.src = &quot;http://maps.googleapis.com/maps/api/js?callback=initialize&quot;;<br>&nbsp; document.body.appendChild(script);<br>
}<br>
<br>
window.onload = loadScript;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryita049.html?filename=tryhtml_map_async">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Multiple Maps</h2>
<p>The example below defines four maps on one web page (four maps with different 
map types):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var map1 = new google.maps.Map(document.getElementById(&quot;googleMap1&quot;), mapProp1);<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryitd0d5.html?filename=tryhtml_map_many">Try it yourself &raquo;</a>
</div>
<hr>

<h2>Google API Key</h2>
<p>Google allows your web site to call any Google API, many thousand times per day.</p>
<p>If you plan for heavier traffic, you should get a free API key from Google.</p>
<p>Go to <a target="_blank" href="https://code.google.com/apis/console/">https://console.developers.google.com</a> to get a free key.</p>
<p>Google Maps expects to find the API key in the <strong>key</strong> parameter when loading an API:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;script src=&quot;http://maps.googleapis.com/maps/api/js?<strong>key=YOUR_KEY</strong>&quot;&gt;&lt;/script&gt;
</div></div>
...
<a href='default.html'>Learn Google Maps</a>
...
<a href='google_maps_ref.html'>Google Maps Reference</a>
</div>
<div class='w3-col l2 m4'>
<h3>Server Side</h3>
...
<!-- Mirrored from www.w3schools.com/googleAPI/google_maps_basic.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:24:29 GMT -->
</html>