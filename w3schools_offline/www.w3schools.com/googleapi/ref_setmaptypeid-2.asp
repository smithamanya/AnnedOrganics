...
<!-- Mirrored from www.w3schools.com/googleapi/ref_setmaptypeid.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:26 GMT -->
<head>
...
<h3>Example</h3>
<p>Change the kind of map to display:</p>
<div class="w3-code notranslate jsHigh">
map.setMapTypeId(google.maps.MapTypeId.TERRAIN);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit2741.asp?filename=tryhtml_ref_setmaptypeid">Try it yourself &raquo;</a>
</div>
<hr>
