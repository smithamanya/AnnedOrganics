...
<!-- Mirrored from www.w3schools.com/googleapi/ref_getcenter.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:56:25 GMT -->
<head>
...
<h3>Example</h3>
<p>Return the latitude/longitude of the current center of the 
map:</p>
<div class="w3-code notranslate jsHigh">
map.getCenter();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit3df7.asp?filename=tryhtml_ref_getcenter">Try it yourself &raquo;</a>
</div>
<hr>
