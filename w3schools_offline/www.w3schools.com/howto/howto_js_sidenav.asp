...
<!-- Mirrored from www.w3schools.com/howto/howto_js_sidenav.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:28 GMT -->
<head>
...
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_js_fullscreen_overlay.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="default.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn how to create a closable side navigation menu.</p>
<hr>
  ...
  <button class="w3-btn w3-padding w3-margin-bottom" onclick="openOffcanvas2()">Sidenav overlay without animation</button><br>
  <button class="w3-btn w3-padding w3-margin-bottom" onclick="openOffcanvas()">Sidenav push (off-canvas)</button><br>
...
<div class="w3-code notranslate cssHigh">
	...
	*/<br>&nbsp;&nbsp;&nbsp; z-index: 1; /* Stay on top */<br>&nbsp;&nbsp;&nbsp; 
	top: 0;<br>&nbsp;&nbsp;&nbsp; left: 0;<br>&nbsp;&nbsp;&nbsp; 
	background-color: #111; /* Black*/<br>&nbsp;&nbsp;&nbsp; 
	overflow-x: hidden; /* Disable horizontal scroll */<br>&nbsp;&nbsp;&nbsp; 
	padding-top: 60px; /* Place content 60px from the top */<br>&nbsp;&nbsp;&nbsp; 
	transition: 0.5s; /* 0.5 second transition effect to slide in the sidenav */<br>
	...
	change their color */<br>.sidenav a:hover, .offcanvas a:focus{<br>&nbsp;&nbsp;&nbsp; 
	color: #f1f1f1;<br>}<br><br>/* Position and style the close button (top 
	right corner) */<br>.closebtn {<br>&nbsp;&nbsp;&nbsp; position: 
	absolute;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; right: 25px;<br>&nbsp;&nbsp;&nbsp; 
	font-size: 36px !important;<br>&nbsp;&nbsp;&nbsp; margin-left: 50px;<br>}<br>
...
<div class="w3-code notranslate jsHigh">
	...
	= &quot;250px&quot;;<br>}<br><br>/* 
	Set the width of the side navigation to 0 */<br>function closeNav() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;mySidenav&quot;).style.width = &quot;0&quot;;<br>}</div>
<a target="_blank" href="tryitcb3c.html?filename=tryhow_js_sidenav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryiteadd.html?filename=tryhow_js_sidenav_push" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
	...
	= &quot;250px&quot;;<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;main&quot;).style.marginLeft 
	= &quot;250px&quot;;<br>&nbsp;&nbsp;&nbsp; 
	document.body.style.backgroundColor = &quot;rgba(0,0,0,0.4)&quot;;<br>}<br><br>/* Set the width of the side navigation to 0 and the 
	left margin of the page content to 0, and the background color of body to 
	white */<br>function closeNav() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;mySidenav&quot;).style.width = &quot;0&quot;;<br>&nbsp;&nbsp;&nbsp; 
	document.getElementById(&quot;main&quot;).style.marginLeft = &quot;0&quot;;<br>&nbsp;&nbsp;&nbsp; 
	document.body.style.backgroundColor = &quot;white&quot;;<br>}</div>
<a target="_blank" href="tryit334d.html?filename=tryhow_js_sidenav_push_opacity" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit8a43.html?filename=tryhow_js_sidenav_none" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/howto/howto_js_sidenav.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:31 GMT -->
</html>
