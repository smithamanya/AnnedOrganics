...
<!-- Mirrored from www.w3schools.com/howto/howto_css_pagination.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:25 GMT -->
<head>

<title>How To Make a Pagination</title>
...
<h1>How TO - CSS Pagination</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_css_contact_chips.asp">« Previous</a></div>
<div class="next"><a class="chapter" href="howto_js_topnav.asp">Next Chapter »</a></div>
</div>
<hr>
<p class="intro">Learn how to create a pagination with CSS.</p>
<hr>
...
<div class="w3-code notranslate htmlHigh">
	&lt;ul class="pagination"&gt;<br>&nbsp; &lt;li&gt;&lt;a href="#"&gt;&amp;laquo;&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
	&lt;li&gt;&lt;a href="#"&gt;1&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a class="active" href="#"&gt;2&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
	&lt;li&gt;&lt;a href="#"&gt;3&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href="#"&gt;4&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
	&lt;li&gt;&lt;a href="#"&gt;5&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href="#"&gt;6&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href="#"&gt;&amp;raquo;&lt;/a&gt;&lt;/li&gt;<br>
	&lt;/ul&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
	.ul.pagination {<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
	padding: 0;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>}<br><br>ul.pagination li 
	{display: inline;}<br><br>ul.pagination li a {<br>&nbsp;&nbsp;&nbsp; color: 
	black;<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; padding: 8px 
	16px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp; 
	transition: background-color .3s;<br>}<br><br>ul.pagination li a.active {<br>&nbsp;&nbsp;&nbsp; 
	background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>
	ul.pagination li a:hover:not(.active) {background-color: #ddd;}</div>
<a target="_blank" href="tryit6685.html?filename=tryhow_css_pagination" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>

<p>Go to our <a href="../css/css3_pagination.html">CSS Pagination Tutorial</a> to learn more about pagination.</p>
<br>
...
<!-- Mirrored from www.w3schools.com/howto/howto_css_pagination.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:26 GMT -->
</html>
