...
<!-- Mirrored from www.w3schools.com/howto/howto_css_loader.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:16 GMT -->
<head>

<title>How To Make a Loader</title>
...
<h1>How TO - CSS Loader</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_css_image_effects.asp">« Previous</a></div>
<div class="next"><a class="chapter" href="howto_css_menu_icon.asp">Next Chapter »</a></div>
</div>
<hr>
<p class="intro">Learn how to create a preloader with CSS.</p>
<hr>
...
<div class="w3-code notranslate cssHigh">
	.loader {<br>&nbsp;&nbsp;&nbsp; border: 16px solid #f3f3f3; /* Light grey */<br>&nbsp;&nbsp;&nbsp; 
	border-top: 16px solid #3498db; /* Blue */<br>&nbsp;&nbsp;&nbsp; border-radius: 50%;<br>&nbsp;&nbsp;&nbsp; 
	width: 120px;<br>&nbsp;&nbsp;&nbsp; height: 120px;<br>&nbsp;&nbsp;&nbsp; animation: 
	spin 2s linear infinite;<br>}<br><br>@keyframes spin {<br>&nbsp;&nbsp;&nbsp; 
	0% { transform: rotate(0deg); }<br>&nbsp;&nbsp;&nbsp; 100% { transform: 
	rotate(360deg); }<br>}</div>
<a target="_blank" href="tryit5ee8.html?filename=tryhow_css_loader" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>
<h3>Example Explained</h3>
<p>The <code>border</code> property specifies the border size and the border color of the loader. 
The <code>border-radius</code> property transforms the loader into a circle.</p>
<p>The blue thing that spins around inside the border is specified with the 
<code>border-top</code> property. You can also include <code>border-bottom</code>, <code>border-left</code> and/or
<code>border-right</code> if you want more "spinners" (see example below).</p>
<p>The size of the loader is specified with the <code>width</code> and <code>height</code> properties.</p>
<p>At last, we add an <code>animation</code> that makes the blue thing spin forever with a 2 
second animation speed.</p>
<p><strong>Note: </strong>You should also include -webkit- and -ms- prefixes for 
browsers that do not support animation and transform properties. Click on the 
example to see how.</p>
<hr>

<h2>Add more spinners</h2>
...
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
	.loader {<br>&nbsp;border-top: 16px solid blue;<br>&nbsp;border-bottom: 16px solid blue;<br>}</div>
<a target="_blank" href="tryit1d4f.html?filename=tryhow_css_loader2" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>
</div>
<div class="w3-third">
...
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
	.loader {<br>&nbsp;border-top: 16px solid blue;<br>&nbsp;border-right: 
	16px solid green;<br>&nbsp;border-bottom: 16px solid red;<br>}</div>
<a target="_blank" href="tryitbaca.html?filename=tryhow_css_loader3" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>
</div>
<div class="w3-third">
...
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
	.loader {<br>&nbsp;border-top: 16px solid blue;<br>&nbsp;border-right: 16px 
	solid green;<br>&nbsp;border-bottom: 16px solid red;<br>&nbsp;border-left: 
	16px solid pink;<br>}</div>
<a target="_blank" href="tryitba96.html?filename=tryhow_css_loader4" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>
</div>
...
<p>An example of how to place the loader in the middle of the page and show 
"page content" when loading is complete:</p>
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
<iframe src="tryhow_css_loader5_iframe.html" style="width:100%;border:none;height:300px;"></iframe>
</div>
<a target="_blank" href="tryit60b1.html?filename=tryhow_css_loader5" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself »</a>
</div>
...
<!-- Mirrored from www.w3schools.com/howto/howto_css_loader.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:20 GMT -->
</html>
