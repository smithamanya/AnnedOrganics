...
<!-- Mirrored from www.w3schools.com/howto/howto_js_accordion.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:21 GMT -->
<head>

<title>How To Create an Accordion</title>
...
<h1>How TO - Collapsibles/Accordion</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_css_menu_icon.asp">&laquo; Previous</a></div>
<div class="next"><a class="chapter" href="howto_css_contact_chips.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn how to create an accordion (collapsible content).</p>
<hr>
<h2>Accordion</h2>
...
<div class="w3-code notranslate htmlHigh">
	&lt;button class=&quot;accordion&quot;&gt;Section 1&lt;/button&gt;<br>&lt;div class=&quot;panel&quot;&gt;<br>&nbsp; &lt;p&gt;Lorem 
	ipsum...&lt;/p&gt;<br>&lt;/div&gt;<br><br>&lt;button class=&quot;accordion&quot;&gt;Section 
	2&lt;/button&gt;<br>&lt;div class=&quot;panel&quot;&gt;<br>&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&lt;/div&gt;<br><br>
	&lt;button class=&quot;accordion&quot;&gt;Section 3&lt;/button&gt;<br>&lt;div class=&quot;panel&quot;&gt;<br>&nbsp; &lt;p&gt;Lorem 
	ipsum...&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
	/* Style the buttons that are used to open and close the accordion panel */<br>
	button.accordion {<br>&nbsp;&nbsp;&nbsp; background-color: #eee;<br>&nbsp;&nbsp;&nbsp; 
	color: #444;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>&nbsp;&nbsp;&nbsp; padding: 18px;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
	text-align: left;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
	outline: none;<br>&nbsp;&nbsp;&nbsp; transition: 0.4s;<br>}<br>
	<br>/* Add a background color to the button if it is clicked on (add the 
	.active class with JS), and when you move the mouse over it (hover) */<br>
	button.accordion.active, button.accordion:hover {<br>&nbsp;&nbsp;&nbsp; 
	background-color: #ddd;<br>}<br><br>/* Style the accordion panel. Note: 
	hidden by default */<br>div.panel {<br>&nbsp;&nbsp;&nbsp; padding: 0 18px;<br>&nbsp;&nbsp;&nbsp; 
	background-color: white;<br>&nbsp;&nbsp;&nbsp; 
	display: none;<br>}<br><br>/* The "show" class is added to the 
	accordion panel when the user clicks on one of the buttons. This 
	will show the panel content */<br>div.panel.show {<br>&nbsp;&nbsp;&nbsp; display: block !important;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
	...
	specific accordion panel */<br>var acc = document.getElementsByClassName(&quot;accordion&quot;);<br>
	var i;<br><br>for (i = 0; i &lt; acc.length; i++) {<br>&nbsp;&nbsp;&nbsp; acc[i].onclick = 
	function(){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	this.classList.toggle(&quot;active&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	this.nextElementSibling.classList.toggle(&quot;show&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>
	}</div>
<a target="_blank" href="tryit8021.html?filename=tryhow_js_accordion" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Animated Accordion</h2>
<p>Make the following changes to the <code>panel</code> and <code>show</code> 
classes, to make an animated accordion.</p>
<p>This will make the accordion slide down (max-height) and fade in (opacity):</p>
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
	div.panel {<br>&nbsp;&nbsp;&nbsp; padding: 0 18px;<br>&nbsp;&nbsp;&nbsp; background-color: white;<br>
	&nbsp;&nbsp;&nbsp;
	max-height: 0;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; transition: 
	0.6s ease-in-out;<br>&nbsp;&nbsp;&nbsp; opacity: 0;<br>}<br><br>div.panel.show {<br>&nbsp;&nbsp;&nbsp; opacity: 1;<br>&nbsp;&nbsp;&nbsp; max-height: 
	500px; /* Whatever you like, as long as its more than the height of the 
	content (on all screen sizes) */<br>}<br></div>
<a target="_blank" href="tryit413c.html?filename=tryhow_js_accordion_animate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/howto/howto_js_accordion.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:23 GMT -->
</html>
