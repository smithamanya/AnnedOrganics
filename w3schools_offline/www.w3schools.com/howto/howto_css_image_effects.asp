...
<!-- Mirrored from www.w3schools.com/howto/howto_css_image_effects.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:14 GMT -->
<head>

<title>How To Add Filter Effects to Images</title>
...
<h1>How TO - Add Image Effects</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_html_include.html">« Previous</a></div>
<div class="next"><a class="chapter" href="howto_css_loader.asp">Next Chapter &raquo;</a></div>
</div>
<hr>
<p class="intro">Learn how to add visual effects to images.</p>
<hr>

<h2>CSS Filters</h2>
<p>The CSS <code>filter</code> property adds visual effects (like blur and saturation) to an element.</p>
<p><strong>Note:</strong> This property is not supported in Internet Explorer.</p>
...
<div class="img">
 <img class="img-responsive filter_gray" src="pineapple.jpg" alt="Pineapple">
 <div class="desc">grayscale(100%)</div>
</div>
<p style="clear:both;"></p>
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit4287.html?filename=trycss3_filter_grayscale">Try it yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Blur Example</h3>
<p>Apply a blur effect to all images:</p>
<div class="w3-code notranslate cssHigh"> 
...
<div class="img">
 <img class="img-responsive filter_blur" src="pineapple.jpg" alt="Pineapple">
 <div class="desc">blur(5px)</div>
</div>
<p style="clear:both;"></p>
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryitc88d.html?filename=trycss3_filter_blur">Try it yourself &raquo;</a>
</div>

<p style="margin-top:30px">Go to our <a href="../css/css3_filters.html">CSS Filters Tutorial</a> to learn more about 
CSS filters.</p>

<br>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_google_maps.html">« Previous</a></div>
<div class="next"><a class="chapter" href="howto_css_loader.asp">Next Chapter »</a></div>
</div>
</div>
...
<!-- Mirrored from www.w3schools.com/howto/howto_css_image_effects.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:16 GMT -->
</html>
