...
<!-- Mirrored from www.w3schools.com/howto/howto_css_menu_icon.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:20 GMT -->
<head>

<title>How To Create a Menu Icon</title>
...
<h1>How TO - Menu Icon</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_css_loader.asp">« Previous</a></div>
<div class="next"><a class="chapter" href="howto_js_accordion.asp">Next Chapter »</a></div>
</div>
<hr>
<p class="intro">Learn how to create a menu icon with CSS.</p>
<hr>
...
<a target="_blank" href="tryit4d10.html?filename=tryhow_css_menu_icon" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>
<h3>Example Explained</h3>
<p>The <code>width</code> and the <code>height</code> property specifies the width and height 
of each bar.</p>
<p>We have added a black <code>background-color</code>, and the top and bottom <code>margin</code> 
is used to 
create some distance between each bar. </p>
<hr>
...
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
	.container {<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
	cursor: pointer;<br>}<br><br>
	.bar1, .bar2, .bar3 {<br>&nbsp;&nbsp;&nbsp; width: 35px;<br>&nbsp;&nbsp;&nbsp; 
	height: 5px;<br>&nbsp;&nbsp;&nbsp; background-color: #333;<br>&nbsp;&nbsp;&nbsp; 
	margin: 6px 0;<br>&nbsp;&nbsp;&nbsp; transition: 0.4s;<br>}<br><br>/* Rotate 
	first bar */<br>.change .bar1 {<br>&nbsp;&nbsp;&nbsp; 
	-webkit-transform: rotate(-45deg) translate(-9px, 6px) ;<br>&nbsp;&nbsp;&nbsp; 
	transform: rotate(-45deg) translate(-9px, 6px) ;<br>}<br><br>/* Fade out the 
	second bar */<br>.change .bar2 {<br>&nbsp;&nbsp;&nbsp; 
	opacity: 0;<br>}<br><br>/* Rotate last bar */<br>.change .bar3 {<br>&nbsp;&nbsp;&nbsp; -webkit-transform: 
	rotate(45deg) translate(-8px, -8px) ;<br>&nbsp;&nbsp;&nbsp; transform: 
	rotate(45deg) translate(-8px, -8px) ;<br>}</div>
</div>
...
<a target="_blank" href="tryitae61.html?filename=tryhow_css_menu_icon_js" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>

<h3>Example Explained</h3>
<p>HTML &amp; CSS: We use the same styles as before, only this time, we wrap a 
container element around each &lt;div&gt; element and we specify a class name for 
each.</p>
<p>The container element is used to show a pointer symbol when the user moves 
...
<!-- Mirrored from www.w3schools.com/howto/howto_css_menu_icon.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:21 GMT -->
</html>
