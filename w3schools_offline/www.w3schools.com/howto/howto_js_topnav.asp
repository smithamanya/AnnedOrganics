...
<!-- Mirrored from www.w3schools.com/howto/howto_js_topnav.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jan 2016 10:42:26 GMT -->
<head>

<title>How To Create a Responsive Top Navigation Menu</title>
...
ul.topnav2 li a:hover {background-color: #111;}
...
<h1>How TO - Responsive Top Navigation</h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="howto_css_pagination.asp">« Previous</a></div>
<div class="next"><a class="chapter" href="howto_js_fullscreen_overlay.asp">Next Chapter »</a></div>
</div>
<hr>
<p class="intro">Learn how to create a responsive top navigation menu with CSS and JavaScript.</p>
<hr>
<h2>Top Navigation</h2>

<p>Resize the browser window to see how the responsive navigation menu works:</p>
...
<script>
function myFunction() {
    document.getElementById("myUl").classList.toggle("responsive");
}
</script>

<hr style="clear:both;">
<h2>Create A Responsive Topnav</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
	&lt;ul class="topnav"&gt;<br>&nbsp; &lt;li&gt;&lt;a href="#home"&gt;Home&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
	&lt;li&gt;&lt;a href="#news"&gt;News&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href="#contact"&gt;Contact&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
	&lt;li&gt;&lt;a href="#about"&gt;About&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li class="icon"&gt;<br>&nbsp;&nbsp;&nbsp; 
	&lt;a href="javascript:void(0);" onclick="myFunction()"&gt;&amp;#9776;&lt;/a&gt;<br>&nbsp; 
	&lt;/li&gt;<br>&lt;/ul&gt;</div>
</div>

<p>The list item with class="icon" has a link that is used to open and close the topnav on small 
screens.</p>
<hr>

<h5>Step 2) Add CSS:</h5>
<p>Style the list to look like a navigation bar:</p>
<div class="w3-example">
	<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
	/* 
	Remove margins and padding from the list, and add a black background color */<br>ul.topnav {<br>&nbsp;&nbsp;&nbsp; list-style-type: none;<br>&nbsp;&nbsp;&nbsp; 
	margin: 0;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; overflow: 
	hidden;<br>&nbsp;&nbsp;&nbsp; background-color: #333;<br>}<br><br>/* Float 
	the list items side by side */<br>ul.topnav li {float: left;}<br><br>/* 
	Style the links inside the list items */<br>ul.topnav li a {<br>&nbsp;&nbsp;&nbsp; 
	display: inline-block;<br>&nbsp;&nbsp;&nbsp; color: #f2f2f2;<br>&nbsp;&nbsp;&nbsp; 
	text-align: center;<br>&nbsp;&nbsp;&nbsp; padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; 
	text-decoration: none;<br>&nbsp;&nbsp;&nbsp; transition: 0.3s;<br>&nbsp;&nbsp;&nbsp; 
	font-size: 17px;<br>}<br><br>/* Change background color of links on hover */<br>ul.topnav li 
	a:hover {background-color: #111;}<br><br>/* Hide the list item that contains 
	the link that should open and close the topnav on small screens */<br>ul.topnav li.icon {display: none;}</div>
</div>
...
<div class="w3-code notranslate cssHigh">
	...
	contains the link to open and close the topnav (li.icon) */<br>@media screen and (max-width:680px) {<br>&nbsp; ul.topnav li:not(:first-child) 
	{display: none;}<br>&nbsp; ul.topnav li.icon {<br>&nbsp;&nbsp;&nbsp; float: 
	right;<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp; }<br>}<br><br>
	...
	screens */<br>@media screen and (max-width:680px) {<br>&nbsp; 
	ul.topnav.responsive {position: relative;}<br>&nbsp; ul.topnav.responsive 
	li.icon {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
	right: 0;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp; }<br>&nbsp; 
	ul.topnav.responsive li {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
	display: inline;<br>&nbsp; }<br>&nbsp; ul.topnav.responsive li a {<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate jsHigh">
	...
	the user clicks on the icon */<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; 
	document.getElementsByClassName("topnav")[0].classList.toggle("responsive");<br>
	}</div>
<a target="_blank" href="tryit6a5e.html?filename=tryhow_js_topnav" class="w3-btn w3-margin-bottom">Try it Yourself »</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="../css/css_navbar.html">CSS Navbar Tutorial</a> to learn more about 
navigation bars.</p>
<br>
